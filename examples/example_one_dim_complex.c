 ...
 *  AOCL-FFTZ APIs to compute 1D complex FFT problem for FFTZ_DOUBLE datatype on
...
int main()
{
     ...
     *
     * type definition for FFTZ_DOUBLE LP64 is used here.
     */
    ...
    /* STEP 1.2: Calculate input/output buffer sizes.
       ...
       sizes for higher dimension problem size. */
    ...
    FFTZ_VOID *aoclfftz_handle = aoclfftz_setup_d(&problem);
