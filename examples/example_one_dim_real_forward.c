 ...
 *  AOCL-FFTZ APIs to compute 1D real FFT problem for FFTZ_FLOAT datatype on
 *  LP64 systems. This file also contains helper macros and functions to be used
...
int main()
{
     ...
     *
     * type definition for FFTZ_FLOAT LP64 is used here.
     */
    ...
    FFTZ_VOID *aoclfftz_handle = aoclfftz_setup_f(&problem);
