...
/** @file rfft9avx512.c
 *
 *  @brief Radix-9 r2hc Real-FFT kernel with AVX-512 operations using x86 SIMD
 *  intrinsics
 *
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS][NUM_FFT_DIRS] = {
    {{0, 22, 37, 232, 139, 55}, {0, 18, 32, 232, 168, 54}},
    {{0, 22, 37, 116, 6, 55}, {0, 18, 32, 116, 6, 54}}};
...
static FFTZ_VOID r2hc_rfft9avx512_fp32_fwd(FFTZ_VOID *in_real,
                                           ...
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_s2 = _mm512_add_ps(v_in2, v_in7);
        v_s3 = _mm512_sub_ps(v_in2, v_in7);
        v_s4 = _mm512_add_ps(v_in3, v_in6);
        v_s5 = _mm512_sub_ps(v_in3, v_in6);
        v_s6 = _mm512_add_ps(v_in4, v_in5);
        v_s7 = _mm512_sub_ps(v_in4, v_in5);

        v_s8 = _mm512_add_ps(v_s0, v_s6);
        v_s9 = _mm512_add_ps(v_s8, v_s2);
        v_s10 = _mm512_sub_ps(v_s1, v_s3);
        v_s11 = _mm512_add_ps(v_s10, v_s7);
        v_s12 = _mm512_add_ps(v_s9, v_s4);
        v_s13 = _mm512_add_ps(v_s12, v_in0);
        v_m0 = _mm512_mul_ps(v_CRTM_9_4, v_s4);
        v_m1 = _mm512_mul_ps(v_CRTM_9_5, v_s5);
        v_s14 = _mm512_sub_ps(v_in0, v_m0);

        v_m2 = _mm512_mul_ps(v_CRTM_9_0, v_s0);
        v_m3 = _mm512_mul_ps(v_CRTM_9_2, v_s2);
        v_m4 = _mm512_mul_ps(v_CRTM_9_6, v_s6);
        v_m5 = _mm512_mul_ps(v_CRTM_9_1, v_s1);
        v_m6 = _mm512_mul_ps(v_CRTM_9_3, v_s3);
        v_m7 = _mm512_mul_ps(v_CRTM_9_7, v_s7);
        v_m8 = _mm512_mul_ps(v_CRTM_9_0, v_s2);
        v_m9 = _mm512_mul_ps(v_CRTM_9_2, v_s0);
        v_m10 = _mm512_mul_ps(v_CRTM_9_6, v_s2);
        v_m11 = _mm512_mul_ps(v_CRTM_9_0, v_s6);
        v_m12 = _mm512_mul_ps(v_CRTM_9_1, v_s7);
        v_m13 = _mm512_mul_ps(v_CRTM_9_3, v_s1);
        v_m14 = _mm512_mul_ps(v_CRTM_9_7, v_s3);
        ...
        // Output point 2: X(1)
        v_out1 = _mm512_add_ps(v_s16, v_s15);

        v_s17 = _mm512_add_ps(v_m5, v_m6);
        v_s18 = _mm512_add_ps(v_m7, v_m1);
        v_s19 = NEGATE_512_S(_mm512_add_ps(v_s17, v_s18));
        // Output point 3: X(2)
        v_out2 = v_s19;
        curr_out = out_cp + out_strides[1];
        STRI_2x512_S(curr_out, v_out_stride, v_out1, v_out2);

        v_s20 = _mm512_add_ps(v_m11, v_m9);
        v_s21 = _mm512_sub_ps(v_s20, v_m10);
        // Output point 4: X(3)
        v_out3 = _mm512_add_ps(v_s21, v_s14);

        v_s22 = _mm512_add_ps(v_m13, v_m14);
        v_s23 = _mm512_sub_ps(v_m1, v_s22);
        // Output point 5: X(4)
        v_out4 = _mm512_add_ps(v_s23, v_m12);
        curr_out = out_cp + out_strides[3];
        STRI_2x512_S(curr_out, v_out_stride, v_out3, v_out4);

        v_m15 = _mm512_mul_ps(v_CRTM_9_4, v_s9);
        v_s24 = _mm512_sub_ps(v_s4, v_m15);
        // Output point 6: X(5)
        v_out5 = _mm512_add_ps(v_in0, v_s24);

        v_m21 = NEGATE_512_S(_mm512_mul_ps(v_CRTM_9_5, v_s11));
        // Output point 7: X(6)
        v_out6 = v_m21;
        curr_out = out_cp + out_strides[5];
        STRI_2x512_S(curr_out, v_out_stride, v_out5, v_out6);

        v_m16 = _mm512_mul_ps(v_CRTM_9_6, v_s0);
        v_m17 = _mm512_mul_ps(v_CRTM_9_2, v_s6);
        v_s25 = _mm512_add_ps(v_s14, v_m8);
        v_s26 = _mm512_sub_ps(v_s25, v_m16);
        // Output point 8: X(7)
        v_out7 = _mm512_add_ps(v_s26, v_m17);

        v_m18 = _mm512_mul_ps(v_CRTM_9_1, v_s3);
        v_m19 = _mm512_mul_ps(v_CRTM_9_3, v_s7);
        v_s27 = _mm512_add_ps(v_m18, v_m19);
        v_s28 = _mm512_sub_ps(v_s27, v_m1);
        v_m20 = _mm512_mul_ps(v_CRTM_9_7, v_s1);
        // Output point 9: X(8)
        v_out8 = _mm512_sub_ps(v_s28, v_m20);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_S)
    {
        ...
        v_s2 = _mm256_add_ps(v_in2, v_in7);
        v_s3 = _mm256_sub_ps(v_in2, v_in7);
        v_s4 = _mm256_add_ps(v_in3, v_in6);
        v_s5 = _mm256_sub_ps(v_in3, v_in6);
        v_s6 = _mm256_add_ps(v_in4, v_in5);
        v_s7 = _mm256_sub_ps(v_in4, v_in5);

        v_s8 = _mm256_add_ps(v_s0, v_s6);
        v_s9 = _mm256_add_ps(v_s8, v_s2);
        v_s10 = _mm256_sub_ps(v_s1, v_s3);
        v_s11 = _mm256_add_ps(v_s10, v_s7);
        v_s12 = _mm256_add_ps(v_s9, v_s4);
        v_s13 = _mm256_add_ps(v_s12, v_in0);
        v_m0 = _mm256_mul_ps(v256_CRTM_9_4, v_s4);
        v_m1 = _mm256_mul_ps(v256_CRTM_9_5, v_s5);
        v_s14 = _mm256_sub_ps(v_in0, v_m0);

        v_m2 = _mm256_mul_ps(v256_CRTM_9_0, v_s0);
        v_m3 = _mm256_mul_ps(v256_CRTM_9_2, v_s2);
        v_m4 = _mm256_mul_ps(v256_CRTM_9_6, v_s6);
        v_m5 = _mm256_mul_ps(v256_CRTM_9_1, v_s1);
        v_m6 = _mm256_mul_ps(v256_CRTM_9_3, v_s3);
        v_m7 = _mm256_mul_ps(v256_CRTM_9_7, v_s7);
        v_m8 = _mm256_mul_ps(v256_CRTM_9_0, v_s2);
        v_m9 = _mm256_mul_ps(v256_CRTM_9_2, v_s0);
        v_m10 = _mm256_mul_ps(v256_CRTM_9_6, v_s2);
        v_m11 = _mm256_mul_ps(v256_CRTM_9_0, v_s6);
        v_m12 = _mm256_mul_ps(v256_CRTM_9_1, v_s7);
        v_m13 = _mm256_mul_ps(v256_CRTM_9_3, v_s1);
        ...
        // Output point 2: X(1)
        v_out1 = _mm256_add_ps(v_s16, v_s15);

        v_s17 = _mm256_add_ps(v_m5, v_m6);
        v_s18 = _mm256_add_ps(v_m7, v_m1);
        v_s19 = NEGATE_256_S(_mm256_add_ps(v_s17, v_s18));
        // Output point 3: X(2)
        v_out2 = v_s19;
        curr_out = out_cp + out_strides[1];
        STRI_2x256_S(curr_out, v_out_stride, v_out1, v_out2);

        v_s20 = _mm256_add_ps(v_m11, v_m9);
        v_s21 = _mm256_sub_ps(v_s20, v_m10);
        // Output point 4: X(3)
        v_out3 = _mm256_add_ps(v_s21, v_s14);

        v_s22 = _mm256_add_ps(v_m13, v_m14);
        v_s23 = _mm256_sub_ps(v_m1, v_s22);
        // Output point 5: X(4)
        v_out4 = _mm256_add_ps(v_s23, v_m12);
        curr_out = out_cp + out_strides[3];
        STRI_2x256_S(curr_out, v_out_stride, v_out3, v_out4);

        v_m15 = _mm256_mul_ps(v256_CRTM_9_4, v_s9);
        v_s24 = _mm256_sub_ps(v_s4, v_m15);
        // Output point 6: X(5)
        v_out5 = _mm256_add_ps(v_in0, v_s24);

        v_m21 = NEGATE_256_S(_mm256_mul_ps(v256_CRTM_9_5, v_s11));
        // Output point 7: X(6)
        v_out6 = v_m21;
        curr_out = out_cp + out_strides[5];
        STRI_2x256_S(curr_out, v_out_stride, v_out5, v_out6);

        v_m16 = _mm256_mul_ps(v256_CRTM_9_6, v_s0);
        v_m17 = _mm256_mul_ps(v256_CRTM_9_2, v_s6);
        v_s25 = _mm256_add_ps(v_s14, v_m8);
        v_s26 = _mm256_sub_ps(v_s25, v_m16);
        // Output point 8: X(7)
        v_out7 = _mm256_add_ps(v_s26, v_m17);

        v_m18 = _mm256_mul_ps(v256_CRTM_9_1, v_s3);
        v_m19 = _mm256_mul_ps(v256_CRTM_9_3, v_s7);
        v_s27 = _mm256_add_ps(v_m18, v_m19);
        v_s28 = _mm256_sub_ps(v_s27, v_m1);
        v_m20 = _mm256_mul_ps(v256_CRTM_9_7, v_s1);
        // Output point 9: X(8)
        v_out8 = _mm256_sub_ps(v_s28, v_m20);
        curr_out = out_cp + out_strides[7];
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        v_m0 = _mm_mul_ps(v128_CRTM_9_4, v_s4);
        v_m1 = _mm_mul_ps(v128_CRTM_9_5, v_s5);
        v_s14 = _mm_sub_ps(v_in0, v_m0);

        v_m2 = _mm_mul_ps(v128_CRTM_9_0, v_s0);
        v_m3 = _mm_mul_ps(v128_CRTM_9_2, v_s2);
        v_m4 = _mm_mul_ps(v128_CRTM_9_6, v_s6);
        v_m5 = _mm_mul_ps(v128_CRTM_9_1, v_s1);
        v_m6 = _mm_mul_ps(v128_CRTM_9_3, v_s3);
        v_m7 = _mm_mul_ps(v128_CRTM_9_7, v_s7);
        v_m8 = _mm_mul_ps(v128_CRTM_9_0, v_s2);
        v_m9 = _mm_mul_ps(v128_CRTM_9_2, v_s0);
        v_m10 = _mm_mul_ps(v128_CRTM_9_6, v_s2);
        v_m11 = _mm_mul_ps(v128_CRTM_9_0, v_s6);
        v_m12 = _mm_mul_ps(v128_CRTM_9_1, v_s7);
        v_m13 = _mm_mul_ps(v128_CRTM_9_3, v_s1);
        ...
        v_m15 = _mm_mul_ps(v128_CRTM_9_4, v_s9);
        v_s24 = _mm_sub_ps(v_s4, v_m15);
        // Output point 6: X(5)
        v_out5 = _mm_add_ps(v_in0, v_s24);

        v_m21 = NEGATE_128_S(_mm_mul_ps(v128_CRTM_9_5, v_s11));
        // Output point 7: X(6)
        v_out6 = v_m21;
        curr_out = out_cp + out_strides[5];
        STRI_2x128_S(curr_out, v_out_stride, v_out5, v_out6);

        v_m16 = _mm_mul_ps(v128_CRTM_9_6, v_s0);
        v_m17 = _mm_mul_ps(v128_CRTM_9_2, v_s6);
        v_s25 = _mm_add_ps(v_s14, v_m8);
        v_s26 = _mm_sub_ps(v_s25, v_m16);
        // Output point 8: X(7)
        v_out7 = _mm_add_ps(v_s26, v_m17);

        v_m18 = _mm_mul_ps(v128_CRTM_9_1, v_s3);
        v_m19 = _mm_mul_ps(v128_CRTM_9_3, v_s7);
        v_s27 = _mm_add_ps(v_m18, v_m19);
        v_s28 = _mm_sub_ps(v_s27, v_m1);
        v_m20 = _mm_mul_ps(v128_CRTM_9_7, v_s1);
        // Output point 9: X(8)
        v_out8 = _mm_sub_ps(v_s28, v_m20);
        curr_out = out_cp + out_strides[7];
    ...
    if (remaining_sets & 1)
    {
        ...
        *out_r = s11;
        ...
        s23 = s22 + m1;
        // Output point 5: X(4)
        out_cp[out_strides[4]] = s23 - m13;

        m14 = CRTM_9_4 * s9;
        s24 = in0 + s4;
        // Output point 6: X(5)
        out_cp[out_strides[5]] = s24 - m14;

        m15 = -CRTM_9_5 * s10;
        // Output point 7: X(6)
        out_cp[out_strides[6]] = m15;
        ...
        s28 = s27 - m1;
        // Output point 9: X(8)
        out_cp[out_strides[8]] = s28 - m21;
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hc_rfft9avx512_fp32_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_m0 = _mm512_mul_ps(v_CRTM_9_7, v_in6);
        v_s0 = _mm512_sub_ps(v_in0, v_in5);
        v_m1 = _mm512_mul_ps(v_CRTM_9_6, v_in5);
        v_s1 = _mm512_add_ps(v_in0, v_m1);
        v_s2 = _mm512_sub_ps(v_s0, v_m0);
        v_s3 = _mm512_add_ps(v_s0, v_m0);
        v_s4 = _mm512_add_ps(v_in7, v_in3);
        v_s5 = _mm512_sub_ps(v_in7, v_in3);
        v_m2 = _mm512_mul_ps(v_CRTM_9_5, v_s5);
        v_s6 = _mm512_add_ps(v_in8, v_in4);
        v_m3 = _mm512_mul_ps(v_CRTM_9_5, v_s6);
        v_s7 = _mm512_sub_ps(v_in4, v_in8);
        v_s8 = _mm512_add_ps(v_in1, v_s4);
        v_m4 = _mm512_mul_ps(v_CRTM_9_4, v_s7);
        v_s9 = _mm512_add_ps(v_in2, v_m4);
        v_s10 = _mm512_add_ps(v_m2, v_s9);
        v_s11 = _mm512_sub_ps(v_s9, v_m2);
        v_m5 = _mm512_mul_ps(v_CRTM_9_4, v_s4);
        v_s12 = _mm512_sub_ps(v_in1, v_m5);
        v_s13 = _mm512_sub_ps(v_s12, v_m3);
        v_s14 = _mm512_add_ps(v_s12, v_m3);
        v_m6 = _mm512_mul_ps(v_CRTM_9_6, v_s8);
        ...
        v_m7 = _mm512_mul_ps(v_CRTM_9_7, v_s17);
        v_s18 = _mm512_sub_ps(v_s16, v_m7);
        v_s19 = _mm512_add_ps(v_s16, v_m7);
        // Output point 4: x(3)
        v_out3 = v_s18;
        ...
        v_s20 = _mm512_sub_ps(v_m8, v_m9);
        v_m10 = _mm512_mul_ps(v_CRTM_9_11, v_s10);
        v_m11 = _mm512_mul_ps(v_CRTM_9_10, v_s13);
        v_s21 = _mm512_add_ps(v_m11, v_m10);
        v_s22 = _mm512_sub_ps(v_s2, v_s20);
        v_m12 = _mm512_mul_ps(v_CRTM_9_6, v_s20);
        v_s23 = _mm512_add_ps(v_s2, v_m12);
        // Output point 2: x(1)
        v_out1 = v_s23;
        ...
        v_s26 = _mm512_add_ps(v_m13, v_m14);
        v_m15 = _mm512_mul_ps(v_CRTM_9_2, v_s14);
        v_m16 = _mm512_mul_ps(v_CRTM_9_3, v_s11);
        v_s27 = _mm512_sub_ps(v_m15, v_m16);
        v_s28 = _mm512_sub_ps(v_s3, v_s27);
        v_m17 = _mm512_mul_ps(v_CRTM_9_6, v_s27);
        v_s29 = _mm512_add_ps(v_s3, v_m17);
        // Output point 3: x(2)
        v_out2 = v_s29;
    ...
    if (remaining_sets & NUM_SETS_REAL_256_S)
    {
        ...
        v_m0 = _mm256_mul_ps(v256_CRTM_9_7, v_in6);
        v_s0 = _mm256_sub_ps(v_in0, v_in5);
        v_m1 = _mm256_mul_ps(v256_CRTM_9_6, v_in5);
        v_s1 = _mm256_add_ps(v_in0, v_m1);
        v_s2 = _mm256_sub_ps(v_s0, v_m0);
        v_s3 = _mm256_add_ps(v_s0, v_m0);
        v_s4 = _mm256_add_ps(v_in7, v_in3);
        v_s5 = _mm256_sub_ps(v_in7, v_in3);
        v_m2 = _mm256_mul_ps(v256_CRTM_9_5, v_s5);
        v_s6 = _mm256_add_ps(v_in8, v_in4);
        v_m3 = _mm256_mul_ps(v256_CRTM_9_5, v_s6);
        v_s7 = _mm256_sub_ps(v_in4, v_in8);
        v_s8 = _mm256_add_ps(v_in1, v_s4);
        v_m4 = _mm256_mul_ps(v256_CRTM_9_4, v_s7);
        v_s9 = _mm256_add_ps(v_in2, v_m4);
        v_s10 = _mm256_add_ps(v_m2, v_s9);
        v_s11 = _mm256_sub_ps(v_s9, v_m2);
        v_m5 = _mm256_mul_ps(v256_CRTM_9_4, v_s4);
        v_s12 = _mm256_sub_ps(v_in1, v_m5);
        v_s13 = _mm256_sub_ps(v_s12, v_m3);
        v_s14 = _mm256_add_ps(v_s12, v_m3);
        v_m6 = _mm256_mul_ps(v256_CRTM_9_6, v_s8);
        ...
        v_m7 = _mm256_mul_ps(v256_CRTM_9_7, v_s17);
        v_s18 = _mm256_sub_ps(v_s16, v_m7);
        v_s19 = _mm256_add_ps(v_s16, v_m7);
        // Output point 4: x(3)
        v_out3 = v_s18;
        curr_out = out_r + out_strides[3];
        ...
        v_s20 = _mm256_sub_ps(v_m8, v_m9);
        v_m10 = _mm256_mul_ps(v256_CRTM_9_11, v_s10);
        v_m11 = _mm256_mul_ps(v256_CRTM_9_10, v_s13);
        v_s21 = _mm256_add_ps(v_m11, v_m10);
        v_s22 = _mm256_sub_ps(v_s2, v_s20);
        v_m12 = _mm256_mul_ps(v256_CRTM_9_6, v_s20);
        v_s23 = _mm256_add_ps(v_s2, v_m12);
        // Output point 2: x(1)
        v_out1 = v_s23;
        curr_out = out_r + out_strides[1];
        ...
        v_s26 = _mm256_add_ps(v_m13, v_m14);
        v_m15 = _mm256_mul_ps(v256_CRTM_9_2, v_s14);
        v_m16 = _mm256_mul_ps(v256_CRTM_9_3, v_s11);
        v_s27 = _mm256_sub_ps(v_m15, v_m16);
        v_s28 = _mm256_sub_ps(v_s3, v_s27);
        v_m17 = _mm256_mul_ps(v256_CRTM_9_6, v_s27);
        v_s29 = _mm256_add_ps(v_s3, v_m17);
        // Output point 3: x(2)
        v_out2 = v_s29;
        curr_out = out_r + out_strides[2];
    ...
    if (remaining_sets & 1)
    {
        ...
        *out_r = s15;
        ...
        s19 = s16 + m7;
        // Output point 4: x(3)
        out_r[out_strides[3]] = s18;
        // Output point 7: x(6)
        out_r[out_strides[6]] = s19;
        ...
        s23 = s2 + m12;
        // Output point 2: x(1)
        out_r[out_strides[1]] = s23;

        s24 = s22 + s21;
        s25 = s22 - s21;
        // Output point 8: x(7)
        out_r[out_strides[7]] = s24;
        // Output point 5: x(4)
        out_r[out_strides[4]] = s25;
        ...
        s29 = s3 + m17;
        // Output point 3: x(2)
        out_r[out_strides[2]] = s29;

        s30 = s28 + s26;
        s31 = s28 - s26;
        // Output point 9: x(8)
        out_r[out_strides[8]] = s30;
        // Output point 6: x(5)
        out_r[out_strides[5]] = s31;
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hc_rfft9avx512_fp64_fwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_s2 = _mm512_add_pd(v_in2, v_in7);
        v_s3 = _mm512_sub_pd(v_in2, v_in7);
        v_s4 = _mm512_add_pd(v_in3, v_in6);
        v_s5 = _mm512_sub_pd(v_in3, v_in6);
        v_s6 = _mm512_add_pd(v_in4, v_in5);
        v_s7 = _mm512_sub_pd(v_in4, v_in5);

        v_s8 = _mm512_add_pd(v_s0, v_s6);
        v_s9 = _mm512_add_pd(v_s8, v_s2);
        v_s10 = _mm512_sub_pd(v_s1, v_s3);
        v_s11 = _mm512_add_pd(v_s10, v_s7);
        v_s12 = _mm512_add_pd(v_s9, v_s4);
        v_s13 = _mm512_add_pd(v_s12, v_in0);
        v_m0 = _mm512_mul_pd(v_CRTM_9_4, v_s4);
        v_m1 = _mm512_mul_pd(v_CRTM_9_5, v_s5);
        v_s14 = _mm512_sub_pd(v_in0, v_m0);

        v_m2 = _mm512_mul_pd(v_CRTM_9_0, v_s0);
        v_m3 = _mm512_mul_pd(v_CRTM_9_2, v_s2);
        v_m4 = _mm512_mul_pd(v_CRTM_9_6, v_s6);
        v_m5 = _mm512_mul_pd(v_CRTM_9_1, v_s1);
        v_m6 = _mm512_mul_pd(v_CRTM_9_3, v_s3);
        v_m7 = _mm512_mul_pd(v_CRTM_9_7, v_s7);
        v_m8 = _mm512_mul_pd(v_CRTM_9_0, v_s2);
        v_m9 = _mm512_mul_pd(v_CRTM_9_2, v_s0);
        v_m10 = _mm512_mul_pd(v_CRTM_9_6, v_s2);
        v_m11 = _mm512_mul_pd(v_CRTM_9_0, v_s6);
        v_m12 = _mm512_mul_pd(v_CRTM_9_1, v_s7);
        v_m13 = _mm512_mul_pd(v_CRTM_9_3, v_s1);
        ...
        // Output point 2: X(1)
        v_out1 = _mm512_add_pd(v_s16, v_s15);

        v_s17 = _mm512_add_pd(v_m5, v_m6);
        v_s18 = _mm512_add_pd(v_m7, v_m1);
        v_s19 = NEGATE_512_D(_mm512_add_pd(v_s17, v_s18));
        // Output point 3: X(2)
        v_out2 = v_s19;
        curr_out = out_cp + out_strides[1];
        STRI_2x512_D(curr_out, v_out_stride, v_out1, v_out2);

        v_s20 = _mm512_add_pd(v_m11, v_m9);
        v_s21 = _mm512_sub_pd(v_s20, v_m10);
        // Output point 4: X(3)
        v_out3 = _mm512_add_pd(v_s21, v_s14);

        v_s22 = _mm512_add_pd(v_m13, v_m14);
        v_s23 = _mm512_sub_pd(v_m1, v_s22);
        // Output point 5: X(4)
        v_out4 = _mm512_add_pd(v_s23, v_m12);
        curr_out = out_cp + out_strides[3];
        STRI_2x512_D(curr_out, v_out_stride, v_out3, v_out4);

        v_m15 = _mm512_mul_pd(v_CRTM_9_4, v_s9);
        v_s24 = _mm512_sub_pd(v_s4, v_m15);
        // Output point 6: X(5)
        v_out5 = _mm512_add_pd(v_in0, v_s24);

        v_m21 = NEGATE_512_D(_mm512_mul_pd(v_CRTM_9_5, v_s11));
        // Output point 7: X(6)
        v_out6 = v_m21;
        curr_out = out_cp + out_strides[5];
        STRI_2x512_D(curr_out, v_out_stride, v_out5, v_out6);

        v_m16 = _mm512_mul_pd(v_CRTM_9_6, v_s0);
        v_m17 = _mm512_mul_pd(v_CRTM_9_2, v_s6);
        v_s25 = _mm512_add_pd(v_s14, v_m8);
        v_s26 = _mm512_sub_pd(v_s25, v_m16);
        // Output point 8: X(7)
        v_out7 = _mm512_add_pd(v_s26, v_m17);

        v_m18 = _mm512_mul_pd(v_CRTM_9_1, v_s3);
        v_m19 = _mm512_mul_pd(v_CRTM_9_3, v_s7);
        v_s27 = _mm512_add_pd(v_m18, v_m19);
        v_s28 = _mm512_sub_pd(v_s27, v_m1);
        v_m20 = _mm512_mul_pd(v_CRTM_9_7, v_s1);
        // Output point 9: X(8)
        v_out8 = _mm512_sub_pd(v_s28, v_m20);
        curr_out = out_cp + out_strides[7];
    ...
    if (remaining_sets & NUM_SETS_REAL_256_D)
    {
        ...
        v_s2 = _mm256_add_pd(v_in2, v_in7);
        v_s3 = _mm256_sub_pd(v_in2, v_in7);
        v_s4 = _mm256_add_pd(v_in3, v_in6);
        v_s5 = _mm256_sub_pd(v_in3, v_in6);
        v_s6 = _mm256_add_pd(v_in4, v_in5);
        v_s7 = _mm256_sub_pd(v_in4, v_in5);

        v_s8 = _mm256_add_pd(v_s0, v_s6);
        v_s9 = _mm256_add_pd(v_s8, v_s2);
        v_s10 = _mm256_sub_pd(v_s1, v_s3);
        v_s11 = _mm256_add_pd(v_s10, v_s7);
        v_s12 = _mm256_add_pd(v_s9, v_s4);
        v_s13 = _mm256_add_pd(v_s12, v_in0);
        v_m0 = _mm256_mul_pd(v256_CRTM_9_4, v_s4);
        v_m1 = _mm256_mul_pd(v256_CRTM_9_5, v_s5);
        v_s14 = _mm256_sub_pd(v_in0, v_m0);

        v_m2 = _mm256_mul_pd(v256_CRTM_9_0, v_s0);
        v_m3 = _mm256_mul_pd(v256_CRTM_9_2, v_s2);
        v_m4 = _mm256_mul_pd(v256_CRTM_9_6, v_s6);
        v_m5 = _mm256_mul_pd(v256_CRTM_9_1, v_s1);
        v_m6 = _mm256_mul_pd(v256_CRTM_9_3, v_s3);
        v_m7 = _mm256_mul_pd(v256_CRTM_9_7, v_s7);
        v_m8 = _mm256_mul_pd(v256_CRTM_9_0, v_s2);
        v_m9 = _mm256_mul_pd(v256_CRTM_9_2, v_s0);
        v_m10 = _mm256_mul_pd(v256_CRTM_9_6, v_s2);
        v_m11 = _mm256_mul_pd(v256_CRTM_9_0, v_s6);
        v_m12 = _mm256_mul_pd(v256_CRTM_9_1, v_s7);
        v_m13 = _mm256_mul_pd(v256_CRTM_9_3, v_s1);
        ...
        // Output point 2: X(1)
        v_out1 = _mm256_add_pd(v_s16, v_s15);

        v_s17 = _mm256_add_pd(v_m5, v_m6);
        v_s18 = _mm256_add_pd(v_m7, v_m1);
        v_s19 = NEGATE_256_D(_mm256_add_pd(v_s17, v_s18));
        // Output point 3: X(2)
        v_out2 = v_s19;
        curr_out = out_cp + out_strides[1];
        STRI_2x256_D(curr_out, v_out_stride, v_out1, v_out2);

        v_s20 = _mm256_add_pd(v_m11, v_m9);
        v_s21 = _mm256_sub_pd(v_s20, v_m10);
        // Output point 4: X(3)
        v_out3 = _mm256_add_pd(v_s21, v_s14);

        v_s22 = _mm256_add_pd(v_m13, v_m14);
        v_s23 = _mm256_sub_pd(v_m1, v_s22);
        // Output point 5: X(4)
        v_out4 = _mm256_add_pd(v_s23, v_m12);
        curr_out = out_cp + out_strides[3];
        STRI_2x256_D(curr_out, v_out_stride, v_out3, v_out4);

        v_m15 = _mm256_mul_pd(v256_CRTM_9_4, v_s9);
        v_s24 = _mm256_sub_pd(v_s4, v_m15);
        // Output point 6: X(5)
        v_out5 = _mm256_add_pd(v_in0, v_s24);

        v_m21 = NEGATE_256_D(_mm256_mul_pd(v256_CRTM_9_5, v_s11));
        // Output point 7: X(6)
        v_out6 = v_m21;
        curr_out = out_cp + out_strides[5];
        STRI_2x256_D(curr_out, v_out_stride, v_out5, v_out6);

        v_m16 = _mm256_mul_pd(v256_CRTM_9_6, v_s0);
        v_m17 = _mm256_mul_pd(v256_CRTM_9_2, v_s6);
        v_s25 = _mm256_add_pd(v_s14, v_m8);
        v_s26 = _mm256_sub_pd(v_s25, v_m16);
        // Output point 8: X(7)
        v_out7 = _mm256_add_pd(v_s26, v_m17);

        v_m18 = _mm256_mul_pd(v256_CRTM_9_1, v_s3);
        v_m19 = _mm256_mul_pd(v256_CRTM_9_3, v_s7);
        v_s27 = _mm256_add_pd(v_m18, v_m19);
        v_s28 = _mm256_sub_pd(v_s27, v_m1);
        v_m20 = _mm256_mul_pd(v256_CRTM_9_7, v_s1);
        // Output point 9: X(8)
        v_out8 = _mm256_sub_pd(v_s28, v_m20);
        curr_out = out_cp + out_strides[7];
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        v_m0 = _mm_mul_pd(v128_CRTM_9_4, v_s4);
        v_m1 = _mm_mul_pd(v128_CRTM_9_5, v_s5);
        v_s14 = _mm_sub_pd(v_in0, v_m0);

        v_m2 = _mm_mul_pd(v128_CRTM_9_0, v_s0);
        v_m3 = _mm_mul_pd(v128_CRTM_9_2, v_s2);
        v_m4 = _mm_mul_pd(v128_CRTM_9_6, v_s6);
        v_m5 = _mm_mul_pd(v128_CRTM_9_1, v_s1);
        v_m6 = _mm_mul_pd(v128_CRTM_9_3, v_s3);
        v_m7 = _mm_mul_pd(v128_CRTM_9_7, v_s7);
        v_m8 = _mm_mul_pd(v128_CRTM_9_0, v_s2);
        v_m9 = _mm_mul_pd(v128_CRTM_9_2, v_s0);
        v_m10 = _mm_mul_pd(v128_CRTM_9_6, v_s2);
        v_m11 = _mm_mul_pd(v128_CRTM_9_0, v_s6);
        v_m12 = _mm_mul_pd(v128_CRTM_9_1, v_s7);
        v_m13 = _mm_mul_pd(v128_CRTM_9_3, v_s1);
        ...
        v_m15 = _mm_mul_pd(v128_CRTM_9_4, v_s9);
        v_s24 = _mm_sub_pd(v_s4, v_m15);
        // Output point 6: X(5)
        v_out5 = _mm_add_pd(v_in0, v_s24);

        v_m21 = NEGATE_128_D(_mm_mul_pd(v128_CRTM_9_5, v_s11));
        // Output point 7: X(6)
        v_out6 = v_m21;
        curr_out = out_cp + out_strides[5];
        STRI_2x128_D(curr_out, v_out_stride, v_out5, v_out6);

        v_m16 = _mm_mul_pd(v128_CRTM_9_6, v_s0);
        v_m17 = _mm_mul_pd(v128_CRTM_9_2, v_s6);
        v_s25 = _mm_add_pd(v_s14, v_m8);
        v_s26 = _mm_sub_pd(v_s25, v_m16);
        // Output point 8: X(7)
        v_out7 = _mm_add_pd(v_s26, v_m17);

        v_m18 = _mm_mul_pd(v128_CRTM_9_1, v_s3);
        v_m19 = _mm_mul_pd(v128_CRTM_9_3, v_s7);
        v_s27 = _mm_add_pd(v_m18, v_m19);
        v_s28 = _mm_sub_pd(v_s27, v_m1);
        v_m20 = _mm_mul_pd(v128_CRTM_9_7, v_s1);
        // Output point 9: X(8)
        v_out8 = _mm_sub_pd(v_s28, v_m20);
        curr_out = out_cp + out_strides[7];
    ...
    if (remaining_sets & 1)
    {
        FFTZ_DOUBLE in0, in1, in2, in3, in4, in5, in6, in7, in8;
...
static FFTZ_VOID r2hc_rfft9avx512_fp64_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_m0 = _mm512_mul_pd(v_CRTM_9_7, v_in6);
        v_s0 = _mm512_sub_pd(v_in0, v_in5);
        v_m1 = _mm512_mul_pd(v_CRTM_9_6, v_in5);
        v_s1 = _mm512_add_pd(v_in0, v_m1);
        v_s2 = _mm512_sub_pd(v_s0, v_m0);
        v_s3 = _mm512_add_pd(v_s0, v_m0);
        v_s4 = _mm512_add_pd(v_in7, v_in3);
        v_s5 = _mm512_sub_pd(v_in7, v_in3);
        v_m2 = _mm512_mul_pd(v_CRTM_9_5, v_s5);
        v_s6 = _mm512_add_pd(v_in8, v_in4);
        v_m3 = _mm512_mul_pd(v_CRTM_9_5, v_s6);
        v_s7 = _mm512_sub_pd(v_in4, v_in8);
        v_s8 = _mm512_add_pd(v_in1, v_s4);
        v_m4 = _mm512_mul_pd(v_CRTM_9_4, v_s7);
        v_s9 = _mm512_add_pd(v_in2, v_m4);
        v_s10 = _mm512_add_pd(v_m2, v_s9);
        v_s11 = _mm512_sub_pd(v_s9, v_m2);
        v_m5 = _mm512_mul_pd(v_CRTM_9_4, v_s4);
        v_s12 = _mm512_sub_pd(v_in1, v_m5);
        v_s13 = _mm512_sub_pd(v_s12, v_m3);
        v_s14 = _mm512_add_pd(v_s12, v_m3);
        v_m6 = _mm512_mul_pd(v_CRTM_9_6, v_s8);
        ...
        v_m7 = _mm512_mul_pd(v_CRTM_9_7, v_s17);
        v_s18 = _mm512_sub_pd(v_s16, v_m7);
        v_s19 = _mm512_add_pd(v_s16, v_m7);
        // Output point 4: x(3)
        v_out3 = v_s18;
        curr_out = out_r + out_strides[3];
        ...
        v_s20 = _mm512_sub_pd(v_m8, v_m9);
        v_m10 = _mm512_mul_pd(v_CRTM_9_11, v_s10);
        v_m11 = _mm512_mul_pd(v_CRTM_9_10, v_s13);
        v_s21 = _mm512_add_pd(v_m11, v_m10);
        v_s22 = _mm512_sub_pd(v_s2, v_s20);
        v_m12 = _mm512_mul_pd(v_CRTM_9_6, v_s20);
        v_s23 = _mm512_add_pd(v_s2, v_m12);
        // Output point 2: x(1)
        v_out1 = v_s23;
        curr_out = out_r + out_strides[1];
        ...
        v_s26 = _mm512_add_pd(v_m13, v_m14);
        v_m15 = _mm512_mul_pd(v_CRTM_9_2, v_s14);
        v_m16 = _mm512_mul_pd(v_CRTM_9_3, v_s11);
        v_s27 = _mm512_sub_pd(v_m15, v_m16);
        v_s28 = _mm512_sub_pd(v_s3, v_s27);
        v_m17 = _mm512_mul_pd(v_CRTM_9_6, v_s27);
        v_s29 = _mm512_add_pd(v_s3, v_m17);
        // Output point 3: x(2)
        v_out2 = v_s29;
        curr_out = out_r + out_strides[2];
    ...
    if (remaining_sets & NUM_SETS_REAL_256_D)
    {
        ...
        v_m0 = _mm256_mul_pd(v256_CRTM_9_7, v_in6);
        v_s0 = _mm256_sub_pd(v_in0, v_in5);
        v_m1 = _mm256_mul_pd(v256_CRTM_9_6, v_in5);
        v_s1 = _mm256_add_pd(v_in0, v_m1);
        v_s2 = _mm256_sub_pd(v_s0, v_m0);
        v_s3 = _mm256_add_pd(v_s0, v_m0);
        v_s4 = _mm256_add_pd(v_in7, v_in3);
        v_s5 = _mm256_sub_pd(v_in7, v_in3);
        v_m2 = _mm256_mul_pd(v256_CRTM_9_5, v_s5);
        v_s6 = _mm256_add_pd(v_in8, v_in4);
        v_m3 = _mm256_mul_pd(v256_CRTM_9_5, v_s6);
        v_s7 = _mm256_sub_pd(v_in4, v_in8);
        v_s8 = _mm256_add_pd(v_in1, v_s4);
        v_m4 = _mm256_mul_pd(v256_CRTM_9_4, v_s7);
        v_s9 = _mm256_add_pd(v_in2, v_m4);
        v_s10 = _mm256_add_pd(v_m2, v_s9);
        v_s11 = _mm256_sub_pd(v_s9, v_m2);
        v_m5 = _mm256_mul_pd(v256_CRTM_9_4, v_s4);
        v_s12 = _mm256_sub_pd(v_in1, v_m5);
        v_s13 = _mm256_sub_pd(v_s12, v_m3);
        v_s14 = _mm256_add_pd(v_s12, v_m3);
        v_m6 = _mm256_mul_pd(v256_CRTM_9_6, v_s8);
        ...
        v_m7 = _mm256_mul_pd(v256_CRTM_9_7, v_s17);
        v_s18 = _mm256_sub_pd(v_s16, v_m7);
        v_s19 = _mm256_add_pd(v_s16, v_m7);
        // Output point 4: x(3)
        v_out3 = v_s18;
        curr_out = out_r + out_strides[3];
        ...
        v_s20 = _mm256_sub_pd(v_m8, v_m9);
        v_m10 = _mm256_mul_pd(v256_CRTM_9_11, v_s10);
        v_m11 = _mm256_mul_pd(v256_CRTM_9_10, v_s13);
        v_s21 = _mm256_add_pd(v_m11, v_m10);
        v_s22 = _mm256_sub_pd(v_s2, v_s20);
        v_m12 = _mm256_mul_pd(v256_CRTM_9_6, v_s20);
        v_s23 = _mm256_add_pd(v_s2, v_m12);
        // Output point 2: x(1)
        v_out1 = v_s23;
        curr_out = out_r + out_strides[1];
        ...
        v_s26 = _mm256_add_pd(v_m13, v_m14);
        v_m15 = _mm256_mul_pd(v256_CRTM_9_2, v_s14);
        v_m16 = _mm256_mul_pd(v256_CRTM_9_3, v_s11);
        v_s27 = _mm256_sub_pd(v_m15, v_m16);
        v_s28 = _mm256_sub_pd(v_s3, v_s27);
        v_m17 = _mm256_mul_pd(v256_CRTM_9_6, v_s27);
        v_s29 = _mm256_add_pd(v_s3, v_m17);
        // Output point 3: x(2)
        v_out2 = v_s29;
        curr_out = out_r + out_strides[2];
                                       ...
                                       FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft9avx512_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft9avx512_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft9avx512_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft9avx512_fp64_bwd;
        }
        else
        {
            return NULL;
