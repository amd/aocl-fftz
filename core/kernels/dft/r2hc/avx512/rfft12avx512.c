...
static FFTZ_VOID r2hc_rfft12avx512_fp32_fwd(FFTZ_VOID *in_real,
...
static FFTZ_VOID r2hc_rfft12avx512_fp32_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 12: x(11)
        curr_in = in_r + in_strides[11];
        LDR_512_S(curr_in, v_in_dc_nyq_stride, v_in11, is_contiguous_in_dc_nyq);
...
static FFTZ_VOID r2hc_rfft12avx512_fp64_fwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
...
static FFTZ_VOID r2hc_rfft12avx512_fp64_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 12: x(11)
        curr_in = in_r + in_strides[11];
        LDR_512_D(curr_in, v_in_dc_nyq_stride, v_in11, is_contiguous_in_dc_nyq);
