...
static FFTZ_VOID r2hc_rfft2avx512_fp32(FFTZ_VOID *in_real,
                                       ...
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        LDR_512_S(curr_in, v_in_dc_nyq_stride, v_in1, is_contiguous_in_dc_nyq);
        // Output point 1: X(0)
    ...
    if (remaining_sets & NUM_SETS_REAL_256_S)
    {
        ...
        // Input point 2: x(1)
        curr_in = in_r + in_strides[1];
        LDR_256_S(curr_in, v_in_dc_nyq_stride, v_in1, is_contiguous_in_dc_nyq);
        // Output point 1: X(0)
...
static FFTZ_VOID r2hc_rfft2avx512_fp64(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 2: x(1)
        curr_in = in_r + in_strides[1];
        LDR_512_D(curr_in, v_in_dc_nyq_stride, v_in1, is_contiguous_in_dc_nyq);
        // Output point 1: X(0)
    ...
    if (remaining_sets & NUM_SETS_REAL_256_D)
    {
        ...
        // Input point 2: x(1)
        curr_in = in_r + in_strides[1];
        LDR_256_D(curr_in, v_in_dc_nyq_stride, v_in1, is_contiguous_in_dc_nyq);
        // Output point 1: X(0)
