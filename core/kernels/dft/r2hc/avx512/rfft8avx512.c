...
/** @file rfft8avx512.c
 *
 *  @brief Radix-8 r2hc Real-FFT kernel with AVX-512 operations using x86 SIMD
 *  intrinsics
 *
...
static FFTZ_VOID r2hc_rfft8avx512_fp32_fwd(FFTZ_VOID *in_real,
                                           ...
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        __m512 v_in0, v_in1, v_in2, v_in3, v_in4, v_in5, v_in6, v_in7;
        ...
        v_s0 = _mm512_add_ps(v_in7, v_in5);
        v_s1 = _mm512_sub_ps(v_in7, v_in5);
        v_s2 = _mm512_add_ps(v_in6, v_in2);
        v_s3 = _mm512_sub_ps(v_in2, v_in6);
        v_s4 = _mm512_add_ps(v_in4, v_in0);
        v_s5 = _mm512_sub_ps(v_in0, v_in4);
        v_s6 = _mm512_add_ps(v_in3, v_in1);
        v_s7 = _mm512_sub_ps(v_in3, v_in1);

        v_s8 = _mm512_add_ps(v_s6, v_s0);
        v_s9 = _mm512_add_ps(v_s4, v_s2);
        v_s10 = _mm512_sub_ps(v_s1, v_s7);
        v_s11 = _mm512_sub_ps(v_s0, v_s6);

        v_t0 = _mm512_mul_ps(v_CRTM_8_1, v_s10);
        v_t1 = _mm512_mul_ps(v_CRTM_8_1, v_s11);
        // Output point 1: X(0)
        v_out0 = _mm512_add_ps(v_s9, v_s8);
        // Output point 2: X(1)
        v_out1 = _mm512_add_ps(v_t0, v_s5);
        // Output point 3: X(2)
        v_out2 = _mm512_sub_ps(v_t1, v_s3);
        // Output point 4: X(3)
        v_out3 = _mm512_sub_ps(v_s4, v_s2);
        // Output point 5: X(4)
        v_out4 = _mm512_add_ps(v_s7, v_s1);
        // Output point 6: X(5)
        v_out5 = _mm512_sub_ps(v_s5, v_t0);
        // Output point 7: X(6)
        v_out6 = _mm512_add_ps(v_s3, v_t1);
        // Output point 8: X(7)
        v_out7 = _mm512_sub_ps(v_s9, v_s8);
        ...
        STR_512_S(curr_out, v_out_dc_nyq_stride, v_out7, is_contiguous_out_dc_nyq);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_S)
    {
        ...
        v_t0 = _mm256_mul_ps(v256_CRTM_8_1, v_s10);
        v_t1 = _mm256_mul_ps(v256_CRTM_8_1, v_s11);
        // Output point 1: X(0)
        ...
        curr_out = out_r + out_strides[7];
        STR_256_S(curr_out, v_out_dc_nyq_stride, v_out7, is_contiguous_out_dc_nyq);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        curr_out = out_r + out_strides[7];
        STR_128_S(curr_out, v_out_dc_nyq_stride, v_out7, is_contiguous_out_dc_nyq);
    ...
    if (remaining_sets & 2)
    {
        ...
        curr_out = out_r + out_strides[7];
        STHR_128_S(curr_out, v_out_dc_nyq_stride, v_out7);
    ...
    if (remaining_sets & 1)
    {
        ...
        *out_r = s9 + s8;
        // Output point 2: X(1)
        out_cp[out_strides[1]] = s5 + t0;
        // Output point 3: X(2)
        out_cp[out_strides[2]] = t1 - s3;
        // Output point 4: X(3)
        out_cp[out_strides[3]] = s4 - s2;
        // Output point 5: X(4)
        out_cp[out_strides[4]] = s7 + s1;
        // Output point 6: X(5)
        out_cp[out_strides[5]] = s5 - t0;
        // Output point 7: X(6)
        out_cp[out_strides[6]] = s3 + t1;
        // Output point 8: X(7)
        out_r[out_strides[7]] = s9 - s8;
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hc_rfft8avx512_fp32_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_512_S(curr_in, v_in_dc_nyq_stride, v_in7, is_contiguous_in_dc_nyq);

        v_s0 = _mm512_add_ps(v_in7, v_in0);
        v_s1 = _mm512_sub_ps(v_in7, v_in0);
        v_s2 = _mm512_add_ps(v_in6, v_in2);
        v_t0 = _mm512_mul_ps(v_CRTM_8_2, _mm512_sub_ps(v_in2, v_in6));
        v_t1 = _mm512_mul_ps(v_CRTM_8_2, _mm512_add_ps(v_in5, v_in1));
        v_s3 = _mm512_sub_ps(v_in5, v_in1);
        v_s4 = _mm512_add_ps(v_in4, v_in4);
        v_s5 = _mm512_add_ps(v_in3, v_in3);

        v_t2 = _mm512_mul_ps(v_CRTM_8_1, _mm512_add_ps(v_s3, v_s2));
        v_t3 = _mm512_mul_ps(v_CRTM_8_1, _mm512_sub_ps(v_s3, v_s2));
        v_s6 = _mm512_add_ps(v_s5, v_s0);
        v_s7 = _mm512_sub_ps(v_s0, v_s5);
        v_s8 = _mm512_add_ps(v_s4, v_s1);
        v_s9 = _mm512_sub_ps(v_s4, v_s1);
        // Output point 1: X(0)
        v_out0 = _mm512_add_ps(v_s6, v_t1);
        // Output point 2: X(1)
        v_out1 = NEGATE_512_S(_mm512_add_ps(v_s8, v_t2));
        // Output point 3: X(2)
        v_out2 = _mm512_sub_ps(v_s7, v_t0);
        // Output point 4: X(3)
        v_out3 = _mm512_add_ps(v_s9, v_t3);
        // Output point 5: X(4)
        v_out4 = _mm512_sub_ps(v_s6, v_t1);
        // Output point 6: X(5)
        v_out5 = _mm512_sub_ps(v_t2, v_s8);
        // Output point 7: X(6)
        v_out6 = _mm512_add_ps(v_s7, v_t0);
        // Output point 8: X(7)
        v_out7 = _mm512_sub_ps(v_s9, v_t3);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_S)
    {
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_256_S(curr_in, v_in_dc_nyq_stride, v_in7, is_contiguous_in_dc_nyq);

        v_s0 = _mm256_add_ps(v_in7, v_in0);
        v_s1 = _mm256_sub_ps(v_in7, v_in0);
        v_s2 = _mm256_add_ps(v_in6, v_in2);
        v_t0 = _mm256_mul_ps(v256_CRTM_8_2, _mm256_sub_ps(v_in2, v_in6));
        v_t1 = _mm256_mul_ps(v256_CRTM_8_2, _mm256_add_ps(v_in5, v_in1));
        v_s3 = _mm256_sub_ps(v_in5, v_in1);
        v_s4 = _mm256_add_ps(v_in4, v_in4);
        v_s5 = _mm256_add_ps(v_in3, v_in3);

        v_t2 = _mm256_mul_ps(v256_CRTM_8_1, _mm256_add_ps(v_s3, v_s2));
        v_t3 = _mm256_mul_ps(v256_CRTM_8_1, _mm256_sub_ps(v_s3, v_s2));
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_128_S(curr_in, v_in_dc_nyq_stride, v_in7, is_contiguous_in_dc_nyq);
    ...
    if (remaining_sets & 2)
    {
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDHR_128_S(curr_in, v_in_dc_nyq_stride, v_in7);
    ...
    if (remaining_sets & 1)
    {
        ...
        *out_r = s6 + t1;
        // Output point 2: X(1)
        out_r[out_strides[1]] = -s8 - t2;
        // Output point 3: X(2)
        out_r[out_strides[2]] = -s7 + t0;
        // Output point 4: X(3)
        out_r[out_strides[3]] = s9 + t3;
        // Output point 5: X(4)
        out_r[out_strides[4]] = s6 - t1;
        // Output point 6: X(5)
        out_r[out_strides[5]] = t2 - s8;
        // Output point 7: X(6)
        out_r[out_strides[6]] = -s7 - t0;
        // Output point 8: X(7)
        out_r[out_strides[7]] = s9 - t3;
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hc_rfft8avx512_fp64_fwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        __m512d v_in0, v_in1, v_in2, v_in3, v_in4, v_in5, v_in6, v_in7;
        ...
        v_s0 = _mm512_add_pd(v_in7, v_in5);
        v_s1 = _mm512_sub_pd(v_in7, v_in5);
        v_s2 = _mm512_add_pd(v_in6, v_in2);
        v_s3 = _mm512_sub_pd(v_in2, v_in6);
        v_s4 = _mm512_add_pd(v_in4, v_in0);
        v_s5 = _mm512_sub_pd(v_in0, v_in4);
        v_s6 = _mm512_add_pd(v_in3, v_in1);
        v_s7 = _mm512_sub_pd(v_in3, v_in1);

        v_s8 = _mm512_add_pd(v_s6, v_s0);
        v_s9 = _mm512_add_pd(v_s4, v_s2);
        v_s10 = _mm512_sub_pd(v_s1, v_s7);
        v_s11 = _mm512_sub_pd(v_s0, v_s6);

        v_t0 = _mm512_mul_pd(v_CRTM_8_1, v_s10);
        v_t1 = _mm512_mul_pd(v_CRTM_8_1, v_s11);
        // Output point 1: X(0)
        v_out0 = _mm512_add_pd(v_s9, v_s8);
        // Output point 2: X(1)
        v_out1 = _mm512_add_pd(v_t0, v_s5);
        // Output point 3: X(2)
        v_out2 = _mm512_sub_pd(v_t1, v_s3);
        // Output point 4: X(3)
        v_out3 = _mm512_sub_pd(v_s4, v_s2);
        // Output point 5: X(4)
        v_out4 = _mm512_add_pd(v_s7, v_s1);
        // Output point 6: X(5)
        v_out5 = _mm512_sub_pd(v_s5, v_t0);
        // Output point 7: X(6)
        v_out6 = _mm512_add_pd(v_s3, v_t1);
        // Output point 8: X(7)
        v_out7 = _mm512_sub_pd(v_s9, v_s8);
        ...
        curr_out = out_r + out_strides[7];
        STR_512_D(curr_out, v_out_dc_nyq_stride, v_out7, is_contiguous_out_dc_nyq);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_D)
    {
        ...
        v_t0 = _mm256_mul_pd(v256_CRTM_8_1, v_s10);
        v_t1 = _mm256_mul_pd(v256_CRTM_8_1, v_s11);
        // Output point 1: X(0)
        v_out0 = _mm256_add_pd(v_s9, v_s8);
        // Output point 2: X(1)
        v_out1 = _mm256_add_pd(v_s5, v_t0);
        // Output point 3: X(2)
        ...
        curr_out = out_r + out_strides[7];
        STR_256_D(curr_out, v_out_dc_nyq_stride, v_out7, is_contiguous_out_dc_nyq);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        curr_out = out_r + out_strides[7];
        STR_128_D(curr_out, v_out_dc_nyq_stride, v_out7, is_contiguous_out_dc_nyq);
...
static FFTZ_VOID r2hc_rfft8avx512_fp64_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_512_D(curr_in, v_in_dc_nyq_stride, v_in7, is_contiguous_in_dc_nyq);

        v_s0 = _mm512_add_pd(v_in7, v_in0);
        v_s1 = _mm512_sub_pd(v_in7, v_in0);
        v_s2 = _mm512_add_pd(v_in6, v_in2);
        v_t0 = _mm512_mul_pd(v_CRTM_8_2, _mm512_sub_pd(v_in2, v_in6));
        v_t1 = _mm512_mul_pd(v_CRTM_8_2, _mm512_add_pd(v_in5, v_in1));
        v_s3 = _mm512_sub_pd(v_in5, v_in1);
        v_s4 = _mm512_add_pd(v_in4, v_in4);
        v_s5 = _mm512_add_pd(v_in3, v_in3);

        v_t2 = _mm512_mul_pd(v_CRTM_8_1, _mm512_add_pd(v_s3, v_s2));
        v_t3 = _mm512_mul_pd(v_CRTM_8_1, _mm512_sub_pd(v_s3, v_s2));
        v_s6 = _mm512_add_pd(v_s5, v_s0);
        v_s7 = _mm512_sub_pd(v_s0, v_s5);
        v_s8 = _mm512_add_pd(v_s4, v_s1);
        v_s9 = _mm512_sub_pd(v_s4, v_s1);
        // Output point 1: X(0)
        v_out0 = _mm512_add_pd(v_s6, v_t1);
        // Output point 2: X(1)
        v_out1 = NEGATE_512_D(_mm512_add_pd(v_s8, v_t2));
        // Output point 3: X(2)
        v_out2 = _mm512_sub_pd(v_s7, v_t0);
        // Output point 4: X(3)
        v_out3 = _mm512_add_pd(v_s9, v_t3);
        // Output point 5: X(4)
        v_out4 = _mm512_sub_pd(v_s6, v_t1);
        // Output point 6: X(5)
        v_out5 = _mm512_sub_pd(v_t2, v_s8);
        // Output point 7: X(6)
        v_out6 = _mm512_add_pd(v_s7, v_t0);
        // Output point 8: X(7)
        v_out7 = _mm512_sub_pd(v_s9, v_t3);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_D)
    {
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_256_D(curr_in, v_in_dc_nyq_stride, v_in7, is_contiguous_in_dc_nyq);

        v_s0 = _mm256_add_pd(v_in7, v_in0);
        v_s1 = _mm256_sub_pd(v_in7, v_in0);
        v_s2 = _mm256_add_pd(v_in6, v_in2);
        v_t0 = _mm256_mul_pd(v256_CRTM_8_2, _mm256_sub_pd(v_in2, v_in6));
        v_t1 = _mm256_mul_pd(v256_CRTM_8_2, _mm256_add_pd(v_in5, v_in1));
        v_s3 = _mm256_sub_pd(v_in5, v_in1);
        v_s4 = _mm256_add_pd(v_in4, v_in4);
        v_s5 = _mm256_add_pd(v_in3, v_in3);

        v_t2 = _mm256_mul_pd(v256_CRTM_8_1, _mm256_add_pd(v_s3, v_s2));
        v_t3 = _mm256_mul_pd(v256_CRTM_8_1, _mm256_sub_pd(v_s3, v_s2));
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_128_D(curr_in, v_in_dc_nyq_stride, v_in7, is_contiguous_in_dc_nyq);
                                       ...
                                       FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft8avx512_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft8avx512_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft8avx512_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft8avx512_fp64_bwd;
        }
        else
        {
            return NULL;
