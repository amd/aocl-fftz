...
/** @file rfft3avx256.c
 *
 *  @brief Radix-3 r2hc Real-FFT kernel with AVX-256 operations using x86 SIMD
 *  intrinsics
 *
...
static FFTZ_VOID r2hc_rfft3avx256_fp32_fwd(FFTZ_VOID *in_real,
                                           ...
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_tv0 = _mm256_mul_ps(v_CRTM_3_1, v_av0);
        v_tv1 = _mm256_mul_ps(v_CRTM_3_2, v_av1);
    ...
    if (remaining_sets & 1)
    {
        ...
        *out_r = v_in0 + v_av0;
        ...
        // Output point 2: X(1)
        out_cp[out_strides[1]] = v_in0 - v_tv0;

        // Output point 3: X(2)
        out_cp[out_strides[2]] = v_tv1;
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hc_rfft3avx256_fp32_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_tv0 = _mm256_mul_ps(v_CRTM_3_1, v_in2);
    ...
    if (remaining_sets & 1)
    {
        ...
        *out_r = v_in0 + 2 * v_in1;
        ...
        // Output point 2: X(1)
        out_r[out_strides[1]] = v_av0 - v_tv0;

        // Output point 3: X(2)
        out_r[out_strides[2]] = v_av0 + v_tv0;
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hc_rfft3avx256_fp64_fwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_tv0 = _mm256_mul_pd(v_CRTM_3_1, v_av0);
        v_tv1 = _mm256_mul_pd(v_CRTM_3_2, v_av1);
...
static FFTZ_VOID r2hc_rfft3avx256_fp64_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_tv0 = _mm256_mul_pd(v_CRTM_3_1, v_in2);
                                       ...
                                       FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft3avx256_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft3avx256_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft3avx256_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft3avx256_fp64_bwd;
        }
        else
        {
            return NULL;
