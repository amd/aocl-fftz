...
/** @file rfft7avx256.c
 *
 *  @brief Radix-7 r2hc Real-FFT kernel with AVX-256 operations using x86 SIMD
 *  intrinsics
 *
...
static FFTZ_VOID r2hc_rfft7avx256_fp32_fwd(FFTZ_VOID *in_real,
                                           ...
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm256_mul_ps(v_CRTM_7_1, v_s4);
        v_t1 = _mm256_mul_ps(v_CRTM_7_3, v_s0);
        v_t2 = _mm256_mul_ps(v_CRTM_7_5, v_s2);
        v_s8 = _mm256_sub_ps(v_in0, v_t0);
        v_s9 = _mm256_sub_ps(v_t1, v_t2);
        // Output point 2: X(1)
        v_out1 = _mm256_add_ps(v_s8, v_s9);

        v_t3 = _mm256_mul_ps(v_CRTM_7_2, v_s5);
        v_t4 = _mm256_mul_ps(v_CRTM_7_4, v_s1);
        v_t5 = _mm256_mul_ps(v_CRTM_7_6, v_s3);
        v_s10 = _mm256_add_ps(v_t3, v_t4);
        // Output point 3: X(2)
        v_out2 = _mm256_add_ps(v_t5, v_s10);

        v_t6 = _mm256_mul_ps(v_CRTM_7_1, v_s2);
        v_t7 = _mm256_mul_ps(v_CRTM_7_3, v_s4);
        v_t8 = _mm256_mul_ps(v_CRTM_7_5, v_s0);
        v_s11 = _mm256_sub_ps(v_in0, v_t6);
        v_s12 = _mm256_sub_ps(v_t7, v_t8);
        // Output point 4: X(3)
        v_out3 = _mm256_add_ps(v_s11, v_s12);

        v_t9 = _mm256_mul_ps(v_CRTM_7_2, v_s3);
        v_t10 = _mm256_mul_ps(v_CRTM_7_4, v_s5);
        v_t11 = _mm256_mul_ps(v_CRTM_7_6, v_s1);
        v_s13 = _mm256_add_ps(v_t9, v_t10);
        // Output point 5: X(4)
        v_out4 = _mm256_sub_ps(v_t11, v_s13);

        v_t12 = _mm256_mul_ps(v_CRTM_7_1, v_s0);
        v_t13 = _mm256_mul_ps(v_CRTM_7_3, v_s2);
        v_t14 = _mm256_mul_ps(v_CRTM_7_5, v_s4);
        v_s14 = _mm256_sub_ps(v_in0, v_t12);
        v_s15 = _mm256_sub_ps(v_t13, v_t14);
        // Output point 6: X(5)
        v_out5 = _mm256_add_ps(v_s14, v_s15);

        v_t15 = _mm256_mul_ps(v_CRTM_7_2, v_s1);
        v_t16 = _mm256_mul_ps(v_CRTM_7_4, v_s3);
        v_t17 = _mm256_mul_ps(v_CRTM_7_6, v_s5);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        __m128 v_128_CRTM_7_1 = _mm256_castps256_ps128(v_CRTM_7_1);
        __m128 v_128_CRTM_7_2 = _mm256_castps256_ps128(v_CRTM_7_2);
        __m128 v_128_CRTM_7_3 = _mm256_castps256_ps128(v_CRTM_7_3);
        __m128 v_128_CRTM_7_4 = _mm256_castps256_ps128(v_CRTM_7_4);
        __m128 v_128_CRTM_7_5 = _mm256_castps256_ps128(v_CRTM_7_5);
        __m128 v_128_CRTM_7_6 = _mm256_castps256_ps128(v_CRTM_7_6);
...
static FFTZ_VOID r2hc_rfft7avx256_fp32_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm256_mul_ps(v_CRTM_7_1, v_in5);
        v_t1 = _mm256_mul_ps(v_CRTM_7_3, v_in1);
        v_t2 = _mm256_mul_ps(v_CRTM_7_5, v_in3);
        v_s0 = _mm256_sub_ps(v_in0, v_t0);
        v_s1 = _mm256_sub_ps(v_t1, v_t2);
        v_s2 = _mm256_add_ps(v_s0, v_s1);

        v_t3 = _mm256_mul_ps(v_CRTM_7_2, v_in6);
        v_t4 = _mm256_mul_ps(v_CRTM_7_4, v_in2);
        v_t5 = _mm256_mul_ps(v_CRTM_7_6, v_in4);
        ...
        v_t6 = _mm256_mul_ps(v_CRTM_7_1, v_in3);
        v_t7 = _mm256_mul_ps(v_CRTM_7_3, v_in5);
        v_t8 = _mm256_mul_ps(v_CRTM_7_5, v_in1);
        v_s5 = _mm256_sub_ps(v_in0, v_t6);
        v_s6 = _mm256_sub_ps(v_t7, v_t8);
        v_s7 = _mm256_add_ps(v_s5, v_s6);

        v_t9 = _mm256_mul_ps(v_CRTM_7_2, v_in4);
        v_t10 = _mm256_mul_ps(v_CRTM_7_4, v_in6);
        v_t11 = _mm256_mul_ps(v_CRTM_7_6, v_in2);
        ...
        v_t12 = _mm256_mul_ps(v_CRTM_7_1, v_in1);
        v_t13 = _mm256_mul_ps(v_CRTM_7_3, v_in3);
        v_t14 = _mm256_mul_ps(v_CRTM_7_5, v_in5);
        v_s10 = _mm256_sub_ps(v_in0, v_t12);
        v_s11 = _mm256_sub_ps(v_t13, v_t14);
        v_s12 = _mm256_add_ps(v_s10, v_s11);

        v_t15 = _mm256_mul_ps(v_CRTM_7_2, v_in2);
        v_t16 = _mm256_mul_ps(v_CRTM_7_4, v_in4);
        v_t17 = _mm256_mul_ps(v_CRTM_7_6, v_in6);
        ...
        v_t18 = _mm256_mul_ps(v_CRTM_7_7, v_s16);
        // Output point 1: X(0)
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        __m128 v_128_CRTM_7_5 = _mm256_castps256_ps128(v_CRTM_7_5);
        __m128 v_128_CRTM_7_6 = _mm256_castps256_ps128(v_CRTM_7_6);
        __m128 v_128_CRTM_7_7 = _mm256_castps256_ps128(v_CRTM_7_7);
...
static FFTZ_VOID r2hc_rfft7avx256_fp64_fwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm256_mul_pd(v_CRTM_7_1, v_s4);
        v_t1 = _mm256_mul_pd(v_CRTM_7_3, v_s0);
        v_t2 = _mm256_mul_pd(v_CRTM_7_5, v_s2);
        v_s8 = _mm256_sub_pd(v_in0, v_t0);
        v_s9 = _mm256_sub_pd(v_t1, v_t2);
        // Output point 2: X(1)
        v_out1 = _mm256_add_pd(v_s8, v_s9);

        v_t3 = _mm256_mul_pd(v_CRTM_7_2, v_s5);
        v_t4 = _mm256_mul_pd(v_CRTM_7_4, v_s1);
        v_t5 = _mm256_mul_pd(v_CRTM_7_6, v_s3);
        v_s10 = _mm256_add_pd(v_t3, v_t4);
        // Output point 3: X(2)
        v_out2 = _mm256_add_pd(v_t5, v_s10);

        v_t6 = _mm256_mul_pd(v_CRTM_7_1, v_s2);
        v_t7 = _mm256_mul_pd(v_CRTM_7_3, v_s4);
        v_t8 = _mm256_mul_pd(v_CRTM_7_5, v_s0);
        v_s11 = _mm256_sub_pd(v_in0, v_t6);
        v_s12 = _mm256_sub_pd(v_t7, v_t8);
        // Output point 4: X(3)
        v_out3 = _mm256_add_pd(v_s11, v_s12);

        v_t9 = _mm256_mul_pd(v_CRTM_7_2, v_s3);
        v_t10 = _mm256_mul_pd(v_CRTM_7_4, v_s5);
        v_t11 = _mm256_mul_pd(v_CRTM_7_6, v_s1);
        v_s13 = _mm256_add_pd(v_t9, v_t10);
        // Output point 5: X(4)
        v_out4 = _mm256_sub_pd(v_t11, v_s13);

        v_t12 = _mm256_mul_pd(v_CRTM_7_1, v_s0);
        v_t13 = _mm256_mul_pd(v_CRTM_7_3, v_s2);
        v_t14 = _mm256_mul_pd(v_CRTM_7_5, v_s4);
        v_s14 = _mm256_sub_pd(v_in0, v_t12);
        v_s15 = _mm256_sub_pd(v_t13, v_t14);
        // Output point 6: X(5)
        v_out5 = _mm256_add_pd(v_s14, v_s15);

        v_t15 = _mm256_mul_pd(v_CRTM_7_2, v_s1);
        v_t16 = _mm256_mul_pd(v_CRTM_7_4, v_s3);
        v_t17 = _mm256_mul_pd(v_CRTM_7_6, v_s5);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        __m128d v_128_CRTM_7_1 = _mm256_castpd256_pd128(v_CRTM_7_1);
        __m128d v_128_CRTM_7_2 = _mm256_castpd256_pd128(v_CRTM_7_2);
        __m128d v_128_CRTM_7_3 = _mm256_castpd256_pd128(v_CRTM_7_3);
        __m128d v_128_CRTM_7_4 = _mm256_castpd256_pd128(v_CRTM_7_4);
        __m128d v_128_CRTM_7_5 = _mm256_castpd256_pd128(v_CRTM_7_5);
        __m128d v_128_CRTM_7_6 = _mm256_castpd256_pd128(v_CRTM_7_6);
...
static FFTZ_VOID r2hc_rfft7avx256_fp64_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm256_mul_pd(v_CRTM_7_1, v_in5);
        v_t1 = _mm256_mul_pd(v_CRTM_7_3, v_in1);
        v_t2 = _mm256_mul_pd(v_CRTM_7_5, v_in3);
        v_s0 = _mm256_sub_pd(v_in0, v_t0);
        v_s1 = _mm256_sub_pd(v_t1, v_t2);
        v_s2 = _mm256_add_pd(v_s0, v_s1);

        v_t3 = _mm256_mul_pd(v_CRTM_7_2, v_in6);
        v_t4 = _mm256_mul_pd(v_CRTM_7_4, v_in2);
        v_t5 = _mm256_mul_pd(v_CRTM_7_6, v_in4);
        ...
        v_t6 = _mm256_mul_pd(v_CRTM_7_1, v_in3);
        v_t7 = _mm256_mul_pd(v_CRTM_7_3, v_in5);
        v_t8 = _mm256_mul_pd(v_CRTM_7_5, v_in1);
        v_s5 = _mm256_sub_pd(v_in0, v_t6);
        v_s6 = _mm256_sub_pd(v_t7, v_t8);
        v_s7 = _mm256_add_pd(v_s5, v_s6);

        v_t9 = _mm256_mul_pd(v_CRTM_7_2, v_in4);
        v_t10 = _mm256_mul_pd(v_CRTM_7_4, v_in6);
        v_t11 = _mm256_mul_pd(v_CRTM_7_6, v_in2);
        ...
        v_t12 = _mm256_mul_pd(v_CRTM_7_1, v_in1);
        v_t13 = _mm256_mul_pd(v_CRTM_7_3, v_in3);
        v_t14 = _mm256_mul_pd(v_CRTM_7_5, v_in5);
        v_s10 = _mm256_sub_pd(v_in0, v_t12);
        v_s11 = _mm256_sub_pd(v_t13, v_t14);
        v_s12 = _mm256_add_pd(v_s10, v_s11);

        v_t15 = _mm256_mul_pd(v_CRTM_7_2, v_in2);
        v_t16 = _mm256_mul_pd(v_CRTM_7_4, v_in4);
        v_t17 = _mm256_mul_pd(v_CRTM_7_6, v_in6);
        ...
        v_t18 = _mm256_mul_pd(v_CRTM_7_7, v_s16);
        // Output point 1: X(0)
        curr_out = out_r + out_strides[0];
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        __m128d v_128_CRTM_7_5 = _mm256_castpd256_pd128(v_CRTM_7_5);
        __m128d v_128_CRTM_7_6 = _mm256_castpd256_pd128(v_CRTM_7_6);
        __m128d v_128_CRTM_7_7 = _mm256_castpd256_pd128(v_CRTM_7_7);
                                       ...
                                       FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft7avx256_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft7avx256_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft7avx256_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft7avx256_fp64_bwd;
        }
        else
        {
            return NULL;
