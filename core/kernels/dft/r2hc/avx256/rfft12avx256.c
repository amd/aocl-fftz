...
/** @file rfft12avx256.c
 *
 *  @brief Radix-12 r2hc Real-FFT kernel with AVX-256 operations using x86 SIMD
 *  intrinsics
 *
...
static FFTZ_VOID r2hc_rfft12avx256_fp32_fwd(FFTZ_VOID *in_real,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm256_mul_ps(v_CRTM_12_2, v_s15);
        v_t1 = _mm256_mul_ps(v_CRTM_12_2, v_s17);
        ...
        v_t2 = _mm256_mul_ps(v_CRTM_12_1, v_s13);
        v_t3 = _mm256_mul_ps(v_CRTM_12_2, v_s20);
        v_t4 = _mm256_mul_ps(v_CRTM_12_2, v_s21);
        v_t5 = _mm256_mul_ps(v_CRTM_12_1, v_s25);
    ...
    if (remaining_sets & 1)
    {
        ...
        FFTZ_FLOAT s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13,
            ...
            s27;
        FFTZ_FLOAT t0, t1, t2, t3, t4, t5;

        in0 = *in_r;                 // Input point 1: x(0)
        in1 = in_r[in_strides[1]];   // Input point 2: x(1)
        in2 = in_r[in_strides[2]];   // Input point 3: x(2)
        in3 = in_r[in_strides[3]];   // Input point 4: x(3)
        in4 = in_r[in_strides[4]];   // Input point 5: x(4)
        in5 = in_r[in_strides[5]];   // Input point 6: x(5)
        in6 = in_r[in_strides[6]];   // Input point 7: x(6)
        in7 = in_r[in_strides[7]];   // Input point 8: x(7)
        in8 = in_r[in_strides[8]];   // Input point 9: x(8)
        in9 = in_r[in_strides[9]];   // Input point 10: x(9)
        in10 = in_r[in_strides[10]]; // Input point 11: x(10)
        in11 = in_r[in_strides[11]]; // Input point 12: x(11)
        ...
        *out_r = s20 + s18;                      // output pt 1: X(0)
        out_cp[out_strides[1]] = s22 + t2;        // output pt 2: X(1)
        out_cp[out_strides[2]] = s23 + t5;        // output pt 2: X(1)
        out_cp[out_strides[3]] = t4 + s19;        // output pt 4: X(3)
        out_cp[out_strides[4]] = CRTM_12_1 * s26; // output pt 5: X(4)
        out_cp[out_strides[5]] = s5 - s15;        // output pt 6: X(5)
        out_cp[out_strides[6]] = s17 - s11;       // output pt 7: X(6)
        out_cp[out_strides[7]] = s18 - t3;        // output pt 8: X(7)
        out_cp[out_strides[8]] = CRTM_12_1 * s27; // output pt 9: X(8)
        out_cp[out_strides[9]] = s22 - t2;        // output pt 10: X(9)
        out_cp[out_strides[10]] = s23 - t5;       // output pt 11: X(10)
        out_r[out_strides[11]] = s19 - s21;      // output pt 12: X(11)
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hc_rfft12avx256_fp32_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 12: x(11)
        curr_in = in_r + in_strides[11];
        LDR_256_S(curr_in, v_in_dc_nyq_stride, v_in11, is_contiguous_in_dc_nyq);
        ...
        v_t0 = _mm256_mul_ps(v_CRTM_12_2, v_in5);
        v_t1 = _mm256_mul_ps(v_CRTM_12_2, v_in6);

        v_s10 = _mm256_add_ps(v_s2, v_s4);
        v_s11 = _mm256_add_ps(v_s0, v_t0);
        v_s12 = _mm256_sub_ps(v_s0, v_t0);
        v_s13 = _mm256_mul_ps(v_CRTM_12_2, v_s10);

        v_s14 = _mm256_add_ps(v_s3, v_s6);
        v_s15 = _mm256_sub_ps(v_s3, v_s6);
        v_t2 = _mm256_mul_ps(v_CRTM_12_1, v_s14);
        v_t3 = _mm256_mul_ps(v_CRTM_12_1, v_s15);

        v_s16 = _mm256_add_ps(v_s9, v_s7);
        v_s17 = _mm256_sub_ps(v_s9, v_s7);
        v_t4 = _mm256_mul_ps(v_CRTM_12_1, v_s16);
        v_t5 = _mm256_mul_ps(v_CRTM_12_1, v_s17);

        v_s18 = _mm256_add_ps(v_s5, v_s8);
        v_s19 = _mm256_sub_ps(v_s5, v_s8);
        v_s20 = _mm256_sub_ps(v_s2, v_s4);
        v_t6 = _mm256_mul_ps(v_CRTM_12_2, v_s18);
        v_t7 = _mm256_mul_ps(v_CRTM_12_2, v_s19);
        v_t8 = _mm256_mul_ps(v_CRTM_12_2, v_s20);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        // Input point 12: x(11)
        curr_in = in_r + in_strides[11];
        LDR_128_S(curr_in, v_in_dc_nyq_stride, v_in11, is_contiguous_in_dc_nyq);
    ...
    if (remaining_sets & 2)
    {
        ...
        // Input point 12: x(11)
        curr_in = in_r + in_strides[11];
        LDHR_128_S(curr_in, v_in_dc_nyq_stride, v_in11);
    ...
    if (remaining_sets & 1)
    {
        ...
        FFTZ_FLOAT s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13,
            s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, s25, s26;
        FFTZ_FLOAT t0, t1, t2, t3, t4, t5, t6, t7, t8;

        in0 = *in_r;                 // Input point 1: X(0)
        in1 = in_cp[in_strides[1]];   // Input point 2: X(1)
        in2 = in_cp[in_strides[2]];   // Input point 3: X(2)
        in3 = in_cp[in_strides[3]];   // Input point 4: X(3)
        in4 = in_cp[in_strides[4]];   // Input point 5: X(4)
        in5 = in_cp[in_strides[5]];   // Input point 6: X(5)
        in6 = in_cp[in_strides[6]];   // Input point 7: X(6)
        in7 = in_cp[in_strides[7]];   // Input point 8: X(7)
        in8 = in_cp[in_strides[8]];   // Input point 9: X(8)
        in9 = in_cp[in_strides[9]];   // Input point 10: X(9)
        in10 = in_cp[in_strides[10]]; // Input point 11: X(10)
        in11 = in_r[in_strides[11]]; // Input point 12: X(11)
        ...
        *out_r = s11 + s13;                // output pt 1: x(0)
        out_r[out_strides[1]] = t3 + s23;  // output pt 2: x(1)
        out_r[out_strides[2]] = t5 + s26;  // output pt 3: x(2)
        out_r[out_strides[3]] = s22 - t6;  // output pt 4: x(3)
        out_r[out_strides[4]] = s25 + t4;  // output pt 5: x(4)
        out_r[out_strides[5]] = s23 - t3;  // output pt 6: x(5)
        out_r[out_strides[6]] = s12 - t8;  // output pt 7: x(6)
        out_r[out_strides[7]] = s24 - t2;  // output pt 8: x(7)
        out_r[out_strides[8]] = s25 - t4;  // output pt 9: x(8)
        out_r[out_strides[9]] = s21 - t7;  // output pt 10: x(9)
        out_r[out_strides[10]] = s26 - t5; // output pt 11: x(10)
        out_r[out_strides[11]] = s24 + t2; // output pt 12: x(11)
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hc_rfft12avx256_fp64_fwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm256_mul_pd(v_CRTM_12_2, v_s15);
        v_t1 = _mm256_mul_pd(v_CRTM_12_2, v_s17);
        ...
        v_t2 = _mm256_mul_pd(v_CRTM_12_1, v_s13);
        v_t3 = _mm256_mul_pd(v_CRTM_12_2, v_s20);
        v_t4 = _mm256_mul_pd(v_CRTM_12_2, v_s21);
        v_t5 = _mm256_mul_pd(v_CRTM_12_1, v_s25);
...
static FFTZ_VOID r2hc_rfft12avx256_fp64_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 12: x(11)
        curr_in = in_r + in_strides[11];
        LDR_256_D(curr_in, v_in_dc_nyq_stride, v_in11, is_contiguous_in_dc_nyq);
        ...
        v_t0 = _mm256_mul_pd(v_CRTM_12_2, v_in5);
        v_t1 = _mm256_mul_pd(v_CRTM_12_2, v_in6);

        v_s10 = _mm256_add_pd(v_s2, v_s4);
        v_s11 = _mm256_add_pd(v_s0, v_t0);
        v_s12 = _mm256_sub_pd(v_s0, v_t0);
        v_s13 = _mm256_mul_pd(v_CRTM_12_2, v_s10);

        v_s14 = _mm256_add_pd(v_s3, v_s6);
        v_s15 = _mm256_sub_pd(v_s3, v_s6);
        v_t2 = _mm256_mul_pd(v_CRTM_12_1, v_s14);
        v_t3 = _mm256_mul_pd(v_CRTM_12_1, v_s15);

        v_s16 = _mm256_add_pd(v_s9, v_s7);
        v_s17 = _mm256_sub_pd(v_s9, v_s7);
        v_t4 = _mm256_mul_pd(v_CRTM_12_1, v_s16);
        v_t5 = _mm256_mul_pd(v_CRTM_12_1, v_s17);

        v_s18 = _mm256_add_pd(v_s5, v_s8);
        v_s19 = _mm256_sub_pd(v_s5, v_s8);
        v_s20 = _mm256_sub_pd(v_s2, v_s4);
        v_t6 = _mm256_mul_pd(v_CRTM_12_2, v_s18);
        v_t7 = _mm256_mul_pd(v_CRTM_12_2, v_s19);
        v_t8 = _mm256_mul_pd(v_CRTM_12_2, v_s20);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        // Input point 12: x(11)
        curr_in = in_r + in_strides[11];
        LDR_128_D(curr_in, v_in_dc_nyq_stride, v_in11, is_contiguous_in_dc_nyq);
    ...
    if (remaining_sets & 1)
    {
        ...
        FFTZ_DOUBLE s0, s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11, s12, s13,
            s14, s15, s16, s17, s18, s19, s20, s21, s22, s23, s24, s25, s26;
        FFTZ_DOUBLE t0, t1, t2, t3, t4, t5, t6, t7, t8;
                                        ...
                                        FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft12avx256_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft12avx256_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft12avx256_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft12avx256_fp64_bwd;
        }
        else
        {
            return NULL;
