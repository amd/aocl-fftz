...
/** @file rfft9avx256.c
 *
 *  @brief Radix-9 r2hc Real-FFT kernel with AVX-256 operations using x86 SIMD
 *  intrinsics
 *
...
static FFTZ_VOID r2hc_rfft9avx256_fp32_fwd(FFTZ_VOID *in_real,
                                           ...
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_m0 = _mm256_mul_ps(v_CRTM_9_4, v_s4);
        v_m1 = _mm256_mul_ps(v_CRTM_9_5, v_s5);
        v_s14 = _mm256_sub_ps(v_in0, v_m0);

        v_m2 = _mm256_mul_ps(v_CRTM_9_0, v_s0);
        v_m3 = _mm256_mul_ps(v_CRTM_9_2, v_s2);
        v_m4 = _mm256_mul_ps(v_CRTM_9_6, v_s6);
        v_m5 = _mm256_mul_ps(v_CRTM_9_1, v_s1);
        v_m6 = _mm256_mul_ps(v_CRTM_9_3, v_s3);
        v_m7 = _mm256_mul_ps(v_CRTM_9_7, v_s7);
        v_m8 = _mm256_mul_ps(v_CRTM_9_0, v_s2);
        v_m9 = _mm256_mul_ps(v_CRTM_9_2, v_s0);
        v_m10 = _mm256_mul_ps(v_CRTM_9_6, v_s2);
        v_m11 = _mm256_mul_ps(v_CRTM_9_0, v_s6);
        v_m12 = _mm256_mul_ps(v_CRTM_9_1, v_s7);
        v_m13 = _mm256_mul_ps(v_CRTM_9_3, v_s1);
        v_m14 = _mm256_mul_ps(v_CRTM_9_7, v_s3);
        // Output point 1: X(0)
        v_out0 = v_s13;
        STR_256_S(curr_out, v_out_dc_nyq_stride, v_out0, is_contiguous_out_dc_nyq);

        v_s15 = _mm256_add_ps(v_s14, v_m2);
        v_s16 = _mm256_sub_ps(v_m3, v_m4);
        // Output point 2: X(1)
        v_out1 = _mm256_add_ps(v_s15, v_s16);
        ...
        v_m15 = _mm256_mul_ps(v_CRTM_9_4, v_s9);
        v_s24 = _mm256_sub_ps(v_s4, v_m15);
        // Output point 6: X(5)
        v_out5 = _mm256_add_ps(v_in0, v_s24);

        v_m16 = NEGATE_256_S(_mm256_mul_ps(v_CRTM_9_5, v_s11));
        // Output point 7: X(6)
        v_out6 = v_m16;
        ...
        v_m17 = _mm256_mul_ps(v_CRTM_9_6, v_s0);
        v_s26 = _mm256_sub_ps(v_s25, v_m17);
        v_m18 = _mm256_mul_ps(v_CRTM_9_2, v_s6);
        // Output point 8: X(7)
        v_out7 = _mm256_add_ps(v_s26, v_m18);

        v_m19 = _mm256_mul_ps(v_CRTM_9_1, v_s3);
        v_m20 = _mm256_mul_ps(v_CRTM_9_3, v_s7);
        v_s27 = _mm256_add_ps(v_m19, v_m20);
        v_s28 = _mm256_sub_ps(v_s27, v_m1);
        v_m21 = _mm256_mul_ps(v_CRTM_9_7, v_s1);
        // Output point 9: X(8)
        v_out8 = _mm256_sub_ps(v_s28, v_m21);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        v_m16 = NEGATE_128_S(_mm_mul_ps(v128_CRTM_9_5, v_s11));
        // Output point 7: X(6)
        v_out6 = v_m16;
        curr_out = out_cp + out_strides[5];
        ...
        v_m17 = _mm_mul_ps(v128_CRTM_9_6, v_s0);
        v_s26 = _mm_sub_ps(v_s25, v_m17);
        v_m18 = _mm_mul_ps(v128_CRTM_9_2, v_s6);
        // Output point 8: X(7)
        v_out7 = _mm_add_ps(v_s26, v_m18);

        v_m19 = _mm_mul_ps(v128_CRTM_9_1, v_s3);
        v_m20 = _mm_mul_ps(v128_CRTM_9_3, v_s7);
        v_s27 = _mm_add_ps(v_m19, v_m20);
        v_s28 = _mm_sub_ps(v_s27, v_m1);
        v_m21 = _mm_mul_ps(v128_CRTM_9_7, v_s1);
        // Output point 9: X(8)
        v_out8 = _mm_sub_ps(v_s28, v_m21);
        curr_out = out_cp + out_strides[7];
...
static FFTZ_VOID r2hc_rfft9avx256_fp32_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_m0 = _mm256_mul_ps(v_CRTM_9_7, v_in6);
        v_s0 = _mm256_sub_ps(v_in0, v_in5);
        v_m1 = _mm256_mul_ps(v_CRTM_9_6, v_in5);
        ...
        v_m7 = _mm256_mul_ps(v_CRTM_9_7, v_s17);
        ...
        v_m8 = _mm256_mul_ps(v_CRTM_9_0, v_s13);
        v_m9 = _mm256_mul_ps(v_CRTM_9_1, v_s10);
        v_s20 = _mm256_sub_ps(v_m8, v_m9);
        v_m10 = _mm256_mul_ps(v_CRTM_9_11, v_s10);
        v_m11 = _mm256_mul_ps(v_CRTM_9_10, v_s13);
        v_s21 = _mm256_add_ps(v_m11, v_m10);
        v_s22 = _mm256_sub_ps(v_s2, v_s20);
        v_m12 = _mm256_mul_ps(v_CRTM_9_6, v_s20);
        ...
        v_m13 = _mm256_mul_ps(v_CRTM_9_8, v_s14);
        v_m14 = _mm256_mul_ps(v_CRTM_9_9, v_s11);
        v_s26 = _mm256_add_ps(v_m13, v_m14);
        v_m15 = _mm256_mul_ps(v_CRTM_9_2, v_s14);
        v_m16 = _mm256_mul_ps(v_CRTM_9_3, v_s11);
        v_s27 = _mm256_sub_ps(v_m15, v_m16);
        v_s28 = _mm256_sub_ps(v_s3, v_s27);
        v_m17 = _mm256_mul_ps(v_CRTM_9_6, v_s27);
...
static FFTZ_VOID r2hc_rfft9avx256_fp64_fwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_m0 = _mm256_mul_pd(v_CRTM_9_4, v_s4);
        v_m1 = _mm256_mul_pd(v_CRTM_9_5, v_s5);
        v_s14 = _mm256_sub_pd(v_in0, v_m0);

        v_m2 = _mm256_mul_pd(v_CRTM_9_0, v_s0);
        v_m3 = _mm256_mul_pd(v_CRTM_9_2, v_s2);
        v_m4 = _mm256_mul_pd(v_CRTM_9_6, v_s6);
        v_m5 = _mm256_mul_pd(v_CRTM_9_1, v_s1);
        v_m6 = _mm256_mul_pd(v_CRTM_9_3, v_s3);
        v_m7 = _mm256_mul_pd(v_CRTM_9_7, v_s7);
        v_m8 = _mm256_mul_pd(v_CRTM_9_0, v_s2);
        v_m9 = _mm256_mul_pd(v_CRTM_9_2, v_s0);
        v_m10 = _mm256_mul_pd(v_CRTM_9_6, v_s2);
        v_m11 = _mm256_mul_pd(v_CRTM_9_0, v_s6);
        v_m12 = _mm256_mul_pd(v_CRTM_9_1, v_s7);
        v_m13 = _mm256_mul_pd(v_CRTM_9_3, v_s1);
        v_m14 = _mm256_mul_pd(v_CRTM_9_7, v_s3);
        // Output point 1: X(0)
        v_out0 = v_s13;
        STR_256_D(curr_out, v_out_dc_nyq_stride, v_out0, is_contiguous_out_dc_nyq);

        v_s15 = _mm256_add_pd(v_s14, v_m2);
        v_s16 = _mm256_sub_pd(v_m3, v_m4);
        // Output point 2: X(1)
        v_out1 = _mm256_add_pd(v_s15, v_s16);
        ...
        v_m15 = _mm256_mul_pd(v_CRTM_9_4, v_s9);
        v_s24 = _mm256_sub_pd(v_s4, v_m15);
        // Output point 6: X(5)
        v_out5 = _mm256_add_pd(v_in0, v_s24);

        v_m16 = NEGATE_256_D(_mm256_mul_pd(v_CRTM_9_5, v_s11));
        // Output point 7: X(6)
        v_out6 = v_m16;
        curr_out = out_cp + out_strides[5];
        ...
        v_m17 = _mm256_mul_pd(v_CRTM_9_6, v_s0);
        v_s26 = _mm256_sub_pd(v_s25, v_m17);
        v_m18 = _mm256_mul_pd(v_CRTM_9_2, v_s6);
        // Output point 8: X(7)
        v_out7 = _mm256_add_pd(v_s26, v_m18);

        v_m19 = _mm256_mul_pd(v_CRTM_9_1, v_s3);
        v_m20 = _mm256_mul_pd(v_CRTM_9_3, v_s7);
        v_s27 = _mm256_add_pd(v_m19, v_m20);
        v_s28 = _mm256_sub_pd(v_s27, v_m1);
        v_m21 = _mm256_mul_pd(v_CRTM_9_7, v_s1);
        // Output point 9: X(8)
        v_out8 = _mm256_sub_pd(v_s28, v_m21);
        curr_out = out_cp + out_strides[7];
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        v_m16 = NEGATE_128_D(_mm_mul_pd(v128_CRTM_9_5, v_s11));
        // Output point 7: X(6)
        v_out6 = v_m16;
        curr_out = out_cp + out_strides[5];
        ...
        v_m17 = _mm_mul_pd(v128_CRTM_9_6, v_s0);
        v_s26 = _mm_sub_pd(v_s25, v_m17);
        v_m18 = _mm_mul_pd(v128_CRTM_9_2, v_s6);
        // Output point 8: X(7)
        v_out7 = _mm_add_pd(v_s26, v_m18);

        v_m19 = _mm_mul_pd(v128_CRTM_9_1, v_s3);
        v_m20 = _mm_mul_pd(v128_CRTM_9_3, v_s7);
        v_s27 = _mm_add_pd(v_m19, v_m20);
        v_s28 = _mm_sub_pd(v_s27, v_m1);
        v_m21 = _mm_mul_pd(v128_CRTM_9_7, v_s1);
        // Output point 9: X(8)
        v_out8 = _mm_sub_pd(v_s28, v_m21);
        curr_out = out_cp + out_strides[7];
...
static FFTZ_VOID r2hc_rfft9avx256_fp64_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    const FFTZ_DOUBLE CRTM_9_10 =
        1.113340798452838732905825904094046265936583819;
    // CRTM_9_11 = CRTM_9_3 + CRTM_9_6 * CRTM_9_2 * CRTM_9_3
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_m0 = _mm256_mul_pd(v_CRTM_9_7, v_in6);
        v_s0 = _mm256_sub_pd(v_in0, v_in5);
        v_m1 = _mm256_mul_pd(v_CRTM_9_6, v_in5);
        ...
        v_m7 = _mm256_mul_pd(v_CRTM_9_7, v_s17);
        ...
        v_m8 = _mm256_mul_pd(v_CRTM_9_0, v_s13);
        v_m9 = _mm256_mul_pd(v_CRTM_9_1, v_s10);
        v_s20 = _mm256_sub_pd(v_m8, v_m9);
        v_m10 = _mm256_mul_pd(v_CRTM_9_11, v_s10);
        v_m11 = _mm256_mul_pd(v_CRTM_9_10, v_s13);
        v_s21 = _mm256_add_pd(v_m11, v_m10);
        v_s22 = _mm256_sub_pd(v_s2, v_s20);
        v_m12 = _mm256_mul_pd(v_CRTM_9_6, v_s20);
        ...
        v_m13 = _mm256_mul_pd(v_CRTM_9_8, v_s14);
        v_m14 = _mm256_mul_pd(v_CRTM_9_9, v_s11);
        v_s26 = _mm256_add_pd(v_m13, v_m14);
        v_m15 = _mm256_mul_pd(v_CRTM_9_2, v_s14);
        v_m16 = _mm256_mul_pd(v_CRTM_9_3, v_s11);
        v_s27 = _mm256_sub_pd(v_m15, v_m16);
        v_s28 = _mm256_sub_pd(v_s3, v_s27);
        v_m17 = _mm256_mul_pd(v_CRTM_9_6, v_s27);
                                       ...
                                       FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft9avx256_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft9avx256_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft9avx256_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft9avx256_fp64_bwd;
        }
        else
        {
            return NULL;
