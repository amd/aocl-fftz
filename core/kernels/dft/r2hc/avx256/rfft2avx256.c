...
/** @file rfft2avx256.c
 *
 *  @brief Radix-2 r2hc Real-FFT kernel with AVX-256 operations using x86 SIMD
 *  intrinsics
 *
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 0, 2, 32, 24, 4},
                                                     {0, 0, 2, 16, 0, 4}};
...
static FFTZ_VOID r2hc_rfft2avx256_fp32(FFTZ_VOID *in_real,
...
static FFTZ_VOID r2hc_rfft2avx256_fp64(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
                                       ...
                                       FFTZ_UINT8 direction)
{
    ...
    if (precision == DT_FLOAT)
    {
        return r2hc_rfft2avx256_fp32;
    }
    else if (precision == DT_DOUBLE)
    {
        return r2hc_rfft2avx256_fp64;
    }
    else
    {
        return NULL;
