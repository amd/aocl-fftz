...
static VOID r2hc_rfft6avx256_fp32_fwd(VOID *in_real, VOID *in_imag,
...
static VOID r2hc_rfft6avx256_fp32_bwd(VOID *in_real, VOID *in_imag,
                                      VOID *out_real, VOID *out_imag, INTP n,
                                      aoclfftz_strides_t *strides, VOID *twd, UINT8 flag)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
...
static VOID r2hc_rfft6avx256_fp64_fwd(VOID *in_real, VOID *in_imag,
                                      VOID *out_real, VOID *out_imag, INTP n,
                                      aoclfftz_strides_t *strides, VOID *twd, UINT8 flag)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
    ...
    if (remaining_sets & 1)
    {
        ...
        *out = s0 + s6;
        ...
        // Output point 5: X(4)
        out[out_strides[4]] = CRTM_6_2 * (s3 + s5);
...
static VOID r2hc_rfft6avx256_fp64_bwd(VOID *in_real, VOID *in_imag,
                                      VOID *out_real, VOID *out_imag, INTP n,
                                      aoclfftz_strides_t *strides, VOID *twd, UINT8 flag)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
