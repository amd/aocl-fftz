...
static FFTZ_VOID r2hc_rfft5avx256_fp32_fwd(FFTZ_VOID *in_real,
                                           ...
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_s5 = _mm256_sub_ps(v_in0, _mm256_mul_ps(v_CRTM_5_4, v_s6));
        v_t1 = _mm256_mul_ps(v_CRTM_5_1, _mm256_sub_ps(v_s1, v_s3));
        // Output point 1: X(0)
        v_out0 = _mm256_add_ps(v_in0, v_s6);
        // Output point 2: X(1)
        v_out1 = _mm256_add_ps(v_s5, v_t1);
        // Output point 3: X(2)
        v_out2 = _mm256_sub_ps(_mm256_mul_ps(v_CRTM_5_2, v_s2),
                               _mm256_mul_ps(v_CRTM_5_3, v_s4));
        // Output point 4: X(3)
        v_out3 = _mm256_sub_ps(v_s5, v_t1);
        // Output point 5: X(4)
        v_out4 = _mm256_add_ps(_mm256_mul_ps(v_CRTM_5_2, v_s4),
                               _mm256_mul_ps(v_CRTM_5_3, v_s2));
    ...
    if (remaining_sets & 1)
    {
        ...
        *out_r = in0 + s6;
        // Output point 2: X(1)
        out_cp[out_strides[1]] = s5 + t1;
        // Output point 3: X(2)
        out_cp[out_strides[2]] = (CRTM_5_2 * s2) - (CRTM_5_3 * s4);
        // Output point 4: X(3)
        out_cp[out_strides[3]] = s5 - t1;
        // Output point 5: X(4)
        out_cp[out_strides[4]] = (CRTM_5_2 * s4) + (CRTM_5_3 * s2);
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hc_rfft5avx256_fp32_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t1 = _mm256_mul_ps(v_CRTM_5_1, _mm256_sub_ps(v_in1, v_in3));
        v_s5 = _mm256_sub_ps(v_in0, _mm256_mul_ps(v_CRTM_5_4, v_s6));
        v_s1 = _mm256_add_ps(v_s5, v_t1);
        v_s2 = _mm256_sub_ps(v_s5, v_t1);
        v_s3 = _mm256_add_ps(_mm256_mul_ps(v_CRTM_5_2, v_in2),
                             _mm256_mul_ps(v_CRTM_5_3, v_in4));
        v_s4 = _mm256_sub_ps(_mm256_mul_ps(v_CRTM_5_2, v_in4),
                             _mm256_mul_ps(v_CRTM_5_3, v_in2));
        // Output point 1: X(0)
        v_out0 = _mm256_add_ps(v_in0, _mm256_mul_ps(v_CRTM_5_5, v_s6));
        // Output point 2: X(1)
    ...
    if (remaining_sets & 1)
    {
        ...
        // Output point 1: X(0)
        *out_r = in0 + CRTM_5_5 * s6;
        // Output point 2: X(1)
        out_r[out_strides[1]] = s1 - s3;
        // Output point 3: X(2)
        out_r[out_strides[2]] = s2 + s4;
        // Output point 4: X(3)
        out_r[out_strides[3]] = s2 - s4;
        // Output point 5: X(4)
        out_r[out_strides[4]] = s1 + s3;
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hc_rfft5avx256_fp64_fwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_s5 = _mm256_sub_pd(v_in0, _mm256_mul_pd(v_CRTM_5_4, v_s6));
        v_t1 = _mm256_mul_pd(v_CRTM_5_1, _mm256_sub_pd(v_s1, v_s3));
        // Output point 1: X(0)
        v_out0 = _mm256_add_pd(v_in0, v_s6);
        // Output point 2: X(1)
        v_out1 = _mm256_add_pd(v_s5, v_t1);
        // Output point 3: X(2)
        v_out2 = _mm256_sub_pd(_mm256_mul_pd(v_CRTM_5_2, v_s2),
                               _mm256_mul_pd(v_CRTM_5_3, v_s4));
        // Output point 4: X(3)
        v_out3 = _mm256_sub_pd(v_s5, v_t1);
        // Output point 5: X(4)
        v_out4 = _mm256_add_pd(_mm256_mul_pd(v_CRTM_5_2, v_s4),
                               _mm256_mul_pd(v_CRTM_5_3, v_s2));
...
static FFTZ_VOID r2hc_rfft5avx256_fp64_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t1 = _mm256_mul_pd(v_CRTM_5_1, _mm256_sub_pd(v_in1, v_in3));
        v_s5 = _mm256_sub_pd(v_in0, _mm256_mul_pd(v_CRTM_5_4, v_s6));
        v_s1 = _mm256_add_pd(v_s5, v_t1);
        v_s2 = _mm256_sub_pd(v_s5, v_t1);
        v_s3 = _mm256_add_pd(_mm256_mul_pd(v_CRTM_5_2, v_in2),
                             _mm256_mul_pd(v_CRTM_5_3, v_in4));
        v_s4 = _mm256_sub_pd(_mm256_mul_pd(v_CRTM_5_2, v_in4),
                             _mm256_mul_pd(v_CRTM_5_3, v_in2));
        // Output point 1: X(0)
        v_out0 = _mm256_add_pd(v_in0, _mm256_mul_pd(v_CRTM_5_5, v_s6));
        // Output point 2: X(1)
