...
static FFTZ_VOID r2hc_rfft4c_fp32_fwd(FFTZ_VOID *in_real,
                                      ...
                                      FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        *out_r = t0 + t1;
        ...
        // Output point 2: X(1)
        out_cp[out_strides[1]] = v0 - v2;

        // Output point 3: X(2)
        out_cp[out_strides[2]] = v3 - v1;

        // Output point 4: X(3)
        out_r[out_strides[3]] = t0 - t1;
...
static FFTZ_VOID r2hc_rfft4c_fp32_bwd(FFTZ_VOID *in_real,
                                      FFTZ_VOID *in_complex,
                                      FFTZ_VOID *out_real,
                                      FFTZ_VOID *out_complex, FFTZ_INTP n,
                                      aoclfftz_strides_t *strides,
                                      FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        *out_r = t0 + t1;
        ...
        // Output point 2: X(1)
        out_r[out_strides[1]] = t2 - t3;

        // Output point 3: X(2)
        out_r[out_strides[2]] = t0 - t1;

        // Output point 4: X(3)
        out_r[out_strides[3]] = t2 + t3;
...
static FFTZ_VOID r2hc_rfft4c_fp64_fwd(FFTZ_VOID *in_real,
                                      FFTZ_VOID *in_complex,
                                      FFTZ_VOID *out_real,
                                      FFTZ_VOID *out_complex, FFTZ_INTP n,
                                      aoclfftz_strides_t *strides,
...
static FFTZ_VOID r2hc_rfft4c_fp64_bwd(FFTZ_VOID *in_real,
                                      FFTZ_VOID *in_complex,
                                      FFTZ_VOID *out_real,
                                      FFTZ_VOID *out_complex, FFTZ_INTP n,
                                      aoclfftz_strides_t *strides,
