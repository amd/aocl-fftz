...
ops_cycles_t get_ops_cnt_r2hc_rfft5c(FFTZ_UINT8 precision, FFTZ_UINT8 direction)
{
...
static FFTZ_VOID r2hc_rfft5c_fp32_fwd(FFTZ_VOID *in_real,
                                      ...
                                      FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        FFTZ_FLOAT v0, v1, v2, v3, v4;
        FFTZ_FLOAT t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12;
        ...
        *out_r = v0 + t4;
        ...
        // Output point 2: X(1)
        out_cp[out_strides[1]] = t7 + t8;

        // Output point 3: X(2)
        out_cp[out_strides[2]] = -t9 - t10;

        // Output point 4: X(3)
        out_cp[out_strides[3]] = t7 - t8;

        // Output point 5: X(4)
        out_cp[out_strides[4]] = t11 - t12;
...
static FFTZ_VOID r2hc_rfft5c_fp32_bwd(FFTZ_VOID *in_real,
                                      FFTZ_VOID *in_complex,
                                      FFTZ_VOID *out_real,
                                      FFTZ_VOID *out_complex, FFTZ_INTP n,
                                      aoclfftz_strides_t *strides,
                                      FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        *out_r = v0 + t11;
        ...
        // Output point 2: X(1)
        out_r[out_strides[1]] = t5 - t12;

        // Output point 3: X(2)
        out_r[out_strides[2]] = t6 + t13;

        // Output point 4: X(3)
        out_r[out_strides[3]] = t6 - t13;

        // Output point 5: X(4)
        out_r[out_strides[4]] = t5 + t12;
...
static FFTZ_VOID r2hc_rfft5c_fp64_fwd(FFTZ_VOID *in_real,
                                      FFTZ_VOID *in_complex,
                                      FFTZ_VOID *out_real,
                                      FFTZ_VOID *out_complex, FFTZ_INTP n,
                                      aoclfftz_strides_t *strides,
                                      FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        FFTZ_DOUBLE v0, v1, v2, v3, v4;
        FFTZ_DOUBLE t0, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12;
...
static FFTZ_VOID r2hc_rfft5c_fp64_bwd(FFTZ_VOID *in_real,
                                      FFTZ_VOID *in_complex,
                                      FFTZ_VOID *out_real,
                                      FFTZ_VOID *out_complex, FFTZ_INTP n,
                                      aoclfftz_strides_t *strides,
