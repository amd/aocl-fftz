...
/** @file rfft12avx128.c
 *
 *  @brief Radix-12 r2hc Real-FFT kernel with AVX-128 operations using x86 SIMD
 *  intrinsics
 *
...
static FFTZ_VOID r2hc_rfft12avx128_fp32_fwd(FFTZ_VOID *in_real,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128 v_CRTM_12_1 = _mm_set1_ps(CRTM_12_1);
    __m128 v_CRTM_12_2 = _mm_set1_ps(CRTM_12_2);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm_mul_ps(v_CRTM_12_2, v_s15);
        v_t1 = _mm_mul_ps(v_CRTM_12_2, v_s17);
        ...
        v_t2 = _mm_mul_ps(v_CRTM_12_1, v_s13);
        v_t3 = _mm_mul_ps(v_CRTM_12_2, v_s20);
        v_t4 = _mm_mul_ps(v_CRTM_12_2, v_s21);
        v_t5 = _mm_mul_ps(v_CRTM_12_1, v_s25);

        v_out0 = _mm_add_ps(v_s20, v_s18);
        v_out1 = _mm_add_ps(v_s22, v_t2);
        v_out2 = _mm_add_ps(v_s23, v_t5);
        v_out3 = _mm_add_ps(v_t4, v_s19);
        v_out4 = _mm_mul_ps(v_CRTM_12_1, v_s26);
        v_out5 = _mm_sub_ps(v_s5, v_s15);
        v_out6 = _mm_sub_ps(v_s17, v_s11);
        v_out7 = _mm_sub_ps(v_s18, v_t3);
        v_out8 = _mm_mul_ps(v_CRTM_12_1, v_s27);
...
static FFTZ_VOID r2hc_rfft12avx128_fp32_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm_mul_ps(v_CRTM_12_2, v_in5);
        v_t1 = _mm_mul_ps(v_CRTM_12_2, v_in6);

        v_s10 = _mm_add_ps(v_s2, v_s4);
        v_s11 = _mm_add_ps(v_s0, v_t0);
        v_s12 = _mm_sub_ps(v_s0, v_t0);
        v_s13 = _mm_mul_ps(v_CRTM_12_2, v_s10);

        v_s14 = _mm_add_ps(v_s3, v_s6);
        v_s15 = _mm_sub_ps(v_s3, v_s6);
        v_t2 = _mm_mul_ps(v_CRTM_12_1, v_s14);
        v_t3 = _mm_mul_ps(v_CRTM_12_1, v_s15);

        v_s16 = _mm_add_ps(v_s9, v_s7);
        v_s17 = _mm_sub_ps(v_s9, v_s7);
        v_t4 = _mm_mul_ps(v_CRTM_12_1, v_s16);
        v_t5 = _mm_mul_ps(v_CRTM_12_1, v_s17);

        v_s18 = _mm_add_ps(v_s5, v_s8);
        v_s19 = _mm_sub_ps(v_s5, v_s8);
        v_s20 = _mm_sub_ps(v_s2, v_s4);
        v_t6 = _mm_mul_ps(v_CRTM_12_2, v_s18);
        v_t7 = _mm_mul_ps(v_CRTM_12_2, v_s19);
        v_t8 = _mm_mul_ps(v_CRTM_12_2, v_s20);
...
static FFTZ_VOID r2hc_rfft12avx128_fp64_fwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm_mul_pd(v_CRTM_12_2, v_s15);
        v_t1 = _mm_mul_pd(v_CRTM_12_2, v_s17);
        ...
        v_t2 = _mm_mul_pd(v_CRTM_12_1, v_s13);
        v_t3 = _mm_mul_pd(v_CRTM_12_2, v_s20);
        v_t4 = _mm_mul_pd(v_CRTM_12_2, v_s21);
        v_t5 = _mm_mul_pd(v_CRTM_12_1, v_s25);

        v_out0 = _mm_add_pd(v_s20, v_s18);
        v_out1 = _mm_add_pd(v_s22, v_t2);
        v_out2 = _mm_add_pd(v_s23, v_t5);
        v_out3 = _mm_add_pd(v_t4, v_s19);
        v_out4 = _mm_mul_pd(v_CRTM_12_1, v_s26);
        v_out5 = _mm_sub_pd(v_s5, v_s15);
        v_out6 = _mm_sub_pd(v_s17, v_s11);
        v_out7 = _mm_sub_pd(v_s18, v_t3);
        v_out8 = _mm_mul_pd(v_CRTM_12_1, v_s27);
...
static FFTZ_VOID r2hc_rfft12avx128_fp64_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm_mul_pd(v_CRTM_12_2, v_in5);
        v_t1 = _mm_mul_pd(v_CRTM_12_2, v_in6);

        v_s10 = _mm_add_pd(v_s2, v_s4);
        v_s11 = _mm_add_pd(v_s0, v_t0);
        v_s12 = _mm_sub_pd(v_s0, v_t0);
        v_s13 = _mm_mul_pd(v_CRTM_12_2, v_s10);

        v_s14 = _mm_add_pd(v_s3, v_s6);
        v_s15 = _mm_sub_pd(v_s3, v_s6);
        v_t2 = _mm_mul_pd(v_CRTM_12_1, v_s14);
        v_t3 = _mm_mul_pd(v_CRTM_12_1, v_s15);

        v_s16 = _mm_add_pd(v_s9, v_s7);
        v_s17 = _mm_sub_pd(v_s9, v_s7);
        v_t4 = _mm_mul_pd(v_CRTM_12_1, v_s16);
        v_t5 = _mm_mul_pd(v_CRTM_12_1, v_s17);

        v_s18 = _mm_add_pd(v_s5, v_s8);
        v_s19 = _mm_sub_pd(v_s5, v_s8);
        v_s20 = _mm_sub_pd(v_s2, v_s4);
        v_t6 = _mm_mul_pd(v_CRTM_12_2, v_s18);
        v_t7 = _mm_mul_pd(v_CRTM_12_2, v_s19);
        v_t8 = _mm_mul_pd(v_CRTM_12_2, v_s20);
                                        ...
                                        FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft12avx128_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft12avx128_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft12avx128_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft12avx128_fp64_bwd;
        }
        else
        {
            return NULL;
