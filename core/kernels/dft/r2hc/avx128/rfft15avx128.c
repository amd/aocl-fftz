...
/** @file rfft15avx128.c
 *
 *  @brief Radix-15 r2hc Real-FFT kernel with AVX-128 operations using x86 SIMD
 *  intrinsics
 *
...
static FFTZ_VOID r2hc_rfft15avx128_fp32_fwd(FFTZ_VOID *in_real,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_s3 = _mm_sub_ps(v_in3, _mm_mul_ps(v_CRTM_15_5, v_s0));
        // Input point 9: X(8)
        ...
        v_s6 = _mm_sub_ps(v_in3, _mm_mul_ps(v_CRTM_15_5, v_s0));
        ...
        v_s0 = _mm_add_ps(v_in1, v_in2);
        v_t0 = _mm_mul_ps(v_CRTM_15_6, _mm_sub_ps(v_in2, v_in1));
        v_s9 = _mm_add_ps(v_in0, v_s0);
        v_s3 = _mm_sub_ps(v_in0, _mm_mul_ps(v_CRTM_15_5, v_s0));
        ...
        v_t1 = _mm_mul_ps(v_CRTM_15_1, _mm_sub_ps(v_s11, v_s12));
        v_s15 = _mm_sub_ps(v_s9, _mm_mul_ps(v_CRTM_15_2, v_s13));
        // Output point 1: X(0)
        ...
        // Output point 4: X(3)
        v_out6 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_3, v_s20),
                               _mm_mul_ps(v_CRTM_15_4, v_s19));
        curr_out = out_cp + out_strides[5];
        STRI_2x128_S(curr_out, v_out_stride, v_out5, v_out6);
        // Output point 6: X(5)
        v_out11 = _mm_sub_ps(v_s15, v_t1);
        // Output point 7: X(6)
        v_out12 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_4, v_s20),
                                _mm_mul_ps(v_CRTM_15_3, v_s19));
        curr_out = out_cp + out_strides[11];
        STRI_2x128_S(curr_out, v_out_stride, v_out11, v_out12);

        v_t2 = _mm_mul_ps(v_CRTM_15_1, _mm_sub_ps(v_s28, v_s23));
        v_s13 = _mm_add_ps(v_s28, v_s23);
        // Output point 5: X(4)
        v_out9 = _mm_add_ps(v_s13, v_s3);

        v_t3 = _mm_mul_ps(v_CRTM_15_9, _mm_add_ps(v_s30, v_s27));
        v_s17 = _mm_sub_ps(v_s30, v_s27);
        // Output point 6: X(5)
        v_out10 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_6, v_s17), v_t0);
        curr_out = out_cp + out_strides[9];
        STRI_2x128_S(curr_out, v_out_stride, v_out9, v_out10);

        v_s15 = _mm_sub_ps(v_s3, _mm_mul_ps(v_CRTM_15_2, v_s13));
        v_s20 = _mm_add_ps(v_t0, _mm_mul_ps(v_CRTM_15_10, v_s17));
        v_s21 = _mm_sub_ps(v_s15, v_t2);
        v_s25 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_8, v_s26),
                              _mm_mul_ps(v_CRTM_15_7, v_s31));
        // Output point 1: X(0)
        ...
        v_s23 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_8, v_s31),
                              _mm_mul_ps(v_CRTM_15_7, v_s26));
        // Output point 7: X(6)
        v_out13 = _mm_add_ps(v_s21, v_s23);

        v_s22 = _mm_add_ps(v_s20, v_t3);
        v_s16 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_4, v_s29),
                              _mm_mul_ps(v_CRTM_15_3, v_s24));
        // Output point 2: X(1)
        ...
        v_s10 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_3, v_s29),
                              _mm_mul_ps(v_CRTM_15_4, v_s24));
        // Output point 8: X(7)
...
static FFTZ_VOID r2hc_rfft15avx128_fp32_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_s1 = _mm_sub_ps(v_in1, v_in2);
        v_s2 = _mm_add_ps(v_in3, v_s0);
        v_s3 = _mm_sub_ps(v_in3, _mm_mul_ps(v_CRTM_15_2, v_s0));
        // Input point 5: X(4)
        ...
        v_s6 = _mm_add_ps(v_in3, _mm_mul_ps(v_CRTM_15_2, v_s0));
        // Input point 2: X(1)
        ...
        v_s8 = _mm_add_ps(v_in3, v_s0);
        v_s9 = _mm_sub_ps(v_in3, _mm_mul_ps(v_CRTM_15_2, v_s0));
        // Input point 3: X(2)
        ...
        v_s12 = _mm_sub_ps(v_in3, _mm_mul_ps(v_CRTM_15_2, v_s0));
        // Input point 10: X(9)
        ...
        v_s13 = _mm_add_ps(v_in0, _mm_mul_ps(v_CRTM_15_5, v_in1));
        v_s14 = _mm_sub_ps(v_in0, v_in1);
        v_s15 = _mm_add_ps(v_s8, v_s2);
        v_t0 = _mm_mul_ps(v_CRTM_15_1, _mm_sub_ps(v_s8, v_s2));
        v_s16 = _mm_sub_ps(v_s13, _mm_mul_ps(v_CRTM_15_2, v_s15));
        // Output point 1: X(0)
        v_out0 = _mm_add_ps(v_s13, _mm_mul_ps(v_CRTM_15_5, v_s15));
        STR_128_S(curr_out, v_out_stride, v_out0, is_contiguous_out);

        v_s17 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_3, v_s11),
                              _mm_mul_ps(v_CRTM_15_4, v_s5));
        ...
        v_s20 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_4, v_s11),
                              _mm_mul_ps(v_CRTM_15_3, v_s5));
        // Output point 4: X(3)
        ...
        v_t1 = _mm_mul_ps(v_CRTM_15_1, _mm_sub_ps(v_s9, v_s3));
        v_t2 = _mm_mul_ps(v_CRTM_15_9, _mm_add_ps(v_s4, v_s10));
        v_s21 = _mm_add_ps(v_s9, v_s3);
        v_s22 = _mm_sub_ps(v_s4, v_s10);
        v_s40 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_5, v_s21), v_s14);
        v_t4 = _mm_mul_ps(v_CRTM_15_10, _mm_add_ps(v_s22, v_in2));
        // Output point 3: X(2)
        ...
        v_s23 = _mm_sub_ps(v_s14, _mm_mul_ps(v_CRTM_15_2, v_s21));
        v_t5 = _mm_mul_ps(v_CRTM_15_10,
                _mm_sub_ps( _mm_mul_ps(v_CRTM_15_6, v_s22), v_in2));
        ...
        v_s29 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_3, v_s6),
                              _mm_mul_ps(v_CRTM_15_4, v_s12));
        v_s30 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_8, v_s1),
                              _mm_mul_ps(v_CRTM_15_7, v_s7));
        ...
        v_s34 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_8, v_s7),
                              _mm_mul_ps(v_CRTM_15_7, v_s1));
        v_s35 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_3, v_s12),
                              _mm_mul_ps(v_CRTM_15_4, v_s6));
...
static FFTZ_VOID r2hc_rfft15avx128_fp64_fwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_s3 = _mm_sub_pd(v_in3, _mm_mul_pd(v_CRTM_15_5, v_s0));
        // Input point 9: X(8)
        curr_in = in_r + in_strides[8];
        LDR_128_D(curr_in, v_in_stride, v_in1, is_contiguous_in);
        // Input point 14: X(13)
        ...
        v_s6 = _mm_sub_pd(v_in3, _mm_mul_pd(v_CRTM_15_5, v_s0));
        ...
        v_s0 = _mm_add_pd(v_in1, v_in2);
        v_t0 = _mm_mul_pd(v_CRTM_15_6, _mm_sub_pd(v_in2, v_in1));
        v_s9 = _mm_add_pd(v_in0, v_s0);
        v_s3 = _mm_sub_pd(v_in0, _mm_mul_pd(v_CRTM_15_5, v_s0));
        ...
        v_t1 = _mm_mul_pd(v_CRTM_15_1, _mm_sub_pd(v_s11, v_s12));
        v_s15 = _mm_sub_pd(v_s9, _mm_mul_pd(v_CRTM_15_2, v_s13));
        // Output point 1: X(0)
        ...
        // Output point 4: X(3)
        v_out6 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_3, v_s20),
                               _mm_mul_pd(v_CRTM_15_4, v_s19));
        curr_out = out_cp + out_strides[5];
        STRI_2x128_D(curr_out, v_out_stride, v_out5, v_out6);
        // Output point 6: X(5)
        v_out11 = _mm_sub_pd(v_s15, v_t1);
        // Output point 7: X(6)
        v_out12 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_4, v_s20),
                                _mm_mul_pd(v_CRTM_15_3, v_s19));
        curr_out = out_cp + out_strides[11];
        STRI_2x128_D(curr_out, v_out_stride, v_out11, v_out12);

        v_t2 = _mm_mul_pd(v_CRTM_15_1, _mm_sub_pd(v_s28, v_s23));
        v_s13 = _mm_add_pd(v_s28, v_s23);
        // Output point 5: X(4)
        v_out9 = _mm_add_pd(v_s13, v_s3);

        v_t3 = _mm_mul_pd(v_CRTM_15_9, _mm_add_pd(v_s30, v_s27));
        v_s17 = _mm_sub_pd(v_s30, v_s27);
        // Output point 6: X(5)
        v_out10 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_6, v_s17), v_t0);
        curr_out = out_cp + out_strides[9];
        STRI_2x128_D(curr_out, v_out_stride, v_out9, v_out10);

        v_s15 = _mm_sub_pd(v_s3, _mm_mul_pd(v_CRTM_15_2, v_s13));
        v_s20 = _mm_add_pd(v_t0, _mm_mul_pd(v_CRTM_15_10, v_s17));
        v_s21 = _mm_sub_pd(v_s15, v_t2);
        v_s25 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_8, v_s26),
                              _mm_mul_pd(v_CRTM_15_7, v_s31));
        // Output point 1: X(0)
        ...
        v_s23 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_8, v_s31),
                              _mm_mul_pd(v_CRTM_15_7, v_s26));
        // Output point 7: X(6)
        v_out13 = _mm_add_pd(v_s21, v_s23);

        v_s22 = _mm_add_pd(v_s20, v_t3);
        v_s16 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_4, v_s29),
                              _mm_mul_pd(v_CRTM_15_3, v_s24));
        // Output point 2: X(1)
        ...
        v_s10 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_3, v_s29),
                              _mm_mul_pd(v_CRTM_15_4, v_s24));
        // Output point 8: X(7)
...
static FFTZ_VOID r2hc_rfft15avx128_fp64_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_s1 = _mm_sub_pd(v_in1, v_in2);
        v_s2 = _mm_add_pd(v_in3, v_s0);
        v_s3 = _mm_sub_pd(v_in3, _mm_mul_pd(v_CRTM_15_2, v_s0));
        // Input point 5: X(4)
        curr_in = in_cp + in_strides[4];
        LDR_128_D(curr_in, v_in_stride, v_in1, is_contiguous_in);
        // Input point 15: X(14)
        ...
        v_s6 = _mm_add_pd(v_in3, _mm_mul_pd(v_CRTM_15_2, v_s0));
        // Input point 2: X(1)
        curr_in = in_cp + in_strides[1];
        LDR_128_D(curr_in, v_in_stride, v_in1, is_contiguous_in);
        // Input point 8: X(7)
        ...
        v_s8 = _mm_add_pd(v_in3, v_s0);
        v_s9 = _mm_sub_pd(v_in3, _mm_mul_pd(v_CRTM_15_2, v_s0));
        // Input point 3: X(2)
        curr_in = in_cp + in_strides[2];
        LDR_128_D(curr_in, v_in_stride, v_in1, is_contiguous_in);
        // Input point 9: X(8)
        ...
        v_s12 = _mm_sub_pd(v_in3, _mm_mul_pd(v_CRTM_15_2, v_s0));
        // Input point 10: X(9)
        curr_in = in_cp + in_strides[9];
        LDR_128_D(curr_in, v_in_stride, v_in1, is_contiguous_in);
        // Input point 11: X(10)
        ...
        v_s13 = _mm_add_pd(v_in0, _mm_mul_pd(v_CRTM_15_5, v_in1));
        v_s14 = _mm_sub_pd(v_in0, v_in1);
        v_s15 = _mm_add_pd(v_s8, v_s2);
        v_t0 = _mm_mul_pd(v_CRTM_15_1, _mm_sub_pd(v_s8, v_s2));
        v_s16 = _mm_sub_pd(v_s13, _mm_mul_pd(v_CRTM_15_2, v_s15));
        // Output point 1: X(0)
        v_out0 = _mm_add_pd(v_s13, _mm_mul_pd(v_CRTM_15_5, v_s15));
        STR_128_D(curr_out, v_out_stride, v_out0, is_contiguous_out);

        v_s17 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_3, v_s11),
                              _mm_mul_pd(v_CRTM_15_4, v_s5));
        ...
        v_s20 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_4, v_s11),
                              _mm_mul_pd(v_CRTM_15_3, v_s5));
        // Output point 4: X(3)
        ...
        v_t1 = _mm_mul_pd(v_CRTM_15_1, _mm_sub_pd(v_s9, v_s3));
        v_t2 = _mm_mul_pd(v_CRTM_15_9, _mm_add_pd(v_s4, v_s10));
        v_s21 = _mm_add_pd(v_s9, v_s3);
        v_s22 = _mm_sub_pd(v_s4, v_s10);
        v_s40 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_5, v_s21), v_s14);
        v_t4 = _mm_mul_pd(v_CRTM_15_10, _mm_add_pd(v_s22, v_in2));
        // Output point 3: X(2)
        ...
        v_s23 = _mm_sub_pd(v_s14, _mm_mul_pd(v_CRTM_15_2, v_s21));
        v_t5 = _mm_mul_pd(v_CRTM_15_10,
                _mm_sub_pd( _mm_mul_pd(v_CRTM_15_6, v_s22), v_in2));
        ...
        v_s29 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_3, v_s6),
                              _mm_mul_pd(v_CRTM_15_4, v_s12));
        v_s30 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_8, v_s1),
                              _mm_mul_pd(v_CRTM_15_7, v_s7));
        ...
        v_s34 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_8, v_s7),
                              _mm_mul_pd(v_CRTM_15_7, v_s1));
        v_s35 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_3, v_s12),
                              _mm_mul_pd(v_CRTM_15_4, v_s6));
                                        ...
                                        FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft15avx128_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft15avx128_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft15avx128_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft15avx128_fp64_bwd;
        }
        else
        {
            return NULL;
