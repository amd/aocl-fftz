...
/** @file rfft13avx128.c
 *
 *  @brief  Radix-13 r2hc Real-FFT kernel with AVX-128 operations using x86 SIMD
 *  intrinsics
 *
 ...
 */
 ...
 static FFTZ_VOID r2hc_rfft13avx128_fp32_fwd(FFTZ_VOID *in_real,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
     ...
     for (cnt = 0; cnt < N; cnt++)
     {
         ...
         v_m0 = _mm_mul_ps(v_CRTM_13_6, v_s5);
         ...
         v_m12 = _mm_mul_ps(v_R13_DGC_2, v_s61);
         v_m13 = _mm_mul_ps(v_R13_DGC_3, v_s46);
         v_s40 = NEGATE_128_S(_mm_add_ps(v_m12, v_m13));

         v_m14 = _mm_mul_ps(v_R13_DGC_2, v_s46);
         v_m15 = _mm_mul_ps(v_R13_DGC_3, v_s61);
         v_s41 = _mm_sub_ps(v_m14, v_m15);
         v_m16 = _mm_mul_ps(v_R13_DGC_10, v_s29);
         v_m17 = _mm_mul_ps(v_R13_DGC_11, v_s62);
         v_s34 = _mm_sub_ps(v_m17, v_m16);
         v_m18 = _mm_mul_ps(v_R13_DGC_10, v_s62);
         v_m19 = _mm_mul_ps(v_R13_DGC_11, v_s29);
         v_s35 = _mm_add_ps(v_m18, v_m19);
         v_s26 = _mm_add_ps(v_s41, v_s34);
         v_s44 = _mm_sub_ps(v_s41, v_s34);
         v_m20 = _mm_mul_ps(v_CRTM_13_1, v_s44);
         v_s27 = _mm_add_ps(v_s40, v_s35);
         v_s64 = _mm_sub_ps(v_s40, v_s35);
         v_m21 = _mm_mul_ps(v_CRTM_13_1, v_s64);
         v_s30 = _mm_add_ps(v_s7, v_s14);
         v_m22 = _mm_mul_ps(v_R13_DGC_4, v_s33);
         v_m23 = _mm_mul_ps(v_CRTM_13_3, v_s30);
         v_s49 = _mm_sub_ps(v_m22, v_m23);
         v_m24 = _mm_mul_ps(v_CRTM_13_2, v_s30);
         v_m25 = _mm_mul_ps(v_R13_DGC_5, v_s33);
         v_s37 = NEGATE_128_S(_mm_add_ps(v_m24, v_m25));

         v_s31 = _mm_sub_ps(v_s7, v_s14);
         v_m26 = _mm_mul_ps(v_R13_DGC_8, v_s32);
         v_m27 = _mm_mul_ps(v_CRTM_13_5, v_s31);
         v_s50 = _mm_sub_ps(v_m26, v_m27);
         v_m28 = _mm_mul_ps(v_CRTM_13_4, v_s31);
         v_m29 = _mm_mul_ps(v_R13_DGC_9, v_s32);
         ...
         v_m32 = _mm_mul_ps(v_CRTM_13_8, v_s27);
         v_s57 = NEGATE_128_S(_mm_add_ps(v_m32, v_s43));
         v_m33 = _mm_mul_ps(v_CRTM_13_8, v_s53);
 ...
 static FFTZ_VOID r2hc_rfft13avx128_fp32_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
     ...
     for (cnt = 0; cnt < N; cnt++)
     {
         ...
         v_m31 = _mm_mul_ps(v_CRTM_13_7, v_s29);
         v_s47 = _mm_add_ps(v_m31, v_s26);
         v_m32 = _mm_mul_ps(v_CRTM_13_7, v_s32);
 ...
 static FFTZ_VOID r2hc_rfft13avx128_fp64_fwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
     ...
     for (cnt = 0; cnt < N; cnt++)
     {
         ...
         v_m0 = _mm_mul_pd(v_CRTM_13_6, v_s5);
         ...
         v_m12 = _mm_mul_pd(v_R13_DGC_2, v_s61);
         v_m13 = _mm_mul_pd(v_R13_DGC_3, v_s46);
         v_s40 = NEGATE_128_D(_mm_add_pd(v_m12, v_m13));

         v_m14 = _mm_mul_pd(v_R13_DGC_2, v_s46);
         v_m15 = _mm_mul_pd(v_R13_DGC_3, v_s61);
         v_s41 = _mm_sub_pd(v_m14, v_m15);
         v_m16 = _mm_mul_pd(v_R13_DGC_10, v_s29);
         v_m17 = _mm_mul_pd(v_R13_DGC_11, v_s62);
         v_s34 = _mm_sub_pd(v_m17, v_m16);
         v_m18 = _mm_mul_pd(v_R13_DGC_10, v_s62);
         v_m19 = _mm_mul_pd(v_R13_DGC_11, v_s29);
         v_s35 = _mm_add_pd(v_m18, v_m19);
         v_s26 = _mm_add_pd(v_s41, v_s34);
         v_s44 = _mm_sub_pd(v_s41, v_s34);
         v_m20 = _mm_mul_pd(v_CRTM_13_1, v_s44);
         v_s27 = _mm_add_pd(v_s40, v_s35);
         v_s64 = _mm_sub_pd(v_s40, v_s35);
         v_m21 = _mm_mul_pd(v_CRTM_13_1, v_s64);
         v_s30 = _mm_add_pd(v_s7, v_s14);
         v_m22 = _mm_mul_pd(v_R13_DGC_4, v_s33);
         v_m23 = _mm_mul_pd(v_CRTM_13_3, v_s30);
         v_s49 = _mm_sub_pd(v_m22, v_m23);
         v_m24 = _mm_mul_pd(v_CRTM_13_2, v_s30);
         v_m25 = _mm_mul_pd(v_R13_DGC_5, v_s33);
         v_s37 = NEGATE_128_D(_mm_add_pd(v_m24, v_m25));

         v_s31 = _mm_sub_pd(v_s7, v_s14);
         v_m26 = _mm_mul_pd(v_R13_DGC_8, v_s32);
         v_m27 = _mm_mul_pd(v_CRTM_13_5, v_s31);
         v_s50 = _mm_sub_pd(v_m26, v_m27);
         v_m28 = _mm_mul_pd(v_CRTM_13_4, v_s31);
         v_m29 = _mm_mul_pd(v_R13_DGC_9, v_s32);
         ...
         v_m32 = _mm_mul_pd(v_CRTM_13_8, v_s27);
         v_s57 = NEGATE_128_D(_mm_add_pd(v_m32, v_s43));
         v_m33 = _mm_mul_pd(v_CRTM_13_8, v_s53);
 ...
 static FFTZ_VOID r2hc_rfft13avx128_fp64_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
     ...
     for (cnt = 0; cnt < N; cnt++)
     {
         ...
         v_m31 = _mm_mul_pd(v_CRTM_13_7, v_s29);
         v_s47 = _mm_add_pd(v_m31, v_s26);
         v_m32 = _mm_mul_pd(v_CRTM_13_7, v_s32);
                                         ...
                                         FFTZ_UINT8 direction)
 {
     if (direction == FORWARD_FFT_DIR)
     {
         if (precision == DT_FLOAT)
         {
             return r2hc_rfft13avx128_fp32_fwd;
         }
         else if (precision == DT_DOUBLE)
         {
             return r2hc_rfft13avx128_fp64_fwd;
         }
         else
         {
             return NULL;
     ...
     else
     {
         if (precision == DT_FLOAT)
         {
             return r2hc_rfft13avx128_fp32_bwd;
         }
         else if (precision == DT_DOUBLE)
         {
             return r2hc_rfft13avx128_fp64_bwd;
         }
         else
         {
             return NULL;
