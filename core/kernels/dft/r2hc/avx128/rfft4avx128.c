...
/** @file rfft4avx128.c
 *
 *  @brief Radix-4 r2hc Real-FFT kernel with AVX-128 operations using x86 SIMD
 *  intrinsics
 *
...
static FFTZ_VOID r2hc_rfft4avx128_fp32_fwd(FFTZ_VOID *in_real,
...
static FFTZ_VOID r2hc_rfft4avx128_fp32_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm_mul_ps(v_CRTM_4_1, v_in1);
        v_s1 = _mm_sub_ps(v_in0, v_in3);
        v_t1 = _mm_mul_ps(v_CRTM_4_1, v_in2);
        // Output point 1: X(0)
...
static FFTZ_VOID r2hc_rfft4avx128_fp64_fwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
...
static FFTZ_VOID r2hc_rfft4avx128_fp64_bwd(FFTZ_VOID *in_real,
                                           FFTZ_VOID *in_complex,
                                           FFTZ_VOID *out_real,
                                           FFTZ_VOID *out_complex, FFTZ_INTP n,
                                           aoclfftz_strides_t *strides,
                                           FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t0 = _mm_mul_pd(v_CRTM_4_1, v_in1);
        v_s1 = _mm_sub_pd(v_in0, v_in3);
        v_t1 = _mm_mul_pd(v_CRTM_4_1, v_in2);
        // Output point 1: X(0)
                                       ...
                                       FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft4avx128_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft4avx128_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft4avx128_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft4avx128_fp64_bwd;
        }
        else
        {
            return NULL;
