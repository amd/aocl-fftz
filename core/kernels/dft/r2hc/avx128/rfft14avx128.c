...
/** @file rfft14avx128.c
 *
 *  @brief Radix-14 r2hc Real-FFT kernel with AVX-128 operations using x86 SIMD
 *  intrinsics
 *
...
static FFTZ_VOID r2hc_rfft14avx128_fp32_fwd(FFTZ_VOID *in_real,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t1 = _mm_mul_ps(v_CRTM_14_1, v_s18);
        v_t2 = _mm_mul_ps(v_CRTM_14_3, v_s19);
        v_t3 = _mm_mul_ps(v_CRTM_14_5, v_s20);
        ...
        v_t4 = _mm_mul_ps(v_CRTM_14_2, v_s21);
        v_t5 = _mm_mul_ps(v_CRTM_14_4, v_s22);
        v_t6 = _mm_mul_ps(v_CRTM_14_6, v_s23);
        ...
        v_t7 = _mm_mul_ps(v_CRTM_14_1, v_s17);
        v_t8 = _mm_mul_ps(v_CRTM_14_3, v_s15);
        v_t9 = _mm_mul_ps(v_CRTM_14_5, v_s16);
        ...
        v_t10 = _mm_mul_ps(v_CRTM_14_2, v_s26);
        v_t11 = _mm_mul_ps(v_CRTM_14_4, v_s24);
        v_t12 = _mm_mul_ps(v_CRTM_14_6, v_s25);
        ...
        v_t13 = _mm_mul_ps(v_CRTM_14_1, v_s19);
        v_t14 = _mm_mul_ps(v_CRTM_14_3, v_s20);
        v_t15 = _mm_mul_ps(v_CRTM_14_5, v_s18);
        v_s37 = _mm_sub_ps(v_s1, v_t13);
        v_s38 = _mm_sub_ps(v_t14, v_t15);
        // Output point 6: X(5)
        v_out5 = _mm_add_ps(v_s37, v_s38);

        v_t16 = _mm_mul_ps(v_CRTM_14_2, v_s22);
        v_t17 = _mm_mul_ps(v_CRTM_14_4, v_s23);
        v_t18 = _mm_mul_ps(v_CRTM_14_6, v_s21);
        ...
        v_t19 = _mm_mul_ps(v_CRTM_14_1, v_s16);
        v_t20 = _mm_mul_ps(v_CRTM_14_3, v_s17);
        v_t21 = _mm_mul_ps(v_CRTM_14_5, v_s15);
        v_s40 = _mm_sub_ps(v_s2, v_t19);
        v_s41 = _mm_sub_ps(v_t20, v_t21);
        // Output point 8: X(7)
        v_out7 = _mm_add_ps(v_s40, v_s41);

        v_t22 = _mm_mul_ps(v_CRTM_14_2, v_s25);
        v_t23 = _mm_mul_ps(v_CRTM_14_4, v_s26);
        v_t24 = _mm_mul_ps(v_CRTM_14_6, v_s24);
        ...
        v_t25 = _mm_mul_ps(v_CRTM_14_1, v_s20);
        v_t26 = _mm_mul_ps(v_CRTM_14_3, v_s18);
        v_t27 = _mm_mul_ps(v_CRTM_14_5, v_s19);
        v_s43 = _mm_sub_ps(v_s1, v_t25);
        v_s44 = _mm_sub_ps(v_t26, v_t27);
        // Output point 10: X(9)
        v_out9 = _mm_add_ps(v_s43, v_s44);

        v_t28 = _mm_mul_ps(v_CRTM_14_2, v_s23);
        v_t29 = _mm_mul_ps(v_CRTM_14_4, v_s21);
        v_t30 = _mm_mul_ps(v_CRTM_14_6, v_s22);
        ...
        v_t31 = _mm_mul_ps(v_CRTM_14_1, v_s15);
        v_t32 = _mm_mul_ps(v_CRTM_14_3, v_s16);
        v_t33 = _mm_mul_ps(v_CRTM_14_5, v_s17);
        v_s46 = _mm_sub_ps(v_s2, v_t31);
        v_s47 = _mm_sub_ps(v_t32, v_t33);
        // Output point 12: X(11)
        v_out11 = _mm_add_ps(v_s46, v_s47);

        v_t34 = _mm_mul_ps(v_CRTM_14_2, v_s24);
        v_t35 = _mm_mul_ps(v_CRTM_14_4, v_s25);
        v_t36 = _mm_mul_ps(v_CRTM_14_6, v_s26);
...
static FFTZ_VOID r2hc_rfft14avx128_fp32_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t37 = _mm_mul_ps(v_CRTM_14_7, v_s28);
        v_s29 = _mm_add_ps(v_s3, v_s7);
        v_s30 = _mm_add_ps(v_s29, v_s11);
        v_t38 = _mm_mul_ps(v_CRTM_14_7, v_s30);
        // Output pt 1: X(0)
        ...
        v_t1 = _mm_mul_ps(v_CRTM_14_1, v_s6);
        v_t2 = _mm_mul_ps(v_CRTM_14_3, v_s10);
        v_t3 = _mm_mul_ps(v_CRTM_14_5, v_s14);
        v_t4 = _mm_mul_ps(v_CRTM_14_2, v_s3);
        v_t5 = _mm_mul_ps(v_CRTM_14_4, v_s7);
        v_t6 = _mm_mul_ps(v_CRTM_14_6, v_s11);
        ...
        v_t7 = _mm_mul_ps(v_CRTM_14_1, v_s13);
        v_t8 = _mm_mul_ps(v_CRTM_14_3, v_s5);
        v_t9 = _mm_mul_ps(v_CRTM_14_5, v_s9);

        v_t10 = _mm_mul_ps(v_CRTM_14_2, v_s12);
        v_t11 = _mm_mul_ps(v_CRTM_14_4, v_s4);
        v_t12 = _mm_mul_ps(v_CRTM_14_6, v_s8);
        ...
        v_t13 = _mm_mul_ps(v_CRTM_14_1, v_s10);
        v_t14 = _mm_mul_ps(v_CRTM_14_3, v_s14);
        v_t15 = _mm_mul_ps(v_CRTM_14_5, v_s6);
        v_t16 = _mm_mul_ps(v_CRTM_14_2, v_s7);
        v_t17 = _mm_mul_ps(v_CRTM_14_4, v_s11);
        v_t18 = _mm_mul_ps(v_CRTM_14_6, v_s3);
        ...
        v_t19 = _mm_mul_ps(v_CRTM_14_1, v_s9);
        v_t20 = _mm_mul_ps(v_CRTM_14_3, v_s13);
        v_t21 = _mm_mul_ps(v_CRTM_14_5, v_s5);
        v_t22 = _mm_mul_ps(v_CRTM_14_2, v_s8);
        v_t23 = _mm_mul_ps(v_CRTM_14_4, v_s12);
        v_t24 = _mm_mul_ps(v_CRTM_14_6, v_s4);
        ...
        v_t25 = _mm_mul_ps(v_CRTM_14_1, v_s14);
        v_t26 = _mm_mul_ps(v_CRTM_14_3, v_s6);
        v_t27 = _mm_mul_ps(v_CRTM_14_5, v_s10);
        v_t28 = _mm_mul_ps(v_CRTM_14_2, v_s11);
        v_t29 = _mm_mul_ps(v_CRTM_14_4, v_s3);
        v_t30 = _mm_mul_ps(v_CRTM_14_6, v_s7);
        ...
        v_t31 = _mm_mul_ps(v_CRTM_14_1, v_s5);
        v_t32 = _mm_mul_ps(v_CRTM_14_3, v_s9);
        v_t33 = _mm_mul_ps(v_CRTM_14_5, v_s13);
        v_t34 = _mm_mul_ps(v_CRTM_14_2, v_s4);
        v_t35 = _mm_mul_ps(v_CRTM_14_4, v_s8);
        v_t36 = _mm_mul_ps(v_CRTM_14_6, v_s12);
...
static FFTZ_VOID r2hc_rfft14avx128_fp64_fwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t1 = _mm_mul_pd(v_CRTM_14_1, v_s18);
        v_t2 = _mm_mul_pd(v_CRTM_14_3, v_s19);
        v_t3 = _mm_mul_pd(v_CRTM_14_5, v_s20);
        ...
        v_t4 = _mm_mul_pd(v_CRTM_14_2, v_s21);
        v_t5 = _mm_mul_pd(v_CRTM_14_4, v_s22);
        v_t6 = _mm_mul_pd(v_CRTM_14_6, v_s23);
        ...
        v_t7 = _mm_mul_pd(v_CRTM_14_1, v_s17);
        v_t8 = _mm_mul_pd(v_CRTM_14_3, v_s15);
        v_t9 = _mm_mul_pd(v_CRTM_14_5, v_s16);
        ...
        v_t10 = _mm_mul_pd(v_CRTM_14_2, v_s26);
        v_t11 = _mm_mul_pd(v_CRTM_14_4, v_s24);
        v_t12 = _mm_mul_pd(v_CRTM_14_6, v_s25);
        ...
        v_t13 = _mm_mul_pd(v_CRTM_14_1, v_s19);
        v_t14 = _mm_mul_pd(v_CRTM_14_3, v_s20);
        v_t15 = _mm_mul_pd(v_CRTM_14_5, v_s18);
        v_s37 = _mm_sub_pd(v_s1, v_t13);
        v_s38 = _mm_sub_pd(v_t14, v_t15);
        // Output point 6: X(5)
        v_out5 = _mm_add_pd(v_s37, v_s38);

        v_t16 = _mm_mul_pd(v_CRTM_14_2, v_s22);
        v_t17 = _mm_mul_pd(v_CRTM_14_4, v_s23);
        v_t18 = _mm_mul_pd(v_CRTM_14_6, v_s21);
        ...
        v_t19 = _mm_mul_pd(v_CRTM_14_1, v_s16);
        v_t20 = _mm_mul_pd(v_CRTM_14_3, v_s17);
        v_t21 = _mm_mul_pd(v_CRTM_14_5, v_s15);
        v_s40 = _mm_sub_pd(v_s2, v_t19);
        v_s41 = _mm_sub_pd(v_t20, v_t21);
        // Output point 8: X(7)
        v_out7 = _mm_add_pd(v_s40, v_s41);

        v_t22 = _mm_mul_pd(v_CRTM_14_2, v_s25);
        v_t23 = _mm_mul_pd(v_CRTM_14_4, v_s26);
        v_t24 = _mm_mul_pd(v_CRTM_14_6, v_s24);
        ...
        v_t25 = _mm_mul_pd(v_CRTM_14_1, v_s20);
        v_t26 = _mm_mul_pd(v_CRTM_14_3, v_s18);
        v_t27 = _mm_mul_pd(v_CRTM_14_5, v_s19);
        v_s43 = _mm_sub_pd(v_s1, v_t25);
        v_s44 = _mm_sub_pd(v_t26, v_t27);
        // Output point 10: X(9)
        v_out9 = _mm_add_pd(v_s43, v_s44);

        v_t28 = _mm_mul_pd(v_CRTM_14_2, v_s23);
        v_t29 = _mm_mul_pd(v_CRTM_14_4, v_s21);
        v_t30 = _mm_mul_pd(v_CRTM_14_6, v_s22);
        ...
        v_t31 = _mm_mul_pd(v_CRTM_14_1, v_s15);
        v_t32 = _mm_mul_pd(v_CRTM_14_3, v_s16);
        v_t33 = _mm_mul_pd(v_CRTM_14_5, v_s17);
        v_s46 = _mm_sub_pd(v_s2, v_t31);
        v_s47 = _mm_sub_pd(v_t32, v_t33);
        // Output point 12: X(11)
        v_out11 = _mm_add_pd(v_s46, v_s47);

        v_t34 = _mm_mul_pd(v_CRTM_14_2, v_s24);
        v_t35 = _mm_mul_pd(v_CRTM_14_4, v_s25);
        v_t36 = _mm_mul_pd(v_CRTM_14_6, v_s26);
...
static FFTZ_VOID r2hc_rfft14avx128_fp64_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        v_t37 = _mm_mul_pd(v_CRTM_14_7, v_s28);
        v_s29 = _mm_add_pd(v_s3, v_s7);
        v_s30 = _mm_add_pd(v_s29, v_s11);
        v_t38 = _mm_mul_pd(v_CRTM_14_7, v_s30);
        // Output pt 1: X(0)
        ...
        v_t1 = _mm_mul_pd(v_CRTM_14_1, v_s6);
        v_t2 = _mm_mul_pd(v_CRTM_14_3, v_s10);
        v_t3 = _mm_mul_pd(v_CRTM_14_5, v_s14);
        v_t4 = _mm_mul_pd(v_CRTM_14_2, v_s3);
        v_t5 = _mm_mul_pd(v_CRTM_14_4, v_s7);
        v_t6 = _mm_mul_pd(v_CRTM_14_6, v_s11);
        ...
        v_t7 = _mm_mul_pd(v_CRTM_14_1, v_s13);
        v_t8 = _mm_mul_pd(v_CRTM_14_3, v_s5);
        v_t9 = _mm_mul_pd(v_CRTM_14_5, v_s9);

        v_t10 = _mm_mul_pd(v_CRTM_14_2, v_s12);
        v_t11 = _mm_mul_pd(v_CRTM_14_4, v_s4);
        v_t12 = _mm_mul_pd(v_CRTM_14_6, v_s8);
        ...
        v_t13 = _mm_mul_pd(v_CRTM_14_1, v_s10);
        v_t14 = _mm_mul_pd(v_CRTM_14_3, v_s14);
        v_t15 = _mm_mul_pd(v_CRTM_14_5, v_s6);
        v_t16 = _mm_mul_pd(v_CRTM_14_2, v_s7);
        v_t17 = _mm_mul_pd(v_CRTM_14_4, v_s11);
        v_t18 = _mm_mul_pd(v_CRTM_14_6, v_s3);
        ...
        v_t19 = _mm_mul_pd(v_CRTM_14_1, v_s9);
        v_t20 = _mm_mul_pd(v_CRTM_14_3, v_s13);
        v_t21 = _mm_mul_pd(v_CRTM_14_5, v_s5);
        v_t22 = _mm_mul_pd(v_CRTM_14_2, v_s8);
        v_t23 = _mm_mul_pd(v_CRTM_14_4, v_s12);
        v_t24 = _mm_mul_pd(v_CRTM_14_6, v_s4);
        ...
        v_t25 = _mm_mul_pd(v_CRTM_14_1, v_s14);
        v_t26 = _mm_mul_pd(v_CRTM_14_3, v_s6);
        v_t27 = _mm_mul_pd(v_CRTM_14_5, v_s10);
        v_t28 = _mm_mul_pd(v_CRTM_14_2, v_s11);
        v_t29 = _mm_mul_pd(v_CRTM_14_4, v_s3);
        v_t30 = _mm_mul_pd(v_CRTM_14_6, v_s7);
        ...
        v_t31 = _mm_mul_pd(v_CRTM_14_1, v_s5);
        v_t32 = _mm_mul_pd(v_CRTM_14_3, v_s9);
        v_t33 = _mm_mul_pd(v_CRTM_14_5, v_s13);
        v_t34 = _mm_mul_pd(v_CRTM_14_2, v_s4);
        v_t35 = _mm_mul_pd(v_CRTM_14_4, v_s8);
        v_t36 = _mm_mul_pd(v_CRTM_14_6, v_s12);
                                        ...
                                        FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft14avx128_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft14avx128_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hc_rfft14avx128_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hc_rfft14avx128_fp64_bwd;
        }
        else
        {
            return NULL;
