...
/** @file twid_bwd_fft11avx512.c
 *
 *  @brief Backward-only twiddle Radix-11 FFT kernel with avx512 operations
...
#define TWID_KNAME_FP32 twid_bwd_fft11avx512fp32
#define TWID_KNAME_FP64 twid_bwd_fft11avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_bwd_fft11avx512
#define REGISTER_KERNEL register_kernel_twid_bwd_fft11avx512
