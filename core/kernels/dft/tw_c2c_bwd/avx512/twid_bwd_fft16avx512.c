...
/** @file twid_bwd_fft16avx512.c
 *
 *  @brief Backward-only twiddle Radix-16 FFT kernel with avx512 operations
...
#define TWID_KNAME_FP32 twid_bwd_fft16avx512fp32
#define TWID_KNAME_FP64 twid_bwd_fft16avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_bwd_fft16avx512
#define REGISTER_KERNEL register_kernel_twid_bwd_fft16avx512
