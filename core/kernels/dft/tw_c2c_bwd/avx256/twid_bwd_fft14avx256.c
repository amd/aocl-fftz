...
/** @file twid_bwd_fft14avx256.c
 *
 *  @brief Backward-only twiddle Radix-14 FFT kernel with avx256 operations
...
#define TWID_KNAME_FP32 twid_bwd_fft14avx256fp32
#define TWID_KNAME_FP64 twid_bwd_fft14avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_bwd_fft14avx256
#define REGISTER_KERNEL register_kernel_twid_bwd_fft14avx256
