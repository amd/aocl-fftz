...
/** @file twid_bwd_fft7avx256.c
 *
 *  @brief Backward-only twiddle Radix-7 FFT kernel with avx256 operations using
 *  x86 SIMD intrinsics
 *
...
#define TWID_KNAME_FP32 twid_bwd_fft7avx256fp32
#define TWID_KNAME_FP64 twid_bwd_fft7avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_bwd_fft7avx256
#define REGISTER_KERNEL register_kernel_twid_bwd_fft7avx256
