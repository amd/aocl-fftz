...
/** @file twid_bwd_fft13avx128.c
 *
 *  @brief Backward-only twiddle Radix-13 FFT kernel with avx128 operations
...
#define TWID_KNAME_FP32 twid_bwd_fft13avx128fp32
#define TWID_KNAME_FP64 twid_bwd_fft13avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_bwd_fft13avx128
#define REGISTER_KERNEL register_kernel_twid_bwd_fft13avx128
