...
/** @file twid_bwd_fft9avx128.c
 *
 *  @brief Backward-only twiddle Radix-9 FFT kernel with avx128 operations using
 *  x86 SIMD intrinsics
 *
...
#define TWID_KNAME_FP32 twid_bwd_fft9avx128fp32
#define TWID_KNAME_FP64 twid_bwd_fft9avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_bwd_fft9avx128
#define REGISTER_KERNEL register_kernel_twid_bwd_fft9avx128
