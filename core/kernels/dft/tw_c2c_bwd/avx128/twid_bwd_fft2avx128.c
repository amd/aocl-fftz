...
/** @file twid_bwd_fft2avx128.c
 *
 *  @brief Backward-only twiddle Radix-2 FFT kernel with avx128 operations using
 *  x86 SIMD intrinsics
 *
 *  This file contains the DIT twiddle radix-2 FFT implementations using AVX-128
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 2, 3, 9, 6, 0},
                                                     {0, 2, 3, 6, 2, 0}};

#define TWID_KNAME_FP32 twid_bwd_fft2avx128fp32
#define TWID_KNAME_FP64 twid_bwd_fft2avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_bwd_fft2avx128
#define REGISTER_KERNEL register_kernel_twid_bwd_fft2avx128
...
#include "core/kernels/dft/twid_c2c_common/twid_fft2.h"
