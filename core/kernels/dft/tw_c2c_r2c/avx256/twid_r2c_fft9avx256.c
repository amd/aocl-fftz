...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 36, 48, 80, 63, 28},
                                                     {0, 36, 48, 44, 38, 28}};

#define TWID_KNAME_FP32 twid_r2c_fft9avx256fp32
#define TWID_KNAME_FP64 twid_r2c_fft9avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft9avx256
#define REGISTER_KERNEL register_kernel_twid_r2c_fft9avx256
