...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 6, 8, 26, 14, 8},
                                                     {0, 6, 8, 14, 7, 8}};

#define TWID_KNAME_FP32 twid_r2c_fft3avx256fp32
#define TWID_KNAME_FP64 twid_r2c_fft3avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft3avx256
#define REGISTER_KERNEL register_kernel_twid_r2c_fft3avx256
