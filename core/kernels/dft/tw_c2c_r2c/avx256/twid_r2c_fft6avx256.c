...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 14, 23, 53, 33, 17},
                                                     {0, 14, 23, 29, 17, 17}};

#define TWID_KNAME_FP32 twid_r2c_fft6avx256fp32
#define TWID_KNAME_FP64 twid_r2c_fft6avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft6avx256
#define REGISTER_KERNEL register_kernel_twid_r2c_fft6avx256
