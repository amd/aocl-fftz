...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 32, 59, 107, 72, 36},
                                                     {0, 32, 59, 59, 38, 36}};

#define TWID_KNAME_FP32 twid_r2c_fft12avx256fp32
#define TWID_KNAME_FP64 twid_r2c_fft12avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft12avx256
#define REGISTER_KERNEL register_kernel_twid_r2c_fft12avx256
