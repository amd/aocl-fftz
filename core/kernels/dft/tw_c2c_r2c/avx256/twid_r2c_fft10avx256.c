...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 30, 51, 89, 59, 29},
                                                     {0, 30, 51, 49, 31, 29}};

#define TWID_KNAME_FP32 twid_r2c_fft10avx256fp32
#define TWID_KNAME_FP64 twid_r2c_fft10avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft10avx256
#define REGISTER_KERNEL register_kernel_twid_r2c_fft10avx256
