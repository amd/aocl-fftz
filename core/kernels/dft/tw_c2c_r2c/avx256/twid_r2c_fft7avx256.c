...
#define TWID_KNAME_FP32 twid_r2c_fft7avx256fp32
#define TWID_KNAME_FP64 twid_r2c_fft7avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft7avx256
#define REGISTER_KERNEL register_kernel_twid_r2c_fft7avx256
