...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 45, 87, 143, 98, 47},
                                                     {0, 45, 87, 79, 52, 47}};

#define TWID_KNAME_FP32 twid_r2c_fft16avx256fp32
#define TWID_KNAME_FP64 twid_r2c_fft16avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft16avx256
#define REGISTER_KERNEL register_kernel_twid_r2c_fft16avx256
...
#include "core/kernels/dft/twid_c2c_common/twid_fft16.h"
