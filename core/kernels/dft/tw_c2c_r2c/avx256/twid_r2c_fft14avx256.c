...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 62, 87, 125, 85, 41},
                                                     {0, 62, 87, 69, 45, 41}};

#define TWID_KNAME_FP32 twid_r2c_fft14avx256fp32
#define TWID_KNAME_FP64 twid_r2c_fft14avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft14avx256
#define REGISTER_KERNEL register_kernel_twid_r2c_fft14avx256
