...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 7, 11, 35, 20, 11},
                                                     {0, 7, 11, 19, 10, 11}};

#define TWID_KNAME_FP32 twid_r2c_fft4avx256fp32
#define TWID_KNAME_FP64 twid_r2c_fft4avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft4avx256
#define REGISTER_KERNEL register_kernel_twid_r2c_fft4avx256
