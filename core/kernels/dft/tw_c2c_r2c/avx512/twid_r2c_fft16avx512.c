...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {
    {15, 45, 72, 286, 130, 111}, {15, 45, 72, 158, 52, 111}};

#define TWID_KNAME_FP32 twid_r2c_fft16avx512fp32
#define TWID_KNAME_FP64 twid_r2c_fft16avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft16avx512
#define REGISTER_KERNEL register_kernel_twid_r2c_fft16avx512
