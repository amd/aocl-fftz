...
/** @file twid_r2c_fft9avx512.c
 *
 *  @brief R2C fused twiddle (forward twiddle + conjugate output) Radix-9 FFT
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{8, 36, 40, 160, 77, 64},
                                                     {8, 36, 40, 88, 34, 64}};

#define TWID_KNAME_FP32 twid_r2c_fft9avx512fp32
#define TWID_KNAME_FP64 twid_r2c_fft9avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft9avx512
#define REGISTER_KERNEL register_kernel_twid_r2c_fft9avx512
...
#include "core/kernels/dft/twid_c2c_common/twid_fft9.h"
