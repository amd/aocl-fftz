...
#define TWID_KNAME_FP32 twid_r2c_fft2avx512fp32
#define TWID_KNAME_FP64 twid_r2c_fft2avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft2avx512
#define REGISTER_KERNEL register_kernel_twid_r2c_fft2avx512
