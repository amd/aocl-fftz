...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{2, 6, 6, 52, 20, 20},
                                                     {2, 6, 6, 28, 7, 20}};

#define TWID_KNAME_FP32 twid_r2c_fft3avx512fp32
#define TWID_KNAME_FP64 twid_r2c_fft3avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft3avx512
#define REGISTER_KERNEL register_kernel_twid_r2c_fft3avx512
