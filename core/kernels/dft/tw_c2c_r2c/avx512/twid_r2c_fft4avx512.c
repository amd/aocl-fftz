...
/** @file twid_r2c_fft4avx512.c
 *
 *  @brief R2C fused twiddle (forward twiddle + conjugate output) Radix-4 FFT
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{3, 7, 8, 70, 28, 27},
                                                     {3, 7, 8, 38, 10, 27}};

#define TWID_KNAME_FP32 twid_r2c_fft4avx512fp32
#define TWID_KNAME_FP64 twid_r2c_fft4avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft4avx512
#define REGISTER_KERNEL register_kernel_twid_r2c_fft4avx512
...
#define TWID_PRELOADED_LOAD_D TW_PRELOADED_GATHER_D_V
#define TWID_PRELOADED_LOAD_256_D TW_PRELOADED_GATHER_256_D_V
#define TWID_PRELOADED_LOAD_128_D TW_PRELOADED_GATHER_128_D_V
#define TWID_PRELOADED_STORE_D PRELOADED_SCATTER_NOTW_D
#define TWID_PRELOADED_STORE_256_D PRELOADED_SCATTER_NOTW_256_D
#define TWID_PRELOADED_STORE_128_D PRELOADED_SCATTER_NOTW_128_D

#include "core/kernels/dft/twid_c2c_common/twid_fft4.h"

#undef TWID_PRELOADED_STORE_128_D
#undef TWID_PRELOADED_STORE_256_D
#undef TWID_PRELOADED_STORE_D
#undef TWID_PRELOADED_LOAD_128_D
#undef TWID_PRELOADED_LOAD_256_D
#undef TWID_PRELOADED_LOAD_D
