...
/** @file twid_r2c_fft10avx512.c
 *
 *  @brief R2C fused twiddle (forward twiddle + conjugate output) Radix-10 FFT
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{9, 30, 42, 178, 79, 69},
                                                     {9, 30, 42, 98, 31, 69}};

#define TWID_KNAME_FP32 twid_r2c_fft10avx512fp32
#define TWID_KNAME_FP64 twid_r2c_fft10avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft10avx512
#define REGISTER_KERNEL register_kernel_twid_r2c_fft10avx512
