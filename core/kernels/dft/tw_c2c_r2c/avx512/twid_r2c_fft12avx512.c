...
/** @file twid_r2c_fft12avx512.c
 *
 *  @brief R2C fused twiddle (forward twiddle + conjugate output) Radix-12 FFT
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{11, 32, 48, 214, 96, 84},
                                                     {11, 32, 48, 118, 38, 84}};

#define TWID_KNAME_FP32 twid_r2c_fft12avx512fp32
#define TWID_KNAME_FP64 twid_r2c_fft12avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft12avx512
#define REGISTER_KERNEL register_kernel_twid_r2c_fft12avx512
