...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{4, 14, 16, 88, 37, 34},
                                                     {4, 14, 16, 48, 14, 34}};

#define TWID_KNAME_FP32 twid_r2c_fft5avx512fp32
#define TWID_KNAME_FP64 twid_r2c_fft5avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft5avx512
#define REGISTER_KERNEL register_kernel_twid_r2c_fft5avx512
