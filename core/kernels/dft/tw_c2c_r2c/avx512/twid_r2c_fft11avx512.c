...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{10, 70, 70, 196, 88, 76},
                                                     {10, 70, 70, 108, 35, 76}};

#define TWID_KNAME_FP32 twid_r2c_fft11avx512fp32
#define TWID_KNAME_FP64 twid_r2c_fft11avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft11avx512
#define REGISTER_KERNEL register_kernel_twid_r2c_fft11avx512
