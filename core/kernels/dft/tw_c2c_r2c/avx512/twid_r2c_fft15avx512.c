...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {
    {14, 56, 78, 268, 122, 104}, {14, 56, 78, 148, 49, 104}};

#define TWID_KNAME_FP32 twid_r2c_fft15avx512fp32
#define TWID_KNAME_FP64 twid_r2c_fft15avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft15avx512
#define REGISTER_KERNEL register_kernel_twid_r2c_fft15avx512
