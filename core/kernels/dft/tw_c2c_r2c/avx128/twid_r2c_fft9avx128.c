...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 36, 48, 44, 54, 10},
                                                     {0, 36, 48, 34, 22, 10}};

#define TWID_KNAME_FP32 twid_r2c_fft9avx128fp32
#define TWID_KNAME_FP64 twid_r2c_fft9avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft9avx128
#define REGISTER_KERNEL register_kernel_twid_r2c_fft9avx128
