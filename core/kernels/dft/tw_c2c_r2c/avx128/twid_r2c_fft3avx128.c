...
/** @file twid_r2c_fft3avx128.c
 *
 *  @brief R2C fused twiddle (forward twiddle + conjugate output) Radix-3 FFT
 *  kernel with avx128 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT twiddle radix-3 FFT implementations using AVX-128
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 6, 8, 14, 11, 2},
                                                     {0, 6, 8, 10, 3, 2}};

#define TWID_KNAME_FP32 twid_r2c_fft3avx128fp32
#define TWID_KNAME_FP64 twid_r2c_fft3avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft3avx128
#define REGISTER_KERNEL register_kernel_twid_r2c_fft3avx128
