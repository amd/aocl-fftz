...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 32, 59, 59, 60, 12},
                                                     {0, 32, 59, 46, 16, 12}};

#define TWID_KNAME_FP32 twid_r2c_fft12avx128fp32
#define TWID_KNAME_FP64 twid_r2c_fft12avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft12avx128
#define REGISTER_KERNEL register_kernel_twid_r2c_fft12avx128
