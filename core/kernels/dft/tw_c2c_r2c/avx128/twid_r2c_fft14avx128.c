...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 62, 87, 69, 71, 13},
                                                     {0, 62, 87, 54, 19, 13}};

#define TWID_KNAME_FP32 twid_r2c_fft14avx128fp32
#define TWID_KNAME_FP64 twid_r2c_fft14avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft14avx128
#define REGISTER_KERNEL register_kernel_twid_r2c_fft14avx128
