...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 14, 20, 24, 22, 4},
                                                     {0, 14, 20, 18, 6, 4}};

#define TWID_KNAME_FP32 twid_r2c_fft5avx128fp32
#define TWID_KNAME_FP64 twid_r2c_fft5avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft5avx128
#define REGISTER_KERNEL register_kernel_twid_r2c_fft5avx128
