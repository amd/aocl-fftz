...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 18, 33, 39, 38, 7},
                                                     {0, 18, 33, 30, 10, 7}};

#define TWID_KNAME_FP32 twid_r2c_fft8avx128fp32
#define TWID_KNAME_FP64 twid_r2c_fft8avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft8avx128
#define REGISTER_KERNEL register_kernel_twid_r2c_fft8avx128
