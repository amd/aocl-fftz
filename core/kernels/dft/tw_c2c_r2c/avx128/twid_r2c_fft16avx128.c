...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 45, 87, 79, 82, 15},
                                                     {0, 45, 87, 62, 22, 15}};

#define TWID_KNAME_FP32 twid_r2c_fft16avx128fp32
#define TWID_KNAME_FP64 twid_r2c_fft16avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft16avx128
#define REGISTER_KERNEL register_kernel_twid_r2c_fft16avx128
