...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 30, 51, 49, 49, 9},
                                                     {0, 30, 51, 38, 13, 9}};

#define TWID_KNAME_FP32 twid_r2c_fft10avx128fp32
#define TWID_KNAME_FP64 twid_r2c_fft10avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft10avx128
#define REGISTER_KERNEL register_kernel_twid_r2c_fft10avx128
