...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 7, 11, 19, 16, 3},
                                                     {0, 7, 11, 14, 4, 3}};

#define TWID_KNAME_FP32 twid_r2c_fft4avx128fp32
#define TWID_KNAME_FP64 twid_r2c_fft4avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_r2c_fft4avx128
#define REGISTER_KERNEL register_kernel_twid_r2c_fft4avx128
