...
static FFTZ_VOID r2hcf_rfft7c_fp32_fwd(FFTZ_VOID *in_real,
                                       ...
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    {
        /* Standard DFT */
        FFTZ_FLOAT av0, av1, av2, av3, av4, av5, av6;
        ...
        *out_r = at6 + at7;                       // Output pt 1: X(0)
        out_cp[out_strides[3]]  = at13 + at14;     // Output pt 4: X(3)
        out_cp[out_strides[4]]  = at15 + at16;     // Output pt 5: X(4)
        out_cp[out_strides[7]]  = at20 + at21;     // Output pt 8: X(7)
        out_cp[out_strides[8]]  = at24 - at28;     // Output pt 9: X(8)
        out_cp[out_strides[11]] = at29 + at30;     // Output pt 12: X(11)
        out_cp[out_strides[12]] = at34 + at33;     // Output pt 13: X(12)

        /* Shifted DFT */
        FFTZ_FLOAT bv0, bv1, bv2, bv3, bv4, bv5, bv6;
        ...
        out_cp[out_strides[1]]  = bt9 - bt10;     // Output pt 2: X(1)
        out_cp[out_strides[2]]  = bt14 - bt13;    // Output pt 3: X(2)
        out_cp[out_strides[5]]  = bt18 + bt19;    // Output pt 6: X(5)
        out_cp[out_strides[6]]  = bt23 - bt22;    // Output pt 7: X(6)
        out_cp[out_strides[9]]  = bt27 + bt28;    // Output pt 10: X(9)
        out_cp[out_strides[10]] = bt31 - bt32;    // Output pt 11: X(10)
        out_r[out_strides[13]] = bt33 + bt34;    // Output pt 14: X(13)
...
static FFTZ_VOID r2hcf_rfft7c_fp32_bwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        *out_r = av0 + at35;                     // Output pt 1: X(0)
        out_r[out_strides[2]]  = at9 - at10;     // Output pt 3: X(2)
        out_r[out_strides[4]]  = at20 - at21;    // Output pt 5: X(4)
        out_r[out_strides[6]]  = at32 - at34;    // Output pt 7: X(6)
        out_r[out_strides[8]]  = at32 + at34;    // Output pt 9: X(8)
        out_r[out_strides[10]] = at20 + at21;    // Output pt 11: X(10)
        out_r[out_strides[12]] = at9 + at10;     // Output pt 13: X(12)
        ...
        out_r[out_strides[1]]  = bv6 + bt35;     // Output pt 2: X(1)
        out_r[out_strides[3]]  = -bt5 - bt10;    // Output pt 4: X(3)
        out_r[out_strides[5]]  = bt20 + bt21;    // Output pt 6: X(5)
        out_r[out_strides[7]]  = bt34 - bt32;    // Output pt 8: X(7)
        out_r[out_strides[9]]  = bt32 + bt34;    // Output pt 10: X(9)
        out_r[out_strides[11]] = bt21 - bt20;    // Output pt 12: X(11)
        out_r[out_strides[13]] = bt5 - bt10;     // Output pt 14: X(13)
...
static FFTZ_VOID r2hcf_rfft7c_fp64_fwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    {
        /* Standard DFT */
        FFTZ_DOUBLE av0, av1, av2, av3, av4, av5, av6;
        ...
        *out_r = at6 + at7;                       // Output pt 1: X(0)
        ...
        out_cp[out_strides[4]]  = at15 + at16;     // Output pt 5: X(4)
        out_cp[out_strides[7]]  = at20 + at21;     // Output pt 8: X(7)
        out_cp[out_strides[8]]  = at24 - at25;     // Output pt 9: X(8)
        out_cp[out_strides[11]] = at29 + at30;     // Output pt 12: X(11)
        out_cp[out_strides[12]] = at34 + at33;     // Output pt 13: X(12)

        /* Shifted DFT */
        FFTZ_DOUBLE bv0, bv1, bv2, bv3, bv4, bv5, bv6;
...
static FFTZ_VOID r2hcf_rfft7c_fp64_bwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
