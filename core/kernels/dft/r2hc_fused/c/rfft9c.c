...
static FFTZ_VOID r2hcf_rfft9c_fp32_fwd(FFTZ_VOID *in_real,
                                       ...
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        *out_r = a_s13;
        ...
        a_s16 = a_s15 + a_m3;
        // Output point 4: X(3)
        out_cp[out_strides[3]] = a_s16 - a_m4;
        ...
        a_s21 = a_s20 + a_m9;
        // Output point 8: X(7)
        out_cp[out_strides[7]] = a_s21 - a_m10;
        ...
        a_s23 = a_s22 + a_m1;
        // Output point 9: X(8)
        out_cp[out_strides[8]] = a_s23 - a_m13;

        a_m14 = CRTM_9_4 * a_s9;
        a_s24 = a_in0 + a_s4;
        // Output point 12: X(11)
        out_cp[out_strides[11]] = a_s24 - a_m14;

        a_m15 = -CRTM_9_5 * a_s11;
        // Output point 13: X(12)
        out_cp[out_strides[12]] = a_m15;
        ...
        out_cp[out_strides[15]] = a_s26 - a_m18;
        ...
        out_cp[out_strides[16]] = a_s28 - a_m21;
        ...
        b_s14 = -(b_s13 + b_m18);
        // Output point 2: X(1)
        out_cp[out_strides[1]] = b_s11;
        // Output point 3: X(2)
        out_cp[out_strides[2]] = b_s14;
        ...
        b_s22 = b_s21 - b_s5;
        // Output point 6: X(5)
        out_cp[out_strides[5]] = b_s22;
        // Output point 7: X(6)
        out_cp[out_strides[6]] = b_s20;
        ...
        b_s29 = b_s28 - b_m16;
        // Output point 10: X(9)
        out_cp[out_strides[9]] = b_s26;
        // Output point 11: X(10)
        out_cp[out_strides[10]] = b_s29;
        ...
        out_cp[out_strides[13]] = b_s33;
        // Output point 15: X(14)
        out_cp[out_strides[14]] = b_s36;
...
static FFTZ_VOID r2hcf_rfft9c_fp32_bwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        *out_r = a_s15;
        ...
        a_s19 = a_s16 + a_m7;
        // Output point 7: x(6)
        out_r[out_strides[6]] = a_s18;
        // Output point 13: x(12)
        out_r[out_strides[12]] = a_s19;
        ...
        a_s23 = a_s2 + a_m12;
        // Output point 3: x(2)
        out_r[out_strides[2]] = a_s23;

        a_s24 = a_s22 + a_s21;
        a_s25 = a_s22 - a_s21;
        // Output point 15: x(14)
        out_r[out_strides[14]] = a_s24;
        // Output point 9: x(8)
        out_r[out_strides[8]] = a_s25;
        ...
        a_s29 = a_s3 + a_m17;
        // Output point 5: x(4)
        out_r[out_strides[4]] = a_s29;

        a_s30 = a_s28 + a_s26;
        a_s31 = a_s28 - a_s26;
        // Output point 17: x(16)
        out_r[out_strides[16]] = a_s30;
        // Output point 11: x(10)
        out_r[out_strides[10]] = a_s31;
        ...
        b_s23 = b_m15 + b_s1;
        // Output point 2: x(1)
        out_r[out_strides[1]] = b_s23;

        b_m16 = CRTM_9_6 * b_s21;
        b_s24 = b_m16 + b_s2;
        // Output point 4: x(3)
        out_r[out_strides[3]] = b_s24;

        b_m17 = CRTM_9_6 * b_s18;
        b_s25 = -(b_m17 + b_s3);
        // Output point 6: x(5)
        out_r[out_strides[5]] = b_s25;

        b_s26 = b_s15 + b_m6;
        // Output point 8: x(7)
        out_r[out_strides[7]] = b_s26;

        b_s27 = b_s22 + b_s20;
        // Output point 10: x(9)
        out_r[out_strides[9]] = b_s27;

        b_s28 = b_s19 + b_s17;
        // Output point 12: x(11)
        out_r[out_strides[11]] = b_s28;

        b_s29 = b_m6 - b_s15;
        // Output point 14: x(13)
        out_r[out_strides[13]] = b_s29;

        b_s30 = b_s20 - b_s22;
        // Output point 16: x(15)
        out_r[out_strides[15]] = b_s30;

        b_s31 = b_s17 - b_s19;
        // Output point 18: x(17)
        out_r[out_strides[17]] = b_s31;
...
static FFTZ_VOID r2hcf_rfft9c_fp64_fwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
...
static FFTZ_VOID r2hcf_rfft9c_fp64_bwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
