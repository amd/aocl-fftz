...
static FFTZ_VOID r2hcf_rfft12c_fp32_fwd(FFTZ_VOID *in_real,
                                        ...
                                        FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
   ...
   FFTZ_INTP cnt;
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        av5 = in_r[in_strides[10]];     // Input point 11: x(10)
        av6 = in_r[in_strides[12]];     // Input point 13: x(12)
        av7 = in_r[in_strides[14]];     // Input point 15: x(14)
        av8 = in_r[in_strides[16]];     // Input point 17: x(16)
        av9 = in_r[in_strides[18]];     // Input point 19: x(18)
        av10 = in_r[in_strides[20]];    // Input point 21: x(20)
        av11 = in_r[in_strides[22]];    // Input point 23: x(22)
        ...
        *out_r = at20 + at18;                           // Output pt 1: X(0)
        out_cp[out_strides[3]]  = at24 + at30;           // Output pt 4: X(3)
        out_cp[out_strides[4]]  = at25 + at33;           // Output pt 5: X(4)
        out_cp[out_strides[7]]  = at32 + at19;           // Output pt 8: X(7)
        out_cp[out_strides[8]]  = CRTM_12_3 * at28;      // Output pt 9: X(8)
        out_cp[out_strides[11]] = at5 - at15;            // Output pt 12: X(11)
        out_cp[out_strides[12]] = at17 - at11;           // Output pt 13: X(12)
        out_cp[out_strides[15]] = at18 - at31;           // Output pt 16: X(15)
        out_cp[out_strides[16]] = CRTM_12_3 * at29;      // Output pt 17: X(16)
        out_cp[out_strides[19]] = at24 - at30;           // Output pt 20: X(19)
        out_cp[out_strides[20]] = at25 - at33;           // Output pt 21: X(20)
        out_r[out_strides[23]] = at19 - at21;           // Output pt 24: X(23)
        ...
        bv5  = in_r[in_strides[11]];   // Input point 12: x(11)
        bv6  = in_r[in_strides[13]];   // Input point 14: x(13)
        bv7  = in_r[in_strides[15]];   // Input point 16: x(15)
        bv8  = in_r[in_strides[17]];   // Input point 18: x(17)
        bv9  = in_r[in_strides[19]];   // Input point 20: x(19)
        bv10 = in_r[in_strides[21]];   // Input point 22: x(21)
        bv11 = in_r[in_strides[23]];   // Input point 24: x(23)
        ...
        out_cp[out_strides[1]]  = bt38 + bt34;      // Output pt 2: X(1)
        out_cp[out_strides[2]]  = -bt40 - bt36;     // Output pt 3: X(2)
        out_cp[out_strides[5]]  = bt10 + bt19;      // Output pt 6: X(5)
        out_cp[out_strides[6]]  = bt18 + bt11;      // Output pt 7: X(6)
        out_cp[out_strides[9]]  = bt39 - bt35;      // Output pt 10: X(9)
        out_cp[out_strides[10]] = bt37 + bt41;      // Output pt 11: X(10)
        out_cp[out_strides[13]] = bt38 - bt34;      // Output pt 14: X(13)
        out_cp[out_strides[14]] = bt40 - bt36;      // Output pt 15: X(14)
        out_cp[out_strides[17]] = bt10 - bt19;      // Output pt 18: X(17)
        out_cp[out_strides[18]] = bt18 - bt11;      // Output pt 19: X(18)
        out_cp[out_strides[21]] = bt39 + bt35;      // Output pt 22: X(21)
        out_cp[out_strides[22]] = bt37 - bt41;      // Output pt 23: X(22)
...
static FFTZ_VOID r2hcf_rfft12c_fp32_bwd(FFTZ_VOID *in_real,
                                        FFTZ_VOID *in_complex,
                                        FFTZ_VOID *out_real,
                                        FFTZ_VOID *out_complex, FFTZ_INTP n,
                                        aoclfftz_strides_t *strides,
                                        FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        av5 = in_cp[in_strides[11]];   // Input point 12: X(11)
        av6 = in_cp[in_strides[12]];   // Input point 13: X(12)
        av7 = in_cp[in_strides[15]];   // Input point 16: X(15)
        av8 = in_cp[in_strides[16]];   // Input point 18: X(16)
        av9 = in_cp[in_strides[19]];   // Input point 20: X(19)
        av10 = in_cp[in_strides[20]];  // Input point 21: X(20)
        av11 = in_r[in_strides[23]];  // Input point 24: X(23)
        ...
        *out_r = at13 + at15;                    // Output pt 1: x(0)
        out_r[out_strides[2]]  = at19 + at32;    // Output pt 2: x(2)
        out_r[out_strides[4]]  = at23 + at35;    // Output pt 3: x(4)
        out_r[out_strides[6]]  = at31 - at27;    // Output pt 7: x(6)
        out_r[out_strides[8]]  = at34 + at22;    // Output pt 9: x(8)
        out_r[out_strides[10]] = at32 - at19;    // Output pt 11: x(10)
        out_r[out_strides[12]] = at14 - at29;    // Output pt 13: x(12)
        out_r[out_strides[14]] = at33 - at18;    // Output pt 15: x(14)
        out_r[out_strides[16]] = at34 - at22;    // Output pt 17: x(16)
        out_r[out_strides[18]] = at30 - at28;    // Output pt 19: x(18)
        out_r[out_strides[20]] = at35 - at23;    // Output pt 21: x(20)
        out_r[out_strides[22]] = at33 + at18;    // Output pt 23: x(22)
        ...
        bv4  = in_cp[in_strides[9]];    // Input point 10: X(9)
        bv5  = in_cp[in_strides[10]];   // Input point 11: X(10)
        bv6  = in_cp[in_strides[13]];   // Input point 14: X(13)
        bv7  = in_cp[in_strides[14]];   // Input point 15: X(14)
        bv8  = in_cp[in_strides[17]];   // Input point 18: X(17)
        bv9  = in_cp[in_strides[18]];   // Input point 19: X(18)
        bv10 = in_cp[in_strides[21]];   // Input point 22: X(21)
        bv11 = in_cp[in_strides[22]];   // Input point 23: X(22)
        ...
        out_r[out_strides[1]]  = CRTM_12_5 * bt14;     // Output pt 2: x(1)
        out_r[out_strides[3]]  = bt44 - bt40;          // Output pt 4: x(3)
        out_r[out_strides[5]]  = bt19 + bt21;          // Output pt 6: x(5)
        out_r[out_strides[7]]  = bt45 - bt39;          // Output pt 8: x(7)
        out_r[out_strides[9]]  = bt20 + bt22;          // Output pt 10: x(9)
        out_r[out_strides[11]] = bt46 + bt40;          // Output pt 12: x(11)
        out_r[out_strides[13]] = CRTM_12_5 * bt23;     // Output pt 14: x(13)
        out_r[out_strides[15]] = bt39 - bt47;          // Output pt 16: x(15)
        out_r[out_strides[17]] = bt20 - bt22;          // Output pt 18: x(17)
        out_r[out_strides[19]] = bt48 - bt40;          // Output pt 20: x(19)
        out_r[out_strides[21]] = bt21 - bt19;          // Output pt 22: x(21)
        out_r[out_strides[23]] = bt49 - bt39;          // Output pt 24: x(23)
...
static FFTZ_VOID r2hcf_rfft12c_fp64_fwd(FFTZ_VOID *in_real,
                                        FFTZ_VOID *in_complex,
                                        FFTZ_VOID *out_real,
                                        FFTZ_VOID *out_complex, FFTZ_INTP n,
                                        aoclfftz_strides_t *strides,
...
static FFTZ_VOID r2hcf_rfft12c_fp64_bwd(FFTZ_VOID *in_real,
                                        FFTZ_VOID *in_complex,
                                        FFTZ_VOID *out_real,
                                        FFTZ_VOID *out_complex, FFTZ_INTP n,
                                        aoclfftz_strides_t *strides,
                                        FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        av6 = in_cp[in_strides[12]];   // Input point 13: X(12)
        av7 = in_cp[in_strides[15]];   // Input point 16: X(15)
        av8 = in_cp[in_strides[16]];   // Input point 17: X(16)
        av9 = in_cp[in_strides[19]];   // Input point 20: X(19)
        av10 = in_cp[in_strides[20]];  // Input point 21: X(20)
        av11 = in_r[in_strides[23]];  // Input point 24: X(23)
        ...
        *out_r = at13 + at15;                    // Output pt 1: x(0)
        out_r[out_strides[2]]  = at19 + at32;    // Output pt 3: x(2)
        out_r[out_strides[4]]  = at23 + at35;    // Output pt 5: x(4)
        out_r[out_strides[6]]  = at31 - at27;    // Output pt 7: x(6)
        out_r[out_strides[8]]  = at34 + at22;    // Output pt 9: x(8)
        out_r[out_strides[10]] = at32 - at19;    // Output pt 11: x(10)
        out_r[out_strides[12]] = at14 - at29;    // Output pt 13: x(12)
