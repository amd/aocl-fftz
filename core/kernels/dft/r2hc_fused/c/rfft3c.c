...
static FFTZ_VOID r2hcf_rfft3c_fp32_fwd(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                       ...
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        // Output
        *out = av0 + at0;                   // Output point 1: X(0)
        out[out_strides[3]] = av0 - at2;    // Output point 4: X(3)
        out[out_strides[4]] = -at3;         // Output point 5: X(4)
        ...
        // Output
        out[out_strides[1]] = bv0 + bt2;    // Output point 2: X(1)
        out[out_strides[2]] = bt3;          // Output point 3: X(2)
        out[out_strides[5]] = bv0 - bt0;    // Output point 6: X(5)
...
static FFTZ_VOID r2hcf_rfft3c_fp32_bwd(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                       FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                       FFTZ_INTP n, aoclfftz_strides_t *strides,
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        // Output
        *out = av0 + at2;                   // Output point 1: X(0)
        out[out_strides[2]] = at0 - at1;    // Output point 3: X(2)
        ...
        // Output
        out[out_strides[1]] = bv2 + bt2;    // Output point 2: X(1)
        out[out_strides[3]] = bt0 - bt1;    // Output point 4: X(3)
        out[out_strides[5]] = -bt0 - bt1;   // Output point 6: X(5)
...
static FFTZ_VOID r2hcf_rfft3c_fp64_fwd(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                       FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                       FFTZ_INTP n, aoclfftz_strides_t *strides,
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
...
static FFTZ_VOID r2hcf_rfft3c_fp64_bwd(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                       FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                       FFTZ_INTP n, aoclfftz_strides_t *strides,
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
