...
static FFTZ_VOID r2hcf_rfft6c_fp32_fwd(FFTZ_VOID *in_real,
                                       ...
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        *out_r = at0 + at6;                       // Output pt 1: X(0)
        out_cp[out_strides[3]]  = at1 + at8;       // Output pt 4: X(3)
        out_cp[out_strides[4]]  = CRTM_6_2 * at9;  // Output pt 5: X(4)
        out_cp[out_strides[7]]  = at0 - at10;      // Output pt 8: X(7)
        out_cp[out_strides[8]]  = CRTM_6_2 * at11; // Output pt 9: X(8)
        out_r[out_strides[11]] = at1 - at7;       // Output pt 12: X(11)
        ...
        out_cp[out_strides[1]]  = bt8 + bt4;   // Output pt 2: X(1)
        out_cp[out_strides[2]]  = -bt7 - bt9;  // Output pt 3: X(2)
        out_cp[out_strides[5]]  = bv0 - bt2;   // Output pt 6: X(5)
        out_cp[out_strides[6]]  = bv3 - bt1;   // Output pt 7: X(6)
        out_cp[out_strides[9]]  = bt8 - bt4;   // Output pt 10: X(9)
        out_cp[out_strides[10]] = bt7 - bt9;   // Output pt 11: X(10)
...
static FFTZ_VOID r2hcf_rfft6c_fp32_bwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        av0 = *in_r;                  // Input point 1: x(0)
        av1 = in_cp[in_strides[3]];    // Input point 3: x(2)
        av2 = in_cp[in_strides[4]];    // Input point 5: x(4)
        av3 = in_cp[in_strides[7]];    // Input point 7: x(6)
        av4 = in_cp[in_strides[8]];    // Input point 9: x(8)
        av5 = in_r[in_strides[11]];   // Input point 11: x(10)
        ...
        *out_r = at0 + at10;                  // Output pt 1: X(0)
        out_r[out_strides[2]]  = at8 - at6;   // Output pt 3: X(2)
        out_r[out_strides[4]]  = at9 - at7;   // Output pt 5: X(4)
        out_r[out_strides[6]]  = at1 - at11;  // Output pt 7: X(6)
        out_r[out_strides[8]]  = at9 + at7;   // Output pt 9: X(8)
        out_r[out_strides[10]] = at8 + at6;   // Output pt 11: X(10)
        ...
        bv1 = in_cp[in_strides[2]];    // Input point 4: x(3)
        bv2 = in_cp[in_strides[5]];    // Input point 6: x(5)
        bv3 = in_cp[in_strides[6]];    // Input point 8: x(7)
        bv4 = in_cp[in_strides[9]];    // Input point 10: x(9)
        bv5 = in_cp[in_strides[10]];   // Input point 12: x(11)
        ...
        out_r[out_strides[1]]  = bt8 + bt6;   // Output pt 2: X(1)
        out_r[out_strides[3]]  = bt2 - bt10;  // Output pt 4: X(3)
        out_r[out_strides[5]]  = bt11 - bt5;  // Output pt 6: X(5)
        out_r[out_strides[7]]  = bt9 - bt7;   // Output pt 8: X(7)
        out_r[out_strides[9]]  = -bt11 - bt5; // Output pt 10: X(9)
        out_r[out_strides[11]] = -bt2 - bt10; // Output pt 12: X(11)
...
static FFTZ_VOID r2hcf_rfft6c_fp64_fwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
...
static FFTZ_VOID r2hcf_rfft6c_fp64_bwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
