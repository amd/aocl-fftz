...
static FFTZ_VOID r2hcf_rfft8c_fp32_fwd(FFTZ_VOID *in_real,
                                       ...
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    {
        /* Standard DFT */
        FFTZ_FLOAT av0, av1, av2, av3, av4, av5, av6, av7;
        FFTZ_FLOAT at0, at1, at2, at3, at4, at5, at6, at7, at8, at9,
              at10, at11, at12, at13;
        ...
        av7 = in_r[in_strides[14]];   // Input point 13: x(12)
        ...
        *out_r = at11 + at10;                   // Output pt 1: X(0)
        out_cp[out_strides[3]]  = at5 - at12;    // Output pt 4: X(3)
        out_cp[out_strides[4]]  = at3 + at13;    // Output pt 5: X(4)
        out_cp[out_strides[7]]  = at4 - at2;     // Output pt 8: X(7)
        out_cp[out_strides[8]]  = at7 + at1;     // Output pt 9: X(8)
        out_cp[out_strides[11]] = at12 + at5;    // Output pt 12: X(11)
        out_cp[out_strides[12]] = at13 - at3;    // Output pt 13: X(12)
        out_r[out_strides[15]] = at11 - at10;   // Output pt 16: X(15)

        /* Shifted DFT */
        FFTZ_FLOAT bv0, bv1, bv2, bv3, bv4, bv5, bv6, bv7;
        ...
        bv7 = in_r[in_strides[15]];   // Input point 14: x(13)
        ...
        out_cp[out_strides[1]]  = bt16 - bt20;   // Output pt 2: X(1)
        out_cp[out_strides[2]]  = -bt19 - bt21;  // Output pt 3: X(2)
        out_cp[out_strides[5]]  = bt17 + bt22;   // Output pt 6: X(5)
        out_cp[out_strides[6]]  = bt18 + bt23;   // Output pt 7: X(6)
        out_cp[out_strides[9]]  = bt17 - bt22;   // Output pt 10: X(9)
        out_cp[out_strides[10]] = bt23 - bt18;   // Output pt 11: X(10)
        out_cp[out_strides[13]] = bt16 + bt20;   // Output pt 14: X(12)
        out_cp[out_strides[14]] = bt19 - bt21;   // Output pt 15: X(14)
...
static FFTZ_VOID r2hcf_rfft8c_fp32_bwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        av7 = in_r[in_strides[15]];   // Input point 14: x(13)
        ...
        *out_r = at14 + at7;                   // Output pt 1: X(0)
        out_r[out_strides[2]]  = -at12 - at16; // Output pt 3: X(2)
        out_r[out_strides[4]]  = at15 + at6;   // Output pt 5: X(4)
        out_r[out_strides[6]]  = at17 + at13;  // Output pt 7: X(6)
        out_r[out_strides[8]]  = at14 - at7;   // Output pt 9: X(8)
        out_r[out_strides[10]] = at12 - at16;  // Output pt 11: X(10)
        out_r[out_strides[12]] = at15 - at6;   // Output pt 13: X(12)
        out_r[out_strides[14]] = at17 - at13;  // Output pt 15: X(14)
        ...
        bv7 = in_cp[in_strides[14]];   // Input point 13: x(12)
        ...
        out_r[out_strides[1]]  = CRTM_8_4 * bt11; // Output pt 2: X(1)
        out_r[out_strides[3]]  = -bt18 - bt20;    // Output pt 4: X(3)
        out_r[out_strides[5]]  = bt12 + bt13;     // Output pt 6: X(5)
        out_r[out_strides[7]]  = bt19 + bt21;     // Output pt 8: X(7)
        out_r[out_strides[9]]  = CRTM_8_4 * bt9;  // Output pt 10: X(9)
        out_r[out_strides[11]] = bt22 - bt24;     // Output pt 12: X(11)
        out_r[out_strides[13]] = bt12 - bt13;     // Output pt 14: X(12)
        out_r[out_strides[15]] = bt25 - bt23;     // Output pt 16: X(15)
...
static FFTZ_VOID r2hcf_rfft8c_fp64_fwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
                                       FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    {
        /* Standard DFT */
        FFTZ_DOUBLE av0, av1, av2, av3, av4, av5, av6, av7;
        FFTZ_DOUBLE at0, at1, at2, at3, at4, at5, at6, at7, at8, at9,
               at10, at11, at12, at13;
        ...
        *out_r = at11 + at10;                   // Output pt 1: X(0)
        ...
        /* Shifted DFT */
        FFTZ_DOUBLE bv0, bv1, bv2, bv3, bv4, bv5, bv6, bv7;
...
static FFTZ_VOID r2hcf_rfft8c_fp64_bwd(FFTZ_VOID *in_real,
                                       FFTZ_VOID *in_complex,
                                       FFTZ_VOID *out_real,
                                       FFTZ_VOID *out_complex, FFTZ_INTP n,
                                       aoclfftz_strides_t *strides,
