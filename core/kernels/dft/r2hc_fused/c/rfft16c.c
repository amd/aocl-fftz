...
static FFTZ_VOID r2hcf_rfft16c_fp32_fwd(FFTZ_VOID *in_real,
                                        ...
                                        FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        *out_r = a_t15 + a_s27;
        ...
        out_r[out_strides[31]] = a_s27 - a_t15;
        ...
        a_t18 = a_t9 + a_s1;
        // Output point 4: X(3)
        out_cp[out_strides[3]] = a_s28 + a_t18;
        // Output point 28: X(27)
        out_cp[out_strides[27]] = a_t18 - a_s28;
        ...
        out_cp[out_strides[11]] = a_s30 - a_s29;
        // Output point 20: X(19)
        out_cp[out_strides[19]] = a_s29 + a_s30;

        a_s31 = a_t6 - a_t1;
        a_s32 = a_s9 - a_t8;
        // Output point 13: X(12)
        out_cp[out_strides[12]] = a_s31 + a_s32;
        // Output point 21: X(20)
        out_cp[out_strides[20]] = a_s31 - a_s32;
        ...
        // Output point 2: X(1)
        out_cp[out_strides[1]] = b_s9 + b_s14;
        // Output point 30: X(29)
        out_cp[out_strides[29]] = b_s9 - b_s14;
        ...
        out_cp[out_strides[14]] = b_s18 + b_s15;
        // Output point 19: X(18)
        out_cp[out_strides[18]] = b_s15 - b_s18;
        ...
        // Output point 3: X(2)
        out_cp[out_strides[2]] = b_s21 - b_s19;
        // Output point 31: X(30)
        out_cp[out_strides[30]] = b_s21 + b_s19;

        // Output point 18: X(17)
        out_cp[out_strides[17]] = b_s8 - b_s20;
        // Output point 14: X(13)
        out_cp[out_strides[13]] = b_s8 + b_s20;
        ...
        // Output point 6: X(5)
        out_cp[out_strides[5]] = b_t19 + b_s27;
        // Output point 26: X(25)
        out_cp[out_strides[25]] = b_t19 - b_s27;
        ...
        out_cp[out_strides[10]] = b_s31 - b_s28;
        // Output point 23: X(22)
        out_cp[out_strides[22]] = -(b_s31 + b_s28);
        ...
        out_cp[out_strides[21]] = b_s23 - b_s33;
        // Output point 10: X(9)
        out_cp[out_strides[9]] = b_s23 + b_s33;

        // Output point 27: X(26)
        out_cp[out_strides[26]] = b_s34 - b_s32;
        // Output point 7: X(6)
        out_cp[out_strides[6]] = b_s34 + b_s32;
...
static FFTZ_VOID r2hcf_rfft16c_fp32_bwd(FFTZ_VOID *in_real,
                                        FFTZ_VOID *in_complex,
                                        FFTZ_VOID *out_real,
                                        FFTZ_VOID *out_complex, FFTZ_INTP n,
                                        aoclfftz_strides_t *strides,
                                        FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < n; cnt++)
    {
        ...
        *out_r = a_s26 + a_t13;
        // Output point 17: X(16)
        out_r[out_strides[16]] = a_s26 - a_t13;

        a_t15 = CRTM_16_4 * a_s21;
        a_s27 = a_s24 - a_t14;
        // Output point 9: X(8)
        out_r[out_strides[8]] = a_s27 - a_t15;
        // Output point 25: X(24)
        out_r[out_strides[24]] = a_s27 + a_t15;
        ...
        a_s30 = a_t0 - a_t1;
        // Output point 3: X(2)
        out_r[out_strides[2]] = a_s29 + a_s30;
        // Output point 19: X(18)
        out_r[out_strides[18]] = a_s29 - a_s30;
        ...
        a_s32 = a_t6 - a_t5;
        // Output point 7: X(6)
        out_r[out_strides[6]] = a_s31 + a_s32;
        // Output point 23: X(22)
        out_r[out_strides[22]] = a_s31 - a_s32;
        ...
        a_s36 = a_t9 + a_t10;
        // Output point 15: X(14)
        out_r[out_strides[14]] = a_s35 - a_s36;
        // Output point 31: X(30)
        out_r[out_strides[30]] = a_s35 + a_s36;
        ...
        a_s34 = a_t7 + a_t8;
        // Output point 11: X(10)
        out_r[out_strides[10]] = a_s33 - a_s34;
        // Output point 27: X(26)
        out_r[out_strides[26]] = a_s33 + a_s34;
        ...
        a_s37 = a_s25 - a_t19;
        // Output point 5: X(4)
        out_r[out_strides[4]] = a_s37 + a_t18;
        // Output point 21: X(20)
        out_r[out_strides[20]] = a_s37 - a_t18;

        a_t11 = a_s15 + a_s20;
        a_t20 = CRTM_16_3 * a_t11;
        a_s38 = a_s25 + a_t19;
        // Output point 13: X(12)
        out_r[out_strides[12]] = a_s38 - a_t20;
        // Output point 29: X(28)
        out_r[out_strides[28]] = a_s38 + a_t20;
        ...
        // Output point 6: X(5)
        out_r[out_strides[5]] = (CRTM_16_1 * b_s12) + (CRTM_16_2 * b_s14);
        // Output point 22: X(21)
        out_r[out_strides[21]] = (CRTM_16_1 * b_s14) - (CRTM_16_2 * b_s12);
        // Output point 30: X(29)
        out_r[out_strides[29]] = (CRTM_16_1 * b_t7) + (CRTM_16_2 * b_s15);
        // Output point 14: X(13)
        out_r[out_strides[13]] = (CRTM_16_1 * b_s15) - (CRTM_16_2 * b_t7);

        b_t9 = b_s1 + b_t3;
        b_s16 = b_s5 + b_t2;
        // Output point 2: X(1)
        out_r[out_strides[1]] = CRTM_16_4 * (b_t9 + b_s16);
        ...
        // Output point 10: X(9)
        out_r[out_strides[9]] = CRTM_16_3 * (b_s17 + b_s18);
        // Output point 26: X(25)
        out_r[out_strides[25]] = CRTM_16_3 * (b_s18 - b_s17);
        ...
        // Output point 4: X(3)
        out_r[out_strides[3]] = (CRTM_16_7 * b_s26) - (CRTM_16_6 * b_s25);
        // Output point 12: X(11)
        out_r[out_strides[11]] = (CRTM_16_9 * b_s27) - (CRTM_16_8 * b_t15);
        // Output point 28: X(27)
        out_r[out_strides[27]] = (CRTM_16_9 * b_t15) + (CRTM_16_8 * b_s27);
        // Output point 20: X(19)
        out_r[out_strides[19]] = (CRTM_16_6 * b_s26) + (CRTM_16_7 * b_s25);
        ...
        // Output point 16: X(15)
        out_r[out_strides[15]] = (CRTM_16_6 * b_s28) + (CRTM_16_7 * b_s31);
        // Output point 32: X(31)
        out_r[out_strides[31]] = (CRTM_16_7 * b_s28) - (CRTM_16_6 * b_s31);
        // Output point 8: X(7)
        out_r[out_strides[7]] = (CRTM_16_9 * b_s29) + (CRTM_16_8 * b_s30);
        // Output point 24: X(23)
        out_r[out_strides[23]] = (CRTM_16_9 * b_s30) - (CRTM_16_8 * b_s29);
...
static FFTZ_VOID r2hcf_rfft16c_fp64_fwd(FFTZ_VOID *in_real,
                                        FFTZ_VOID *in_complex,
                                        FFTZ_VOID *out_real,
                                        FFTZ_VOID *out_complex, FFTZ_INTP n,
                                        aoclfftz_strides_t *strides,
...
static FFTZ_VOID r2hcf_rfft16c_fp64_bwd(FFTZ_VOID *in_real,
                                        FFTZ_VOID *in_complex,
                                        FFTZ_VOID *out_real,
                                        FFTZ_VOID *out_complex, FFTZ_INTP n,
                                        aoclfftz_strides_t *strides,
