...
/** @file rfft4avx512.c
 *
 *  @brief Radix-4 r2hc_fused Real-FFT kernel with with AVX-512 operations using
 *  x86 SIMD intrinsics.
 *
...
static FFTZ_VOID r2hcf_rfft4avx512_fp32_fwd(FFTZ_VOID *in_real,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m512 v_CRTM_4_1 = _mm512_set1_ps(CRTM_4_1);

    for (cnt = 0; cnt < N; cnt++)
    {
        // Standard DFT
        __m512 av_in0, av_in1, av_in2, av_in4;
        __m512 av_s0, av_s1;
        ...
        av_s0 = _mm512_add_ps(av_in0, av_in2);
        av_s1 = _mm512_add_ps(av_in1, av_in4);

        // Output point 1: x(0)
        v_out0 = _mm512_add_ps(av_s0, av_s1);
        curr_out = out_r;
        ...
        bv_s0 = _mm512_add_ps(bv_in1, bv_in3);
        bv_s1 = _mm512_sub_ps(bv_in1, bv_in3);

        bv_t0 = _mm512_mul_ps(v_CRTM_4_1, bv_s0);
        bv_t1 = _mm512_mul_ps(v_CRTM_4_1, bv_s1);

        // Output point 2: x(1) & Output point 3: X(2)
        curr_out = out_cp + out_strides[1];
        v_out1 = _mm512_sub_ps(bv_in0, bv_t1);
        v_out2 = _mm512_sub_ps(bv_t0, bv_in2);
        STRI_2x512_S(curr_out, v_out_stride, v_out1, v_out2);
        // Output point 6: X(5) & Output point 7: X(6)
        curr_out = out_cp + out_strides[5];
        v_out5 = _mm512_add_ps(bv_in0, bv_t1);
        v_out6 = _mm512_add_ps(bv_in2, bv_t0);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_S)
    {
        ...
        __m256 v256_CRTM_4_1 = _mm512_castps512_ps256(v_CRTM_4_1);
        ...
        bv_t0 = _mm256_mul_ps(v256_CRTM_4_1, bv_s0);
        bv_t1 = _mm256_mul_ps(v256_CRTM_4_1, bv_s1);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        __m128 v128_CRTM_4_1 = _mm512_castps512_ps128(v_CRTM_4_1);
    ...
    if (remaining_sets & 1)
    {
        ...
        *out_r = a_s0 + a_s1;                  // Output point 1: X(0)
        out_cp[out_strides[3]] = a_in0 - a_in2; // Output point 4: X(3)
        out_cp[out_strides[4]] = a_in3 - a_in1; // Output point 5: X(4)
        out_r[out_strides[7]] = a_s0 - a_s1;   // Output point 8: X(7)
        ...
        out_cp[out_strides[1]] = b_in0 - b_t1; // Output point 2: X(1)
        out_cp[out_strides[2]] = b_t0 - b_in2; // Output point 3: X(2)
        out_cp[out_strides[5]] = b_in0 + b_t1; // Output point 6: X(5)
        out_cp[out_strides[6]] = b_in2 + b_t0; // Output point 7: X(6)
...
static FFTZ_VOID r2hcf_rfft4avx512_fp32_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m512 v_CRTM_4_1 = _mm512_set1_ps(CRTM_4_1);
    __m512 v_CRTM_4_2 = _mm512_set1_ps(CRTM_4_2);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_512_S(curr_in, v_in_dc_nyq_stride, av_in4, is_contiguous_in_dc_nyq);

        av_s0 = _mm512_add_ps(av_in0, av_in4);
        av_t0 = _mm512_mul_ps(v_CRTM_4_2, av_in1);
        av_s1 = _mm512_sub_ps(av_in0, av_in4);
        av_t1 = _mm512_mul_ps(v_CRTM_4_2, av_in2);

        // Output point 1: x(0)
        v_out0 = _mm512_add_ps(av_s0, av_t0);
        STR_512_S(curr_out, v_out_stride, v_out0, is_contiguous_out);
        // Output point 3: x(2)
        curr_out = out_r + out_strides[2];
        v_out2 = _mm512_sub_ps(av_s1, av_t1);
        ...
        v_out6 = _mm512_add_ps(av_s1, av_t1);
        STR_512_S(curr_out, v_out_stride, v_out6, is_contiguous_out);

        // Shifted DFT
        __m512 bv_in0, bv_in1, bv_in2, bv_in3;
        __m512 bv_s0, bv_s1, bv_s2, bv_s3;
        __m512 bv_t0, bv_t1;
    ...
    if (remaining_sets & NUM_SETS_REAL_256_S)
    {
        ...
        __m256 v256_CRTM_4_1 = _mm512_castps512_ps256(v_CRTM_4_1);
        __m256 v256_CRTM_4_2 = _mm512_castps512_ps256(v_CRTM_4_2);
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_256_S(curr_in, v_in_dc_nyq_stride, av_in4, is_contiguous_in_dc_nyq);

        av_s0 = _mm256_add_ps(av_in0, av_in4);
        av_t0 = _mm256_mul_ps(v256_CRTM_4_2, av_in1);
        av_s1 = _mm256_sub_ps(av_in0, av_in4);
        av_t1 = _mm256_mul_ps(v256_CRTM_4_2, av_in2);
        ...
        bv_t0 = _mm256_mul_ps(v256_CRTM_4_1, bv_s0);
        bv_t1 = _mm256_mul_ps(v256_CRTM_4_1, bv_s2);

        // Output point 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm256_mul_ps(v256_CRTM_4_2, bv_s1);
        ...
        // Output point 6: X(5)
        curr_out = out_r + out_strides[5];
        v_out5 = _mm256_mul_ps(v256_CRTM_4_2, bv_s3);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        __m128 v128_CRTM_4_1 = _mm512_castps512_ps128(v_CRTM_4_1);
        __m128 v128_CRTM_4_2 = _mm512_castps512_ps128(v_CRTM_4_2);
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_128_S(curr_in, v_in_dc_nyq_stride, av_in4, is_contiguous_in_dc_nyq);
    ...
    if (remaining_sets & 2)
    {
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDHR_128_S(curr_in, v_in_dc_nyq_stride, av_in4);
    ...
    if (remaining_sets & 1)
    {
        ...
        a_in3 = in_r[in_strides[7]]; // Input point 8: x(7)
        ...
        *out_r = a_s0 + a_t0;                // Output point 1: X(0)
        out_r[out_strides[2]] = a_s1 - a_t2; // Output point 3: X(2)
        out_r[out_strides[4]] = a_s0 - a_t0; // Output point 5: X(4)
        out_r[out_strides[6]] = a_s1 + a_t2; // Output point 7: X(6)
        ...
        out_r[out_strides[1]] = CRTM_4_2 * b_s1; // Output point 2: X(1)
        out_r[out_strides[3]] = b_t1 - b_t0;     // Output point 4: X(3)
        out_r[out_strides[5]] = CRTM_4_2 * b_s3; // Output point 6: X(5)
        out_r[out_strides[7]] = b_t0 + b_t1;     // Output point 8: X(7)
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hcf_rfft4avx512_fp64_fwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m512d v_CRTM_4_1 = _mm512_set1_pd(CRTM_4_1);

    for (cnt = 0; cnt < N; cnt++)
    {
        // Standard DFT
        __m512d av_in0, av_in1, av_in2, av_in4;
        __m512d av_s0, av_s1;
        ...
        bv_s0 = _mm512_add_pd(bv_in1, bv_in3);
        bv_s1 = _mm512_sub_pd(bv_in1, bv_in3);

        bv_t0 = _mm512_mul_pd(v_CRTM_4_1, bv_s0);
        bv_t1 = _mm512_mul_pd(v_CRTM_4_1, bv_s1);

        // Output point 2: x(1) & Output point 3: X(2)
        curr_out = out_cp + out_strides[1];
        v_out1 = _mm512_sub_pd(bv_in0, bv_t1);
        v_out2 = _mm512_sub_pd(bv_t0, bv_in2);
        STRI_2x512_D(curr_out, v_out_stride, v_out1, v_out2);
        // Output point 6: X(5) & Output point 7: X(6)
        curr_out = out_cp + out_strides[5];
        v_out5 = _mm512_add_pd(bv_in0, bv_t1);
        v_out6 = _mm512_add_pd(bv_in2, bv_t0);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_D)
    {
        ...
        __m256d v256_CRTM_4_1 = _mm512_castpd512_pd256(v_CRTM_4_1);
        ...
        bv_t0 = _mm256_mul_pd(v256_CRTM_4_1, bv_s0);
        bv_t1 = _mm256_mul_pd(v256_CRTM_4_1, bv_s1);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        __m128d v128_CRTM_4_1 = _mm512_castpd512_pd128(v_CRTM_4_1);
...
static FFTZ_VOID r2hcf_rfft4avx512_fp64_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m512d v_CRTM_4_1 = _mm512_set1_pd(CRTM_4_1);
    __m512d v_CRTM_4_2 = _mm512_set1_pd(CRTM_4_2);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_512_D(curr_in, v_in_dc_nyq_stride, av_in4, is_contiguous_in_dc_nyq);

        av_s0 = _mm512_add_pd(av_in0, av_in4);
        av_t0 = _mm512_mul_pd(v_CRTM_4_2, av_in1);
        av_s1 = _mm512_sub_pd(av_in0, av_in4);
        av_t1 = _mm512_mul_pd(v_CRTM_4_2, av_in2);

        // Output point 1: x(0)
        v_out0 = _mm512_add_pd(av_s0, av_t0);
        STR_512_D(curr_out, v_out_stride, v_out0, is_contiguous_out);
        // Output point 3: x(2)
        curr_out = out_r + out_strides[2];
        v_out2 = _mm512_sub_pd(av_s1, av_t1);
        ...
        // Output point 7: x(6)
        curr_out = out_r + out_strides[6];
        v_out6 = _mm512_add_pd(av_s1, av_t1);
        STR_512_D(curr_out, v_out_stride, v_out6, is_contiguous_out);

        // Shifted DFT
        __m512d bv_in0, bv_in1, bv_in2, bv_in3;
        __m512d bv_s0, bv_s1, bv_s2, bv_s3;
        __m512d bv_t0, bv_t1;
        ...
        bv_s2 = _mm512_add_pd(bv_in1, bv_in3);
        bv_s3 = _mm512_sub_pd(bv_in3, bv_in1);
        bv_t0 = _mm512_mul_pd(v_CRTM_4_1, bv_s0);
        bv_t1 = _mm512_mul_pd(v_CRTM_4_1, bv_s2);

        // Output point 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm512_mul_pd(v_CRTM_4_2, bv_s1);
        STR_512_D(curr_out, v_out_stride, v_out1, is_contiguous_out);
        // Output point 4: X(3)
        curr_out = out_r + out_strides[3];
        v_out3 = _mm512_sub_pd(bv_t1, bv_t0);
        STR_512_D(curr_out, v_out_stride, v_out3, is_contiguous_out);
        // Output point 6: X(5)
        curr_out = out_r + out_strides[5];
        v_out5 = _mm512_mul_pd(v_CRTM_4_2, bv_s3);
        STR_512_D(curr_out, v_out_stride, v_out5, is_contiguous_out);
        // Output point 8: X(7)
        curr_out = out_r + out_strides[7];
        v_out7 = _mm512_add_pd(bv_t0, bv_t1);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_D)
    {
        ...
        __m256d v256_CRTM_4_1 = _mm512_castpd512_pd256(v_CRTM_4_1);
        __m256d v256_CRTM_4_2 = _mm512_castpd512_pd256(v_CRTM_4_2);
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_256_D(curr_in, v_in_dc_nyq_stride, av_in4, is_contiguous_in_dc_nyq);

        av_s0 = _mm256_add_pd(av_in0, av_in4);
        av_t0 = _mm256_mul_pd(v256_CRTM_4_2, av_in1);
        av_s1 = _mm256_sub_pd(av_in0, av_in4);
        av_t1 = _mm256_mul_pd(v256_CRTM_4_2, av_in2);
        ...
        bv_t0 = _mm256_mul_pd(v256_CRTM_4_1, bv_s0);
        bv_t1 = _mm256_mul_pd(v256_CRTM_4_1, bv_s2);

        // Output point 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm256_mul_pd(v256_CRTM_4_2, bv_s1);
        ...
        // Output point 6: X(5)
        curr_out = out_r + out_strides[5];
        v_out5 = _mm256_mul_pd(v256_CRTM_4_2, bv_s3);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        __m128d v128_CRTM_4_1 = _mm512_castpd512_pd128(v_CRTM_4_1);
        __m128d v128_CRTM_4_2 = _mm512_castpd512_pd128(v_CRTM_4_2);
        ...
        // Input point 8: x(7)
        curr_in = in_r + in_strides[7];
        LDR_128_D(curr_in, v_in_dc_nyq_stride, av_in4, is_contiguous_in_dc_nyq);
                                        ...
                                        FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft4avx512_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft4avx512_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft4avx512_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft4avx512_fp64_bwd;
        }
        else
        {
            return NULL;
