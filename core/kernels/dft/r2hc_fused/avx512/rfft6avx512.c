...
/** @file rfft6avx512.c
 *
 *  @brief Radix-6 r2hc_fused Real-FFT kernel with with AVX-512 operations using
 *  x86 SIMD intrinsics.
 *
...
static FFTZ_VOID r2hcf_rfft6avx512_fp32_fwd(FFTZ_VOID *in_real,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    {
        // Standard DFT
        __m512 av_in0, av_in1, av_in2, av_in3, av_in4, av_in5;
        ...
        av_s0 = _mm512_add_ps(av_in0, av_in3);
        av_s1 = _mm512_sub_ps(av_in0, av_in3);
        av_s2 = _mm512_add_ps(av_in1, av_in2);
        av_s3 = _mm512_sub_ps(av_in2, av_in1);

        av_s4 = _mm512_add_ps(av_in4, av_in5);
        av_s5 = _mm512_sub_ps(av_in5, av_in4);
        av_s6 = _mm512_add_ps(av_s2, av_s4);
        av_s7 = _mm512_sub_ps(av_s5, av_s3);

        av_t0 = _mm512_mul_ps(v_CRTM_6_1, av_s7);
        av_s8 = _mm512_sub_ps(av_s4, av_s2);

        av_t1 = _mm512_mul_ps(v_CRTM_6_1, av_s6);
        av_s9 = _mm512_add_ps(av_s3, av_s5);

        // Output pt 1: X(0)
        v_out0 = _mm512_add_ps(av_s0, av_s6);
        curr_out = out_r;
        ...
        v_out3 = _mm512_add_ps(av_s1, av_t0);
        v_out4 = _mm512_mul_ps(v_CRTM_6_2, av_s8);
        STRI_2x512_S(curr_out, v_out_stride, v_out3, v_out4);
        // Output pt 8: X(7) & Output pt 9: X(8)
        curr_out = out_cp + out_strides[7];
        v_out7 = _mm512_sub_ps(av_s0, av_t1);
        v_out8 = _mm512_mul_ps(v_CRTM_6_2, av_s9);
        STRI_2x512_S(curr_out, v_out_stride, v_out7, v_out8);
        // Output pt 12: X(11)
        curr_out = out_r + out_strides[11];
        v_out11 = _mm512_sub_ps(av_s1, av_s7);
        STR_512_S(curr_out, v_out_dc_nyq_stride, v_out11, is_contiguous_out_dc_nyq);

        // Shifted DFT
        __m512 bv_in0, bv_in1, bv_in2, bv_in3, bv_in4, bv_in5;
        __m512 bv_s0, bv_s1, bv_s2, bv_s3, bv_s4, bv_s5;
        __m512 bv_t0, bv_t1, bv_t2, bv_t3;
        ...
        bv_s0 = _mm512_sub_ps(bv_in1, bv_in5);
        bv_s1 = _mm512_add_ps(bv_in1, bv_in5);
        bv_s2 = _mm512_sub_ps(bv_in2, bv_in4);
        bv_s3 = _mm512_add_ps(bv_in2, bv_in4);

        bv_t0 = _mm512_mul_ps(v_CRTM_6_2, bv_s0);
        bv_t1 = _mm512_mul_ps(v_CRTM_6_1, bv_s1);
        bv_t2 = _mm512_mul_ps(v_CRTM_6_1, bv_s2);
        bv_t3 = _mm512_mul_ps(v_CRTM_6_2, bv_s3);

        bv_s4 = _mm512_add_ps(bv_in0, bv_t2);
        bv_s5 = _mm512_add_ps(bv_in3, bv_t1);

        // Output point 2: X(1) & Output point 3: X(2)
        curr_out = out_cp + out_strides[1];
        v_out1 = _mm512_add_ps(bv_s4, bv_t0);
        v_out2 = NEGATE_512_S(_mm512_add_ps(bv_t3, bv_s5));
        STRI_2x512_S(curr_out, v_out_stride, v_out1, v_out2);
        // Output point 6: X(5) & Output point 7: X(6)
        curr_out = out_cp + out_strides[5];
        v_out5 = _mm512_sub_ps(bv_in0, bv_s2);
        v_out6 = _mm512_sub_ps(bv_in3, bv_s1);
        STRI_2x512_S(curr_out, v_out_stride, v_out5, v_out6);
        // Output point 10: X(9) & Output point 11: X(10)
        curr_out = out_cp + out_strides[9];
        v_out9 = _mm512_sub_ps(bv_s4, bv_t0);
        v_out10 = _mm512_sub_ps(bv_t3, bv_s5);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_S)
    {
        ...
        av_t0 = _mm256_mul_ps(v256_CRTM_6_1, av_s7);
        av_s8 = _mm256_sub_ps(av_s4, av_s2);

        av_t1 = _mm256_mul_ps(v256_CRTM_6_1, av_s6);
        ...
        bv_t0 = _mm256_mul_ps(v256_CRTM_6_2, bv_s0);
        bv_t1 = _mm256_mul_ps(v256_CRTM_6_1, bv_s1);
        bv_t2 = _mm256_mul_ps(v256_CRTM_6_1, bv_s2);
        bv_t3 = _mm256_mul_ps(v256_CRTM_6_2, bv_s3);
...
static FFTZ_VOID r2hcf_rfft6avx512_fp32_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        // Standard DFT
        __m512 av_in0, av_in1, av_in2, av_in3, av_in4, av_in5;
        __m512 av_s0, av_s1, av_s2, av_s3, av_s4, av_s5, av_s6, av_s7;
        ...
        // Input point 12: x(11)
        curr_in = in_r + in_strides[11];
        LDR_512_S(curr_in, v_in_dc_nyq_stride, av_in5, is_contiguous_in_dc_nyq);

        av_s0 = _mm512_add_ps(av_in0, av_in5);
        av_s1 = _mm512_sub_ps(av_in0, av_in5);
        av_s2 = _mm512_add_ps(av_in1, av_in3);

        av_s3 = _mm512_sub_ps(av_in1, av_in3);
        av_s4 = _mm512_add_ps(av_in2, av_in4);
        av_s5 = _mm512_sub_ps(av_in2, av_in4);

        av_t0 = _mm512_mul_ps(v_CRTM_6_1, av_s4);
        av_t1 = _mm512_mul_ps(v_CRTM_6_1, av_s5);
        av_s6 = _mm512_add_ps(av_s1, av_s3);

        av_s7 = _mm512_sub_ps(av_s0, av_s2);
        av_t2 = _mm512_mul_ps(v_CRTM_6_2, av_s2);
        av_t3 = _mm512_mul_ps(v_CRTM_6_2, av_s3);

        // Output pt 1: X(0)
        v_out0 = _mm512_add_ps(av_s0, av_t2);
        STR_512_S(curr_out, v_out_stride, v_out0, is_contiguous_out);
        // Output point 3: X(2)--> type-0
        curr_out = out_r + out_strides[2];
        v_out2 = _mm512_sub_ps(av_s6, av_t0);
        STR_512_S(curr_out, v_out_stride, v_out2, is_contiguous_out);
        // Output pt 5: X(4)
        curr_out = out_r + out_strides[4];
        v_out4 = _mm512_sub_ps(av_s7, av_t1);
        STR_512_S(curr_out, v_out_stride, v_out4, is_contiguous_out);
        // Output pt 7: X(6)
        curr_out = out_r + out_strides[6];
        v_out6 = _mm512_sub_ps(av_s1, av_t3);
        STR_512_S(curr_out, v_out_stride, v_out6, is_contiguous_out);
        // Output pt 9: X(8)
        curr_out = out_r + out_strides[8];
        v_out8 = _mm512_add_ps(av_s7, av_t1);
        STR_512_S(curr_out, v_out_stride, v_out8, is_contiguous_out);
        // Output pt 11: X(10)
        curr_out = out_r + out_strides[10];
        v_out10 = _mm512_add_ps(av_s6, av_t0);
        STR_512_S(curr_out, v_out_stride, v_out10, is_contiguous_out);

        // Shifted DFT
        __m512 bv_in0, bv_in1, bv_in2, bv_in3, bv_in4, bv_in5;
        __m512 bv_s0, bv_s1, bv_s2, bv_s3, bv_s4, bv_s5;
        __m512 bv_t0, bv_t1, bv_t2, bv_t3, bv_t4, bv_t5;
        ...
        bv_s0 = _mm512_add_ps(bv_in0, bv_in4);
        bv_s1 = _mm512_sub_ps(bv_in0, bv_in4);
        bv_t0 = _mm512_mul_ps(v_CRTM_6_1, bv_s1);

        bv_s2 = _mm512_add_ps(bv_in1, bv_in5);
        bv_s3 = _mm512_sub_ps(bv_in5, bv_in1);
        bv_t1 = _mm512_mul_ps(v_CRTM_6_1, bv_s3);

        bv_t2 = _mm512_mul_ps(v_CRTM_6_2, bv_s0);
        bv_t3 = _mm512_mul_ps(v_CRTM_6_2, bv_s2);
        bv_t4 = _mm512_mul_ps(v_CRTM_6_2, bv_in2);

        bv_t5 = _mm512_mul_ps(v_CRTM_6_2, bv_in3);
        bv_s4 = _mm512_add_ps(bv_s2, bv_t5);
        bv_s5 = _mm512_sub_ps(bv_s0, bv_t4);

        // Output pt 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm512_add_ps(bv_t4, bv_t2);
        STR_512_S(curr_out, v_out_stride, v_out1, is_contiguous_out);
        // Output pt 4: X(3)
        curr_out = out_r + out_strides[3];
        v_out3 = _mm512_sub_ps(bv_t0, bv_s4);
        STR_512_S(curr_out, v_out_stride, v_out3, is_contiguous_out);
        // Output pt 6: X(5)
        curr_out = out_r + out_strides[5];
        v_out5 = _mm512_add_ps(bv_s5, bv_t1);
        STR_512_S(curr_out, v_out_stride, v_out5, is_contiguous_out);
        // Output pt 8: X(7)
        curr_out = out_r + out_strides[7];
        v_out7 = _mm512_sub_ps(bv_t5, bv_t3);
        STR_512_S(curr_out, v_out_stride, v_out7, is_contiguous_out);
        // Output pt 10: X(9)
        curr_out = out_r + out_strides[9];
        v_out9 = _mm512_sub_ps(bv_t1, bv_s5);
        STR_512_S(curr_out, v_out_stride, v_out9, is_contiguous_out);
        // Output pt 12: X(11)
        curr_out = out_r + out_strides[11];
        v_out11 = NEGATE_512_S(_mm512_add_ps(bv_t0, bv_s4));
    ...
    if (remaining_sets & NUM_SETS_REAL_256_S)
    {
        ...
        // Input point 12: x(11)
        curr_in = in_r + in_strides[11];
        LDR_256_S(curr_in, v_in_dc_nyq_stride, av_in5, is_contiguous_in_dc_nyq);
        ...
        av_t0 = _mm256_mul_ps(v256_CRTM_6_1, av_s4);
        av_t1 = _mm256_mul_ps(v256_CRTM_6_1, av_s5);
        av_s6 = _mm256_add_ps(av_s1, av_s3);

        av_s7 = _mm256_sub_ps(av_s0, av_s2);
        av_t2 = _mm256_mul_ps(v256_CRTM_6_2, av_s2);
        av_t3 = _mm256_mul_ps(v256_CRTM_6_2, av_s3);
        ...
        bv_t0 = _mm256_mul_ps(v256_CRTM_6_1, bv_s1);

        bv_s2 = _mm256_add_ps(bv_in1, bv_in5);
        bv_s3 = _mm256_sub_ps(bv_in5, bv_in1);
        bv_t1 = _mm256_mul_ps(v256_CRTM_6_1, bv_s3);

        bv_t2 = _mm256_mul_ps(v256_CRTM_6_2, bv_s0);
        bv_t3 = _mm256_mul_ps(v256_CRTM_6_2, bv_s2);
        bv_t4 = _mm256_mul_ps(v256_CRTM_6_2, bv_in2);

        bv_t5 = _mm256_mul_ps(v256_CRTM_6_2, bv_in3);
...
static FFTZ_VOID r2hcf_rfft6avx512_fp64_fwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    {
        // Standard DFT
        __m512d av_in0, av_in1, av_in2, av_in3, av_in4, av_in5;
        ...
        av_s0 = _mm512_add_pd(av_in0, av_in3);
        av_s1 = _mm512_sub_pd(av_in0, av_in3);
        av_s2 = _mm512_add_pd(av_in1, av_in2);
        av_s3 = _mm512_sub_pd(av_in2, av_in1);

        av_s4 = _mm512_add_pd(av_in4, av_in5);
        av_s5 = _mm512_sub_pd(av_in5, av_in4);
        av_s6 = _mm512_add_pd(av_s2, av_s4);
        av_s7 = _mm512_sub_pd(av_s5, av_s3);

        av_t0 = _mm512_mul_pd(v_CRTM_6_1, av_s7);
        av_s8 = _mm512_sub_pd(av_s4, av_s2);

        av_t1 = _mm512_mul_pd(v_CRTM_6_1, av_s6);
        av_s9 = _mm512_add_pd(av_s3, av_s5);

        // Output pt 1: X(0)
        v_out0 = _mm512_add_pd(av_s0, av_s6);
        curr_out = out_r;
        STR_512_D(curr_out, v_out_dc_nyq_stride, v_out0, is_contiguous_out_dc_nyq);
        // Output pt 4: X(3) & Output pt 5: X(4)
        curr_out = out_cp + out_strides[3];
        v_out3 = _mm512_add_pd(av_s1, av_t0);
        v_out4 = _mm512_mul_pd(v_CRTM_6_2, av_s8);
        STRI_2x512_D(curr_out, v_out_stride, v_out3, v_out4);
        // Output pt 8: X(7) & Output pt 9: X(8)
        curr_out = out_cp + out_strides[7];
        v_out7 = _mm512_sub_pd(av_s0, av_t1);
        v_out8 = _mm512_mul_pd(v_CRTM_6_2, av_s9);
        STRI_2x512_D(curr_out, v_out_stride, v_out7, v_out8);
        // Output pt 12: X(11)
        curr_out = out_r + out_strides[11];
        v_out11 = _mm512_sub_pd(av_s1, av_s7);
        STR_512_D(curr_out, v_out_dc_nyq_stride, v_out11, is_contiguous_out_dc_nyq);

        // Shifted DFT
        __m512d bv_in0, bv_in1, bv_in2, bv_in3, bv_in4, bv_in5;
        __m512d bv_s0, bv_s1, bv_s2, bv_s3, bv_s4, bv_s5;
        __m512d bv_t0, bv_t1, bv_t2, bv_t3;
        ...
        bv_s0 = _mm512_sub_pd(bv_in1, bv_in5);
        bv_s1 = _mm512_add_pd(bv_in1, bv_in5);
        bv_s2 = _mm512_sub_pd(bv_in2, bv_in4);
        bv_s3 = _mm512_add_pd(bv_in2, bv_in4);

        bv_t0 = _mm512_mul_pd(v_CRTM_6_2, bv_s0);
        bv_t1 = _mm512_mul_pd(v_CRTM_6_1, bv_s1);
        bv_t2 = _mm512_mul_pd(v_CRTM_6_1, bv_s2);
        bv_t3 = _mm512_mul_pd(v_CRTM_6_2, bv_s3);

        bv_s4 = _mm512_add_pd(bv_in0, bv_t2);
        bv_s5 = _mm512_add_pd(bv_in3, bv_t1);

        // Output point 2: X(1) & Output point 3: X(2)
        curr_out = out_cp + out_strides[1];
        v_out1 = _mm512_add_pd(bv_s4, bv_t0);
        v_out2 = NEGATE_512_D(_mm512_add_pd(bv_t3, bv_s5));
        STRI_2x512_D(curr_out, v_out_stride, v_out1, v_out2);
        // Output point 6: X(5) & Output point 7: X(6)
        curr_out = out_cp + out_strides[5];
        v_out5 = _mm512_sub_pd(bv_in0, bv_s2);
        v_out6 = _mm512_sub_pd(bv_in3, bv_s1);
        STRI_2x512_D(curr_out, v_out_stride, v_out5, v_out6);
        // Output point 10: X(9) & Output point 11: X(10)
        curr_out = out_cp + out_strides[9];
        v_out9 = _mm512_sub_pd(bv_s4, bv_t0);
        v_out10 = _mm512_sub_pd(bv_t3, bv_s5);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_D)
    {
        ...
        av_t0 = _mm256_mul_pd(v256_CRTM_6_1, av_s7);
        av_s8 = _mm256_sub_pd(av_s4, av_s2);

        av_t1 = _mm256_mul_pd(v256_CRTM_6_1, av_s6);
        ...
        bv_t0 = _mm256_mul_pd(v256_CRTM_6_2, bv_s0);
        bv_t1 = _mm256_mul_pd(v256_CRTM_6_1, bv_s1);
        bv_t2 = _mm256_mul_pd(v256_CRTM_6_1, bv_s2);
        bv_t3 = _mm256_mul_pd(v256_CRTM_6_2, bv_s3);
...
static FFTZ_VOID r2hcf_rfft6avx512_fp64_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        // Standard DFT
        __m512d av_in0, av_in1, av_in2, av_in3, av_in4, av_in5;
        __m512d av_s0, av_s1, av_s2, av_s3, av_s4, av_s5, av_s6, av_s7;
        ...
        // Input point 12: x(11)
        curr_in = in_r + in_strides[11];
        LDR_512_D(curr_in, v_in_dc_nyq_stride, av_in5, is_contiguous_in_dc_nyq);

        av_s0 = _mm512_add_pd(av_in0, av_in5);
        av_s1 = _mm512_sub_pd(av_in0, av_in5);
        av_s2 = _mm512_add_pd(av_in1, av_in3);

        av_s3 = _mm512_sub_pd(av_in1, av_in3);
        av_s4 = _mm512_add_pd(av_in2, av_in4);
        av_s5 = _mm512_sub_pd(av_in2, av_in4);

        av_t0 = _mm512_mul_pd(v_CRTM_6_1, av_s4);
        av_t1 = _mm512_mul_pd(v_CRTM_6_1, av_s5);
        av_s6 = _mm512_add_pd(av_s1, av_s3);

        av_s7 = _mm512_sub_pd(av_s0, av_s2);
        av_t2 = _mm512_mul_pd(v_CRTM_6_2, av_s2);
        av_t3 = _mm512_mul_pd(v_CRTM_6_2, av_s3);

        // Output pt 1: X(0)
        v_out0 = _mm512_add_pd(av_s0, av_t2);
        STR_512_D(curr_out, v_out_stride, v_out0, is_contiguous_out);
        // Output point 3: X(2)--> type-0
        curr_out = out_r + out_strides[2];
        v_out2 = _mm512_sub_pd(av_s6, av_t0);
        STR_512_D(curr_out, v_out_stride, v_out2, is_contiguous_out);
        // Output pt 5: X(4)
        curr_out = out_r + out_strides[4];
        v_out4 = _mm512_sub_pd(av_s7, av_t1);
        STR_512_D(curr_out, v_out_stride, v_out4, is_contiguous_out);
        // Output pt 7: X(6)
        curr_out = out_r + out_strides[6];
        v_out6 = _mm512_sub_pd(av_s1, av_t3);
        STR_512_D(curr_out, v_out_stride, v_out6, is_contiguous_out);
        // Output pt 9: X(8)
        curr_out = out_r + out_strides[8];
        v_out8 = _mm512_add_pd(av_s7, av_t1);
        STR_512_D(curr_out, v_out_stride, v_out8, is_contiguous_out);
        // Output pt 11: X(10)
        curr_out = out_r + out_strides[10];
        v_out10 = _mm512_add_pd(av_s6, av_t0);
        STR_512_D(curr_out, v_out_stride, v_out10, is_contiguous_out);

        // Shifted DFT
        __m512d bv_in0, bv_in1, bv_in2, bv_in3, bv_in4, bv_in5;
        __m512d bv_s0, bv_s1, bv_s2, bv_s3, bv_s4, bv_s5;
        __m512d bv_t0, bv_t1, bv_t2, bv_t3, bv_t4, bv_t5;
        ...
        bv_s0 = _mm512_add_pd(bv_in0, bv_in4);
        bv_s1 = _mm512_sub_pd(bv_in0, bv_in4);
        bv_t0 = _mm512_mul_pd(v_CRTM_6_1, bv_s1);

        bv_s2 = _mm512_add_pd(bv_in1, bv_in5);
        bv_s3 = _mm512_sub_pd(bv_in5, bv_in1);
        bv_t1 = _mm512_mul_pd(v_CRTM_6_1, bv_s3);

        bv_t2 = _mm512_mul_pd(v_CRTM_6_2, bv_s0);
        bv_t3 = _mm512_mul_pd(v_CRTM_6_2, bv_s2);
        bv_t4 = _mm512_mul_pd(v_CRTM_6_2, bv_in2);

        bv_t5 = _mm512_mul_pd(v_CRTM_6_2, bv_in3);
        bv_s4 = _mm512_add_pd(bv_s2, bv_t5);
        bv_s5 = _mm512_sub_pd(bv_s0, bv_t4);

        // Output pt 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm512_add_pd(bv_t4, bv_t2);
        STR_512_D(curr_out, v_out_stride, v_out1, is_contiguous_out);
        // Output pt 4: X(3)
        curr_out = out_r + out_strides[3];
        v_out3 = _mm512_sub_pd(bv_t0, bv_s4);
        STR_512_D(curr_out, v_out_stride, v_out3, is_contiguous_out);
        // Output pt 6: X(5)
        curr_out = out_r + out_strides[5];
        v_out5 = _mm512_add_pd(bv_s5, bv_t1);
        STR_512_D(curr_out, v_out_stride, v_out5, is_contiguous_out);
        // Output pt 8: X(7)
        curr_out = out_r + out_strides[7];
        v_out7 = _mm512_sub_pd(bv_t5, bv_t3);
        STR_512_D(curr_out, v_out_stride, v_out7, is_contiguous_out);
        // Output pt 10: X(9)
        curr_out = out_r + out_strides[9];
        v_out9 = _mm512_sub_pd(bv_t1, bv_s5);
        STR_512_D(curr_out, v_out_stride, v_out9, is_contiguous_out);
        // Output pt 12: X(11)
        curr_out = out_r + out_strides[11];
        v_out11 = NEGATE_512_D(_mm512_add_pd(bv_t0, bv_s4));
    ...
    if (remaining_sets & NUM_SETS_REAL_256_D)
    {
        ...
        // Input point 12: x(11)
        curr_in = in_r + in_strides[11];
        LDR_256_D(curr_in, v_in_dc_nyq_stride, av_in5, is_contiguous_in_dc_nyq);
        ...
        av_t0 = _mm256_mul_pd(v256_CRTM_6_1, av_s4);
        av_t1 = _mm256_mul_pd(v256_CRTM_6_1, av_s5);
        av_s6 = _mm256_add_pd(av_s1, av_s3);

        av_s7 = _mm256_sub_pd(av_s0, av_s2);
        av_t2 = _mm256_mul_pd(v256_CRTM_6_2, av_s2);
        av_t3 = _mm256_mul_pd(v256_CRTM_6_2, av_s3);
        ...
        bv_t0 = _mm256_mul_pd(v256_CRTM_6_1, bv_s1);

        bv_s2 = _mm256_add_pd(bv_in1, bv_in5);
        bv_s3 = _mm256_sub_pd(bv_in5, bv_in1);
        bv_t1 = _mm256_mul_pd(v256_CRTM_6_1, bv_s3);

        bv_t2 = _mm256_mul_pd(v256_CRTM_6_2, bv_s0);
        bv_t3 = _mm256_mul_pd(v256_CRTM_6_2, bv_s2);
        bv_t4 = _mm256_mul_pd(v256_CRTM_6_2, bv_in2);

        bv_t5 = _mm256_mul_pd(v256_CRTM_6_2, bv_in3);
                                        ...
                                        FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft6avx512_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft6avx512_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft6avx512_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft6avx512_fp64_bwd;
        }
        else
        {
            return NULL;
