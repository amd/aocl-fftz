                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        STR_512_S(curr_out, v_out_dc_nyq_stride, v_out23, is_contiguous_out_dc_nyq);
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 24: x(23)
        curr_in = in_r + in_strides[23];
        LDR_512_S(curr_in, v_in_dc_nyq_stride, av_in11, is_contiguous_in_dc_nyq);
...
static FFTZ_VOID r2hcf_rfft12avx512_fp64_fwd(FFTZ_VOID *in_real,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        curr_out = out_r + out_strides[23];
        STR_512_D(curr_out, v_out_dc_nyq_stride, v_out23, is_contiguous_out_dc_nyq);
...
static FFTZ_VOID r2hcf_rfft12avx512_fp64_bwd(FFTZ_VOID *in_real,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 24: x(23)
        curr_in = in_r + in_strides[23];
        LDR_512_D(curr_in, v_in_dc_nyq_stride, av_in11, is_contiguous_in_dc_nyq);
