...
/** @file rfft2avx512.c
 *
 *  @brief Radix-2 r2hc_fused Real-FFT kernel with with AVX-512 operations using
 *  x86 SIMD intrinsics.
 *
...
static FFTZ_VOID r2hcf_rfft2avx512_fp32_fwd(FFTZ_VOID *in_real,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Output point 1: x(0)
        v_out0 = _mm512_add_ps(av_in0, av_in1);
        curr_out = out_r;
        STR_512_S(curr_out, v_out_dc_nyq_stride, v_out0, is_contiguous_out_dc_nyq);
        curr_out = out_r + out_strides[3];
        // Output point 4: x(3)
        v_out1 = _mm512_sub_ps(av_in0, av_in1);
        STR_512_S(curr_out, v_out_dc_nyq_stride, v_out1, is_contiguous_out_dc_nyq);

        /* Shifted DFT */
        __m512 bv_in0, bv_in1;
        ...
        v_out2 = NEGATE_512_S(bv_in1);
        STRI_2x512_S(curr_out, v_out_stride, bv_in0, v_out2);
...
static FFTZ_VOID r2hcf_rfft2avx512_fp32_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 4: x(3)
        curr_in = in_r + in_strides[3];
        LDR_512_S(curr_in, v_in_dc_nyq_stride, av_in1, is_contiguous_in_dc_nyq);
        ...
        v_out2 = _mm512_sub_ps(av_in0, av_in1);
        ...
        v_out1 = _mm512_add_ps(bv_in0, bv_in0);
        STR_512_S(curr_out, v_out_stride, v_out1, is_contiguous_out);
        // Output point 4: X(3)
        curr_out = out_r + out_strides[3];
        v_out3 = NEGATE_512_S(_mm512_add_ps(bv_in1, bv_in1));
...
static FFTZ_VOID r2hcf_rfft2avx512_fp64_fwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Output point 1: x(0)
        v_out0 = _mm512_add_pd(av_in0, av_in1);
        curr_out = out_r;
        STR_512_D(curr_out, v_out_dc_nyq_stride, v_out0, is_contiguous_out_dc_nyq);
        curr_out = out_r + out_strides[3];
        // Output point 4: x(3)
        v_out1 = _mm512_sub_pd(av_in0, av_in1);
        STR_512_D(curr_out, v_out_dc_nyq_stride, v_out1, is_contiguous_out_dc_nyq);

        /* Shifted DFT */
        __m512d bv_in0, bv_in1;
        ...
        // Output point 2: x(1)  & Output point 3: x(2)
        curr_out = out_cp + out_strides[1];
        v_out2 = NEGATE_512_D(bv_in1);
        STRI_2x512_D(curr_out, v_out_stride, bv_in0, v_out2);
...
static FFTZ_VOID r2hcf_rfft2avx512_fp64_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 4: x(3)
        curr_in = in_r + in_strides[3];
        LDR_512_D(curr_in, v_in_dc_nyq_stride, av_in1, is_contiguous_in_dc_nyq);
        ...
        // Output point 3: X(2)
        curr_out = out_r + out_strides[2];
        v_out2 = _mm512_sub_pd(av_in0, av_in1);
        ...
        // Output point 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm512_add_pd(bv_in0, bv_in0);
        STR_512_D(curr_out, v_out_stride, v_out1, is_contiguous_out);
        // Output point 4: X(3)
        curr_out = out_r + out_strides[3];
        v_out3 = NEGATE_512_D(_mm512_add_pd(bv_in1, bv_in1));
                                        ...
                                        FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft2avx512_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft2avx512_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft2avx512_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft2avx512_fp64_bwd;
        }
        else
        {
            return NULL;
