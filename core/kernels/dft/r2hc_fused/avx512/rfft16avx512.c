                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        STR_512_S(curr_out, v_out_dc_nyq_stride, v_out31, is_contiguous_out_dc_nyq);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_S)
    {
        ...
        STR_256_S(curr_out, v_out_dc_nyq_stride, v_out31, is_contiguous_out_dc_nyq);
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 32: x(31)
        curr_in = in_r + in_strides[31];
        LDR_512_S(curr_in, v_in_dc_nyq_stride, av_in15, is_contiguous_in_dc_nyq);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_S)
    {
        ...
        // Input point 32: x(31)
        curr_in = in_r + in_strides[31];
        LDR_256_S(curr_in, v_in_dc_nyq_stride, av_in15, is_contiguous_in_dc_nyq);
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        STR_512_D(curr_out, v_out_dc_nyq_stride, v_out31, is_contiguous_out_dc_nyq);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_D)
    {
        ...
        STR_256_D(curr_out, v_out_dc_nyq_stride, v_out31, is_contiguous_out_dc_nyq);
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 32: x(31)
        curr_in = in_r + in_strides[31];
        LDR_512_D(curr_in, v_in_dc_nyq_stride, av_in15, is_contiguous_in_dc_nyq);
    ...
    if (remaining_sets & NUM_SETS_REAL_256_D)
    {
        ...
        // Input point 32: x(31)
        curr_in = in_r + in_strides[31];
        LDR_256_D(curr_in, v_in_dc_nyq_stride, av_in15, is_contiguous_in_dc_nyq);
