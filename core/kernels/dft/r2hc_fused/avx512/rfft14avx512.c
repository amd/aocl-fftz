                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        STR_512_S(curr_out, v_out_dc_nyq_stride, v_out27, is_contiguous_out_dc_nyq);
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 28: x(27)
        curr_in = in_r + in_strides[27];
        LDR_512_S(curr_in, v_in_dc_nyq_stride, av_in13, is_contiguous_in_dc_nyq);
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        curr_out = out_r + out_strides[27];
        STR_512_D(curr_out, v_out_dc_nyq_stride, v_out27, is_contiguous_out_dc_nyq);
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 28: x(27)
        curr_in = in_r + in_strides[27];
        LDR_512_D(curr_in, v_in_dc_nyq_stride, av_in13, is_contiguous_in_dc_nyq);
