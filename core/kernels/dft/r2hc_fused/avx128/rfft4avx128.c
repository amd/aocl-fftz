...
/** @file rfft4avx128.c
 *
 *  @brief Radix-4 r2hc_fused Real-FFT kernel with with AVX-128 operations using
 *  x86 SIMD intrinsics.
 *
...
static FFTZ_VOID r2hcf_rfft4avx128_fp32_fwd(FFTZ_VOID *in_real,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128 v_CRTM_4_1 = _mm_broadcast_ss(&CRTM_4_1);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        bv_t0 = _mm_mul_ps(v_CRTM_4_1, bv_s0);
        bv_t1 = _mm_mul_ps(v_CRTM_4_1, bv_s1);
...
static FFTZ_VOID r2hcf_rfft4avx128_fp32_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128 v_CRTM_4_1 = _mm_broadcast_ss(&CRTM_4_1);
    __m128 v_CRTM_4_2 = _mm_broadcast_ss(&CRTM_4_2);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t0 = _mm_mul_ps(v_CRTM_4_2, av_in1);
        av_s1 = _mm_sub_ps(av_in0, av_in4);
        av_t1 = _mm_mul_ps(v_CRTM_4_2, av_in2);
        ...
        bv_t0 = _mm_mul_ps(v_CRTM_4_1, bv_s0);
        bv_t1 = _mm_mul_ps(v_CRTM_4_1, bv_s2);

        // Output point 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm_mul_ps(v_CRTM_4_2, bv_s1);
        ...
        v_out5 = _mm_mul_ps(v_CRTM_4_2, bv_s3);
...
static FFTZ_VOID r2hcf_rfft4avx128_fp64_fwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128d v_CRTM_4_1 = _mm_set1_pd(CRTM_4_1);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        bv_t0 = _mm_mul_pd(v_CRTM_4_1, bv_s0);
        bv_t1 = _mm_mul_pd(v_CRTM_4_1, bv_s1);
...
static FFTZ_VOID r2hcf_rfft4avx128_fp64_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128d v_CRTM_4_1 = _mm_set1_pd(CRTM_4_1);
    __m128d v_CRTM_4_2 = _mm_set1_pd(CRTM_4_2);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t0 = _mm_mul_pd(v_CRTM_4_2, av_in1);
        av_s1 = _mm_sub_pd(av_in0, av_in4);
        av_t1 = _mm_mul_pd(v_CRTM_4_2, av_in2);
        ...
        bv_t0 = _mm_mul_pd(v_CRTM_4_1, bv_s0);
        bv_t1 = _mm_mul_pd(v_CRTM_4_1, bv_s2);

        // Output point 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm_mul_pd(v_CRTM_4_2, bv_s1);
        ...
        // Output point 6: X(5)
        curr_out = out_r + out_strides[5];
        v_out5 = _mm_mul_pd(v_CRTM_4_2, bv_s3);
                                        ...
                                        FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft4avx128_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft4avx128_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft4avx128_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft4avx128_fp64_bwd;
        }
        else
        {
            return NULL;
