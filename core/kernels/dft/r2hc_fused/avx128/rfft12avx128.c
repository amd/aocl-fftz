...
/** @file rfft12avx128.c
 *
 *  @brief Radix-12 r2hc_fused Real-FFT kernel with AVX-128 operations using
 *  x86 SIMD intrinsics.
 *
...
static FFTZ_VOID r2hcf_rfft12avx128_fp32_fwd(FFTZ_VOID *in_real,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128 v_CRTM_12_1 = _mm_broadcast_ss(&CRTM_12_1);
    __m128 v_CRTM_12_2 = _mm_broadcast_ss(&CRTM_12_2);
    __m128 v_CRTM_12_3 = _mm_broadcast_ss(&CRTM_12_3);
    __m128 v_CRTM_12_4 = _mm_broadcast_ss(&CRTM_12_4);
    __m128 v_CRTM_12_5 = _mm_broadcast_ss(&CRTM_12_5);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t1 = _mm_mul_ps(v_CRTM_12_4, av_s16);
        av_t2 = _mm_mul_ps(v_CRTM_12_4, av_s18);
        ...
        av_t3 = _mm_mul_ps(v_CRTM_12_3, av_s14);
        av_t4 = _mm_mul_ps(v_CRTM_12_4, av_s21);
        av_t5 = _mm_mul_ps(v_CRTM_12_4, av_s22);
        av_t6 = _mm_mul_ps(v_CRTM_12_3, av_s26);
        ...
        v_out8 = _mm_mul_ps(v_CRTM_12_3, av_s27);
        ...
        v_out16 = _mm_mul_ps(v_CRTM_12_3, av_s28);
        ...
        bv_t1 = _mm_mul_ps(v_CRTM_12_5, bv_s17);
        bv_t2 = _mm_mul_ps(v_CRTM_12_5, bv_s18);
        ...
        bv_t3 = _mm_mul_ps(v_CRTM_12_1, bv_s13);
        bv_t4 = _mm_mul_ps(v_CRTM_12_2, bv_s14);
        bv_t5 = _mm_mul_ps(v_CRTM_12_1, bv_s15);
        bv_t6 = _mm_mul_ps(v_CRTM_12_2, bv_s16);

        bv_t7 = _mm_mul_ps(v_CRTM_12_4, bv_s5);
        bv_t8 = _mm_mul_ps(v_CRTM_12_3, bv_s6);
        bv_t9 = _mm_mul_ps(v_CRTM_12_3, bv_s7);
        bv_t10 = _mm_mul_ps(v_CRTM_12_4, bv_s8);
        bv_t11 = _mm_mul_ps(v_CRTM_12_5, bv_s9);
        bv_t12 = _mm_mul_ps(v_CRTM_12_5, bv_s10);
...
static FFTZ_VOID r2hcf_rfft12avx128_fp32_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t1 = _mm_mul_ps(v_CRTM_12_5, av_in5);
        av_t2 = _mm_mul_ps(v_CRTM_12_5, av_in6);

        av_s11 = _mm_add_ps(av_s3, av_s5);
        av_s12 = _mm_add_ps(av_s1, av_t1);
        av_s13 = _mm_sub_ps(av_s1, av_t1);
        av_t3 = _mm_mul_ps(v_CRTM_12_5, av_s11);
        // Output pt 1: X(0)
        ...
        av_t4 = _mm_mul_ps(v_CRTM_12_3, av_s14);
        av_t5 = _mm_mul_ps(v_CRTM_12_3, av_s15);

        av_s16 = _mm_add_ps(av_s10, av_s8);
        av_s17 = _mm_sub_ps(av_s10, av_s8);
        av_t6 = _mm_mul_ps(v_CRTM_12_3, av_s16);
        av_t7 = _mm_mul_ps(v_CRTM_12_3, av_s17);

        av_s18 = _mm_add_ps(av_s6, av_s9);
        av_s19 = _mm_sub_ps(av_s6, av_s9);
        av_s20 = _mm_sub_ps(av_s3, av_s5);
        av_t8 = _mm_mul_ps(v_CRTM_12_5, av_s18);
        av_t9 = _mm_mul_ps(v_CRTM_12_5, av_s19);
        av_t10 = _mm_mul_ps(v_CRTM_12_5, av_s20);
        // Output pt 13: X(12)
        ...
        v_out1 = _mm_mul_ps(v_CRTM_12_5, bv_s15);
        STR_128_S(curr_out, v_out_stride, v_out1, is_contiguous_out);

        bv_s16 = _mm_add_ps(bv_s10, bv_s8);
        bv_s17 = _mm_sub_ps(bv_s10, bv_s8);
        bv_t1 = _mm_mul_ps(v_CRTM_12_5, bv_s3);
        bv_t2 = _mm_mul_ps(v_CRTM_12_5, bv_s12);
        bv_t3 = _mm_mul_ps(v_CRTM_12_3, bv_s14);
        bv_t4 = _mm_mul_ps(v_CRTM_12_3, bv_s17);
        ...
        v_out13 = _mm_mul_ps(v_CRTM_12_5, bv_s20);
        ...
        bv_t5 = _mm_mul_ps(v_CRTM_12_1, bv_s21);
        bv_t6 = _mm_mul_ps(v_CRTM_12_2, bv_s21);
        bv_t7 = _mm_mul_ps(v_CRTM_12_4, bv_s21);

        bv_t8 = _mm_mul_ps(v_CRTM_12_1, bv_s22);
        bv_t9 = _mm_mul_ps(v_CRTM_12_2, bv_s22);
        bv_t10 = _mm_mul_ps(v_CRTM_12_4, bv_s22);

        bv_t17 = _mm_mul_ps(v_CRTM_12_1, bv_s23);
        bv_t16 = _mm_mul_ps(v_CRTM_12_2, bv_s23);
        bv_t18 = _mm_mul_ps(v_CRTM_12_4, bv_s23);
        // Output pt 6: X(5)
        ...
        bv_t11 = _mm_mul_ps(v_CRTM_12_1, bv_s24);
        bv_t12 = _mm_mul_ps(v_CRTM_12_2, bv_s24);
        bv_t13 = _mm_mul_ps(v_CRTM_12_4, bv_s24);

        bv_t14 = _mm_mul_ps(v_CRTM_12_4, bv_s25);
        bv_t15 = _mm_mul_ps(v_CRTM_12_4, bv_s26);
...
static FFTZ_VOID r2hcf_rfft12avx128_fp64_fwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
    ...
    __m128d v_CRTM_12_1 = _mm_set1_pd(CRTM_12_1);
    __m128d v_CRTM_12_2 = _mm_set1_pd(CRTM_12_2);
    __m128d v_CRTM_12_3 = _mm_set1_pd(CRTM_12_3);
    __m128d v_CRTM_12_4 = _mm_set1_pd(CRTM_12_4);
    __m128d v_CRTM_12_5 = _mm_set1_pd(CRTM_12_5);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t1 = _mm_mul_pd(v_CRTM_12_4, av_s16);
        av_t2 = _mm_mul_pd(v_CRTM_12_4, av_s18);
        ...
        av_t3 = _mm_mul_pd(v_CRTM_12_3, av_s14);
        av_t4 = _mm_mul_pd(v_CRTM_12_4, av_s21);
        av_t5 = _mm_mul_pd(v_CRTM_12_4, av_s22);
        av_t6 = _mm_mul_pd(v_CRTM_12_3, av_s26);
        ...
        bv_t1 = _mm_mul_pd(v_CRTM_12_5, bv_s17);
        bv_t2 = _mm_mul_pd(v_CRTM_12_5, bv_s18);
        // Output pt 6: X(5) & Output pt 7: X(6)
        ...
        bv_t3 = _mm_mul_pd(v_CRTM_12_1, bv_s13);
        bv_t4 = _mm_mul_pd(v_CRTM_12_2, bv_s14);
        bv_t5 = _mm_mul_pd(v_CRTM_12_1, bv_s15);
        bv_t6 = _mm_mul_pd(v_CRTM_12_2, bv_s16);

        bv_t7 = _mm_mul_pd(v_CRTM_12_4, bv_s5);
        bv_t8 = _mm_mul_pd(v_CRTM_12_3, bv_s6);
        bv_t9 = _mm_mul_pd(v_CRTM_12_3, bv_s7);
        bv_t10 = _mm_mul_pd(v_CRTM_12_4, bv_s8);
        bv_t11 = _mm_mul_pd(v_CRTM_12_5, bv_s9);
        bv_t12 = _mm_mul_pd(v_CRTM_12_5, bv_s10);
...
static FFTZ_VOID r2hcf_rfft12avx128_fp64_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t1 = _mm_mul_pd(v_CRTM_12_5, av_in5);
        av_t2 = _mm_mul_pd(v_CRTM_12_5, av_in6);

        av_s11 = _mm_add_pd(av_s3, av_s5);
        av_s12 = _mm_add_pd(av_s1, av_t1);
        av_s13 = _mm_sub_pd(av_s1, av_t1);
        av_t3 = _mm_mul_pd(v_CRTM_12_5, av_s11);
        // Output pt 1: X(0)
        ...
        av_t4 = _mm_mul_pd(v_CRTM_12_3, av_s14);
        av_t5 = _mm_mul_pd(v_CRTM_12_3, av_s15);

        av_s16 = _mm_add_pd(av_s10, av_s8);
        av_s17 = _mm_sub_pd(av_s10, av_s8);
        av_t6 = _mm_mul_pd(v_CRTM_12_3, av_s16);
        av_t7 = _mm_mul_pd(v_CRTM_12_3, av_s17);

        av_s18 = _mm_add_pd(av_s6, av_s9);
        av_s19 = _mm_sub_pd(av_s6, av_s9);
        av_s20 = _mm_sub_pd(av_s3, av_s5);
        av_t8 = _mm_mul_pd(v_CRTM_12_5, av_s18);
        av_t9 = _mm_mul_pd(v_CRTM_12_5, av_s19);
        av_t10 = _mm_mul_pd(v_CRTM_12_5, av_s20);
        // Output pt 13: X(12)
        curr_out = out_r + out_strides[12];
        ...
        // Output pt 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm_mul_pd(v_CRTM_12_5, bv_s15);
        STR_128_D(curr_out, v_out_stride, v_out1, is_contiguous_out);

        bv_s16 = _mm_add_pd(bv_s10, bv_s8);
        bv_s17 = _mm_sub_pd(bv_s10, bv_s8);
        bv_t1 = _mm_mul_pd(v_CRTM_12_5, bv_s3);
        bv_t2 = _mm_mul_pd(v_CRTM_12_5, bv_s12);
        bv_t3 = _mm_mul_pd(v_CRTM_12_3, bv_s14);
        bv_t4 = _mm_mul_pd(v_CRTM_12_3, bv_s17);
        ...
        // Output pt 14: X(13)
        curr_out = out_r + out_strides[13];
        v_out13 = _mm_mul_pd(v_CRTM_12_5, bv_s20);
        ...
        bv_t5 = _mm_mul_pd(v_CRTM_12_1, bv_s21);
        bv_t6 = _mm_mul_pd(v_CRTM_12_2, bv_s21);
        bv_t7 = _mm_mul_pd(v_CRTM_12_4, bv_s21);

        bv_t8 = _mm_mul_pd(v_CRTM_12_1, bv_s22);
        bv_t9 = _mm_mul_pd(v_CRTM_12_2, bv_s22);
        bv_t10 = _mm_mul_pd(v_CRTM_12_4, bv_s22);

        bv_t17 = _mm_mul_pd(v_CRTM_12_1, bv_s23);
        bv_t16 = _mm_mul_pd(v_CRTM_12_2, bv_s23);
        bv_t18 = _mm_mul_pd(v_CRTM_12_4, bv_s23);
        // Output pt 6: X(5)
        curr_out = out_r + out_strides[5];
        ...
        bv_t11 = _mm_mul_pd(v_CRTM_12_1, bv_s24);
        bv_t12 = _mm_mul_pd(v_CRTM_12_2, bv_s24);
        bv_t13 = _mm_mul_pd(v_CRTM_12_4, bv_s24);

        bv_t14 = _mm_mul_pd(v_CRTM_12_4, bv_s25);
        bv_t15 = _mm_mul_pd(v_CRTM_12_4, bv_s26);
                                         ...
                                         FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft12avx128_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft12avx128_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft12avx128_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft12avx128_fp64_bwd;
        }
        else
        {
            return NULL;
