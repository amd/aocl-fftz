...
/** @file rfft8avx128.c
 *
 *  @brief Radix-8 r2hc_fused Real-FFT kernel with with AVX-128 operations using
 *  x86 SIMD intrinsics.
 *
...
static FFTZ_VOID r2hcf_rfft8avx128_fp32_fwd(FFTZ_VOID *in_real,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128 v_CRTM_8_3 = _mm_broadcast_ss(&CRTM_8_3);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t0 = _mm_mul_ps(v_CRTM_8_1, av_s10);
        av_t1 = _mm_mul_ps(v_CRTM_8_1, av_s11);
        ...
        bv_t0 = _mm_mul_ps(v_CRTM_8_1, bv_s0);
        bv_t1 = _mm_mul_ps(v_CRTM_8_1, bv_s1);
        bv_s2 = _mm_add_ps(bv_in7, bv_in1);
        bv_s3 = _mm_sub_ps(bv_in7, bv_in1);
        bv_s4 = _mm_add_ps(bv_in5, bv_in3);
        bv_s5 = _mm_sub_ps(bv_in5, bv_in3);

        bv_t2 = _mm_mul_ps(v_CRTM_8_2, bv_s2);
        bv_t3 = _mm_mul_ps(v_CRTM_8_3, bv_s2);
        bv_t4 = _mm_mul_ps(v_CRTM_8_2, bv_s3);
        bv_t5 = _mm_mul_ps(v_CRTM_8_3, bv_s3);

        bv_t6 = _mm_mul_ps(v_CRTM_8_2, bv_s4);
        bv_t7 = _mm_mul_ps(v_CRTM_8_3, bv_s4);

        bv_t8 = _mm_mul_ps(v_CRTM_8_2, bv_s5);
        bv_t9 = _mm_mul_ps(v_CRTM_8_3, bv_s5);
...
static FFTZ_VOID r2hcf_rfft8avx128_fp32_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128 v_CRTM_8_2 = _mm_broadcast_ss(&CRTM_8_2);
    __m128 v_CRTM_8_3 = _mm_broadcast_ss(&CRTM_8_3);
    __m128 v_CRTM_8_4 = _mm_broadcast_ss(&CRTM_8_4);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t0 = _mm_mul_ps(v_CRTM_8_4, av_s3);
        av_t1 = _mm_mul_ps(v_CRTM_8_4, av_s4);
        ...
        av_t2 = _mm_mul_ps(v_CRTM_8_1, av_s8);
        av_t3 = _mm_mul_ps(v_CRTM_8_1, av_s9);
        ...
        bv_t0 = _mm_mul_ps(v_CRTM_8_1, bv_s8);
        bv_t1 = _mm_mul_ps(v_CRTM_8_1, bv_s9);
        ...
        bv_t2 = _mm_mul_ps(v_CRTM_8_2, bv_s13);

        bv_t3 = _mm_mul_ps(v_CRTM_8_3, bv_s12);
        bv_t4 = _mm_mul_ps(v_CRTM_8_2, bv_s11);
        bv_t5 = _mm_mul_ps(v_CRTM_8_3, bv_s10);
        bv_s15 = _mm_sub_ps(bv_s5, bv_s7);
        bv_t6 = _mm_mul_ps(v_CRTM_8_2, bv_s12);
        bv_t7 = _mm_mul_ps(v_CRTM_8_3, bv_s13);
        bv_t8 = _mm_mul_ps(v_CRTM_8_2, bv_s10);
        bv_t9 = _mm_mul_ps(v_CRTM_8_3, bv_s11);

        // Output pt 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm_mul_ps(v_CRTM_8_4, bv_s14);
        ...
        v_out9 = _mm_mul_ps(v_CRTM_8_4, bv_s15);
...
static FFTZ_VOID r2hcf_rfft8avx128_fp64_fwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128d v_CRTM_8_3 = _mm_set1_pd(CRTM_8_3);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t0 = _mm_mul_pd(v_CRTM_8_1, av_s10);
        av_t1 = _mm_mul_pd(v_CRTM_8_1, av_s11);
        ...
        bv_t0 = _mm_mul_pd(v_CRTM_8_1, bv_s0);
        bv_t1 = _mm_mul_pd(v_CRTM_8_1, bv_s1);
        bv_s2 = _mm_add_pd(bv_in7, bv_in1);
        bv_s3 = _mm_sub_pd(bv_in7, bv_in1);
        bv_s4 = _mm_add_pd(bv_in5, bv_in3);
        bv_s5 = _mm_sub_pd(bv_in5, bv_in3);

        bv_t2 = _mm_mul_pd(v_CRTM_8_2, bv_s2);
        bv_t3 = _mm_mul_pd(v_CRTM_8_3, bv_s2);
        bv_t4 = _mm_mul_pd(v_CRTM_8_2, bv_s3);
        bv_t5 = _mm_mul_pd(v_CRTM_8_3, bv_s3);

        bv_t6 = _mm_mul_pd(v_CRTM_8_2, bv_s4);
        bv_t7 = _mm_mul_pd(v_CRTM_8_3, bv_s4);

        bv_t8 = _mm_mul_pd(v_CRTM_8_2, bv_s5);
        bv_t9 = _mm_mul_pd(v_CRTM_8_3, bv_s5);
...
static FFTZ_VOID r2hcf_rfft8avx128_fp64_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128d v_CRTM_8_2 = _mm_set1_pd(CRTM_8_2);
    __m128d v_CRTM_8_3 = _mm_set1_pd(CRTM_8_3);
    __m128d v_CRTM_8_4 = _mm_set1_pd(CRTM_8_4);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t0 = _mm_mul_pd(v_CRTM_8_4, av_s3);
        av_t1 = _mm_mul_pd(v_CRTM_8_4, av_s4);
        ...
        av_t2 = _mm_mul_pd(v_CRTM_8_1, av_s8);
        av_t3 = _mm_mul_pd(v_CRTM_8_1, av_s9);
        ...
        bv_t0 = _mm_mul_pd(v_CRTM_8_1, bv_s8);
        bv_t1 = _mm_mul_pd(v_CRTM_8_1, bv_s9);
        ...
        bv_t2 = _mm_mul_pd(v_CRTM_8_2, bv_s13);

        bv_t3 = _mm_mul_pd(v_CRTM_8_3, bv_s12);
        bv_t4 = _mm_mul_pd(v_CRTM_8_2, bv_s11);
        bv_t5 = _mm_mul_pd(v_CRTM_8_3, bv_s10);
        bv_s15 = _mm_sub_pd(bv_s5, bv_s7);
        bv_t6 = _mm_mul_pd(v_CRTM_8_2, bv_s12);
        bv_t7 = _mm_mul_pd(v_CRTM_8_3, bv_s13);
        bv_t8 = _mm_mul_pd(v_CRTM_8_2, bv_s10);
        bv_t9 = _mm_mul_pd(v_CRTM_8_3, bv_s11);

        // Output pt 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm_mul_pd(v_CRTM_8_4, bv_s14);
        ...
        // Output pt 10: X(9)
        curr_out = out_r + out_strides[9];
        v_out9 = _mm_mul_pd(v_CRTM_8_4, bv_s15);
                                        ...
                                        FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft8avx128_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft8avx128_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft8avx128_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft8avx128_fp64_bwd;
        }
        else
        {
            return NULL;
