...
/** @file rfft10avx128.c
 *
 *  @brief Radix-10 r2hc_fused Real-FFT kernel with with AVX-128 operations
...
static FFTZ_VOID r2hcf_rfft10avx128_fp32_fwd(FFTZ_VOID *in_real,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t0  = _mm_mul_ps(v_CRTM_10_2, av_s21);
        av_t1  = _mm_mul_ps(v_CRTM_10_1, av_s20);
        ...
        av_t4  = _mm_mul_ps(v_CRTM_10_3, av_s12);
        av_t10 = _mm_mul_ps(v_CRTM_10_4, av_s15);
        // Output point 5: X(4)
        v_out4 = NEGATE_128_S(_mm_add_ps(av_t4, av_t10));
        curr_out = out_cp + out_strides[3];
        STRI_2x128_S(curr_out, v_out_stride, v_out3, v_out4);

        av_t6 = _mm_mul_ps(v_CRTM_10_3, av_s15);
        av_t8 = _mm_mul_ps(v_CRTM_10_4, av_s12);
        ...
        av_t5  = _mm_mul_ps(v_CRTM_10_3, av_s13);
        av_t11 = _mm_mul_ps(v_CRTM_10_4, av_s16);
        // Output point 17: X(16)
        v_out16 = _mm_add_ps(av_t11, av_t5);

        av_t7 = _mm_mul_ps(v_CRTM_10_3, av_s16);
        av_t9 = _mm_mul_ps(v_CRTM_10_4, av_s13);
        // Output point 9: X(8)
        v_out8 = _mm_sub_ps(av_t9, av_t7);

        av_s19 = _mm_sub_ps(av_s10, av_s14);
        av_t2  = _mm_mul_ps(v_CRTM_10_2, av_s18);
        av_t3  = _mm_mul_ps(v_CRTM_10_1, av_s19);
        ...
        bv_t0 = _mm_mul_ps(v_CRTM_10_2, bv_s11);
        bv_t1 = _mm_mul_ps(v_CRTM_10_1, bv_s10);
        bv_t2 = _mm_mul_ps(v_CRTM_10_1, bv_s8);
        bv_t3 = _mm_mul_ps(v_CRTM_10_2, bv_s9);

        bv_s12 = _mm_add_ps(bv_in0, bv_t0);
        bv_s13 = _mm_sub_ps(bv_t3, bv_in5);

        bv_t4  = _mm_mul_ps(v_CRTM_10_4, bv_s1);
        bv_t5  = _mm_mul_ps(v_CRTM_10_3, bv_s5);
        bv_t6  = _mm_mul_ps(v_CRTM_10_4, bv_s6);
        bv_t7  = _mm_mul_ps(v_CRTM_10_3, bv_s2);
        bv_t8  = _mm_mul_ps(v_CRTM_10_4, bv_s5);
        bv_t9  = _mm_mul_ps(v_CRTM_10_3, bv_s1);
        bv_t10 = _mm_mul_ps(v_CRTM_10_4, bv_s2);
        bv_t11 = _mm_mul_ps(v_CRTM_10_3, bv_s6);
...
static FFTZ_VOID r2hcf_rfft10avx128_fp32_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t4  = _mm_mul_ps(v_CRTM_10_1, av_s13);
        av_t2  = _mm_mul_ps(v_CRTM_10_2, av_s14);
        ...
        av_t5  = _mm_mul_ps(v_CRTM_10_4, av_s5);
        av_t6  = _mm_mul_ps(v_CRTM_10_5, av_s9);
        ...
        av_t7  = _mm_mul_ps(v_CRTM_10_4, av_s10);
        av_t8  = _mm_mul_ps(v_CRTM_10_5, av_s6);
        ...
        bv_t1  = _mm_mul_ps(v_CRTM_10_1, bv_s11);
        bv_t2  = _mm_mul_ps(v_CRTM_10_2, bv_s12);
        bv_t3  = _mm_mul_ps(v_CRTM_10_1, bv_s10);
        bv_t4  = _mm_mul_ps(v_CRTM_10_2, bv_s9);
        bv_t5  = _mm_mul_ps(v_CRTM_10_3, bv_in4);
        bv_t6  = _mm_mul_ps(v_CRTM_10_3, bv_in5);
        ...
        bv_t7  = _mm_mul_ps(v_CRTM_10_5, bv_s2);
        bv_t8  = _mm_mul_ps(v_CRTM_10_5, bv_s4);
        bv_t9  = _mm_mul_ps(v_CRTM_10_5, bv_s6);
        bv_t10 = _mm_mul_ps(v_CRTM_10_5, bv_s8);
        bv_t11 = _mm_mul_ps(v_CRTM_10_4, bv_s2);
        bv_t12 = _mm_mul_ps(v_CRTM_10_4, bv_s4);
        bv_t13 = _mm_mul_ps(v_CRTM_10_4, bv_s6);
        bv_t14 = _mm_mul_ps(v_CRTM_10_4, bv_s8);
...
static FFTZ_VOID r2hcf_rfft10avx128_fp64_fwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t0  = _mm_mul_pd(v_CRTM_10_2, av_s21);
        av_t1  = _mm_mul_pd(v_CRTM_10_1, av_s20);
        ...
        av_t4  = _mm_mul_pd(v_CRTM_10_3, av_s12);
        av_t10 = _mm_mul_pd(v_CRTM_10_4, av_s15);
        // Output point 5: X(4)
        v_out4 = NEGATE_128_D(_mm_add_pd(av_t4, av_t10));
        curr_out = out_cp + out_strides[3];
        STRI_2x128_D(curr_out, v_out_stride, v_out3, v_out4);

        av_t6 = _mm_mul_pd(v_CRTM_10_3, av_s15);
        av_t8 = _mm_mul_pd(v_CRTM_10_4, av_s12);
        // Output point 13: X(12)
        ...
        av_t5  = _mm_mul_pd(v_CRTM_10_3, av_s13);
        av_t11 = _mm_mul_pd(v_CRTM_10_4, av_s16);
        // Output point 17: X(16)
        v_out16 = _mm_add_pd(av_t11, av_t5);

        av_t7 = _mm_mul_pd(v_CRTM_10_3, av_s16);
        av_t9 = _mm_mul_pd(v_CRTM_10_4, av_s13);
        // Output point 9: X(8)
        v_out8 = _mm_sub_pd(av_t9, av_t7);

        av_s19 = _mm_sub_pd(av_s10, av_s14);
        av_t2  = _mm_mul_pd(v_CRTM_10_2, av_s18);
        av_t3  = _mm_mul_pd(v_CRTM_10_1, av_s19);
        ...
        bv_t0 = _mm_mul_pd(v_CRTM_10_2, bv_s11);
        bv_t1 = _mm_mul_pd(v_CRTM_10_1, bv_s10);
        bv_t2 = _mm_mul_pd(v_CRTM_10_1, bv_s8);
        bv_t3 = _mm_mul_pd(v_CRTM_10_2, bv_s9);

        bv_s12 = _mm_add_pd(bv_in0, bv_t0);
        bv_s13 = _mm_sub_pd(bv_t3, bv_in5);

        bv_t4  = _mm_mul_pd(v_CRTM_10_4, bv_s1);
        bv_t5  = _mm_mul_pd(v_CRTM_10_3, bv_s5);
        bv_t6  = _mm_mul_pd(v_CRTM_10_4, bv_s6);
        bv_t7  = _mm_mul_pd(v_CRTM_10_3, bv_s2);
        bv_t8  = _mm_mul_pd(v_CRTM_10_4, bv_s5);
        bv_t9  = _mm_mul_pd(v_CRTM_10_3, bv_s1);
        bv_t10 = _mm_mul_pd(v_CRTM_10_4, bv_s2);
        bv_t11 = _mm_mul_pd(v_CRTM_10_3, bv_s6);
...
static FFTZ_VOID r2hcf_rfft10avx128_fp64_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t4  = _mm_mul_pd(v_CRTM_10_1, av_s13);
        av_t2  = _mm_mul_pd(v_CRTM_10_2, av_s14);
        ...
        av_t5  = _mm_mul_pd(v_CRTM_10_4, av_s5);
        av_t6  = _mm_mul_pd(v_CRTM_10_5, av_s9);
        ...
        av_t7  = _mm_mul_pd(v_CRTM_10_4, av_s10);
        av_t8  = _mm_mul_pd(v_CRTM_10_5, av_s6);
        ...
        bv_t1  = _mm_mul_pd(v_CRTM_10_1, bv_s11);
        bv_t2  = _mm_mul_pd(v_CRTM_10_2, bv_s12);
        bv_t3  = _mm_mul_pd(v_CRTM_10_1, bv_s10);
        bv_t4  = _mm_mul_pd(v_CRTM_10_2, bv_s9);
        bv_t5  = _mm_mul_pd(v_CRTM_10_3, bv_in4);
        bv_t6  = _mm_mul_pd(v_CRTM_10_3, bv_in5);
        ...
        bv_t7  = _mm_mul_pd(v_CRTM_10_5, bv_s2);
        bv_t8  = _mm_mul_pd(v_CRTM_10_5, bv_s4);
        bv_t9  = _mm_mul_pd(v_CRTM_10_5, bv_s6);
        bv_t10 = _mm_mul_pd(v_CRTM_10_5, bv_s8);
        bv_t11 = _mm_mul_pd(v_CRTM_10_4, bv_s2);
        bv_t12 = _mm_mul_pd(v_CRTM_10_4, bv_s4);
        bv_t13 = _mm_mul_pd(v_CRTM_10_4, bv_s6);
        bv_t14 = _mm_mul_pd(v_CRTM_10_4, bv_s8);
                                         ...
                                         FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft10avx128_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft10avx128_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft10avx128_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft10avx128_fp64_bwd;
        }
        else
        {
            return NULL;
