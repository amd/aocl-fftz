...
static VOID r2hcf_rfft9avx128_fp32_fwd(VOID *in_real, VOID *in_imag,
                                       ...
                                       UINT8 flag)
{
    ...
    INTP remaining_sets = n % NUM_SETS_REAL_128_S;
...
static VOID r2hcf_rfft9avx128_fp32_bwd(VOID *in_real, VOID *in_imag,
                                       VOID *out_real, VOID *out_imag, INTP n,
                                       aoclfftz_strides_t *strides, VOID *twd,
                                       UINT8 flag)
{
...
static VOID r2hcf_rfft9avx128_fp64_fwd(VOID *in_real, VOID *in_imag,
                                       VOID *out_real, VOID *out_imag, INTP n,
                                       aoclfftz_strides_t *strides, VOID *twd,
                                       UINT8 flag)
{
    ...
    INTP remaining_sets = n % NUM_SETS_REAL_128_D;
...
static VOID r2hcf_rfft9avx128_fp64_bwd(VOID *in_real, VOID *in_imag,
                                       VOID *out_real, VOID *out_imag, INTP n,
                                       aoclfftz_strides_t *strides, VOID *twd,
                                       UINT8 flag)
{
