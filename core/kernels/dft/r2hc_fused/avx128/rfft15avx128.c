...
/** @file rfft15avx128.c
 *
 *  @brief Radix-15 r2hc_fused Real-FFT kernel with with AVX-128 operations
...
static FFTZ_VOID r2hcf_rfft15avx128_fp32_fwd(FFTZ_VOID *in_real,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128 v_CRTM_15_1 = _mm_broadcast_ss(&CRTM_15_1);
    __m128 v_CRTM_15_2 = _mm_broadcast_ss(&CRTM_15_2);
    __m128 v_CRTM_15_3 = _mm_broadcast_ss(&CRTM_15_3);
    __m128 v_CRTM_15_4 = _mm_broadcast_ss(&CRTM_15_4);
    __m128 v_CRTM_15_5 = _mm_broadcast_ss(&CRTM_15_5);
    __m128 v_CRTM_15_6 = _mm_broadcast_ss(&CRTM_15_6);
    __m128 v_CRTM_15_7 = _mm_broadcast_ss(&CRTM_15_7);
    __m128 v_CRTM_15_8 = _mm_broadcast_ss(&CRTM_15_8);
    __m128 v_CRTM_15_9 = _mm_broadcast_ss(&CRTM_15_9);
    __m128 v_CRTM_15_10 = _mm_broadcast_ss(&CRTM_15_10);
    __m128 v_CRTM_15_11 = _mm_broadcast_ss(&CRTM_15_11);
    __m128 v_CRTM_15_12 = _mm_broadcast_ss(&CRTM_15_12);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_s3 = _mm_sub_ps(av_in3, _mm_mul_ps(v_CRTM_15_5, av_s0));
        ...
        av_s6 = _mm_sub_ps(av_in3, _mm_mul_ps(v_CRTM_15_5, av_s0));
        ...
        av_s0 = _mm_add_ps(av_in1, av_in2);
        av_t0 = _mm_mul_ps(v_CRTM_15_6, _mm_sub_ps(av_in2, av_in1));
        av_s9 = _mm_add_ps(av_in0, av_s0);
        av_s3 = _mm_sub_ps(av_in0, _mm_mul_ps(v_CRTM_15_5, av_s0));
        ...
        av_t1 = _mm_mul_ps(v_CRTM_15_1, _mm_sub_ps(av_s11, av_s12));
        av_s15 = _mm_sub_ps(av_s9, _mm_mul_ps(v_CRTM_15_2, av_s13));
        ...
        v_out12 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_3, av_s20),
                             _mm_mul_ps(v_CRTM_15_4, av_s19));
        ...
        v_out24 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_4, av_s20),
                             _mm_mul_ps(v_CRTM_15_3, av_s19));
        curr_out = out_cp + out_strides[23];
        STRI_2x128_S(curr_out, v_out_stride, v_out23, v_out24);

        av_t2 = _mm_mul_ps(v_CRTM_15_1, _mm_sub_ps(av_s28, av_s23));
        av_s13 = _mm_add_ps(av_s28, av_s23);

        // Output point 20: X(19)
        v_out19 = _mm_add_ps(av_s13, av_s3);

        av_t3 = _mm_mul_ps(v_CRTM_15_9, _mm_add_ps(av_s30, av_s27));
        av_s17 = _mm_sub_ps(av_s30, av_s27);

        // Output point 21: X(20)
        v_out20 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_6, av_s17), av_t0);
        curr_out = out_cp + out_strides[19];
        STRI_2x128_S(curr_out, v_out_stride, v_out19, v_out20);

        av_s15 = _mm_sub_ps(av_s3, _mm_mul_ps(v_CRTM_15_2, av_s13));
        av_s20 = _mm_add_ps(av_t0, _mm_mul_ps(v_CRTM_15_10, av_s17));
        av_s21 = _mm_sub_ps(av_s15, av_t2);
        av_s25 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_8, av_s26),
                            _mm_mul_ps(v_CRTM_15_7, av_s31));
        ...
        av_s23 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_8, av_s31),
                            _mm_mul_ps(v_CRTM_15_7, av_s26));

        // Output point 28: X(27)
        v_out27 = _mm_add_ps(av_s21, av_s23);

        av_s22 = _mm_add_ps(av_s20, av_t3);
        av_s16 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_4, av_s29),
                            _mm_mul_ps(v_CRTM_15_3, av_s24));
        ...
        av_s10 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_3, av_s29),
                            _mm_mul_ps(v_CRTM_15_4, av_s24));
        ...
        bv_s42 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_4, bv_s5),
                            _mm_mul_ps(v_CRTM_15_3, bv_s4));
        bv_s28 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_4, bv_s4),
                            _mm_mul_ps(v_CRTM_15_3, bv_s5));

        bv_s6 = _mm_add_ps(bv_in14, bv_in11);
        bv_s7 = _mm_add_ps(bv_in2, bv_in8);
        bv_t2  = _mm_mul_ps(v_CRTM_15_1, _mm_sub_ps(bv_in14, bv_s7));
        bv_s47 = _mm_sub_ps(bv_t2, _mm_mul_ps(v_CRTM_15_11, bv_in11));
        bv_s30 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_12, bv_in11), bv_in5);

        bv_s8 = _mm_sub_ps(bv_in2, bv_in8);
        bv_s9 = _mm_add_ps(bv_in9, bv_in3);
        bv_s10 = _mm_add_ps(bv_in6, bv_in12);
        bv_s26 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_4, bv_s6),
                            _mm_mul_ps(v_CRTM_15_3, bv_s8));

        bv_s11 = _mm_sub_ps(bv_s9, bv_s10);
        bv_s12 = _mm_add_ps(bv_in1, bv_s2);
        bv_s13 = _mm_add_ps(bv_in14, bv_s7);
        bv_s48 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_2, bv_s13), bv_in5);
        ...
        bv_s20 = _mm_add_ps(bv_in0, _mm_mul_ps(v_CRTM_15_2, bv_s11));
        // Output pt 30: X(29)
        ...
        v_out9 = _mm_sub_ps(bv_s14, _mm_mul_ps(v_CRTM_15_5, bv_s19));
        v_out10 = _mm_mul_ps(v_CRTM_15_6, _mm_sub_ps(bv_s16, bv_s18));
        ...
        bv_t1  = _mm_mul_ps(v_CRTM_15_1, bv_s23);
        bv_s24 = _mm_add_ps(bv_s20, bv_t1);
        bv_s25 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_3, bv_s3),
                            _mm_mul_ps(v_CRTM_15_4, bv_s1));

        bv_t6  = _mm_mul_ps(v_CRTM_15_6, _mm_add_ps(bv_s25, bv_s26));
        bv_s27 = _mm_sub_ps(bv_s25, bv_s26);

        bv_s29 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_5, bv_s27), bv_s28);
        bv_s31 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_2, bv_s13), bv_t2);
        bv_s32 = _mm_sub_ps(bv_s30, bv_s31);

        bv_t3  = _mm_mul_ps(v_CRTM_15_1, _mm_sub_ps(bv_in1, bv_s2));
        bv_s33 = _mm_add_ps(bv_in10, bv_t3);
        bv_t4  = _mm_mul_ps(v_CRTM_15_2, bv_s12);
        bv_s34 = _mm_sub_ps(bv_t4, _mm_mul_ps(v_CRTM_15_12, bv_in4));
        bv_s35 = _mm_add_ps(bv_s33, bv_s34);
        bv_s36 = _mm_add_ps(bv_s32, bv_s35);
        bv_t5  = _mm_mul_ps(v_CRTM_15_6, _mm_sub_ps(bv_s32, bv_s35));
        ...
        bv_s37 = _mm_sub_ps(bv_s24, _mm_mul_ps(v_CRTM_15_5, bv_s36));
        ...
        bv_t7  = _mm_mul_ps(v_CRTM_15_4, bv_s3);
        bv_t8  = _mm_mul_ps(v_CRTM_15_3, bv_s1);
        bv_s38 = _mm_add_ps(bv_t8, bv_t7);
        bv_t9  = _mm_mul_ps(v_CRTM_15_4, bv_s8);
        bv_t10 = _mm_mul_ps(v_CRTM_15_3, bv_s6);
        bv_s39 = _mm_sub_ps(bv_t9, bv_t10);

        bv_t11 = _mm_mul_ps(v_CRTM_15_6, _mm_add_ps(bv_s38, bv_s39));
        bv_s40 = _mm_sub_ps(bv_s20, bv_t1);
        bv_s41 = _mm_sub_ps(bv_s39, bv_s38);
        bv_s43 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_5, bv_s41), bv_s42);

        bv_s44 = _mm_sub_ps(bv_t4, bv_t3);
        bv_s45 = _mm_add_ps(bv_in10, _mm_mul_ps(v_CRTM_15_11, bv_in4));
        bv_s46 = _mm_add_ps(bv_s45, bv_s44);
        bv_s49 = _mm_sub_ps(bv_s47, bv_s48);
        bv_s50 = _mm_add_ps(bv_s46, bv_s49);
        bv_t12 = _mm_mul_ps(v_CRTM_15_6, _mm_sub_ps(bv_s49, bv_s46));
        bv_s51 = _mm_sub_ps(bv_s40, _mm_mul_ps(v_CRTM_15_5, bv_s50));
...
static FFTZ_VOID r2hcf_rfft15avx128_fp32_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128 v_CRTM_15_11 = _mm_broadcast_ss(&CRTM_15_11);
    __m128 v_CRTM_15_12 = _mm_broadcast_ss(&CRTM_15_12);
    __m128 v_CRTM_15_13 = _mm_broadcast_ss(&CRTM_15_13);
    __m128 v_CRTM_15_14 = _mm_broadcast_ss(&CRTM_15_14);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_s1 = _mm_sub_ps(av_in1, av_in2);
        av_s2 = _mm_add_ps(av_in3, av_s0);
        av_s3 = _mm_sub_ps(av_in3, _mm_mul_ps(v_CRTM_15_2, av_s0));
        ...
        av_s6 = _mm_add_ps(av_in3, _mm_mul_ps(v_CRTM_15_2, av_s0));
        ...
        av_s8 = _mm_add_ps(av_in3, av_s0);
        av_s9 = _mm_sub_ps(av_in3, _mm_mul_ps(v_CRTM_15_2, av_s0));
        ...
        av_s12 = _mm_sub_ps(av_in3, _mm_mul_ps(v_CRTM_15_2, av_s0));
        ...
        av_s13 = _mm_add_ps(av_in0, _mm_mul_ps(v_CRTM_15_5, av_in1));
        av_s14 = _mm_sub_ps(av_in0, av_in1);
        av_s15 = _mm_add_ps(av_s8, av_s2);
        av_t0 = _mm_mul_ps(v_CRTM_15_1, _mm_sub_ps(av_s8, av_s2));
        av_s16 = _mm_sub_ps(av_s13, _mm_mul_ps(v_CRTM_15_2, av_s15));

        // Output point 1: X(0)
        v_out0 = _mm_add_ps(av_s13, _mm_mul_ps(v_CRTM_15_5, av_s15));
        STR_128_S(curr_out, v_out_stride, v_out0, is_contiguous_out);

        av_s17 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_3, av_s11),
                            _mm_mul_ps(v_CRTM_15_4, av_s5));
        ...
        av_s20 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_4, av_s11),
                            _mm_mul_ps(v_CRTM_15_3, av_s5));
        ...
        av_t1 = _mm_mul_ps(v_CRTM_15_1, _mm_sub_ps(av_s9, av_s3));
        av_t2 = _mm_mul_ps(v_CRTM_15_9, _mm_add_ps(av_s4, av_s10));
        av_s21 = _mm_add_ps(av_s9, av_s3);
        av_s22 = _mm_sub_ps(av_s4, av_s10);
        av_s40 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_5, av_s21), av_s14);
        av_t4 = _mm_mul_ps(v_CRTM_15_10, _mm_add_ps(av_s22, av_in2));
        ...
        av_s23 = _mm_sub_ps(av_s14, _mm_mul_ps(v_CRTM_15_2, av_s21));
        av_t5 = _mm_mul_ps(v_CRTM_15_10,
                _mm_sub_ps( _mm_mul_ps(v_CRTM_15_6, av_s22), av_in2));
        ...
        av_s29 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_3, av_s6),
                            _mm_mul_ps(v_CRTM_15_4, av_s12));
        av_s30 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_8, av_s1),
                            _mm_mul_ps(v_CRTM_15_7, av_s7));
        ...
        av_s34 = _mm_add_ps(_mm_mul_ps(v_CRTM_15_8, av_s7),
                            _mm_mul_ps(v_CRTM_15_7, av_s1));
        av_s35 = _mm_sub_ps(_mm_mul_ps(v_CRTM_15_3, av_s12),
                            _mm_mul_ps(v_CRTM_15_4, av_s6));
        ...
        bv_t1 = _mm_mul_ps(v_CRTM_15_14, bv_s11);
        bv_t2 = _mm_mul_ps(v_CRTM_15_1, bv_s10);
        bv_t3 = _mm_mul_ps(v_CRTM_15_5, bv_t1);
        bv_s12 = _mm_sub_ps(bv_t3, bv_t2);
        bv_t4 = _mm_mul_ps(v_CRTM_15_2, bv_s9);
        bv_s13 = _mm_sub_ps(bv_in14, bv_t4);
        bv_s14 = _mm_add_ps(bv_s1, bv_s5);

        bv_t5 = _mm_mul_ps(v_CRTM_15_6, bv_s14);
        bv_s15 = _mm_sub_ps(bv_in4, bv_t5);
        bv_t6 = _mm_mul_ps(v_CRTM_15_5, bv_s15);
        bv_s16 = _mm_add_ps(bv_s13, bv_t6);
        bv_s17 = _mm_sub_ps(bv_s12, bv_s16);
        bv_s18 = _mm_add_ps(bv_s12, bv_s16);

        bv_t7 = _mm_mul_ps(v_CRTM_15_13, bv_s8);
        bv_t8 = _mm_mul_ps(v_CRTM_15_12, bv_s3);
        bv_t9 = _mm_mul_ps(v_CRTM_15_4, bv_in9);
        bv_t10 = _mm_mul_ps(v_CRTM_15_3, bv_in3);
        bv_s19 = _mm_sub_ps(bv_t7, bv_t8);
        bv_t11 = _mm_mul_ps(v_CRTM_15_5, bv_s19);
        ...
        bv_t12 = _mm_mul_ps(v_CRTM_15_10, bv_s23);
        bv_s24 = _mm_add_ps(bv_s14, bv_in4);
        bv_t13 = _mm_mul_ps(v_CRTM_15_5, bv_s9);
        ...
        bv_t19 = _mm_mul_ps(v_CRTM_15_5, bv_s24);
        // Output pt 2: X(1)
        v_out1 = _mm_add_ps(bv_t19, bv_s25);
        curr_out = out_r + out_strides[1];
        STR_128_S(curr_out, v_out_stride, v_out1, is_contiguous_out);

        bv_t14 = _mm_mul_ps(v_CRTM_15_4, bv_in3);
        bv_t15 = _mm_mul_ps(v_CRTM_15_3, bv_in9);
        bv_s27 = _mm_add_ps(bv_t14, bv_t15);

        bv_t16 = _mm_mul_ps(v_CRTM_15_13, bv_s3);
        bv_t17 = _mm_mul_ps(v_CRTM_15_12, bv_s8);
        bv_s28 = _mm_add_ps(bv_t16, bv_t17);
        bv_t18 = _mm_mul_ps(v_CRTM_15_5, bv_s28);
        ...
        bv_t20 = _mm_mul_ps(v_CRTM_15_11, bv_s22);
        bv_t21 = _mm_mul_ps(v_CRTM_15_10, bv_in5);
        bv_s30 = _mm_add_ps(bv_t20, bv_t21);
        bv_s31 = _mm_sub_ps(bv_s4, bv_s7);
        bv_t22 = _mm_mul_ps(v_CRTM_15_9, bv_s31);
        ...
        bv_t23 = _mm_mul_ps(v_CRTM_15_8, bv_s2);
        bv_t24 = _mm_mul_ps(v_CRTM_15_7, bv_s6);
        bv_s39 = _mm_add_ps(bv_t23, bv_t24);
        bv_t25 = _mm_mul_ps(v_CRTM_15_8, bv_s6);
        bv_t26 = _mm_mul_ps(v_CRTM_15_7, bv_s2);
...
static FFTZ_VOID r2hcf_rfft15avx128_fp64_fwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128d v_CRTM_15_1 = _mm_set1_pd(CRTM_15_1);
    __m128d v_CRTM_15_2 = _mm_set1_pd(CRTM_15_2);
    __m128d v_CRTM_15_3 = _mm_set1_pd(CRTM_15_3);
    __m128d v_CRTM_15_4 = _mm_set1_pd(CRTM_15_4);
    __m128d v_CRTM_15_5 = _mm_set1_pd(CRTM_15_5);
    __m128d v_CRTM_15_6 = _mm_set1_pd(CRTM_15_6);
    __m128d v_CRTM_15_7 = _mm_set1_pd(CRTM_15_7);
    __m128d v_CRTM_15_8 = _mm_set1_pd(CRTM_15_8);
    __m128d v_CRTM_15_9 = _mm_set1_pd(CRTM_15_9);
    __m128d v_CRTM_15_10 = _mm_set1_pd(CRTM_15_10);
    __m128d v_CRTM_15_11 = _mm_set1_pd(CRTM_15_11);
    __m128d v_CRTM_15_12 = _mm_set1_pd(CRTM_15_12);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_s3 = _mm_sub_pd(av_in3, _mm_mul_pd(v_CRTM_15_5, av_s0));
        ...
        av_s6 = _mm_sub_pd(av_in3, _mm_mul_pd(v_CRTM_15_5, av_s0));
        ...
        av_s0 = _mm_add_pd(av_in1, av_in2);
        av_t0 = _mm_mul_pd(v_CRTM_15_6, _mm_sub_pd(av_in2, av_in1));
        av_s9 = _mm_add_pd(av_in0, av_s0);
        av_s3 = _mm_sub_pd(av_in0, _mm_mul_pd(v_CRTM_15_5, av_s0));
        ...
        av_t1 = _mm_mul_pd(v_CRTM_15_1, _mm_sub_pd(av_s11, av_s12));
        av_s15 = _mm_sub_pd(av_s9, _mm_mul_pd(v_CRTM_15_2, av_s13));
        ...
        // Output point 13: X(12)
        v_out12 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_3, av_s20),
                             _mm_mul_pd(v_CRTM_15_4, av_s19));
        curr_out = out_cp + out_strides[11];
        ...
        // Output point 25: X(24)
        v_out24 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_4, av_s20),
                             _mm_mul_pd(v_CRTM_15_3, av_s19));
        curr_out = out_cp + out_strides[23];
        STRI_2x128_D(curr_out, v_out_stride, v_out23, v_out24);

        av_t2 = _mm_mul_pd(v_CRTM_15_1, _mm_sub_pd(av_s28, av_s23));
        av_s13 = _mm_add_pd(av_s28, av_s23);

        // Output point 20: X(19)
        v_out19 = _mm_add_pd(av_s13, av_s3);

        av_t3 = _mm_mul_pd(v_CRTM_15_9, _mm_add_pd(av_s30, av_s27));
        av_s17 = _mm_sub_pd(av_s30, av_s27);

        // Output point 21: X(20)
        v_out20 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_6, av_s17), av_t0);
        curr_out = out_cp + out_strides[19];
        STRI_2x128_D(curr_out, v_out_stride, v_out19, v_out20);

        av_s15 = _mm_sub_pd(av_s3, _mm_mul_pd(v_CRTM_15_2, av_s13));
        av_s20 = _mm_add_pd(av_t0, _mm_mul_pd(v_CRTM_15_10, av_s17));
        av_s21 = _mm_sub_pd(av_s15, av_t2);
        av_s25 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_8, av_s26),
                            _mm_mul_pd(v_CRTM_15_7, av_s31));
        ...
        av_s23 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_8, av_s31),
                            _mm_mul_pd(v_CRTM_15_7, av_s26));

        // Output point 28: X(27)
        v_out27 = _mm_add_pd(av_s21, av_s23);

        av_s22 = _mm_add_pd(av_s20, av_t3);
        av_s16 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_4, av_s29),
                            _mm_mul_pd(v_CRTM_15_3, av_s24));
        ...
        av_s10 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_3, av_s29),
                            _mm_mul_pd(v_CRTM_15_4, av_s24));
        ...
        bv_s42 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_4, bv_s5),
                            _mm_mul_pd(v_CRTM_15_3, bv_s4));
        bv_s28 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_4, bv_s4),
                            _mm_mul_pd(v_CRTM_15_3, bv_s5));

        bv_s6 = _mm_add_pd(bv_in14, bv_in11);
        bv_s7 = _mm_add_pd(bv_in2, bv_in8);
        bv_t2  = _mm_mul_pd(v_CRTM_15_1, _mm_sub_pd(bv_in14, bv_s7));
        bv_s47 = _mm_sub_pd(bv_t2, _mm_mul_pd(v_CRTM_15_11, bv_in11));
        bv_s30 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_12, bv_in11), bv_in5);

        bv_s8 = _mm_sub_pd(bv_in2, bv_in8);
        bv_s9 = _mm_add_pd(bv_in9, bv_in3);
        bv_s10 = _mm_add_pd(bv_in6, bv_in12);
        bv_s26 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_4, bv_s6),
                            _mm_mul_pd(v_CRTM_15_3, bv_s8));

        bv_s11 = _mm_sub_pd(bv_s9, bv_s10);
        bv_s12 = _mm_add_pd(bv_in1, bv_s2);
        bv_s13 = _mm_add_pd(bv_in14, bv_s7);
        bv_s48 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_2, bv_s13), bv_in5);
        ...
        bv_s20 = _mm_add_pd(bv_in0, _mm_mul_pd(v_CRTM_15_2, bv_s11));
        // Output pt 30: X(29)
        v_out29 = _mm_add_pd(bv_s19, bv_s14);
        curr_out = out_r + out_strides[29];
        STR_128_D(curr_out, v_out_dc_nyq_stride, v_out29, is_contiguous_out_dc_nyq);
        // Output pt 10: X(9) & Output pt 11: X(10)
        v_out9 = _mm_sub_pd(bv_s14, _mm_mul_pd(v_CRTM_15_5, bv_s19));
        v_out10 = _mm_mul_pd(v_CRTM_15_6, _mm_sub_pd(bv_s16, bv_s18));
        curr_out = out_cp + out_strides[9];
        ...
        bv_t1  = _mm_mul_pd(v_CRTM_15_1, bv_s23);
        bv_s24 = _mm_add_pd(bv_s20, bv_t1);
        bv_s25 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_3, bv_s3),
                            _mm_mul_pd(v_CRTM_15_4, bv_s1));

        bv_t6  = _mm_mul_pd(v_CRTM_15_6, _mm_add_pd(bv_s25, bv_s26));
        bv_s27 = _mm_sub_pd(bv_s25, bv_s26);

        bv_s29 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_5, bv_s27), bv_s28);
        bv_s31 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_2, bv_s13), bv_t2);
        bv_s32 = _mm_sub_pd(bv_s30, bv_s31);

        bv_t3  = _mm_mul_pd(v_CRTM_15_1, _mm_sub_pd(bv_in1, bv_s2));
        bv_s33 = _mm_add_pd(bv_in10, bv_t3);
        bv_t4  = _mm_mul_pd(v_CRTM_15_2, bv_s12);
        bv_s34 = _mm_sub_pd(bv_t4, _mm_mul_pd(v_CRTM_15_12, bv_in4));
        bv_s35 = _mm_add_pd(bv_s33, bv_s34);
        bv_s36 = _mm_add_pd(bv_s32, bv_s35);
        bv_t5  = _mm_mul_pd(v_CRTM_15_6, _mm_sub_pd(bv_s32, bv_s35));
        // Output pt 6: X(5) & Output pt 7: X(6)
        ...
        bv_s37 = _mm_sub_pd(bv_s24, _mm_mul_pd(v_CRTM_15_5, bv_s36));
        // Output pt 14: X(13)& Output pt 15: X(14)
        ...
        bv_t7  = _mm_mul_pd(v_CRTM_15_4, bv_s3);
        bv_t8  = _mm_mul_pd(v_CRTM_15_3, bv_s1);
        bv_s38 = _mm_add_pd(bv_t8, bv_t7);
        bv_t9  = _mm_mul_pd(v_CRTM_15_4, bv_s8);
        bv_t10 = _mm_mul_pd(v_CRTM_15_3, bv_s6);
        bv_s39 = _mm_sub_pd(bv_t9, bv_t10);

        bv_t11 = _mm_mul_pd(v_CRTM_15_6, _mm_add_pd(bv_s38, bv_s39));
        bv_s40 = _mm_sub_pd(bv_s20, bv_t1);
        bv_s41 = _mm_sub_pd(bv_s39, bv_s38);
        bv_s43 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_5, bv_s41), bv_s42);

        bv_s44 = _mm_sub_pd(bv_t4, bv_t3);
        bv_s45 = _mm_add_pd(bv_in10, _mm_mul_pd(v_CRTM_15_11, bv_in4));
        bv_s46 = _mm_add_pd(bv_s45, bv_s44);
        bv_s49 = _mm_sub_pd(bv_s47, bv_s48);
        bv_s50 = _mm_add_pd(bv_s46, bv_s49);
        bv_t12 = _mm_mul_pd(v_CRTM_15_6, _mm_sub_pd(bv_s49, bv_s46));
        bv_s51 = _mm_sub_pd(bv_s40, _mm_mul_pd(v_CRTM_15_5, bv_s50));
...
static FFTZ_VOID r2hcf_rfft15avx128_fp64_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128d v_CRTM_15_11 = _mm_set1_pd(CRTM_15_11);
    __m128d v_CRTM_15_12 = _mm_set1_pd(CRTM_15_12);
    __m128d v_CRTM_15_13 = _mm_set1_pd(CRTM_15_13);
    __m128d v_CRTM_15_14 = _mm_set1_pd(CRTM_15_14);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_s1 = _mm_sub_pd(av_in1, av_in2);
        av_s2 = _mm_add_pd(av_in3, av_s0);
        av_s3 = _mm_sub_pd(av_in3, _mm_mul_pd(v_CRTM_15_2, av_s0));
        ...
        av_s6 = _mm_add_pd(av_in3, _mm_mul_pd(v_CRTM_15_2, av_s0));
        ...
        av_s8 = _mm_add_pd(av_in3, av_s0);
        av_s9 = _mm_sub_pd(av_in3, _mm_mul_pd(v_CRTM_15_2, av_s0));
        ...
        av_s12 = _mm_sub_pd(av_in3, _mm_mul_pd(v_CRTM_15_2, av_s0));
        ...
        av_s13 = _mm_add_pd(av_in0, _mm_mul_pd(v_CRTM_15_5, av_in1));
        av_s14 = _mm_sub_pd(av_in0, av_in1);
        av_s15 = _mm_add_pd(av_s8, av_s2);
        av_t0 = _mm_mul_pd(v_CRTM_15_1, _mm_sub_pd(av_s8, av_s2));
        av_s16 = _mm_sub_pd(av_s13, _mm_mul_pd(v_CRTM_15_2, av_s15));

        // Output point 1: X(0)
        v_out0 = _mm_add_pd(av_s13, _mm_mul_pd(v_CRTM_15_5, av_s15));
        STR_128_D(curr_out, v_out_stride, v_out0, is_contiguous_out);

        av_s17 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_3, av_s11),
                            _mm_mul_pd(v_CRTM_15_4, av_s5));
        ...
        av_s20 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_4, av_s11),
                            _mm_mul_pd(v_CRTM_15_3, av_s5));
        ...
        av_t1 = _mm_mul_pd(v_CRTM_15_1, _mm_sub_pd(av_s9, av_s3));
        av_t2 = _mm_mul_pd(v_CRTM_15_9, _mm_add_pd(av_s4, av_s10));
        av_s21 = _mm_add_pd(av_s9, av_s3);
        av_s22 = _mm_sub_pd(av_s4, av_s10);
        av_s40 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_5, av_s21), av_s14);
        av_t4 = _mm_mul_pd(v_CRTM_15_10, _mm_add_pd(av_s22, av_in2));
        ...
        av_s23 = _mm_sub_pd(av_s14, _mm_mul_pd(v_CRTM_15_2, av_s21));
        av_t5 = _mm_mul_pd(v_CRTM_15_10,
                _mm_sub_pd( _mm_mul_pd(v_CRTM_15_6, av_s22), av_in2));
        ...
        av_s29 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_3, av_s6),
                            _mm_mul_pd(v_CRTM_15_4, av_s12));
        av_s30 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_8, av_s1),
                            _mm_mul_pd(v_CRTM_15_7, av_s7));
        ...
        av_s34 = _mm_add_pd(_mm_mul_pd(v_CRTM_15_8, av_s7),
                            _mm_mul_pd(v_CRTM_15_7, av_s1));
        av_s35 = _mm_sub_pd(_mm_mul_pd(v_CRTM_15_3, av_s12),
                            _mm_mul_pd(v_CRTM_15_4, av_s6));
        ...
        bv_t1 = _mm_mul_pd(v_CRTM_15_14, bv_s11);
        bv_t2 = _mm_mul_pd(v_CRTM_15_1, bv_s10);
        bv_t3 = _mm_mul_pd(v_CRTM_15_5, bv_t1);
        bv_s12 = _mm_sub_pd(bv_t3, bv_t2);
        bv_t4 = _mm_mul_pd(v_CRTM_15_2, bv_s9);
        bv_s13 = _mm_sub_pd(bv_in14, bv_t4);
        bv_s14 = _mm_add_pd(bv_s1, bv_s5);

        bv_t5 = _mm_mul_pd(v_CRTM_15_6, bv_s14);
        bv_s15 = _mm_sub_pd(bv_in4, bv_t5);
        bv_t6 = _mm_mul_pd(v_CRTM_15_5, bv_s15);
        bv_s16 = _mm_add_pd(bv_s13, bv_t6);
        bv_s17 = _mm_sub_pd(bv_s12, bv_s16);
        bv_s18 = _mm_add_pd(bv_s12, bv_s16);

        bv_t7 = _mm_mul_pd(v_CRTM_15_13, bv_s8);
        bv_t8 = _mm_mul_pd(v_CRTM_15_12, bv_s3);
        bv_t9 = _mm_mul_pd(v_CRTM_15_4, bv_in9);
        bv_t10 = _mm_mul_pd(v_CRTM_15_3, bv_in3);
        bv_s19 = _mm_sub_pd(bv_t7, bv_t8);
        bv_t11 = _mm_mul_pd(v_CRTM_15_5, bv_s19);
        ...
        bv_t12 = _mm_mul_pd(v_CRTM_15_10, bv_s23);
        bv_s24 = _mm_add_pd(bv_s14, bv_in4);
        bv_t13 = _mm_mul_pd(v_CRTM_15_5, bv_s9);
        ...
        bv_t19 = _mm_mul_pd(v_CRTM_15_5, bv_s24);
        // Output pt 2: X(1)
        v_out1 = _mm_add_pd(bv_t19, bv_s25);
        curr_out = out_r + out_strides[1];
        STR_128_D(curr_out, v_out_stride, v_out1, is_contiguous_out);

        bv_t14 = _mm_mul_pd(v_CRTM_15_4, bv_in3);
        bv_t15 = _mm_mul_pd(v_CRTM_15_3, bv_in9);
        bv_s27 = _mm_add_pd(bv_t14, bv_t15);

        bv_t16 = _mm_mul_pd(v_CRTM_15_13, bv_s3);
        bv_t17 = _mm_mul_pd(v_CRTM_15_12, bv_s8);
        bv_s28 = _mm_add_pd(bv_t16, bv_t17);
        bv_t18 = _mm_mul_pd(v_CRTM_15_5, bv_s28);
        ...
        bv_t20 = _mm_mul_pd(v_CRTM_15_11, bv_s22);
        bv_t21 = _mm_mul_pd(v_CRTM_15_10, bv_in5);
        bv_s30 = _mm_add_pd(bv_t20, bv_t21);
        bv_s31 = _mm_sub_pd(bv_s4, bv_s7);
        bv_t22 = _mm_mul_pd(v_CRTM_15_9, bv_s31);
        ...
        bv_t23 = _mm_mul_pd(v_CRTM_15_8, bv_s2);
        bv_t24 = _mm_mul_pd(v_CRTM_15_7, bv_s6);
        bv_s39 = _mm_add_pd(bv_t23, bv_t24);
        bv_t25 = _mm_mul_pd(v_CRTM_15_8, bv_s6);
        bv_t26 = _mm_mul_pd(v_CRTM_15_7, bv_s2);
                                         ...
                                         FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft15avx128_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft15avx128_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft15avx128_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft15avx128_fp64_bwd;
        }
        else
        {
            return NULL;
