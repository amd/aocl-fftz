                                              ...
                                              FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
     ...
     if (remaining_sets & 1)
     {
         ...
         *out = a_s28 + a_in0;
         ...
         // Output point 5: X(4)
         out[out_strides[4]]  = a_s46 + a_m31;
 
         a_s57 = a_s24 - a_s55;
         // Output point 12: X(11)
         out[out_strides[11]] = a_s57 + a_s62;
         // Output point 16: X(15)
         out[out_strides[15]] = a_s57 - a_s62;

         a_s58 = a_s46 - a_s26;
         // Output point 13: X(12)
         out[out_strides[12]] = a_s58 + a_m21;
         // Output point 17: X(16)
         out[out_strides[16]] = a_m21 - a_s58;
 
         a_s59 = a_s27 - a_s44;
         // Output point 9: X(8)
         out[out_strides[8]]  = a_m20 + a_s59;
         // Output point 25: X(24)
         out[out_strides[24]] = a_s59 - a_m20;
 
         a_m32 = CRTM_13_8 * a_s27;
         a_s60 = -(a_m32 + a_s44);
         // Output point 21: X(20)
         out[out_strides[20]] = a_s60;
         a_m33 = CRTM_13_8 * a_s56;
         a_s61 = a_s25 - a_m33;
         // Output point 20: X(19)
         out[out_strides[19]] = a_s61;

         a_s63 = a_s25 + a_s56;
         // Output point 8: X(7)
         out[out_strides[7]]  = a_s63 - a_s54;
         // Output point 24: X(23)
         out[out_strides[23]] = a_s63 + a_s54;
