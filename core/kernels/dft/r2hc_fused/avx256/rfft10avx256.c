...
/** @file rfft10avx256.c
 *
 *  @brief Radix-10 r2hc_fused Real-FFT kernel with with AVX-256 operations
...
static FFTZ_VOID r2hcf_rfft10avx256_fp32_fwd(FFTZ_VOID *in_real,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m256 v_CRTM_10_1 = _mm256_broadcast_ss(&CRTM_10_1);
    __m256 v_CRTM_10_2 = _mm256_broadcast_ss(&CRTM_10_2);
    __m256 v_CRTM_10_3 = _mm256_broadcast_ss(&CRTM_10_3);
    __m256 v_CRTM_10_4 = _mm256_broadcast_ss(&CRTM_10_4);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        STR_256_S(curr_out, v_out_dc_nyq_stride, v_out19, is_contiguous_out_dc_nyq);

        av_t0  = _mm256_mul_ps(v_CRTM_10_2, av_s21);
        av_t1  = _mm256_mul_ps(v_CRTM_10_1, av_s20);
        ...
        av_t4  = _mm256_mul_ps(v_CRTM_10_3, av_s12);
        av_t10 = _mm256_mul_ps(v_CRTM_10_4, av_s15);
        // Output point 5: X(4)
        ...
        av_t6 = _mm256_mul_ps(v_CRTM_10_3, av_s15);
        av_t8 = _mm256_mul_ps(v_CRTM_10_4, av_s12);
        ...
        av_t5  = _mm256_mul_ps(v_CRTM_10_3, av_s13);
        av_t11 = _mm256_mul_ps(v_CRTM_10_4, av_s16);
        // Output point 17: X(16)
        v_out16 = _mm256_add_ps(av_t11, av_t5);

        av_t7 = _mm256_mul_ps(v_CRTM_10_3, av_s16);
        av_t9 = _mm256_mul_ps(v_CRTM_10_4, av_s13);
        // Output point 9: X(8)
        v_out8 = _mm256_sub_ps(av_t9, av_t7);

        av_s19 = _mm256_sub_ps(av_s10, av_s14);
        av_t2  = _mm256_mul_ps(v_CRTM_10_2, av_s18);
        av_t3  = _mm256_mul_ps(v_CRTM_10_1, av_s19);
        ...
        bv_t0 = _mm256_mul_ps(v_CRTM_10_2, bv_s11);
        bv_t1 = _mm256_mul_ps(v_CRTM_10_1, bv_s10);
        bv_t2 = _mm256_mul_ps(v_CRTM_10_1, bv_s8);
        bv_t3 = _mm256_mul_ps(v_CRTM_10_2, bv_s9);

        bv_s12 = _mm256_add_ps(bv_in0, bv_t0);
        bv_s13 = _mm256_sub_ps(bv_t3, bv_in5);

        bv_t4  = _mm256_mul_ps(v_CRTM_10_4, bv_s1);
        bv_t5  = _mm256_mul_ps(v_CRTM_10_3, bv_s5);
        bv_t6  = _mm256_mul_ps(v_CRTM_10_4, bv_s6);
        bv_t7  = _mm256_mul_ps(v_CRTM_10_3, bv_s2);
        bv_t8  = _mm256_mul_ps(v_CRTM_10_4, bv_s5);
        bv_t9  = _mm256_mul_ps(v_CRTM_10_3, bv_s1);
        bv_t10 = _mm256_mul_ps(v_CRTM_10_4, bv_s2);
        bv_t11 = _mm256_mul_ps(v_CRTM_10_3, bv_s6);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        __m128 v128_CRTM_10_1 = _mm256_castps256_ps128(v_CRTM_10_1);
        __m128 v128_CRTM_10_2 = _mm256_castps256_ps128(v_CRTM_10_2);
        __m128 v128_CRTM_10_3 = _mm256_castps256_ps128(v_CRTM_10_3);
        __m128 v128_CRTM_10_4 = _mm256_castps256_ps128(v_CRTM_10_4);
        ...
        curr_out = out_r + out_strides[19];
        STR_128_S(curr_out, v_out_dc_nyq_stride, v_out19, is_contiguous_out_dc_nyq);
    ...
    if (remaining_sets & 2)
    {
        ...
        v_out19 = _mm_sub_ps(av_s1, av_s21);
        curr_out = out_r + out_strides[19];
        STHR_128_S(curr_out, v_out_dc_nyq_stride, v_out19);
    ...
    if (remaining_sets & 1)
    {
        ...
        *out_r = a_s0 + a_s18;
        ...
        a_s21 = a_s11 - a_s17;
        // Output point 20: X(19)
        out_r[out_strides[19]] = a_s1 - a_s21;

        a_t0 = CRTM_10_2 * a_s21;
        a_t1 = CRTM_10_1 * a_s20;
        a_s22 = a_t0 + a_s1;
        // Output point 4: X(3)
        out_cp[out_strides[3]] = a_s22 + a_t1;
        // Output point 12: X(11)
        out_cp[out_strides[11]] = a_s22 - a_t1;
        ...
        // Output point 5: X(4)
        out_cp[out_strides[4]] = -(a_t2 + a_t3);

        a_t4 = CRTM_10_3 * a_s15;
        a_t5 = CRTM_10_4 * a_s12;
        // Output point 13: X(12)
        out_cp[out_strides[12]] = a_t4 - a_t5;
        ...
        // Output point 17: X(16)
        out_cp[out_strides[16]] = a_t7 + a_t6;

        a_t8 = CRTM_10_3 * a_s16;
        a_t9 = CRTM_10_4 * a_s13;
        // Output point 9: X(8)
        out_cp[out_strides[8]] = a_t9 - a_t8;
        ...
        a_s23 = a_s0 - a_t10;
        // Output point 8: X(7)
        out_cp[out_strides[7]] = a_s23 + a_t11;
        // Output point 16: X(15)
        out_cp[out_strides[15]] = a_s23 - a_t11;
        ...
        b_s11 = b_s3 - b_s7;
        // Output point 11: X(10)
        out_cp[out_strides[10]] = -(b_s9 + b_in5);
        // Output point 10: X(9)
        out_cp[out_strides[9]] = b_in0 - b_s11;
        ...
        b_s15 = b_t4 + b_t5;
        // Output point 2: X(1)
        out_cp[out_strides[1]] = b_s14 + b_s15;
        // Output point 18: X(17)
        out_cp[out_strides[17]] = b_s14 - b_s15;

        b_s16 = b_s13 - b_t2;
        b_s17 = b_t6 + b_t7;
        // Output point 3: X(2)
        out_cp[out_strides[2]] = b_s16 - b_s17;
        // Output point 19: X(18)
        out_cp[out_strides[18]] = b_s16 + b_s17;

        b_s18 = b_s12 - b_t1;
        b_s19 = b_t9 - b_t8;
        // Output point 6: X(5)
        out_cp[out_strides[5]] = b_s18 + b_s19;
        // Output point 14: X(13)
        out_cp[out_strides[13]] = b_s18 - b_s19;

        b_s20 = b_s13 + b_t2;
        b_s21 = b_t11 - b_t10;
        // Output point 7: X(6)
        out_cp[out_strides[6]] = b_s21 - b_s20;
        // Output point 15: X(14)
        out_cp[out_strides[14]] = -(b_s21 + b_s20);
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hcf_rfft10avx256_fp32_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m256 v_CRTM_10_3 = _mm256_broadcast_ss(&CRTM_10_3);
    __m256 v_CRTM_10_4 = _mm256_broadcast_ss(&CRTM_10_4);
    __m256 v_CRTM_10_5 = _mm256_broadcast_ss(&CRTM_10_5);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 20: x(19)
        curr_in = in_r + in_strides[19];
        LDR_256_S(curr_in, v_in_dc_nyq_stride, av_in9, is_contiguous_in_dc_nyq);
        ...
        av_t11 = _mm256_mul_ps(v_CRTM_10_4, av_s6);
        av_s9  = _mm256_add_ps(av_in4, av_in6);

        av_t9  = _mm256_mul_ps(v_CRTM_10_4, av_s9);
        av_t10 = _mm256_mul_ps(v_CRTM_10_5, av_s5);
        av_s23 = _mm256_sub_ps(av_t9, av_t10);
        av_s10 = _mm256_sub_ps(av_in4, av_in6);
        av_t12 = _mm256_mul_ps(v_CRTM_10_5, av_s10);
        ...
        av_t14 = _mm256_mul_ps(v_CRTM_10_3, av_s14);
        // Output point 11: X(10)
        ...
        av_t4  = _mm256_mul_ps(v_CRTM_10_1, av_s13);
        av_t2  = _mm256_mul_ps(v_CRTM_10_2, av_s14);
        ...
        av_t5  = _mm256_mul_ps(v_CRTM_10_4, av_s5);
        av_t6  = _mm256_mul_ps(v_CRTM_10_5, av_s9);
        ...
        av_t7  = _mm256_mul_ps(v_CRTM_10_4, av_s10);
        av_t8  = _mm256_mul_ps(v_CRTM_10_5, av_s6);
        ...
        bv_t1  = _mm256_mul_ps(v_CRTM_10_1, bv_s11);
        bv_t2  = _mm256_mul_ps(v_CRTM_10_2, bv_s12);
        bv_t3  = _mm256_mul_ps(v_CRTM_10_1, bv_s10);
        bv_t4  = _mm256_mul_ps(v_CRTM_10_2, bv_s9);
        bv_t5  = _mm256_mul_ps(v_CRTM_10_3, bv_in4);
        bv_t6  = _mm256_mul_ps(v_CRTM_10_3, bv_in5);
        ...
        bv_t7  = _mm256_mul_ps(v_CRTM_10_5, bv_s2);
        bv_t8  = _mm256_mul_ps(v_CRTM_10_5, bv_s4);
        bv_t9  = _mm256_mul_ps(v_CRTM_10_5, bv_s6);
        bv_t10 = _mm256_mul_ps(v_CRTM_10_5, bv_s8);
        bv_t11 = _mm256_mul_ps(v_CRTM_10_4, bv_s2);
        bv_t12 = _mm256_mul_ps(v_CRTM_10_4, bv_s4);
        bv_t13 = _mm256_mul_ps(v_CRTM_10_4, bv_s6);
        bv_t14 = _mm256_mul_ps(v_CRTM_10_4, bv_s8);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        __m128 v128_CRTM_10_3 = _mm256_castps256_ps128(v_CRTM_10_3);
        __m128 v128_CRTM_10_4 = _mm256_castps256_ps128(v_CRTM_10_4);
        __m128 v128_CRTM_10_5 = _mm256_castps256_ps128(v_CRTM_10_5);
        ...
        // Input point 20: x(19)
        curr_in = in_r + in_strides[19];
        LDR_128_S(curr_in, v_in_dc_nyq_stride, av_in9, is_contiguous_in_dc_nyq);
    ...
    if (remaining_sets & 2)
    {
        ...
        // Input point 20: x(19)
        curr_in = in_r + in_strides[19];
        LDHR_128_S(curr_in, v_in_dc_nyq_stride, av_in9);
    ...
    if (remaining_sets & 1)
    {
        ...
        // Output point 11: X(10)
        out_r[out_strides[10]] = a_s1 - a_t4;
        ...
        *out_r = a_s0 + a_t5;
        ...
        a_s19 = a_s15 - a_t7;
        // Output point 9: X(8)
        out_r[out_strides[8]] = a_s19 + a_s23;
        // Output point 13: X(12)
        out_r[out_strides[12]] = a_s19 - a_s23;
        ...
        a_s17 = a_s14 - a_t8;
        // Output point 7: X(6)
        out_r[out_strides[6]] = a_s17 + a_s22;
        // Output point 15: X(14)
        out_r[out_strides[14]] = a_s17 - a_s22;

        a_t10 = CRTM_10_4 * a_s4;
        a_t11 = CRTM_10_5 * a_s8;
        a_s20 = a_t10 + a_t11;
        // Output point 3: X(2)
        out_r[out_strides[2]] = a_s16 - a_s20;
        // Output point 19: X(18)
        out_r[out_strides[18]] = a_s16 + a_s20;

        a_t12 = CRTM_10_4 * a_s9;
        a_t13 = CRTM_10_5 * a_s5;
        a_s21 = a_t12 + a_t13;
        // Output point 5: X(4)
        out_r[out_strides[4]] = a_s18 - a_s21;
        // Output point 17: X(16)
        out_r[out_strides[16]] = a_s18 + a_s21;
        ...
        b_s22 = b_s8 + b_s8;
        // Output point 2: X(1)
        out_r[out_strides[1]] = b_t4 + b_s22;
        b_s23 = b_s11 + b_s11;
        // Output point 12: X(11)
        out_r[out_strides[11]] = -(b_t5 + b_s23);
        ...
        b_s18 = b_t6 + b_t12;
        // Output point 4: X(3)
        out_r[out_strides[3]] = b_s14 + b_s18;
        // Output point 20: X(19)
        out_r[out_strides[19]] = b_s14 - b_s18;

        b_s19 = b_t9 + b_t11;
        // Output point 6: X(5)
        out_r[out_strides[5]] = b_s16 - b_s19;
        // Output point 18: X(17)
        out_r[out_strides[17]] = -(b_s16 + b_s19);

        b_s20 = b_t10 - b_t8;
        // Output point 8: X(7)
        out_r[out_strides[7]] = b_s20 - b_s15;
        // Output point 16: X(15)
        out_r[out_strides[15]] = -(b_s15 + b_s20);

        b_s21 = b_t13 - b_t7;
        // Output point 10: X(9)
        out_r[out_strides[9]] = b_s21 + b_s17;
        // Output point 14: X(13)
        out_r[out_strides[13]] = b_s21 - b_s17;
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hcf_rfft10avx256_fp64_fwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m256d v_CRTM_10_1 = _mm256_broadcast_sd(&CRTM_10_1);
    __m256d v_CRTM_10_2 = _mm256_broadcast_sd(&CRTM_10_2);
    __m256d v_CRTM_10_3 = _mm256_broadcast_sd(&CRTM_10_3);
    __m256d v_CRTM_10_4 = _mm256_broadcast_sd(&CRTM_10_4);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        curr_out = out_r + out_strides[19];
        STR_256_D(curr_out, v_out_dc_nyq_stride, v_out19, is_contiguous_out_dc_nyq);

        av_t0  = _mm256_mul_pd(v_CRTM_10_2, av_s21);
        av_t1  = _mm256_mul_pd(v_CRTM_10_1, av_s20);
        ...
        av_t4  = _mm256_mul_pd(v_CRTM_10_3, av_s12);
        av_t10 = _mm256_mul_pd(v_CRTM_10_4, av_s15);
        // Output point 5: X(4)
        v_out4 = NEGATE_256_D(_mm256_add_pd(av_t4, av_t10));
        curr_out = out_cp + out_strides[3];
        STRI_2x256_D(curr_out, v_out_stride, v_out3, v_out4);

        av_t6 = _mm256_mul_pd(v_CRTM_10_3, av_s15);
        av_t8 = _mm256_mul_pd(v_CRTM_10_4, av_s12);
        // Output point 13: X(12)
        ...
        av_t5  = _mm256_mul_pd(v_CRTM_10_3, av_s13);
        av_t11 = _mm256_mul_pd(v_CRTM_10_4, av_s16);
        // Output point 17: X(16)
        v_out16 = _mm256_add_pd(av_t11, av_t5);

        av_t7 = _mm256_mul_pd(v_CRTM_10_3, av_s16);
        av_t9 = _mm256_mul_pd(v_CRTM_10_4, av_s13);
        // Output point 9: X(8)
        v_out8 = _mm256_sub_pd(av_t9, av_t7);

        av_s19 = _mm256_sub_pd(av_s10, av_s14);
        av_t2  = _mm256_mul_pd(v_CRTM_10_2, av_s18);
        av_t3  = _mm256_mul_pd(v_CRTM_10_1, av_s19);
        ...
        bv_t0 = _mm256_mul_pd(v_CRTM_10_2, bv_s11);
        bv_t1 = _mm256_mul_pd(v_CRTM_10_1, bv_s10);
        bv_t2 = _mm256_mul_pd(v_CRTM_10_1, bv_s8);
        bv_t3 = _mm256_mul_pd(v_CRTM_10_2, bv_s9);

        bv_s12 = _mm256_add_pd(bv_in0, bv_t0);
        bv_s13 = _mm256_sub_pd(bv_t3, bv_in5);

        bv_t4  = _mm256_mul_pd(v_CRTM_10_4, bv_s1);
        bv_t5  = _mm256_mul_pd(v_CRTM_10_3, bv_s5);
        bv_t6  = _mm256_mul_pd(v_CRTM_10_4, bv_s6);
        bv_t7  = _mm256_mul_pd(v_CRTM_10_3, bv_s2);
        bv_t8  = _mm256_mul_pd(v_CRTM_10_4, bv_s5);
        bv_t9  = _mm256_mul_pd(v_CRTM_10_3, bv_s1);
        bv_t10 = _mm256_mul_pd(v_CRTM_10_4, bv_s2);
        bv_t11 = _mm256_mul_pd(v_CRTM_10_3, bv_s6);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        __m128d v128_CRTM_10_1 = _mm256_castpd256_pd128(v_CRTM_10_1);
        __m128d v128_CRTM_10_2 = _mm256_castpd256_pd128(v_CRTM_10_2);
        __m128d v128_CRTM_10_3 = _mm256_castpd256_pd128(v_CRTM_10_3);
        __m128d v128_CRTM_10_4 = _mm256_castpd256_pd128(v_CRTM_10_4);
        ...
        curr_out = out_r + out_strides[19];
        STR_128_D(curr_out, v_out_dc_nyq_stride, v_out19, is_contiguous_out_dc_nyq);
...
static FFTZ_VOID r2hcf_rfft10avx256_fp64_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m256d v_CRTM_10_3 = _mm256_broadcast_sd(&CRTM_10_3);
    __m256d v_CRTM_10_4 = _mm256_broadcast_sd(&CRTM_10_4);
    __m256d v_CRTM_10_5 = _mm256_broadcast_sd(&CRTM_10_5);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 20: x(19)
        curr_in = in_r + in_strides[19];
        LDR_256_D(curr_in, v_in_dc_nyq_stride, av_in9, is_contiguous_in_dc_nyq);
        ...
        av_t11 = _mm256_mul_pd(v_CRTM_10_4, av_s6);
        av_s9  = _mm256_add_pd(av_in4, av_in6);

        av_t9  = _mm256_mul_pd(v_CRTM_10_4, av_s9);
        av_t10 = _mm256_mul_pd(v_CRTM_10_5, av_s5);
        av_s23 = _mm256_sub_pd(av_t9, av_t10);
        av_s10 = _mm256_sub_pd(av_in4, av_in6);
        av_t12 = _mm256_mul_pd(v_CRTM_10_5, av_s10);
        ...
        av_t14 = _mm256_mul_pd(v_CRTM_10_3, av_s14);
        // Output point 11: X(10)
        ...
        av_t4  = _mm256_mul_pd(v_CRTM_10_1, av_s13);
        av_t2  = _mm256_mul_pd(v_CRTM_10_2, av_s14);
        ...
        av_t5  = _mm256_mul_pd(v_CRTM_10_4, av_s5);
        av_t6  = _mm256_mul_pd(v_CRTM_10_5, av_s9);
        ...
        av_t7  = _mm256_mul_pd(v_CRTM_10_4, av_s10);
        av_t8  = _mm256_mul_pd(v_CRTM_10_5, av_s6);
        ...
        bv_t1  = _mm256_mul_pd(v_CRTM_10_1, bv_s11);
        bv_t2  = _mm256_mul_pd(v_CRTM_10_2, bv_s12);
        bv_t3  = _mm256_mul_pd(v_CRTM_10_1, bv_s10);
        bv_t4  = _mm256_mul_pd(v_CRTM_10_2, bv_s9);
        bv_t5  = _mm256_mul_pd(v_CRTM_10_3, bv_in4);
        bv_t6  = _mm256_mul_pd(v_CRTM_10_3, bv_in5);
        ...
        bv_t7  = _mm256_mul_pd(v_CRTM_10_5, bv_s2);
        bv_t8  = _mm256_mul_pd(v_CRTM_10_5, bv_s4);
        bv_t9  = _mm256_mul_pd(v_CRTM_10_5, bv_s6);
        bv_t10 = _mm256_mul_pd(v_CRTM_10_5, bv_s8);
        bv_t11 = _mm256_mul_pd(v_CRTM_10_4, bv_s2);
        bv_t12 = _mm256_mul_pd(v_CRTM_10_4, bv_s4);
        bv_t13 = _mm256_mul_pd(v_CRTM_10_4, bv_s6);
        bv_t14 = _mm256_mul_pd(v_CRTM_10_4, bv_s8);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        __m128d v128_CRTM_10_3 = _mm256_castpd256_pd128(v_CRTM_10_3);
        __m128d v128_CRTM_10_4 = _mm256_castpd256_pd128(v_CRTM_10_4);
        __m128d v128_CRTM_10_5 = _mm256_castpd256_pd128(v_CRTM_10_5);
        ...
        // Input point 20: x(19)
        curr_in = in_r + in_strides[19];
        LDR_128_D(curr_in, v_in_dc_nyq_stride, av_in9, is_contiguous_in_dc_nyq);
                                         ...
                                         FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft10avx256_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft10avx256_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft10avx256_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft10avx256_fp64_bwd;
        }
        else
        {
            return NULL;
