...
/** @file rfft5avx256.c
 *
 *  @brief Radix-5 r2hc_fused Real-FFT kernel with with AVX-256 operations using
 *  x86 SIMD intrinsics.
 *
...
static FFTZ_VOID r2hcf_rfft5avx256_fp32_fwd(FFTZ_VOID *in_real,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t1 = _mm256_mul_ps(v_CRTM_5_4, av_s5);
        av_s6 = _mm256_sub_ps(av_s1, av_s3);

        av_s7 = _mm256_sub_ps(av_in0, av_t1);
        av_t2 = _mm256_mul_ps(v_CRTM_5_1, av_s6);

        av_t3 = _mm256_mul_ps(v_CRTM_5_3, av_s4);
        av_t4 = _mm256_mul_ps(v_CRTM_5_2, av_s2);
        av_t5 = _mm256_mul_ps(v_CRTM_5_2, av_s4);
        av_t6 = _mm256_mul_ps(v_CRTM_5_3, av_s2);
        ...
        bv_t1 = _mm256_mul_ps(v_CRTM_5_4, bv_s5);
        bv_s7 = _mm256_add_ps(bv_in0, bv_t1);
        bv_t2 = _mm256_mul_ps(v_CRTM_5_1, bv_s6);

        bv_t3 = _mm256_mul_ps(v_CRTM_5_2, bv_s3);
        bv_t4 = _mm256_mul_ps(v_CRTM_5_3, bv_s1);
        bv_t5 = _mm256_mul_ps(v_CRTM_5_3, bv_s3);
        bv_t6 = _mm256_mul_ps(v_CRTM_5_2, bv_s1);
...
static FFTZ_VOID r2hcf_rfft5avx256_fp32_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t1 = _mm256_mul_ps(v_CRTM_5_4, av_s1);
        av_t2 = _mm256_mul_ps(v_CRTM_5_1, av_s2);
        av_s3 = _mm256_sub_ps(av_in0, av_t1);
        av_s4 = _mm256_add_ps(av_s3, av_t2);
        av_s5 = _mm256_sub_ps(av_s3, av_t2);

        av_t3 = _mm256_mul_ps(v_CRTM_5_2, av_in4);
        av_t4 = _mm256_mul_ps(v_CRTM_5_3, av_in2);
        av_t5 = _mm256_mul_ps(v_CRTM_5_3, av_in4);
        av_t6 = _mm256_mul_ps(v_CRTM_5_2, av_in2);
        av_t7 = _mm256_mul_ps(v_CRTM_5_5, av_s1);
        ...
        // Input point 10: x(9)
        curr_in = in_r + in_strides[9];
        LDR_256_S(curr_in, v_in_dc_nyq_stride, bv_in4, is_contiguous_in_dc_nyq);

        bv_s1 = _mm256_add_ps(bv_in0, bv_in2);
        bv_s2 = _mm256_sub_ps(bv_in2, bv_in0);
        bv_t1 = _mm256_mul_ps(v_CRTM_5_1, bv_s2);
        bv_t2 = _mm256_mul_ps(v_CRTM_5_4, bv_s1);
        bv_s3 = _mm256_sub_ps(bv_in4, bv_t2);
        bv_s4 = _mm256_add_ps(bv_s3, bv_t1);
        bv_s5 = _mm256_sub_ps(bv_s3, bv_t1);

        bv_t3 = _mm256_mul_ps(v_CRTM_5_3, bv_in1);
        bv_t4 = _mm256_mul_ps(v_CRTM_5_2, bv_in3);
        bv_t5 = _mm256_mul_ps(v_CRTM_5_2, bv_in1);
        bv_t6 = _mm256_mul_ps(v_CRTM_5_3, bv_in3);
        bv_s6 = _mm256_add_ps(bv_t3, bv_t4);

        bv_s7 = _mm256_sub_ps(bv_t6, bv_t5);
        bv_t7 = _mm256_mul_ps(v_CRTM_5_5, bv_s1);
...
static FFTZ_VOID r2hcf_rfft5avx256_fp64_fwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t1 = _mm256_mul_pd(v_CRTM_5_4, av_s5);
        av_s6 = _mm256_sub_pd(av_s1, av_s3);

        av_s7 = _mm256_sub_pd(av_in0, av_t1);
        av_t2 = _mm256_mul_pd(v_CRTM_5_1, av_s6);

        av_t3 = _mm256_mul_pd(v_CRTM_5_3, av_s4);
        av_t4 = _mm256_mul_pd(v_CRTM_5_2, av_s2);
        av_t5 = _mm256_mul_pd(v_CRTM_5_2, av_s4);
        av_t6 = _mm256_mul_pd(v_CRTM_5_3, av_s2);
        ...
        bv_t1 = _mm256_mul_pd(v_CRTM_5_4, bv_s5);
        bv_s7 = _mm256_add_pd(bv_in0, bv_t1);
        bv_t2 = _mm256_mul_pd(v_CRTM_5_1, bv_s6);

        bv_t3 = _mm256_mul_pd(v_CRTM_5_2, bv_s3);
        bv_t4 = _mm256_mul_pd(v_CRTM_5_3, bv_s1);
        bv_t5 = _mm256_mul_pd(v_CRTM_5_3, bv_s3);
        bv_t6 = _mm256_mul_pd(v_CRTM_5_2, bv_s1);
...
static FFTZ_VOID r2hcf_rfft5avx256_fp64_bwd(FFTZ_VOID *in_real,
                                            FFTZ_VOID *in_complex,
                                            FFTZ_VOID *out_real,
                                            FFTZ_VOID *out_complex,
                                            FFTZ_INTP n,
                                            ...
                                            FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        av_t1 = _mm256_mul_pd(v_CRTM_5_4, av_s1);
        av_t2 = _mm256_mul_pd(v_CRTM_5_1, av_s2);
        av_s3 = _mm256_sub_pd(av_in0, av_t1);
        av_s4 = _mm256_add_pd(av_s3, av_t2);
        av_s5 = _mm256_sub_pd(av_s3, av_t2);

        av_t3 = _mm256_mul_pd(v_CRTM_5_2, av_in4);
        av_t4 = _mm256_mul_pd(v_CRTM_5_3, av_in2);
        av_t5 = _mm256_mul_pd(v_CRTM_5_3, av_in4);
        av_t6 = _mm256_mul_pd(v_CRTM_5_2, av_in2);
        av_t7 = _mm256_mul_pd(v_CRTM_5_5, av_s1);
        ...
        // Input point 10: x(9)
        curr_in = in_r + in_strides[9];
        LDR_256_D(curr_in, v_in_dc_nyq_stride, bv_in4, is_contiguous_in_dc_nyq);

        bv_s1 = _mm256_add_pd(bv_in0, bv_in2);
        bv_s2 = _mm256_sub_pd(bv_in2, bv_in0);
        bv_t1 = _mm256_mul_pd(v_CRTM_5_1, bv_s2);
        bv_t2 = _mm256_mul_pd(v_CRTM_5_4, bv_s1);
        bv_s3 = _mm256_sub_pd(bv_in4, bv_t2);
        bv_s4 = _mm256_add_pd(bv_s3, bv_t1);
        bv_s5 = _mm256_sub_pd(bv_s3, bv_t1);

        bv_t3 = _mm256_mul_pd(v_CRTM_5_3, bv_in1);
        bv_t4 = _mm256_mul_pd(v_CRTM_5_2, bv_in3);
        bv_t5 = _mm256_mul_pd(v_CRTM_5_2, bv_in1);
        bv_t6 = _mm256_mul_pd(v_CRTM_5_3, bv_in3);
        bv_s6 = _mm256_add_pd(bv_t3, bv_t4);

        bv_s7 = _mm256_sub_pd(bv_t6, bv_t5);
        bv_t7 = _mm256_mul_pd(v_CRTM_5_5, bv_s1);
                                        ...
                                        FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft5avx256_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft5avx256_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft5avx256_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft5avx256_fp64_bwd;
        }
        else
        {
            return NULL;
