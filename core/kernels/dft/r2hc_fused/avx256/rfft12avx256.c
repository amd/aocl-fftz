...
/** @file rfft12avx256.c
 *
 *  @brief Radix-12 r2hc_fused Real-FFT kernel with AVX-256 operations using
 *  x86 SIMD intrinsics.
 *
...
static FFTZ_VOID r2hcf_rfft12avx256_fp32_fwd(FFTZ_VOID *in_real,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m256 v_CRTM_12_3 = _mm256_broadcast_ss(&CRTM_12_3);
    __m256 v_CRTM_12_4 = _mm256_broadcast_ss(&CRTM_12_4);
    __m256 v_CRTM_12_5 = _mm256_broadcast_ss(&CRTM_12_5);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        STR_256_S(curr_out, v_out_dc_nyq_stride, v_out23, is_contiguous_out_dc_nyq);

        av_t1 = _mm256_mul_ps(v_CRTM_12_4, av_s16);
        av_t2 = _mm256_mul_ps(v_CRTM_12_4, av_s18);
        ...
        av_t3 = _mm256_mul_ps(v_CRTM_12_3, av_s14);
        av_t4 = _mm256_mul_ps(v_CRTM_12_4, av_s21);
        av_t5 = _mm256_mul_ps(v_CRTM_12_4, av_s22);
        av_t6 = _mm256_mul_ps(v_CRTM_12_3, av_s26);
        ...
        v_out8 = _mm256_mul_ps(v_CRTM_12_3, av_s27);
        ...
        v_out16 = _mm256_mul_ps(v_CRTM_12_3, av_s28);
        ...
        bv_t1 = _mm256_mul_ps(v_CRTM_12_5, bv_s17);
        bv_t2 = _mm256_mul_ps(v_CRTM_12_5, bv_s18);
        ...
        bv_t3 = _mm256_mul_ps(v_CRTM_12_1, bv_s13);
        bv_t4 = _mm256_mul_ps(v_CRTM_12_2, bv_s14);
        bv_t5 = _mm256_mul_ps(v_CRTM_12_1, bv_s15);
        bv_t6 = _mm256_mul_ps(v_CRTM_12_2, bv_s16);

        bv_t7 = _mm256_mul_ps(v_CRTM_12_4, bv_s5);
        bv_t8 = _mm256_mul_ps(v_CRTM_12_3, bv_s6);
        bv_t9 = _mm256_mul_ps(v_CRTM_12_3, bv_s7);
        bv_t10 = _mm256_mul_ps(v_CRTM_12_4, bv_s8);
        bv_t11 = _mm256_mul_ps(v_CRTM_12_5, bv_s9);
        bv_t12 = _mm256_mul_ps(v_CRTM_12_5, bv_s10);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        __m128 v128_CRTM_12_1 = _mm256_castps256_ps128(v_CRTM_12_1);
        __m128 v128_CRTM_12_2 = _mm256_castps256_ps128(v_CRTM_12_2);
        __m128 v128_CRTM_12_3 = _mm256_castps256_ps128(v_CRTM_12_3);
        __m128 v128_CRTM_12_4 = _mm256_castps256_ps128(v_CRTM_12_4);
        __m128 v128_CRTM_12_5 = _mm256_castps256_ps128(v_CRTM_12_5);
        ...
        curr_out = out_r + out_strides[23];
        STR_128_S(curr_out, v_out_dc_nyq_stride, v_out23, is_contiguous_out_dc_nyq);
    ...
    if (remaining_sets & 2)
    {
        ...
        v_out23 = _mm_sub_ps(av_s20, av_s22);
        curr_out = out_r + out_strides[23];
        STHR_128_S(curr_out, v_out_dc_nyq_stride, v_out23);
    ...
    if (remaining_sets & 1)
    {
        ...
        a_in7 = in_r[in_strides[14]];     // Input point 15: x(14)
        a_in8 = in_r[in_strides[16]];     // Input point 17: x(16)
        a_in9 = in_r[in_strides[18]];     // Input point 19: x(18)
        a_in10 = in_r[in_strides[20]];    // Input point 21: x(20)
        a_in11 = in_r[in_strides[22]];    // Input point 23: x(22)
        ...
        *out_r = a_s21 + a_s19;                          // Output pt 1: X(0)
        out_cp[out_strides[3]]  = a_s23 + a_t3;           // Output pt 4: X(3)
        out_cp[out_strides[4]]  = a_s24 + a_t6;           // Output pt 5: X(4)
        out_cp[out_strides[7]]  = a_t5 + a_s20;           // Output pt 8: X(7)
        out_cp[out_strides[8]]  = CRTM_12_3 * a_s27;      // Output pt 9: X(8)
        out_cp[out_strides[11]] = a_s6 - a_s16;           // Output pt 12: X(11)
        out_cp[out_strides[12]] = a_s18 - a_s12;          // Output pt 13: X(12)
        out_cp[out_strides[15]] = a_s19 - a_t4;           // Output pt 16: X(15)
        out_cp[out_strides[16]] = CRTM_12_3 * a_s28;      // Output pt 17: X(16)
        out_cp[out_strides[19]] = a_s23 - a_t3;           // Output pt 20: X(19)
        out_cp[out_strides[20]] = a_s24 - a_t6;           // Output pt 21: X(20)
        out_r[out_strides[23]] = a_s20 - a_s22;          // Output pt 24: X(23)
        ...
        b_in7  = in_r[in_strides[15]];   // Input point 16: x(15)
        b_in8  = in_r[in_strides[17]];   // Input point 18: x(17)
        b_in9  = in_r[in_strides[19]];   // Input point 20: x(19)
        b_in10 = in_r[in_strides[21]];   // Input point 22: x(21)
        b_in11 = in_r[in_strides[23]];   // Input point 24: x(23)
        ...
        out_cp[out_strides[1]]  = b_s27 + b_s23;      // Output pt 2: X(1)
        out_cp[out_strides[2]]  = -(b_s29 + b_s25);   // Output pt 3: X(2)
        out_cp[out_strides[5]]  = b_s11 + b_t2;       // Output pt 6: X(5)
        out_cp[out_strides[6]]  = b_t1 + b_s12;       // Output pt 7: X(6)
        out_cp[out_strides[9]]  = b_s28 - b_s24;      // Output pt 10: X(9)
        out_cp[out_strides[10]] = b_s26 + b_s30;      // Output pt 11: X(10)
        out_cp[out_strides[13]] = b_s27 - b_s23;      // Output pt 14: X(13)
        out_cp[out_strides[14]] = b_s29 - b_s25;      // Output pt 15: X(14)
        out_cp[out_strides[17]] = b_s11 - b_t2;       // Output pt 18: X(17)
        out_cp[out_strides[18]] = b_t1 - b_s12;       // Output pt 19: X(18)
        out_cp[out_strides[21]] = b_s28 + b_s24;      // Output pt 22: X(21)
        out_cp[out_strides[22]] = b_s26 - b_s30;      // Output pt 23: X(22)
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hcf_rfft12avx256_fp32_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 24: x(23)
        curr_in = in_r + in_strides[23];
        LDR_256_S(curr_in, v_in_dc_nyq_stride, av_in11, is_contiguous_in_dc_nyq);
        ...
        av_t1 = _mm256_mul_ps(v_CRTM_12_5, av_in5);
        av_t2 = _mm256_mul_ps(v_CRTM_12_5, av_in6);

        av_s11 = _mm256_add_ps(av_s3, av_s5);
        av_s12 = _mm256_add_ps(av_s1, av_t1);
        av_s13 = _mm256_sub_ps(av_s1, av_t1);
        av_t3 = _mm256_mul_ps(v_CRTM_12_5, av_s11);
        // Output pt 1: X(0)
        ...
        av_t4 = _mm256_mul_ps(v_CRTM_12_3, av_s14);
        av_t5 = _mm256_mul_ps(v_CRTM_12_3, av_s15);

        av_s16 = _mm256_add_ps(av_s10, av_s8);
        av_s17 = _mm256_sub_ps(av_s10, av_s8);
        av_t6 = _mm256_mul_ps(v_CRTM_12_3, av_s16);
        av_t7 = _mm256_mul_ps(v_CRTM_12_3, av_s17);

        av_s18 = _mm256_add_ps(av_s6, av_s9);
        av_s19 = _mm256_sub_ps(av_s6, av_s9);
        av_s20 = _mm256_sub_ps(av_s3, av_s5);
        av_t8 = _mm256_mul_ps(v_CRTM_12_5, av_s18);
        av_t9 = _mm256_mul_ps(v_CRTM_12_5, av_s19);
        av_t10 = _mm256_mul_ps(v_CRTM_12_5, av_s20);
        // Output pt 13: X(12)
        ...
        v_out1 = _mm256_mul_ps(v_CRTM_12_5, bv_s15);
        ...
        bv_t1 = _mm256_mul_ps(v_CRTM_12_5, bv_s3);
        bv_t2 = _mm256_mul_ps(v_CRTM_12_5, bv_s12);
        bv_t3 = _mm256_mul_ps(v_CRTM_12_3, bv_s14);
        bv_t4 = _mm256_mul_ps(v_CRTM_12_3, bv_s17);
        ...
        v_out13 = _mm256_mul_ps(v_CRTM_12_5, bv_s20);
        ...
        bv_t5 = _mm256_mul_ps(v_CRTM_12_1, bv_s21);
        bv_t6 = _mm256_mul_ps(v_CRTM_12_2, bv_s21);
        bv_t7 = _mm256_mul_ps(v_CRTM_12_4, bv_s21);

        bv_t8 = _mm256_mul_ps(v_CRTM_12_1, bv_s22);
        bv_t9 = _mm256_mul_ps(v_CRTM_12_2, bv_s22);
        bv_t10 = _mm256_mul_ps(v_CRTM_12_4, bv_s22);

        bv_t17 = _mm256_mul_ps(v_CRTM_12_1, bv_s23);
        bv_t16 = _mm256_mul_ps(v_CRTM_12_2, bv_s23);
        bv_t18 = _mm256_mul_ps(v_CRTM_12_4, bv_s23);
        // Output pt 6: X(5)
        ...
        bv_t11 = _mm256_mul_ps(v_CRTM_12_1, bv_s24);
        bv_t12 = _mm256_mul_ps(v_CRTM_12_2, bv_s24);
        bv_t13 = _mm256_mul_ps(v_CRTM_12_4, bv_s24);

        bv_t14 = _mm256_mul_ps(v_CRTM_12_4, bv_s25);
        bv_t15 = _mm256_mul_ps(v_CRTM_12_4, bv_s26);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_S)
    {
        ...
        // Input point 24: x(23)
        curr_in = in_r + in_strides[23];
        LDR_128_S(curr_in, v_in_dc_nyq_stride, av_in11, is_contiguous_in_dc_nyq);
    ...
    if (remaining_sets & 2)
    {
        ...
        // Input point 24: x(23)
        curr_in = in_r + in_strides[23];
        LDHR_128_S(curr_in, v_in_dc_nyq_stride, av_in11);
    ...
    if (remaining_sets & 1)
    {
        ...
        a_in7 = in_cp[in_strides[15]];   // Input point 16: X(15)
        a_in8 = in_cp[in_strides[16]];   // Input point 18: X(16)
        a_in9 = in_cp[in_strides[19]];   // Input point 20: X(19)
        a_in10 = in_cp[in_strides[20]];  // Input point 21: X(20)
        a_in11 = in_r[in_strides[23]];  // Input point 24: X(23)
        ...
        *out_r = a_s12 + a_t3;                    // Output pt 1: x(0)
        out_r[out_strides[2]]  = a_t5 + a_s23;    // Output pt 2: x(2)
        out_r[out_strides[4]]  = a_t7 + a_s26;    // Output pt 3: x(4)
        out_r[out_strides[6]]  = a_s22 - a_t8;    // Output pt 7: x(6)
        out_r[out_strides[8]]  = a_s25 + a_t6;    // Output pt 9: x(8)
        out_r[out_strides[10]] = a_s23 - a_t5;    // Output pt 11: x(10)
        out_r[out_strides[12]] = a_s13 - a_t10;   // Output pt 13: x(12)
        out_r[out_strides[14]] = a_s24 - a_t4;    // Output pt 15: x(14)
        out_r[out_strides[16]] = a_s25 - a_t6;    // Output pt 17: x(16)
        out_r[out_strides[18]] = a_s21 - a_t9;    // Output pt 19: x(18)
        out_r[out_strides[20]] = a_s26 - a_t7;    // Output pt 21: x(20)
        out_r[out_strides[22]] = a_s24 + a_t4;    // Output pt 23: x(22)
        ...
        b_in7  = in_cp[in_strides[14]];   // Input point 15: X(14)
        b_in8  = in_cp[in_strides[17]];   // Input point 18: X(17)
        b_in9  = in_cp[in_strides[18]];   // Input point 19: X(18)
        b_in10 = in_cp[in_strides[21]];   // Input point 22: X(21)
        b_in11 = in_cp[in_strides[22]];   // Input point 23: X(22)
        ...
        out_r[out_strides[1]]  = CRTM_12_5 * b_s15;      // Output pt 2: x(1)
        out_r[out_strides[3]]  = b_s27 - b_t18;          // Output pt 4: x(3)
        out_r[out_strides[5]]  = b_t3 + b_s18;           // Output pt 6: x(5)
        out_r[out_strides[7]]  = b_s28 - b_t17;          // Output pt 8: x(7)
        out_r[out_strides[9]]  = b_t4 + b_s19;           // Output pt 10: x(9)
        out_r[out_strides[11]] = b_s29 + b_t18;          // Output pt 12: x(11)
        out_r[out_strides[13]] = CRTM_12_5 * b_s20;      // Output pt 14: x(13)
        out_r[out_strides[15]] = b_t17 - b_s30;          // Output pt 16: x(15)
        out_r[out_strides[17]] = b_t4 - b_s19;           // Output pt 18: x(17)
        out_r[out_strides[19]] = b_s31 - b_t18;          // Output pt 20: x(19)
        out_r[out_strides[21]] = b_s18 - b_t3;           // Output pt 22: x(21)
        out_r[out_strides[23]] = b_s32 - b_t17;          // Output pt 24: x(23)
    }
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Exit");
}

static FFTZ_VOID r2hcf_rfft12avx256_fp64_fwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
    ...
    __m256d v_CRTM_12_3 = _mm256_broadcast_sd(&CRTM_12_3);
    __m256d v_CRTM_12_4 = _mm256_broadcast_sd(&CRTM_12_4);
    __m256d v_CRTM_12_5 = _mm256_broadcast_sd(&CRTM_12_5);
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        curr_out = out_r + out_strides[23];
        STR_256_D(curr_out, v_out_dc_nyq_stride, v_out23, is_contiguous_out_dc_nyq);

        av_t1 = _mm256_mul_pd(v_CRTM_12_4, av_s16);
        av_t2 = _mm256_mul_pd(v_CRTM_12_4, av_s18);
        ...
        av_t3 = _mm256_mul_pd(v_CRTM_12_3, av_s14);
        av_t4 = _mm256_mul_pd(v_CRTM_12_4, av_s21);
        av_t5 = _mm256_mul_pd(v_CRTM_12_4, av_s22);
        av_t6 = _mm256_mul_pd(v_CRTM_12_3, av_s26);
        ...
        bv_t1 = _mm256_mul_pd(v_CRTM_12_5, bv_s17);
        bv_t2 = _mm256_mul_pd(v_CRTM_12_5, bv_s18);
        // Output pt 6: X(5) & Output pt 7: X(6)
        ...
        bv_t3 = _mm256_mul_pd(v_CRTM_12_1, bv_s13);
        bv_t4 = _mm256_mul_pd(v_CRTM_12_2, bv_s14);
        bv_t5 = _mm256_mul_pd(v_CRTM_12_1, bv_s15);
        bv_t6 = _mm256_mul_pd(v_CRTM_12_2, bv_s16);

        bv_t7 = _mm256_mul_pd(v_CRTM_12_4, bv_s5);
        bv_t8 = _mm256_mul_pd(v_CRTM_12_3, bv_s6);
        bv_t9 = _mm256_mul_pd(v_CRTM_12_3, bv_s7);
        bv_t10 = _mm256_mul_pd(v_CRTM_12_4, bv_s8);
        bv_t11 = _mm256_mul_pd(v_CRTM_12_5, bv_s9);
        bv_t12 = _mm256_mul_pd(v_CRTM_12_5, bv_s10);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        __m128d v128_CRTM_12_1 = _mm256_castpd256_pd128(v_CRTM_12_1);
        __m128d v128_CRTM_12_2 = _mm256_castpd256_pd128(v_CRTM_12_2);
        __m128d v128_CRTM_12_3 = _mm256_castpd256_pd128(v_CRTM_12_3);
        __m128d v128_CRTM_12_4 = _mm256_castpd256_pd128(v_CRTM_12_4);
        __m128d v128_CRTM_12_5 = _mm256_castpd256_pd128(v_CRTM_12_5);
        ...
        curr_out = out_r + out_strides[23];
        STR_128_D(curr_out, v_out_dc_nyq_stride, v_out23, is_contiguous_out_dc_nyq);
...
static FFTZ_VOID r2hcf_rfft12avx256_fp64_bwd(FFTZ_VOID *in_real,
                                             FFTZ_VOID *in_complex,
                                             FFTZ_VOID *out_real,
                                             FFTZ_VOID *out_complex,
                                             FFTZ_INTP n,
                                             ...
                                             FFTZ_VOID *twd, FFTZ_UINT8 flag)
 {
    ...
    for (cnt = 0; cnt < N; cnt++)
    {
        ...
        // Input point 24: x(23)
        curr_in = in_r + in_strides[23];
        LDR_256_D(curr_in, v_in_dc_nyq_stride, av_in11, is_contiguous_in_dc_nyq);
        ...
        av_t1 = _mm256_mul_pd(v_CRTM_12_5, av_in5);
        av_t2 = _mm256_mul_pd(v_CRTM_12_5, av_in6);

        av_s11 = _mm256_add_pd(av_s3, av_s5);
        av_s12 = _mm256_add_pd(av_s1, av_t1);
        av_s13 = _mm256_sub_pd(av_s1, av_t1);
        av_t3 = _mm256_mul_pd(v_CRTM_12_5, av_s11);
        // Output pt 1: X(0)
        ...
        av_t4 = _mm256_mul_pd(v_CRTM_12_3, av_s14);
        av_t5 = _mm256_mul_pd(v_CRTM_12_3, av_s15);

        av_s16 = _mm256_add_pd(av_s10, av_s8);
        av_s17 = _mm256_sub_pd(av_s10, av_s8);
        av_t6 = _mm256_mul_pd(v_CRTM_12_3, av_s16);
        av_t7 = _mm256_mul_pd(v_CRTM_12_3, av_s17);

        av_s18 = _mm256_add_pd(av_s6, av_s9);
        av_s19 = _mm256_sub_pd(av_s6, av_s9);
        av_s20 = _mm256_sub_pd(av_s3, av_s5);
        av_t8 = _mm256_mul_pd(v_CRTM_12_5, av_s18);
        av_t9 = _mm256_mul_pd(v_CRTM_12_5, av_s19);
        av_t10 = _mm256_mul_pd(v_CRTM_12_5, av_s20);
        // Output pt 13: X(12)
        curr_out = out_r + out_strides[12];
        ...
        // Output pt 2: X(1)
        curr_out = out_r + out_strides[1];
        v_out1 = _mm256_mul_pd(v_CRTM_12_5, bv_s15);
        ...
        bv_t1 = _mm256_mul_pd(v_CRTM_12_5, bv_s3);
        bv_t2 = _mm256_mul_pd(v_CRTM_12_5, bv_s12);
        bv_t3 = _mm256_mul_pd(v_CRTM_12_3, bv_s14);
        bv_t4 = _mm256_mul_pd(v_CRTM_12_3, bv_s17);
        ...
        // Output pt 14: X(13)
        curr_out = out_r + out_strides[13];
        v_out13 = _mm256_mul_pd(v_CRTM_12_5, bv_s20);
        ...
        bv_t5 = _mm256_mul_pd(v_CRTM_12_1, bv_s21);
        bv_t6 = _mm256_mul_pd(v_CRTM_12_2, bv_s21);
        bv_t7 = _mm256_mul_pd(v_CRTM_12_4, bv_s21);

        bv_t8 = _mm256_mul_pd(v_CRTM_12_1, bv_s22);
        bv_t9 = _mm256_mul_pd(v_CRTM_12_2, bv_s22);
        bv_t10 = _mm256_mul_pd(v_CRTM_12_4, bv_s22);

        bv_t17 = _mm256_mul_pd(v_CRTM_12_1, bv_s23);
        bv_t16 = _mm256_mul_pd(v_CRTM_12_2, bv_s23);
        bv_t18 = _mm256_mul_pd(v_CRTM_12_4, bv_s23);
        // Output pt 6: X(5)
        curr_out = out_r + out_strides[5];
        ...
        bv_t11 = _mm256_mul_pd(v_CRTM_12_1, bv_s24);
        bv_t12 = _mm256_mul_pd(v_CRTM_12_2, bv_s24);
        bv_t13 = _mm256_mul_pd(v_CRTM_12_4, bv_s24);

        bv_t14 = _mm256_mul_pd(v_CRTM_12_4, bv_s25);
        bv_t15 = _mm256_mul_pd(v_CRTM_12_4, bv_s26);
    ...
    if (remaining_sets & NUM_SETS_REAL_128_D)
    {
        ...
        // Input point 24: x(23)
        curr_in = in_r + in_strides[23];
        LDR_128_D(curr_in, v_in_dc_nyq_stride, av_in11, is_contiguous_in_dc_nyq);
                                         ...
                                         FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft12avx256_fp32_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft12avx256_fp64_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return r2hcf_rfft12avx256_fp32_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return r2hcf_rfft12avx256_fp64_bwd;
        }
        else
        {
            return NULL;
