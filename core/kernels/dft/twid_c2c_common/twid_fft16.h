                            ...
                            VOID *twd, UINT8 flag)
{
    ...
    for (count = 0; count < N; count++)
    {
        ...
        LOAD_IN_S(in_h2_r, in_strides, 15, v_in_h2_stride, v_in15, tw, cols,
                  col, load_multi_cols, 0);
        ...
        LOAD_IN_S(in_r, in_strides, 14, v_in_stride, v_in14, tw, cols, col,
                  load_multi_cols, is_contiguous_in);
        LOAD_IN_S(in_r, in_strides, 15, v_in_stride, v_in15, tw, cols, col,
                  load_multi_cols, is_contiguous_in);
#endif
        ...
        STORE_OUT_S(out_h2_r, out_strides, 15, v_out_h2_stride, v_out15, tw,
                    cols, col, load_multi_cols, 0);
#else
        ...
        STORE_OUT_S(out_r, out_strides, 14, v_out_stride, v_out14, tw, cols,
                    col, load_multi_cols, is_contiguous_out);
        STORE_OUT_S(out_r, out_strides, 15, v_out_stride, v_out15, tw, cols,
                    col, load_multi_cols, is_contiguous_out);
#endif
    ...
    if (remaining_sets >= NUM_SETS_256_S)
    {
        ...
        LOAD_IN_256_S(in_h2_r, in_strides, 15, v_in_h2_stride, v_in15, tw, cols,
                      cnt_256, load_multi_cols, 0);
        ...
        LOAD_IN_256_S(in_r, in_strides, 14, v_in_stride, v_in14, tw, cols,
                      cnt_256, load_multi_cols, is_contiguous_in);
        LOAD_IN_256_S(in_r, in_strides, 15, v_in_stride, v_in15, tw, cols,
                      cnt_256, load_multi_cols, is_contiguous_in);
#endif
        ...
        STORE_OUT_256_S(out_h2_r, out_strides, 15, v_out_h2_stride, v_out15, tw,
                        cols, cnt_256, load_multi_cols, 0);
#else
        ...
        STORE_OUT_256_S(out_r, out_strides, 14, v_out_stride, v_out14, tw, cols,
                        cnt_256, load_multi_cols, is_contiguous_out);
        STORE_OUT_256_S(out_r, out_strides, 15, v_out_stride, v_out15, tw, cols,
                        cnt_256, load_multi_cols, is_contiguous_out);
#endif
    ...
    if (remaining_sets >= NUM_SETS_128_S)
    {
        ...
        LOAD_IN_128_S(in_h2_r, in_strides, 15, v_in_h2_stride, v_in15, tw, cols,
                      cnt_128, load_multi_cols, 0);
        ...
        LOAD_IN_128_S(in_r, in_strides, 14, v_in_stride, v_in14, tw, cols,
                      cnt_128, load_multi_cols, is_contiguous_in);
        LOAD_IN_128_S(in_r, in_strides, 15, v_in_stride, v_in15, tw, cols,
                      cnt_128, load_multi_cols, is_contiguous_in);
#endif
        ...
        STORE_OUT_128_S(out_h2_r, out_strides, 15, v_out_h2_stride, v_out15, tw,
                        cols, cnt_128, load_multi_cols, 0);
#else
        ...
        STORE_OUT_128_S(out_r, out_strides, 14, v_out_stride, v_out14, tw, cols,
                        cnt_128, load_multi_cols, is_contiguous_out);
        STORE_OUT_128_S(out_r, out_strides, 15, v_out_stride, v_out15, tw, cols,
                        cnt_128, load_multi_cols, is_contiguous_out);
#endif
    ...
    if (remaining_sets & 1)
    {
        ...
        LOAD_IN_64_S(in_h2_r, in_strides, 14, v_in14, tw, cols, cnt_128_low,
                     load_multi_cols, 0);
        v_in14 = IN_H2_128_S(v_in14);
        LOAD_IN_64_S(in_h2_r, in_strides, 15, v_in15, tw, cols, cnt_128_low,
                     load_multi_cols, 0);
        v_in15 = IN_H2_128_S(v_in15);
#else
        ...
        LOAD_IN_64_S(in_r, in_strides, 14, v_in14, tw, cols, cnt_128_low,
                     load_multi_cols, is_contiguous_in);
        LOAD_IN_64_S(in_r, in_strides, 15, v_in15, tw, cols, cnt_128_low,
                     load_multi_cols, is_contiguous_in);
#endif
        ...
        STORE_OUT_64_S(out_h2_r, out_strides, 14, v_out14, tw, cols,
                       cnt_128_low, load_multi_cols, 0);
        v_out15 = OUT_H2_128_S(v_out15);
        STORE_OUT_64_S(out_h2_r, out_strides, 15, v_out15, tw, cols,
                       cnt_128_low, load_multi_cols, 0);
#else
        ...
        STORE_OUT_64_S(out_r, out_strides, 14, v_out14, tw, cols, cnt_128_low,
                       load_multi_cols, is_contiguous_out);
        STORE_OUT_64_S(out_r, out_strides, 15, v_out15, tw, cols, cnt_128_low,
                       load_multi_cols, is_contiguous_out);
#endif
    }
#endif
                            ...
                            VOID *twd, UINT8 flag)
{
    ...
    for (count = 0; count < N; count++)
    {
        ...
        LOAD_IN_D(in_h2_r, in_strides, 15, v_in_h2_stride, v_in15, tw, cols,
                  col, load_multi_cols, 0);
        ...
        LOAD_IN_D(in_r, in_strides, 14, v_in_stride, v_in14, tw, cols, col,
                  load_multi_cols, is_contiguous_in);
        LOAD_IN_D(in_r, in_strides, 15, v_in_stride, v_in15, tw, cols, col,
                  load_multi_cols, is_contiguous_in);
#endif
        ...
        STORE_OUT_D(out_h2_r, out_strides, 15, v_out_h2_stride, v_out15, tw,
                    cols, col, load_multi_cols, 0);
#else
        ...
        STORE_OUT_D(out_r, out_strides, 14, v_out_stride, v_out14, tw, cols,
                    col, load_multi_cols, is_contiguous_out);
        STORE_OUT_D(out_r, out_strides, 15, v_out_stride, v_out15, tw, cols,
                    col, load_multi_cols, is_contiguous_out);
#endif
    ...
    if (remaining_sets >= NUM_SETS_256_D)
    {
        ...
        LOAD_IN_256_D(in_h2_r, in_strides, 15, v_in_h2_stride, v_in15, tw, cols,
                      cnt_256, load_multi_cols, 0);
        ...
        LOAD_IN_256_D(in_r, in_strides, 14, v_in_stride, v_in14, tw, cols,
                      cnt_256, load_multi_cols, is_contiguous_in);
        LOAD_IN_256_D(in_r, in_strides, 15, v_in_stride, v_in15, tw, cols,
                      cnt_256, load_multi_cols, is_contiguous_in);
#endif
        ...
        STORE_OUT_256_D(out_h2_r, out_strides, 15, v_out_h2_stride, v_out15, tw,
                        cols, cnt_256, load_multi_cols, 0);
#else
        ...
        STORE_OUT_256_D(out_r, out_strides, 14, v_out_stride, v_out14, tw, cols,
                        cnt_256, load_multi_cols, is_contiguous_out);
        STORE_OUT_256_D(out_r, out_strides, 15, v_out_stride, v_out15, tw, cols,
                        cnt_256, load_multi_cols, is_contiguous_out);
#endif
    ...
    if (remaining_sets & 1)
    {
        ...
        LOAD_IN_128_D(in_h2_r, in_strides, 15, /* unused */ 0, v_in15, tw, cols,
                      cnt_128, load_multi_cols, 0);
        ...
        LOAD_IN_128_D(in_r, in_strides, 14, /* unused */ 0, v_in14, tw, cols,
                      cnt_128, load_multi_cols, is_contiguous_in);
        LOAD_IN_128_D(in_r, in_strides, 15, /* unused */ 0, v_in15, tw, cols,
                      cnt_128, load_multi_cols, is_contiguous_in);
#endif
        ...
        STORE_OUT_128_D(out_h2_r, out_strides, 15, /* unused */ 0, v_out15, tw,
                        cols, cnt_128, load_multi_cols, 0);
#else
        ...
        STORE_OUT_128_D(out_r, out_strides, 14, /* unused */ 0, v_out14, tw,
                        cols, cnt_128, load_multi_cols, is_contiguous_out);
        STORE_OUT_128_D(out_r, out_strides, 15, /* unused */ 0, v_out15, tw,
                        cols, cnt_128, load_multi_cols, is_contiguous_out);
#endif
    }
#endif
