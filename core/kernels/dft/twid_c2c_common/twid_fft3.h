                                 ...
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (count = 0; count < N; count++)
    {
        ...
        LOAD_IN_D(in_r, in_strides, 1, v_in_stride, v_in1, tw_ptr,
                  load_multi_cols, is_contiguous_in);
#if defined(KERNEL_VARIANT_C2R)
        LOAD_IN_D(in_h2_r, in_strides, 2, v_in_h2_stride, v_in2, tw_ptr,
                  load_multi_cols, 0);
        v_in2 = IN_H2_D(v_in2);
#else
        ...
        STORE_OUT_D(out_h2_r, out_strides, 2, v_out_h2_stride, v_out2, tw_ptr,
                    load_multi_cols, 0);
#else
    ...
    if (remaining_sets >= NUM_SETS_256_D)
    {
        ...
        LOAD_IN_256_D(in_r, in_strides, 1, v_in_stride, v_in1, tw_ptr,
                      load_multi_cols, is_contiguous_in);
#if defined(KERNEL_VARIANT_C2R)
        LOAD_IN_256_D(in_h2_r, in_strides, 2, v_in_h2_stride, v_in2, tw_ptr,
                      load_multi_cols, 0);
        ...
        STORE_OUT_256_D(out_h2_r, out_strides, 2, v_out_h2_stride, v_out2,
                        tw_ptr, load_multi_cols, 0);
#else
    ...
    if (remaining_sets & 1)
    {
        ...
        LOAD_IN_128_D(in_r, in_strides, 1, 0, v_in1, tw_ptr, load_multi_cols,
                      is_contiguous_in);
#if defined(KERNEL_VARIANT_C2R)
        LOAD_IN_128_D(in_h2_r, in_strides, 2, 0, v_in2, tw_ptr, load_multi_cols,
                      0);
        ...
        STORE_OUT_128_D(out_h2_r, out_strides, 2, 0, v_out2, tw_ptr,
                        load_multi_cols, 0);
#else
