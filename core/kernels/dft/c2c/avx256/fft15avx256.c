...
ops_cycles_t get_ops_cnt_fft15avx256(FFTZ_UINT8 precision, FFTZ_UINT8 direction)
{
...
static FFTZ_VOID fft15avx256fp32(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                 FFTZ_INTP n, aoclfftz_strides_t *strides,
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
    const FFTZ_FLOAT CRTM_15[10] = {
...
static FFTZ_VOID fft15avx256fp64(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                 FFTZ_INTP n, aoclfftz_strides_t *strides,
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
    const FFTZ_DOUBLE CRTM_15[10] = {
        0.55901699437494742410229341718281905886015458990288,
        0.25000000000000000000000000000000000000000000000000,
        0.95105651629515357211643933337938214340569863400000,
        0.58778525229247301629891039327884007596190389052978,
...
kfft_ register_kernel_fft15avx256(FFTZ_UINT8 precision,
