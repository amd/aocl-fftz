...
/** @file fft9avx256.c
 *
 *  @brief Radix-9 FFT kernel with AVX-256 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT radix-9 FFT implementations using AVX-256
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 20, 40, 72, 23, 24},
                                                     {0, 20, 40, 36, 14, 24}};
...
static FFTZ_VOID fft9avx256fp32(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                ...
                                FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m256 v_C1 = _mm256_broadcast_ss(&CRTM_9[0]);
    __m256 v_C2 = _mm256_broadcast_ss(&CRTM_9[1]);
    v_C2 = _mm256_xor_ps(v_C2, _neg_256_f[flag].s);
    __m256 v_C3 = _mm256_broadcast_ss(&CRTM_9[2]);
    v_C3 = _mm256_xor_ps(v_C3, _neg_256_f[flag].s);
    __m256 v_C4 = _mm256_broadcast_ss(&CRTM_9[3]);
    __m256 v_C5 = _mm256_broadcast_ss(&CRTM_9[4]);
    v_C5 = _mm256_xor_ps(v_C5, _neg_256_f[flag].s);
    __m256 v_C6 = _mm256_broadcast_ss(&CRTM_9[5]);
    __m256 v_C7 = _mm256_broadcast_ss(&CRTM_9[6]);
    __m256 v_C8 = _mm256_broadcast_ss(&CRTM_9[7]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        v_tv1 = _mm256_sub_ps(v_in0, _mm256_mul_ps(v_C7, v_av1));
        v_tv2 = _mm256_mul_ps(v_C8, _mm256_sub_ps(v_in3, v_in6));
        ...
        v_tv1 = _mm256_sub_ps(v_in1, _mm256_mul_ps(v_C7, v_av1));
        v_tv2 = _mm256_mul_ps(v_C8, _mm256_sub_ps(v_in4, v_in7));
        v_tv2 = CONJ_256_S(SWAP_RI_256_S(v_tv2));
        ...
        v_tv1 = _mm256_sub_ps(v_in2, _mm256_mul_ps(v_C7, v_av1));
        v_tv2 = _mm256_mul_ps(v_C8, _mm256_sub_ps(v_in5, v_in8));
        v_tv2 = CONJ_256_S(SWAP_RI_256_S(v_tv2));
        ...
        // Output point 4: X[3]
        v_tv1 = _mm256_sub_ps(v_cv1, _mm256_mul_ps(v_C7, v_av1));
        v_tv2 = _mm256_mul_ps(v_C8, _mm256_sub_ps(v_cv4, v_cv7));
        v_tv2 = CONJ_256_S(SWAP_RI_256_S(v_tv2));
        ...
        // Output point 5: X[4]
        v_tv1 = _mm256_sub_ps(v_cv2, _mm256_mul_ps(v_C7, v_av1));
        v_tv2 = _mm256_mul_ps(v_C8, _mm256_sub_ps(v_cv5, v_cv8));
        v_tv2 = CONJ_256_S(SWAP_RI_256_S(v_tv2));
        ...
        // Output point 6: X[5]
        v_tv1 = _mm256_sub_ps(v_cv3, _mm256_mul_ps(v_C7, v_av1));
        v_tv2 = _mm256_mul_ps(v_C8, _mm256_sub_ps(v_cv6, v_cv9));
        v_tv2 = CONJ_256_S(SWAP_RI_256_S(v_tv2));
...
static FFTZ_VOID fft9avx256fp64(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                FFTZ_INTP n, aoclfftz_strides_t *strides,
                                FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m256d v_C1 = _mm256_broadcast_sd(&CRTM_9[0]);
    __m256d v_C2 = _mm256_broadcast_sd(&CRTM_9[1]);
    v_C2 = _mm256_xor_pd(v_C2, _neg_256_d[flag].d);
    __m256d v_C3 = _mm256_broadcast_sd(&CRTM_9[2]);
    v_C3 = _mm256_xor_pd(v_C3, _neg_256_d[flag].d);
    __m256d v_C4 = _mm256_broadcast_sd(&CRTM_9[3]);
    __m256d v_C5 = _mm256_broadcast_sd(&CRTM_9[4]);
    v_C5 = _mm256_xor_pd(v_C5, _neg_256_d[flag].d);
    __m256d v_C6 = _mm256_broadcast_sd(&CRTM_9[5]);
    __m256d v_C7 = _mm256_broadcast_sd(&CRTM_9[6]);
    __m256d v_C8 = _mm256_broadcast_sd(&CRTM_9[7]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        v_tv1 = _mm256_sub_pd(v_in0, _mm256_mul_pd(v_C7, v_av1));
        v_tv2 = _mm256_mul_pd(v_C8, _mm256_sub_pd(v_in3, v_in6));
        ...
        v_tv1 = _mm256_sub_pd(v_in1, _mm256_mul_pd(v_C7, v_av1));
        v_tv2 = _mm256_mul_pd(v_C8, _mm256_sub_pd(v_in4, v_in7));
        v_tv2 = CONJ_256_D(SWAP_RI_256_D(v_tv2));
        ...
        v_tv1 = _mm256_sub_pd(v_in2, _mm256_mul_pd(v_C7, v_av1));
        v_tv2 = _mm256_mul_pd(v_C8, _mm256_sub_pd(v_in5, v_in8));
        v_tv2 = CONJ_256_D(SWAP_RI_256_D(v_tv2));
        ...
        v_tv1 = _mm256_sub_pd(v_cv1, _mm256_mul_pd(v_C7, v_av1));
        v_tv2 = _mm256_mul_pd(v_C8, _mm256_sub_pd(v_cv4, v_cv7));
        v_tv2 = CONJ_256_D(SWAP_RI_256_D(v_tv2));
        ...
        v_tv1 = _mm256_sub_pd(v_cv2, _mm256_mul_pd(v_C7, v_av1));
        v_tv2 = _mm256_mul_pd(v_C8, _mm256_sub_pd(v_cv5, v_cv8));
        v_tv2 = CONJ_256_D(SWAP_RI_256_D(v_tv2));
        ...
        v_tv1 = _mm256_sub_pd(v_cv3, _mm256_mul_pd(v_C7, v_av1));
        v_tv2 = _mm256_mul_pd(v_C8, _mm256_sub_pd(v_cv6, v_cv9));
        v_tv2 = CONJ_256_D(SWAP_RI_256_D(v_tv2));
...
kfft_ register_kernel_fft9avx256(FFTZ_UINT8 precision,
