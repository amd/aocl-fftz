...
/** @file fft12avx256.c
 *
 *  @brief Radix-12 FFT kernel with avx256 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT radix-12 FFT implementations using avx256
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 10, 48, 96, 17, 30},
                                                     {0, 10, 48, 48,  5, 30}};

ops_cycles_t get_ops_cnt_fft12avx256(FFTZ_UINT8 precision, FFTZ_UINT8 direction)
{
...
static FFTZ_VOID fft12avx256fp32(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                 FFTZ_INTP n, aoclfftz_strides_t *strides,
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
    const FFTZ_FLOAT CRTM_12[5] = {
    ...
    __m256 v_C1 = _mm256_broadcast_ss(&CRTM_12[0]);
    __m256 v_C2 = _mm256_broadcast_ss(&CRTM_12[1]);
    __m256 v_C3 = _mm256_broadcast_ss(&CRTM_12[2]);
    v_C3 = _mm256_xor_ps(v_C3, _neg_256_f[flag].s);
    __m256 v_C4 = _mm256_broadcast_ss(&CRTM_12[3]);
    v_C4 = _mm256_xor_ps(v_C4, _neg_256_f[flag].s);
    __m256 v_C5 = _mm256_broadcast_ss(&CRTM_12[4]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        v_tv1 = _mm256_mul_ps(v_C3, v_cv7);
        ...
        v_tv1 = _mm256_mul_ps(v_C2, v_cv6);
        ...
        v_tv2 = _mm256_mul_ps(v_C4, v_cv6);
        ...
        v_tv1 = _mm256_mul_ps(v_C2, v_cv5);
...
static FFTZ_VOID fft12avx256fp64(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                 FFTZ_INTP n, aoclfftz_strides_t *strides,
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
    const FFTZ_DOUBLE CRTM_12[5] = {
        0.86602540378443864676372317075293618347140262700000,
        0.50000000000000000000000000000000000000000000000000,
        1.00000000000000000000000000000000000000000000000000,
        0.86602540378443864676372317075293618347140262700000,
    ...
    __m256d v_C1 = _mm256_broadcast_sd(&CRTM_12[0]);
    __m256d v_C2 = _mm256_broadcast_sd(&CRTM_12[1]);
    __m256d v_C3 = _mm256_broadcast_sd(&CRTM_12[2]);
    v_C3 = _mm256_xor_pd(v_C3, _neg_256_d[flag].d);
    __m256d v_C4 = _mm256_broadcast_sd(&CRTM_12[3]);
    v_C4 = _mm256_xor_pd(v_C4, _neg_256_d[flag].d);
    __m256d v_C5 = _mm256_broadcast_sd(&CRTM_12[4]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        v_tv1 = _mm256_mul_pd(v_C3, v_cv7);
        ...
        v_tv1 = _mm256_mul_pd(v_C2, v_cv6);
        ...
        v_tv2 = _mm256_mul_pd(v_C4, v_cv6);
        ...
        v_tv1 = _mm256_mul_pd(v_C2, v_cv5);
...
kfft_ register_kernel_fft12avx256(FFTZ_UINT8 precision,
                                  FFTZ_UINT8 direction /* unused */)
{
    if (precision == DT_FLOAT)
    {
        return fft12avx256fp32;
    }
    else if (precision == DT_DOUBLE)
    {
        return fft12avx256fp64;
    }
    else
    {
        return NULL;
