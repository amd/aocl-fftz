...
/** @file fft13avx256.c
 *
 *  @brief Radix-13 FFT kernel with avx256 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT radix-13 FFT implementations using avx256
                     ...
                     VOID *twd, UINT8 flag)
{
    ...
    for (count = 0; count < N; count++)
    {
        ...
        v_tv9  = _mm256_mul_ps(v_C4, v_cv16);
        v_tv10 = _mm256_mul_ps(v_C3, v_cv15);

        // use xor insead of multipling 1.0/-1.0
        v_tv11 = _mm256_xor_ps(v_ZERO, v_av12);
        v_cv19 = _mm256_add_ps(v_tv9, v_tv11);
        v_cv20 = _mm256_add_ps(v_cv19, v_tv10);

        v_tv12 = _mm256_mul_ps(v_C2, v_cv17);
        v_tv13 = _mm256_mul_ps(v_C1, v_cv18);
        v_cv21 = _mm256_add_ps(v_av7, v_tv12);
        v_cv22 = _mm256_add_ps(v_cv21, v_tv13);

        v_tv14 = _mm256_mul_ps(v_DG2, v_cv20);
        v_tv15 = _mm256_mul_ps(v_DG3, v_cv22);
        v_t4   = _mm256_add_ps(v_tv14, v_tv15);
        v_t4   = CONJ_256_S(SWAP_RI_256_S(v_t4));

        v_tv14 = _mm256_mul_ps(v_DG3, v_cv20);
        v_tv15 = _mm256_mul_ps(v_DG2, v_cv22);
        ...
        v_tv16 = _mm256_mul_ps(v_DG10, v_cv23);
        v_tv17 = _mm256_mul_ps(v_DG11, v_cv24);
        v_t5   = _mm256_add_ps(v_tv16, v_tv17);
        v_t5   = SWAP_RI_256_S(CONJ_256_S(v_t5));

        v_tv16 = _mm256_mul_ps(v_DG11, v_cv23);
        v_tv17 = _mm256_mul_ps(v_DG10, v_cv24);
        ...
        v_tv18 = _mm256_mul_ps(v_C9, v_cv25);
        v_tv19 = _mm256_mul_ps(v_DG7, v_cv26);
        v_t6   = _mm256_add_ps(v_tv18, v_tv19);
        v_t6   = CONJ_256_S(SWAP_RI_256_S(v_t6));

        v_tv18 = _mm256_mul_ps(v_C10, v_cv25);
        v_tv19 = _mm256_mul_ps(v_DG6, v_cv26);
        ...
        // use xor insead of multipling 1.0/-1.0
        v_tv20 = _mm256_xor_ps(v_ZERO, v_av18);
        v_tv21 = _mm256_xor_ps(v_ZERO, v_t12);
        ...
        v_tv26 = _mm256_mul_ps(v_C2, v_av17);
        v_cv36 = _mm256_add_ps(v_tv26, v_t7);
        v_av21 = _mm256_sub_ps(v_t4, v_t5);
        v_tv27 = _mm256_mul_ps(v_C1, v_av21);
        v_tv28 = _mm256_mul_ps(v_C4, v_av18);
        v_av22 = _mm256_add_ps(v_t8, v_t9);
        v_tv29 = _mm256_mul_ps(v_C3, v_av22);
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            TRANSPOSE_ST4_256_S(curr_out, v_out_stride, v_out8, v_out9, v_out10,
                                v_out11);
            curr_out = curr_out + NUM_SETS_256_S * DATA_STRIDE;
            SCATTER4_256_S_STRIDED(curr_out, v_out_stride, v_out12);
        }
        else
        {
    ...
    if (remaining_sets >= NUM_SETS_128_S)
    {
        ...
        __m128 v_D1  = _mm256_castps256_ps128(v_DG1);
        __m128 v_D2  = _mm256_castps256_ps128(v_DG2);
        __m128 v_D3  = _mm256_castps256_ps128(v_DG3);
        __m128 v_D4  = _mm256_castps256_ps128(v_DG4);
        __m128 v_D5  = _mm256_castps256_ps128(v_DG5);
        __m128 v_D6  = _mm256_castps256_ps128(v_DG6);
        __m128 v_D7  = _mm256_castps256_ps128(v_DG7);
        __m128 v_D8  = _mm256_castps256_ps128(v_DG8);
        __m128 v_D9  = _mm256_castps256_ps128(v_DG9);
        __m128 v_D10 = _mm256_castps256_ps128(v_DG10);
        __m128 v_D11 = _mm256_castps256_ps128(v_DG11);
        __m128 v_D12 = _mm256_castps256_ps128(v_DG12);

        __m128 v_ZERO_128 = _mm256_castps256_ps128(v_ZERO);
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            curr_out = curr_out + NUM_SETS_128_S * DATA_STRIDE;
            SCATTER2_128_S_STRIDED(curr_out, v_out_stride, v_out12);
        }
        else
        {
                     ...
                     VOID *twd, UINT8 flag)
{
    ...
    for (count = 0; count < N; count++)
    {
        ...
        v_tv9  = _mm256_mul_pd(v_C4, v_cv16);
        v_tv10 = _mm256_mul_pd(v_C3, v_cv15);

        // use xor insead of multipling 1.0/-1.0
        v_tv11 = _mm256_xor_pd(v_ZERO, v_av12);
        v_cv19 = _mm256_add_pd(v_tv9, v_tv11);
        v_cv20 = _mm256_add_pd(v_cv19, v_tv10);

        v_tv12 = _mm256_mul_pd(v_C2, v_cv17);
        v_tv13 = _mm256_mul_pd(v_C1, v_cv18);
        v_cv21 = _mm256_add_pd(v_av7, v_tv12);
        v_cv22 = _mm256_add_pd(v_cv21, v_tv13);

        v_tv14 = _mm256_mul_pd(v_DG2, v_cv20);
        v_tv15 = _mm256_mul_pd(v_DG3, v_cv22);
        v_t4   = _mm256_add_pd(v_tv14, v_tv15);
        v_t4   = CONJ_256_D(SWAP_RI_256_D(v_t4));

        v_tv14 = _mm256_mul_pd(v_DG3, v_cv20);
        v_tv15 = _mm256_mul_pd(v_DG2, v_cv22);
        ...
        v_tv16 = _mm256_mul_pd(v_DG10, v_cv23);
        v_tv17 = _mm256_mul_pd(v_DG11, v_cv24);
        v_t5   = _mm256_add_pd(v_tv16, v_tv17);
        v_t5   = SWAP_RI_256_D(CONJ_256_D(v_t5));

        v_tv16 = _mm256_mul_pd(v_DG11, v_cv23);
        v_tv17 = _mm256_mul_pd(v_DG10, v_cv24);
        ...
        v_tv18 = _mm256_mul_pd(v_C9, v_cv25);
        v_tv19 = _mm256_mul_pd(v_DG7, v_cv26);
        v_t6   = _mm256_add_pd(v_tv18, v_tv19);
        v_t6   = CONJ_256_D(SWAP_RI_256_D(v_t6));

        v_tv18 = _mm256_mul_pd(v_C10, v_cv25);
        v_tv19 = _mm256_mul_pd(v_DG6, v_cv26);
        ...
        // use xor insead of multipling 1.0/-1.0
        v_tv20 = _mm256_xor_pd(v_ZERO, v_av18);
        v_tv21 = _mm256_xor_pd(v_ZERO, v_t12);
        ...
        v_tv26 = _mm256_mul_pd(v_C2, v_av17);
        v_cv36 = _mm256_add_pd(v_tv26, v_t7);
        v_av21 = _mm256_sub_pd(v_t4, v_t5);
        v_tv27 = _mm256_mul_pd(v_C1, v_av21);
        v_tv28 = _mm256_mul_pd(v_C4, v_av18);
        v_av22 = _mm256_add_pd(v_t8, v_t9);
        v_tv29 = _mm256_mul_pd(v_C3, v_av22);
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            curr_out = curr_out + NUM_SETS_256_D * DATA_STRIDE;
            SCATTER2_256_D_STRIDED(curr_out, v_out_stride, v_out12);
        }
        else
        {
    ...
    if (n & 1)
    {
        ...
        __m128d v_D1  = _mm256_castpd256_pd128(v_DG1);
        __m128d v_D2  = _mm256_castpd256_pd128(v_DG2);
        __m128d v_D3  = _mm256_castpd256_pd128(v_DG3);
        __m128d v_D4  = _mm256_castpd256_pd128(v_DG4);
        __m128d v_D5  = _mm256_castpd256_pd128(v_DG5);
        __m128d v_D6  = _mm256_castpd256_pd128(v_DG6);
        __m128d v_D7  = _mm256_castpd256_pd128(v_DG7);
        __m128d v_D8  = _mm256_castpd256_pd128(v_DG8);
        __m128d v_D9  = _mm256_castpd256_pd128(v_DG9);
        __m128d v_D10 = _mm256_castpd256_pd128(v_DG10);
        __m128d v_D11 = _mm256_castpd256_pd128(v_DG11);
        __m128d v_D12 = _mm256_castpd256_pd128(v_DG12);

        __m128d v_ZERO_128 = _mm256_castpd256_pd128(v_ZERO);
...
kfft_ register_kernel_fft13avx256(UINT8 precision, UINT8 direction /* unused */)
{
    if (precision == DT_FLOAT)
    {
        return fft13avx256fp32;
    }
    else if (precision == DT_DOUBLE)
    {
        return fft13avx256fp64;
    }
    else
    {
        return NULL;
