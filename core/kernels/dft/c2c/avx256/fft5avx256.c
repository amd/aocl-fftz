...
/** @file fft5avx256.c
 *
 *  @brief Radix-5 FFT kernel with AVX-256 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT radix-5 FFT implementations using AVX-256
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 6, 16, 40, 7, 12},
                                                     {0, 6, 16, 20, 2, 12}};
...
static FFTZ_VOID fft5avx256fp32(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                ...
                                FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m256 v_C1 = _mm256_broadcast_ss(&CRTM_5[0]);
    __m256 v_C2 = _mm256_broadcast_ss(&CRTM_5[1]);
    __m256 v_C3 = _mm256_broadcast_ss(&CRTM_5[2]);
    v_C3 = _mm256_xor_ps(v_C3, _neg_256_f[flag].s);
    __m256 v_C4 = _mm256_broadcast_ss(&CRTM_5[3]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        v_tv4 = _mm256_mul_ps(v_C4, v_av4);

        // Output point 1 : X[0]
        v_out0 = _mm256_add_ps(v_in0, v_av5);

        v_tv1 = _mm256_mul_ps(v_C2, v_av5);
        v_tv2 = _mm256_mul_ps(v_C1, v_av6);
        ...
        v_tv3 = _mm256_mul_ps(v_C4, v_av3);
...
static FFTZ_VOID fft5avx256fp64(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                FFTZ_INTP n, aoclfftz_strides_t *strides,
                                FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m256d v_C1 = _mm256_broadcast_sd(&CRTM_5[0]);
    __m256d v_C2 = _mm256_broadcast_sd(&CRTM_5[1]);
    __m256d v_C3 = _mm256_broadcast_sd(&CRTM_5[2]);
    v_C3 = _mm256_xor_pd(v_C3, _neg_256_d[flag].d);
    __m256d v_C4 = _mm256_broadcast_sd(&CRTM_5[3]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        v_tv4 = _mm256_mul_pd(v_C4, v_av4);

        // Output point 1 : X[0]
        v_out0 = _mm256_add_pd(v_in0, v_av5);

        v_tv1 = _mm256_mul_pd(v_C2, v_av5);
        v_tv2 = _mm256_mul_pd(v_C1, v_av6);
        ...
        v_tv3 = _mm256_mul_pd(v_C4, v_av3);
...
kfft_ register_kernel_fft5avx256(FFTZ_UINT8 precision,
