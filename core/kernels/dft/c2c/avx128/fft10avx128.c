...
/** @file fft10avx128.c
 *
 *  @brief Radix-10 FFT kernel with avx128 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT radix-10 FFT implementations using avx128
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 12, 42, 40, 4, 4},
                                                     {0, 12, 42, 20, 4, 4}};

ops_cycles_t get_ops_cnt_fft10avx128(FFTZ_UINT8 precision, FFTZ_UINT8 direction)
{
...
static FFTZ_VOID fft10avx128fp32(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 ...
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128 v_cv1, v_cv2, v_cv3, v_cv4, v_tv1, v_tv2;
    ...
    __m128 v_K1 = _mm_broadcast_ss(&CRTM_10[0]);
    __m128 v_K2 = _mm_broadcast_ss(&CRTM_10[1]);
    v_K2 = _mm_xor_ps(v_K2, _neg_128_f[flag].s);
    __m128 v_K3 = _mm_broadcast_ss(&CRTM_10[2]);
    __m128 v_K4 = _mm_broadcast_ss(&CRTM_10[3]);
...
static FFTZ_VOID fft10avx128fp64(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                 FFTZ_INTP n, aoclfftz_strides_t *strides,
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m128d v_K1 = _mm_set1_pd(CRTM_10[0]);
    __m128d v_K2 = _mm_set1_pd(CRTM_10[1]);
    v_K2 = _mm_xor_pd(v_K2, _neg_128_d[flag].d);
    __m128d v_K3 = _mm_set1_pd(CRTM_10[2]);
    __m128d v_K4 = _mm_set1_pd(CRTM_10[3]);
...
kfft_ register_kernel_fft10avx128(FFTZ_UINT8 precision,
                                  FFTZ_UINT8 direction /* unused */)
{
    if (precision == DT_FLOAT)
    {
        return fft10avx128fp32;
    }
    else if (precision == DT_DOUBLE)
    {
        return fft10avx128fp64;
    }
    else
    {
        return NULL;
