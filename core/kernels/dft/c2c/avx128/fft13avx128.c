...
ops_cycles_t get_ops_cnt_fft13avx128(FFTZ_UINT8 precision, FFTZ_UINT8 direction)
{
...
static FFTZ_VOID fft13avx128fp32(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 ...
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    for (count = 0; count < N; count++)
    {
        ...
        GATHER2_128_S(curr_set, v_in_stride, v_in12, is_contiguous_in);
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            curr_set = curr_set + NUM_SETS_128_S * DATA_STRIDE;
            SCATTER2_128_S_STRIDED(curr_set, v_out_stride, v_out12);
        }
        else
        {
            ...
            SCATTER2_128_S(curr_set, v_out_stride, v_out12, is_contiguous_out);
        }
...
static FFTZ_VOID fft13avx128fp64(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                 FFTZ_INTP n, aoclfftz_strides_t *strides,
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
...
kfft_ register_kernel_fft13avx128(FFTZ_UINT8 precision,
