...
static FFTZ_VOID fft6avx128fp32(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
...
static FFTZ_VOID fft6avx128fp64(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                FFTZ_INTP n, aoclfftz_strides_t *strides,
                                FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
...
kfft_ register_kernel_fft6avx128(FFTZ_UINT8 precision,
