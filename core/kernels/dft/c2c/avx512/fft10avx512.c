...
/** @file fft10avx512.c
 *
 *  @brief Radix-10 FFT kernel with AVX-512 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT radix-10 FFT implementations using AVX-512
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 12, 42, 160, 34, 64},
                                                     {0, 12, 42,  80,  4, 64}};

ops_cycles_t get_ops_cnt_fft10avx512(FFTZ_UINT8 precision, FFTZ_UINT8 direction)
{
...
static FFTZ_VOID fft10avx512fp32(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 ...
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m512 v_C1 = _mm512_set1_ps(CRTM_10[0]);
    __m512 v_C2 = _mm512_set1_ps(CRTM_10[1]);
    v_C2 = _mm512_xor_ps(v_C2, _neg_512_f[flag].s);
    __m512 v_C3 = _mm512_set1_ps(CRTM_10[2]);
    __m512 v_C4 = _mm512_set1_ps(CRTM_10[3]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        __m512 v_out0, v_out1, v_out2, v_out3, v_out4, v_out5, v_out6, v_out7,
               v_out8;
        __m512 v_out9, v_cv1, v_cv2, v_cv3, v_cv4, v_tv1, v_tv2;
        ...
        v_av2 = _mm512_add_ps(v_in2, v_in8);
        v_av3 = _mm512_add_ps(v_in3, v_in7);
        v_av4 = _mm512_add_ps(v_in4, v_in6);
        v_av5 = _mm512_sub_ps(v_in9, v_in1);
        v_av6 = _mm512_sub_ps(v_in8, v_in2);
        v_av7 = _mm512_sub_ps(v_in7, v_in3);
        v_av8 = _mm512_sub_ps(v_in6, v_in4);

        // Output point 6:X[5]
        v_av9 = _mm512_sub_ps(v_in0, v_in5);
        v_cv1 = _mm512_sub_ps(v_av2, v_av3);
        v_cv2 = _mm512_sub_ps(v_av1, v_av4);
        v_cv3 = _mm512_sub_ps(v_cv1, v_cv2);
        v_out5 = _mm512_add_ps(v_av9, v_cv3);

        // Output point 2:X[1]
        v_cv4 = _mm512_add_ps(v_cv1, v_cv2);
        v_cv1 = _mm512_sub_ps(v_av9, _mm512_mul_ps(v_C3, v_cv3));
        v_tv1 = _mm512_mul_ps(v_C1, v_cv4);
        v_cv2 = _mm512_add_ps(v_cv1, v_tv1);
        v_cv3 = _mm512_add_ps(v_av6, v_av7);
        v_cv4 = _mm512_add_ps(v_av5, v_av8);
        v_tv2 = _mm512_add_ps(_mm512_mul_ps(v_C4, v_cv3),
                              _mm512_mul_ps(v_C2, v_cv4));
        v_tv2 = SWAP_RI_512_S(CONJ_512_S(v_tv2));
        v_out1 = _mm512_add_ps(v_cv2, v_tv2);
        // Output point 10:X[9]
        v_out9 = _mm512_sub_ps(v_cv2, v_tv2);

        // Output point 4:X[3]
        v_cv2 = _mm512_sub_ps(v_cv1, v_tv1);
        v_tv2 = _mm512_sub_ps(_mm512_mul_ps(v_C4, v_cv4),
                              _mm512_mul_ps(v_C2, v_cv3));
        v_tv2 = SWAP_RI_512_S(CONJ_512_S(v_tv2));
        v_out3 = _mm512_add_ps(v_cv2, v_tv2);
        // Output point 8:X[7]
        v_out7 = _mm512_sub_ps(v_cv2, v_tv2);

        // Output point 1:X[0]
        v_av9 = _mm512_add_ps(v_in0, v_in5);
        v_cv1 = _mm512_add_ps(v_av2, v_av3);
        v_cv2 = _mm512_add_ps(v_av1, v_av4);
        v_cv3 = _mm512_add_ps(v_cv2, v_cv1);
        v_out0 = _mm512_add_ps(v_av9, v_cv3);

        // Output point 3:X[2]
        v_cv4 = _mm512_sub_ps(v_cv2, v_cv1);
        v_cv1 = _mm512_sub_ps(v_av9, _mm512_mul_ps(v_C3, v_cv3));
        v_tv1 = _mm512_mul_ps(v_C1, v_cv4);
        v_cv2 = _mm512_add_ps(v_cv1, v_tv1);

        v_cv3 = _mm512_sub_ps(v_av6, v_av7);
        v_cv4 = _mm512_sub_ps(v_av5, v_av8);
        v_tv2 = _mm512_add_ps(_mm512_mul_ps(v_C4, v_cv4),
                              _mm512_mul_ps(v_C2, v_cv3));
        v_tv2 = SWAP_RI_512_S(CONJ_512_S(v_tv2));
        v_out2 = _mm512_add_ps(v_cv2, v_tv2);
        // Output point 9:X[8]
        v_out8 = _mm512_sub_ps(v_cv2, v_tv2);

        // Output point 7:X[6]
        v_cv2 = _mm512_sub_ps(v_cv1, v_tv1);
        v_tv2 = _mm512_sub_ps(_mm512_mul_ps(v_C4, v_cv3),
                              _mm512_mul_ps(v_C2, v_cv4));
        v_tv2 = SWAP_RI_512_S(CONJ_512_S(v_tv2));
        v_out6 = _mm512_add_ps(v_cv2, v_tv2);
        // Output point 5:X[4]
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            TRANSPOSE_ST2_512_S(curr_out, v_out_stride, v_out8, v_out9);
        }
        else
        {
...
static FFTZ_VOID fft10avx512fp64(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                 FFTZ_INTP n, aoclfftz_strides_t *strides,
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m512d v_C1 = _mm512_set1_pd(CRTM_10[0]);
    __m512d v_C2 = _mm512_set1_pd(CRTM_10[1]);
    v_C2 = _mm512_xor_pd(v_C2, _neg_512_d[flag].d);
    __m512d v_C3 = _mm512_set1_pd(CRTM_10[2]);
    __m512d v_C4 = _mm512_set1_pd(CRTM_10[3]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        __m512d v_out0, v_out1, v_out2, v_out3, v_out4, v_out5, v_out6, v_out7,
                v_out8;
        __m512d v_out9, v_cv1, v_cv2, v_cv3, v_cv4, v_tv1, v_tv2;
        ...
        v_av2 = _mm512_add_pd(v_in2, v_in8);
        v_av3 = _mm512_add_pd(v_in3, v_in7);
        v_av4 = _mm512_add_pd(v_in4, v_in6);
        v_av5 = _mm512_sub_pd(v_in9, v_in1);
        v_av6 = _mm512_sub_pd(v_in8, v_in2);
        v_av7 = _mm512_sub_pd(v_in7, v_in3);
        v_av8 = _mm512_sub_pd(v_in6, v_in4);

        // Output point 6:X[5]
        v_av9 = _mm512_sub_pd(v_in0, v_in5);
        v_cv1 = _mm512_sub_pd(v_av2, v_av3);
        v_cv2 = _mm512_sub_pd(v_av1, v_av4);
        v_cv3 = _mm512_sub_pd(v_cv1, v_cv2);
        v_out5 = _mm512_add_pd(v_av9, v_cv3);

        // Output point 2:X[1]
        v_cv4 = _mm512_add_pd(v_cv1, v_cv2);
        v_cv1 = _mm512_sub_pd(v_av9, _mm512_mul_pd(v_C3, v_cv3));
        v_tv1 = _mm512_mul_pd(v_C1, v_cv4);
        v_cv2 = _mm512_add_pd(v_cv1, v_tv1);
        v_cv3 = _mm512_add_pd(v_av6, v_av7);
        v_cv4 = _mm512_add_pd(v_av5, v_av8);
        v_tv2 = _mm512_add_pd(_mm512_mul_pd(v_C4, v_cv3),
                              _mm512_mul_pd(v_C2, v_cv4));
        v_tv2 = SWAP_RI_512_D(CONJ_512_D(v_tv2));
        v_out1 = _mm512_add_pd(v_cv2, v_tv2);
        // Output point 10:X[9]
        v_out9 = _mm512_sub_pd(v_cv2, v_tv2);

        // Output point 4:X[3]
        v_cv2 = _mm512_sub_pd(v_cv1, v_tv1);
        v_tv2 = _mm512_sub_pd(_mm512_mul_pd(v_C4, v_cv4),
                              _mm512_mul_pd(v_C2, v_cv3));
        v_tv2 = SWAP_RI_512_D(CONJ_512_D(v_tv2));
        v_out3 = _mm512_add_pd(v_cv2, v_tv2);
        // Output point 8:X[7]
        v_out7 = _mm512_sub_pd(v_cv2, v_tv2);

        // Output point 1:X[0]
        v_av9 = _mm512_add_pd(v_in0, v_in5);
        v_cv1 = _mm512_add_pd(v_av2, v_av3);
        v_cv2 = _mm512_add_pd(v_av1, v_av4);
        v_cv3 = _mm512_add_pd(v_cv2, v_cv1);
        v_out0 = _mm512_add_pd(v_av9, v_cv3);

        // Output point 3:X[2]
        v_cv4 = _mm512_sub_pd(v_cv2, v_cv1);
        v_cv1 = _mm512_sub_pd(v_av9, _mm512_mul_pd(v_C3, v_cv3));
        v_tv1 = _mm512_mul_pd(v_C1, v_cv4);
        v_cv2 = _mm512_add_pd(v_cv1, v_tv1);

        v_cv3 = _mm512_sub_pd(v_av6, v_av7);
        v_cv4 = _mm512_sub_pd(v_av5, v_av8);
        v_tv2 = _mm512_add_pd(_mm512_mul_pd(v_C4, v_cv4),
                              _mm512_mul_pd(v_C2, v_cv3));
        v_tv2 = SWAP_RI_512_D(CONJ_512_D(v_tv2));
        v_out2 = _mm512_add_pd(v_cv2, v_tv2);
        // Output point 9:X[8]
        v_out8 = _mm512_sub_pd(v_cv2, v_tv2);

        // Output point 7:X[6]
        v_cv2 = _mm512_sub_pd(v_cv1, v_tv1);
        v_tv2 = _mm512_sub_pd(_mm512_mul_pd(v_C4, v_cv3),
                              _mm512_mul_pd(v_C2, v_cv4));
        v_tv2 = SWAP_RI_512_D(CONJ_512_D(v_tv2));
        v_out6 = _mm512_add_pd(v_cv2, v_tv2);
        // Output point 5:X[4]
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            TRANSPOSE_ST4_512_D(curr_out, v_out_stride, v_out4, v_out5, v_out6,
                                v_out7);
            curr_out = curr_out + NUM_SETS_512_D * DATA_STRIDE;
            TRANSPOSE_ST2_512_D(curr_out, v_out_stride, v_out8, v_out9);
        }
        else
        {
...
kfft_ register_kernel_fft10avx512(FFTZ_UINT8 precision,
                                  FFTZ_UINT8 direction /* unused */)
{
    if (precision == DT_FLOAT)
    {
        return fft10avx512fp32;
    }
    else if (precision == DT_DOUBLE)
    {
        return fft10avx512fp64;
    }
    else
    {
        return NULL;
