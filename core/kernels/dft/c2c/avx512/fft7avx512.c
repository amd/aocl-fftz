...
/** @file fft7avx512.c
 *
 *  @brief Radix-7 FFT kernel with AVX-512 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT radix-7 FFT implementations using AVX-512
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 18, 33, 112, 24, 45},
                                                     {0, 18, 33,  56,  3, 45}};
...
static VOID fft7avx512fp32(VOID *in_real, VOID *in_imag, VOID *out_real,
                           VOID *out_imag, INTP n, aoclfftz_strides_t *strides,
                           VOID *twd, UINT8 flag)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
    const FLOAT CRTM_7[6] = {+0.222520933956314404288902564496794759466355569f,
    ...
    __m512 v_C1 = _mm512_set1_ps(CRTM_7[0]);
    __m512 v_C2 = _mm512_set1_ps(CRTM_7[1]);
    __m512 v_C3 = _mm512_set1_ps(CRTM_7[2]);
    __m512 v_C4 = _mm512_set1_ps(CRTM_7[3]);
    v_C4 = _mm512_xor_ps(v_C4, _neg_512_f[flag].s);
    __m512 v_C5 = _mm512_set1_ps(CRTM_7[4]);
    v_C5 = _mm512_xor_ps(v_C5, _neg_512_f[flag].s);
    __m512 v_C6 = _mm512_set1_ps(CRTM_7[5]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        __m512 v_tv1, v_tv2, v_tv3, v_tv4, v_tv5, v_tv6, v_tv7;
        __m512 v_tv8, v_tv9, v_tv10, v_tv11, v_tv12, v_tv13, v_tv14;
        __m512 v_tv16, v_tv17, v_tv18, v_tv19;
        ...
        // common calculations
        v_av1 = _mm512_add_ps(v_in2, v_in5);
        v_av2 = _mm512_sub_ps(v_in2, v_in5);
        v_av3 = _mm512_add_ps(v_in3, v_in4);
        v_av4 = _mm512_sub_ps(v_in3, v_in4);
        v_av5 = _mm512_add_ps(v_in1, v_in6);
        v_av6 = _mm512_sub_ps(v_in1, v_in6);
        v_av7 = _mm512_add_ps(_mm512_add_ps(v_av1, v_av3), v_av5);

        v_tv1 = _mm512_mul_ps(v_av1, v_C1);
        v_tv2 = _mm512_mul_ps(v_av3, v_C1);
        v_tv3 = _mm512_mul_ps(v_av5, v_C1);
        v_tv4 = _mm512_mul_ps(v_av1, v_C2);
        v_tv5 = _mm512_mul_ps(v_av3, v_C2);
        v_tv6 = _mm512_mul_ps(v_av5, v_C2);
        v_tv7 = _mm512_mul_ps(v_av1, v_C3);
        v_tv8 = _mm512_mul_ps(v_av3, v_C3);
        v_tv9 = _mm512_mul_ps(v_av5, v_C3);
        v_tv10 = _mm512_mul_ps(v_av2, v_C4);
        v_tv11 = _mm512_mul_ps(v_av4, v_C4);
        v_tv12 = _mm512_mul_ps(v_av6, v_C4);
        v_tv13 = _mm512_mul_ps(v_av2, v_C5);
        v_tv14 = _mm512_mul_ps(v_av4, v_C5);
        v_tv16 = _mm512_mul_ps(v_av6, v_C5);
        v_tv17 = _mm512_mul_ps(v_av2, v_C6);
        v_tv18 = _mm512_mul_ps(v_av4, v_C6);
        v_tv19 = _mm512_mul_ps(v_av6, v_C6);

        v_cv1 = _mm512_sub_ps(_mm512_add_ps(v_tv1, v_tv5), v_tv9);
        v_cv2 = _mm512_add_ps(_mm512_add_ps(v_tv11, v_tv16), v_tv17);
        v_cv3 = _mm512_sub_ps(_mm512_add_ps(v_tv3, v_tv4), v_tv8);
        v_cv4 = _mm512_sub_ps(_mm512_add_ps(v_tv10, v_tv14), v_tv19);
        v_cv5 = _mm512_sub_ps(_mm512_add_ps(v_tv2, v_tv6), v_tv7);
        v_cv6 = _mm512_add_ps(_mm512_sub_ps(v_tv12, v_tv13), v_tv18);

        v_cv2 = SWAP_RI_512_S(CONJ_512_S(v_cv2));
        v_cv4 = SWAP_RI_512_S(CONJ_512_S(v_cv4));
        v_cv6 = SWAP_RI_512_S(CONJ_512_S(v_cv6));

        // Output point 1:X[0]
        v_out0 = _mm512_add_ps(v_in0, v_av7);
        // Output point 7:X[6]
        v_out6 = _mm512_add_ps(_mm512_sub_ps(v_in0, v_cv1), v_cv2);
        // Output point 2:X[1]
        v_out1 = _mm512_sub_ps(_mm512_sub_ps(v_in0, v_cv1), v_cv2);
        // Output point 3:X[2]
        v_out2 = _mm512_add_ps(_mm512_sub_ps(v_in0, v_cv3), v_cv4);
        // Output point 6:X[5]
        v_out5 = _mm512_sub_ps(_mm512_sub_ps(v_in0, v_cv3), v_cv4);
        // Output point 5:X[4]
        v_out4 = _mm512_add_ps(_mm512_sub_ps(v_in0, v_cv5), v_cv6);
        // Output point 4:X[3]
        v_out3 = _mm512_sub_ps(_mm512_sub_ps(v_in0, v_cv5), v_cv6);
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            SCATTER8_512_S_STRIDED(curr_out, v_out_stride, v_out6);
        }
        else
        {
    ...
    if (remaining_sets >= NUM_SETS_256_S)
    {
        ...
        v_tv1 = _mm256_mul_ps(v_av1, v_K1);
        v_tv2 = _mm256_mul_ps(v_av3, v_K1);
        v_tv3 = _mm256_mul_ps(v_av5, v_K1);
        v_tv4 = _mm256_mul_ps(v_av1, v_K2);
        v_tv5 = _mm256_mul_ps(v_av3, v_K2);
        v_tv6 = _mm256_mul_ps(v_av5, v_K2);
        v_tv7 = _mm256_mul_ps(v_av1, v_K3);
        v_tv8 = _mm256_mul_ps(v_av3, v_K3);
        v_tv9 = _mm256_mul_ps(v_av5, v_K3);
        v_tv10 = _mm256_mul_ps(v_av2, v_K4);
        v_tv11 = _mm256_mul_ps(v_av4, v_K4);
        v_tv12 = _mm256_mul_ps(v_av6, v_K4);
        v_tv13 = _mm256_mul_ps(v_av2, v_K5);
        v_tv14 = _mm256_mul_ps(v_av4, v_K5);
        v_tv16 = _mm256_mul_ps(v_av6, v_K5);
        v_tv17 = _mm256_mul_ps(v_av2, v_K6);
        v_tv18 = _mm256_mul_ps(v_av4, v_K6);
        v_tv19 = _mm256_mul_ps(v_av6, v_K6);
...
static VOID fft7avx512fp64(VOID *in_real, VOID *in_imag, VOID *out_real,
                           VOID *out_imag, INTP n, aoclfftz_strides_t *strides,
                           VOID *twd, UINT8 flag)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
    ...
    __m512d v_C1 = _mm512_set1_pd(CRTM_7[0]);
    __m512d v_C2 = _mm512_set1_pd(CRTM_7[1]);
    __m512d v_C3 = _mm512_set1_pd(CRTM_7[2]);
    __m512d v_C4 = _mm512_set1_pd(CRTM_7[3]);
    v_C4 = _mm512_xor_pd(v_C4, _neg_512_d[flag].d);
    __m512d v_C5 = _mm512_set1_pd(CRTM_7[4]);
    v_C5 = _mm512_xor_pd(v_C5, _neg_512_d[flag].d);
    __m512d v_C6 = _mm512_set1_pd(CRTM_7[5]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        __m512d v_tv1, v_tv2, v_tv3, v_tv4, v_tv5, v_tv6, v_tv7;
        __m512d v_tv8, v_tv9, v_tv10, v_tv11, v_tv12, v_tv13, v_tv14;
        __m512d v_tv16, v_tv17, v_tv18, v_tv19;
        __m512d v_cv1, v_cv2, v_cv3, v_cv4, v_cv5, v_cv6;
        ...
        // common calculations
        v_av1 = _mm512_add_pd(v_in2, v_in5);
        v_av2 = _mm512_sub_pd(v_in2, v_in5);
        v_av3 = _mm512_add_pd(v_in3, v_in4);
        v_av4 = _mm512_sub_pd(v_in3, v_in4);
        v_av5 = _mm512_add_pd(v_in1, v_in6);
        v_av6 = _mm512_sub_pd(v_in1, v_in6);
        v_av7 = _mm512_add_pd(_mm512_add_pd(v_av1, v_av3), v_av5);

        v_tv1 = _mm512_mul_pd(v_av1, v_C1);
        v_tv2 = _mm512_mul_pd(v_av3, v_C1);
        v_tv3 = _mm512_mul_pd(v_av5, v_C1);
        v_tv4 = _mm512_mul_pd(v_av1, v_C2);
        v_tv5 = _mm512_mul_pd(v_av3, v_C2);
        v_tv6 = _mm512_mul_pd(v_av5, v_C2);
        v_tv7 = _mm512_mul_pd(v_av1, v_C3);
        v_tv8 = _mm512_mul_pd(v_av3, v_C3);
        v_tv9 = _mm512_mul_pd(v_av5, v_C3);
        v_tv10 = _mm512_mul_pd(v_av2, v_C4);
        v_tv11 = _mm512_mul_pd(v_av4, v_C4);
        v_tv12 = _mm512_mul_pd(v_av6, v_C4);
        v_tv13 = _mm512_mul_pd(v_av2, v_C5);
        v_tv14 = _mm512_mul_pd(v_av4, v_C5);
        v_tv16 = _mm512_mul_pd(v_av6, v_C5);
        v_tv17 = _mm512_mul_pd(v_av2, v_C6);
        v_tv18 = _mm512_mul_pd(v_av4, v_C6);
        v_tv19 = _mm512_mul_pd(v_av6, v_C6);

        v_cv1 = _mm512_sub_pd(_mm512_add_pd(v_tv1, v_tv5), v_tv9);
        v_cv2 = _mm512_add_pd(_mm512_add_pd(v_tv11, v_tv16), v_tv17);
        v_cv3 = _mm512_sub_pd(_mm512_add_pd(v_tv3, v_tv4), v_tv8);
        v_cv4 = _mm512_sub_pd(_mm512_add_pd(v_tv10, v_tv14), v_tv19);
        v_cv5 = _mm512_sub_pd(_mm512_add_pd(v_tv2, v_tv6), v_tv7);
        v_cv6 = _mm512_add_pd(_mm512_sub_pd(v_tv12, v_tv13), v_tv18);

        v_cv2 = SWAP_RI_512_D(CONJ_512_D(v_cv2));
        v_cv4 = SWAP_RI_512_D(CONJ_512_D(v_cv4));
        v_cv6 = SWAP_RI_512_D(CONJ_512_D(v_cv6));

        // Output point 1:X[0]
        v_out0 = _mm512_add_pd(v_in0, v_av7);
        // Output point 7:X[6]
        v_out6 = _mm512_add_pd(_mm512_sub_pd(v_in0, v_cv1), v_cv2);
        // Output point 2:X[1]
        v_out1 = _mm512_sub_pd(_mm512_sub_pd(v_in0, v_cv1), v_cv2);
        // Output point 3:X[2]
        v_out2 = _mm512_add_pd(_mm512_sub_pd(v_in0, v_cv3), v_cv4);
        // Output point 6:X[5]
        v_out5 = _mm512_sub_pd(_mm512_sub_pd(v_in0, v_cv3), v_cv4);
        // Output point 5:X[4]
        v_out4 = _mm512_add_pd(_mm512_sub_pd(v_in0, v_cv5), v_cv6);
        // Output point 4:X[3]
        v_out3 = _mm512_sub_pd(_mm512_sub_pd(v_in0, v_cv5), v_cv6);
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            curr_out = curr_out + 2 * DATA_STRIDE;
            SCATTER4_512_D_STRIDED(curr_out, v_out_stride, v_out6);
        }
        else
        {
    ...
    if (remaining_sets >= NUM_SETS_256_D)
    {
        ...
        v_tv1 = _mm256_mul_pd(v_av1, v_K1);
        v_tv2 = _mm256_mul_pd(v_av3, v_K1);
        v_tv3 = _mm256_mul_pd(v_av5, v_K1);
        v_tv4 = _mm256_mul_pd(v_av1, v_K2);
        v_tv5 = _mm256_mul_pd(v_av3, v_K2);
        v_tv6 = _mm256_mul_pd(v_av5, v_K2);
        v_tv7 = _mm256_mul_pd(v_av1, v_K3);
        v_tv8 = _mm256_mul_pd(v_av3, v_K3);
        v_tv9 = _mm256_mul_pd(v_av5, v_K3);
        v_tv10 = _mm256_mul_pd(v_av2, v_K4);
        v_tv11 = _mm256_mul_pd(v_av4, v_K4);
        v_tv12 = _mm256_mul_pd(v_av6, v_K4);
        v_tv13 = _mm256_mul_pd(v_av2, v_K5);
        v_tv14 = _mm256_mul_pd(v_av4, v_K5);
        v_tv16 = _mm256_mul_pd(v_av6, v_K5);
        v_tv17 = _mm256_mul_pd(v_av2, v_K6);
        v_tv18 = _mm256_mul_pd(v_av4, v_K6);
        v_tv19 = _mm256_mul_pd(v_av6, v_K6);
...
kfft_ register_kernel_fft7avx512(UINT8 precision, UINT8 direction /* unused */)
{
    if (precision == DT_FLOAT)
    {
        return fft7avx512fp32;
    }
    else if (precision == DT_DOUBLE)
    {
        return fft7avx512fp64;
    }
    else
    {
        return NULL;
