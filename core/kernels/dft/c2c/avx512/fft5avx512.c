...
/** @file fft5avx512.c
 *
 *  @brief Radix-5 FFT kernel with AVX-512 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT radix-5 FFT implementations using AVX-512
                                ...
                                FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m512 v_C3 = _mm512_set1_ps(CRTM_5[2]);
    v_C3 = _mm512_xor_ps(v_C3, _neg_512_f[flag].s);
    __m512 v_C4 = _mm512_set1_ps(CRTM_5[3]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        __m512 v_cv1, v_tv1, v_tv2, v_tv3, v_tv4;
        ...
        v_av2 = _mm512_add_ps(v_in2, v_in3);
        v_av3 = _mm512_sub_ps(v_in1, v_in4);
        v_av4 = _mm512_sub_ps(v_in2, v_in3);
        v_av5 = _mm512_add_ps(v_av1, v_av2);
        v_av6 = _mm512_sub_ps(v_av1, v_av2);
        v_tv3 = _mm512_mul_ps(v_C3, v_av3);
        v_tv4 = _mm512_mul_ps(v_C4, v_av4);

        // Output point 1 : X[0]
        v_out0 = _mm512_add_ps(v_in0, v_av5);

        v_tv1 = _mm512_mul_ps(v_C2, v_av5);
        v_tv2 = _mm512_mul_ps(v_C1, v_av6);
        v_tv1 = _mm512_sub_ps(v_in0, v_tv1);
        v_tv4 = _mm512_add_ps(v_tv3, v_tv4);
        v_tv4 = SWAP_RI_512_S(CONJ_512_S(v_tv4));
        v_cv1 = _mm512_add_ps(v_tv1, v_tv2);

        // Output point 2 : X[1]
        v_out1 = _mm512_sub_ps(v_cv1, v_tv4);
        // Output point 5 : X[4]
        v_out4 = _mm512_add_ps(v_cv1, v_tv4);

        v_tv3 = _mm512_mul_ps(v_C4, v_av3);
        v_tv4 = _mm512_mul_ps(v_C3, v_av4);
        v_tv3 = _mm512_sub_ps(v_tv3, v_tv4);
        v_tv3 = SWAP_RI_512_S(CONJ_512_S(v_tv3));
        v_cv1 = _mm512_sub_ps(v_tv1, v_tv2);

        // Output point 3 : X[2]
        v_out2 = _mm512_sub_ps(v_cv1, v_tv3);
        // Output point 4 : X[3]
        v_out3 = _mm512_add_ps(v_cv1, v_tv3);
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            SCATTER8_512_S_STRIDED(curr_out, v_out_stride, v_out4);
        }
        else
        {
    ...
    if (remaining_sets >= NUM_SETS_256_S)
    {
        ...
        v_tv4 = _mm256_mul_ps(v_K4, v_av4);

        // Output point 1 : X[0]
        v_out0 = _mm256_add_ps(v_in0, v_av5);

        v_tv1 = _mm256_mul_ps(v_K2, v_av5);
        v_tv2 = _mm256_mul_ps(v_K1, v_av6);
        ...
        v_tv3 = _mm256_mul_ps(v_K4, v_av3);
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            SCATTER4_256_S_STRIDED(curr_out, v_out_stride, v_out4);
        }
        else
        {
    ...
    if (remaining_sets >= NUM_SETS_128_S)
    {
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            curr_out = curr_out + NUM_SETS_128_S * DATA_STRIDE;
            SCATTER2_128_S_STRIDED(curr_out, v_out_stride, v_out4);
        }
        else
        {
                         ...
                         FFTZ_UINT8 flag)
{
    ...
    __m512d v_C3 = _mm512_set1_pd(CRTM_5[2]);
    v_C3 = _mm512_xor_pd(v_C3, _neg_512_d[flag].d);
    __m512d v_C4 = _mm512_set1_pd(CRTM_5[3]);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        __m512d v_cv1, v_tv1, v_tv2, v_tv3, v_tv4;
        ...
        v_av2 = _mm512_add_pd(v_in2, v_in3);
        v_av3 = _mm512_sub_pd(v_in1, v_in4);
        v_av4 = _mm512_sub_pd(v_in2, v_in3);
        v_av5 = _mm512_add_pd(v_av1, v_av2);
        v_av6 = _mm512_sub_pd(v_av1, v_av2);
        v_tv3 = _mm512_mul_pd(v_C3, v_av3);
        v_tv4 = _mm512_mul_pd(v_C4, v_av4);

        // Output point 1 : X[0]
        v_out0 = _mm512_add_pd(v_in0, v_av5);

        v_tv1 = _mm512_mul_pd(v_C2, v_av5);
        v_tv2 = _mm512_mul_pd(v_C1, v_av6);
        v_tv1 = _mm512_sub_pd(v_in0, v_tv1);
        v_tv4 = _mm512_add_pd(v_tv3, v_tv4);
        v_tv4 = SWAP_RI_512_D(CONJ_512_D(v_tv4));
        v_cv1 = _mm512_add_pd(v_tv1, v_tv2);

        // Output point 2 : X[1]
        v_out1 = _mm512_sub_pd(v_cv1, v_tv4);
        // Output point 5 : X[4]
        v_out4 = _mm512_add_pd(v_cv1, v_tv4);

        v_tv3 = _mm512_mul_pd(v_C4, v_av3);
        v_tv4 = _mm512_mul_pd(v_C3, v_av4);
        v_tv3 = _mm512_sub_pd(v_tv3, v_tv4);
        v_tv3 = SWAP_RI_512_D(CONJ_512_D(v_tv3));
        v_cv1 = _mm512_sub_pd(v_tv1, v_tv2);

        // Output point 3 : X[2]
        v_out2 = _mm512_sub_pd(v_cv1, v_tv3);
        // Output point 4 : X[3]
        v_out3 = _mm512_add_pd(v_cv1, v_tv3);
        curr_out = out_r;
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            SCATTER4_512_D_STRIDED(curr_out, v_out_stride, v_out4);
        }
        else
        {
    ...
    if (remaining_sets >= NUM_SETS_256_D)
    {
        ...
        v_tv4 = _mm256_mul_pd(v_K4, v_av4);

        // Output point 1 : X[0]
        v_out0 = _mm256_add_pd(v_in0, v_av5);

        v_tv1 = _mm256_mul_pd(v_K2, v_av5);
        v_tv2 = _mm256_mul_pd(v_K1, v_av6);
        ...
        v_tv3 = _mm256_mul_pd(v_K4, v_av3);
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            curr_out = curr_out + NUM_SETS_256_D * DATA_STRIDE;
            SCATTER2_256_D_STRIDED(curr_out, v_out_stride, v_out4);
        }
        else
        {
    ...
    if (remaining_sets & 1)
    {
        ...
        __m128d _v_K1 = _mm512_castpd512_pd128(v_C1);
        __m128d _v_K2 = _mm512_castpd512_pd128(v_C2);
        __m128d _v_K3 = _mm512_castpd512_pd128(v_C3);
        __m128d _v_K4 = _mm512_castpd512_pd128(v_C4);
        ...
        v_tv3 = _mm_mul_pd(_v_K3, v_av3);
        v_tv4 = _mm_mul_pd(_v_K4, v_av4);

        // Output point 1 : X[0]
        v_out0 = _mm_add_pd(v_in0, v_av5);

        v_tv1 = _mm_mul_pd(_v_K2, v_av5);
        v_tv2 = _mm_mul_pd(_v_K1, v_av6);
        ...
        v_tv3 = _mm_mul_pd(_v_K4, v_av3);
        v_tv4 = _mm_mul_pd(_v_K3, v_av4);
                                 ...
                                 FFTZ_UINT8 direction /* unused */)
{
    if (precision == DT_FLOAT)
    {
        return fft5avx512fp32;
    }
    else if (precision == DT_DOUBLE)
    {
        return fft5avx512fp64;
    }
    else
    {
        return NULL;
