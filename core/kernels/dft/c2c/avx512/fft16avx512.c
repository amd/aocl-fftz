...
static VOID fft16avx512fp32(VOID *in_real, VOID *in_imag, VOID *out_real,
                            ...
                            VOID *twd, UINT8 flag)
{
    ...
    for (count = 0; count < N; count++)
    {
        ...
        GATHER8_512_S(curr_in, v_in_stride, v_in13);
        curr_in = in_r + in_strides[14];
        GATHER8_512_S(curr_in, v_in_stride, v_in14);
        curr_in = in_r + in_strides[15];
        GATHER8_512_S(curr_in, v_in_stride, v_in15);
        ...
        SCATTER8_512_S(curr_out, v_out_stride, v_out13);
        curr_out = out_r + out_strides[14];
        SCATTER8_512_S(curr_out, v_out_stride, v_out14);
        curr_out = out_r + out_strides[15];
        SCATTER8_512_S(curr_out, v_out_stride, v_out15);
    ...
    if (remaining_sets >= NUM_SETS_256_S)
    {
        ...
        curr_in = in_r + in_strides[13];
        GATHER4_256_S(curr_in, v_in_stride, v_in13);
        curr_in = in_r + in_strides[14];
        GATHER4_256_S(curr_in, v_in_stride, v_in14);
        curr_in = in_r + in_strides[15];
        GATHER4_256_S(curr_in, v_in_stride, v_in15);
        ...
        curr_out = out_r + out_strides[13];
        SCATTER4_256_S(curr_out, v_out_stride, v_out13);
        curr_out = out_r + out_strides[14];
        SCATTER4_256_S(curr_out, v_out_stride, v_out14);
        curr_out = out_r + out_strides[15];
        SCATTER4_256_S(curr_out, v_out_stride, v_out15);
...
static VOID fft16avx512fp64(VOID *in_real, VOID *in_imag, VOID *out_real,
                            VOID *out_imag, INTP n, aoclfftz_strides_t *strides,
                            VOID *twd, UINT8 flag)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
    ...
    for (count = 0; count < N; count++)
    {
        ...
        curr_in = in_r + in_strides[13];
        GATHER4_512_D(curr_in, v_in_stride, v_in13);
        curr_in = in_r + in_strides[14];
        GATHER4_512_D(curr_in, v_in_stride, v_in14);
        curr_in = in_r + in_strides[15];
        GATHER4_512_D(curr_in, v_in_stride, v_in15);
        ...
        curr_out = out_r + out_strides[13];
        SCATTER4_512_D(curr_out, v_out_stride, v_out13);
        curr_out = out_r + out_strides[14];
        SCATTER4_512_D(curr_out, v_out_stride, v_out14);
        curr_out = out_r + out_strides[15];
        SCATTER4_512_D(curr_out, v_out_stride, v_out15);
    ...
    if (remaining_sets >= NUM_SETS_256_D)
    {
        ...
        curr_in = in_r + in_strides[13];
        GATHER2_256_D(curr_in, v_in_stride, v_in13);
        curr_in = in_r + in_strides[14];
        GATHER2_256_D(curr_in, v_in_stride, v_in14);
        curr_in = in_r + in_strides[15];
        GATHER2_256_D(curr_in, v_in_stride, v_in15);
        ...
        curr_out = out_r + out_strides[13];
        SCATTER2_256_D(curr_out, v_out_stride, v_out13);
        curr_out = out_r + out_strides[14];
        SCATTER2_256_D(curr_out, v_out_stride, v_out14);
        curr_out = out_r + out_strides[15];
        SCATTER2_256_D(curr_out, v_out_stride, v_out15);
...
kfft_ register_kernel_fft16avx512(UINT8 precision, UINT8 direction /* unused */)
{
    if (precision == DT_FLOAT)
    {
