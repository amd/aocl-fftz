...
/** @file fft16avx512.c
 *
 *  @brief Radix-16 FFT kernel with AVX-512 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT radix-16 FFT implementations using AVX-512
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 15, 72, 256, 55, 103},
                                                     {0, 15, 72, 128,  7, 103}};

ops_cycles_t get_ops_cnt_fft16avx512(FFTZ_UINT8 precision, FFTZ_UINT8 direction)
{
...
static FFTZ_VOID fft16avx512fp32(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 ...
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m512 v_C1 = _mm512_set1_ps(CRTM_16[0]);
    __m512 v_C2 = _mm512_set1_ps(CRTM_16[1]);
    v_C2 = _mm512_xor_ps(v_C2, _neg_512_f[flag].s);
    __m512 v_C3 = _mm512_set1_ps(CRTM_16[2]);
    __m512 v_C4 = _mm512_set1_ps(CRTM_16[2]);
    v_C4 = _mm512_xor_ps(v_C4, _neg_512_f[flag].s);
    __m512 v_C5 = _mm512_set1_ps(CRTM_16[1]);
    __m512 v_C6 = _mm512_set1_ps(CRTM_16[0]);
    v_C6 = _mm512_xor_ps(v_C6, _neg_512_f[flag].s);
    __m512 v_C7 = _mm512_set1_ps(CRTM_16[3]);
    v_C7 = _mm512_xor_ps(v_C7, _neg_512_f[flag].s);

    for (count = 0; count < N; count++)
    {
        __m512 v_in0, v_in1, v_in2, v_in3, v_in4, v_in5;
        __m512 v_in6, v_in7, v_in8, v_in9, v_in10;
        __m512 v_in11, v_in12, v_in13, v_in14, v_in15;
        __m512 v_tv1, v_tv2, v_tv3, v_tv4, v_tv5, v_tv6;
        __m512 v_tv7, v_tv9, v_tv11, v_tv12;
        __m512 v_av1, v_av2, v_av3, v_av4, v_av5, v_av6;
        __m512 v_av7, v_av8, v_av9, v_av10, v_av12, v_av14;
        __m512 v_av15, v_av16, v_av17, v_av18, v_av19, v_av21;
        __m512 v_av22, v_av23, v_av24, v_av25, v_av20, v_av26;
        __m512 v_av27, v_av28, v_av29, v_av30, v_av31;
        __m512 v_av32, v_av33, v_av34, v_av35, v_av36;
        __m512 v_av39, v_av40, v_av41, v_av42, v_av43;
        __m512 v_cv1, v_cv2, v_cv3, v_cv4, v_cv5, v_cv6, v_cv7;
        __m512 v_cv8, v_cv9, v_cv10, v_cv11, v_cv12, v_cv13;
        __m512 v_cv14, v_cv15, v_cv16;
        __m512 v_out0, v_out1, v_out2, v_out3, v_out4, v_out5, v_out6;
        __m512 v_out7, v_out8, v_out9, v_out10, v_out11, v_out12;
        __m512 v_out13, v_out14, v_out15;
        ...
        GATHER8_512_S(curr_in, v_in_stride, v_in15, is_contiguous_in);

        // common calculations
        v_cv1 = _mm512_add_ps(v_in0, v_in8);
        v_cv2 = _mm512_add_ps(v_in1, v_in15);
        v_cv3 = _mm512_add_ps(v_in2, v_in14);
        v_cv4 = _mm512_add_ps(v_in3, v_in13);
        v_cv5 = _mm512_add_ps(v_in4, v_in12);
        v_cv6 = _mm512_add_ps(v_in5, v_in11);
        v_cv7 = _mm512_add_ps(v_in6, v_in10);
        v_cv8 = _mm512_add_ps(v_in7, v_in9);
        v_cv9 = _mm512_sub_ps(v_in0, v_in8);
        v_cv10 = _mm512_sub_ps(v_in1, v_in15);
        v_cv11 = _mm512_sub_ps(v_in2, v_in14);
        v_cv12 = _mm512_sub_ps(v_in3, v_in13);
        v_cv13 = _mm512_sub_ps(v_in4, v_in12);
        v_cv14 = _mm512_sub_ps(v_in5, v_in11);
        v_cv15 = _mm512_sub_ps(v_in6, v_in10);
        v_cv16 = _mm512_sub_ps(v_in7, v_in9);

        v_av1 = _mm512_sub_ps(v_cv8, v_cv2);
        v_tv1 = _mm512_mul_ps(v_C1, v_av1);
        v_av2 = _mm512_sub_ps(v_cv7, v_cv3);
        v_tv2 = _mm512_mul_ps(v_C3, v_av2);
        v_av3 = _mm512_sub_ps(v_cv6, v_cv4);
        v_tv3 = _mm512_mul_ps(v_C5, v_av3);
        v_av4 = _mm512_sub_ps(v_cv9, v_tv2);
        v_av5 = _mm512_add_ps(v_tv3, v_tv1);
        v_av15 = _mm512_sub_ps(v_av4, v_av5);
        v_av6 = _mm512_add_ps(v_cv16, v_cv10);
        v_tv4 = _mm512_mul_ps(v_C2, v_av6);
        v_av7 = _mm512_add_ps(v_cv11, v_cv15);
        v_tv5 = _mm512_mul_ps(v_C4, v_av7);
        v_av8 = _mm512_add_ps(v_cv12, v_cv14);
        v_tv6 = _mm512_mul_ps(v_C6, v_av8);
        v_tv7 = _mm512_mul_ps(v_C7, v_cv13);
        v_av9 = _mm512_add_ps(v_tv5, v_tv7);
        v_av41 = _mm512_add_ps(v_tv4, v_tv6);
        v_av10 = _mm512_add_ps(v_av41, v_av9);
        v_av10 = SWAP_RI_512_S(CONJ_512_S(v_av10));

        // Output point 2 : X[1]
        v_out1 = _mm512_sub_ps(v_av15, v_av10);
        // Output point 16 : X[15]
        v_out15 = _mm512_add_ps(v_av15, v_av10);

        v_av12 = _mm512_add_ps(v_av4, v_av5);
        v_av14 = _mm512_sub_ps(v_av41, v_av9);
        v_av14 = SWAP_RI_512_S(CONJ_512_S(v_av14));

        // Output point 8 : X[7]
        v_out7 = _mm512_sub_ps(v_av12, v_av14);
        // Output point 10 : X[9]
        v_out9 = _mm512_add_ps(v_av12, v_av14);

        v_av16 = _mm512_sub_ps(v_cv1, v_cv5);
        v_av17 = _mm512_add_ps(v_cv2, v_cv8);
        v_av18 = _mm512_add_ps(v_cv4, v_cv6);
        v_av19 = _mm512_sub_ps(v_av17, v_av18);
        v_av20 = _mm512_mul_ps(v_C3, v_av19);
        v_av21 = _mm512_add_ps(v_av16, v_av20);
        v_av22 = _mm512_sub_ps(v_cv14, v_cv12);
        v_av23 = _mm512_sub_ps(v_cv16, v_cv10);
        v_av24 = _mm512_mul_ps(v_C4, _mm512_add_ps(v_av22, v_av23));
        v_av25 = _mm512_sub_ps(v_cv15, v_cv11);
        v_av26 = _mm512_mul_ps(v_C7, v_av25);
        v_av27 = _mm512_add_ps(v_av24, v_av26);
        v_av27 = SWAP_RI_512_S(CONJ_512_S(v_av27));

        // Output point 3 : X[2]
        v_out2 = _mm512_add_ps(v_av21, v_av27);
        // Output point 15 : X[14]
        v_out14 = _mm512_sub_ps(v_av21, v_av27);

        v_av21 = _mm512_sub_ps(v_av16, v_av20);
        v_av27 = _mm512_sub_ps(v_av24, v_av26);
        v_av27 = SWAP_RI_512_S(CONJ_512_S(v_av27));

        // Output point 7 : X[6]
        v_out6 = _mm512_add_ps(v_av21, v_av27);
        // Output point 11 : X[10]
        v_out10 = _mm512_sub_ps(v_av21, v_av27);

        v_av28 = _mm512_sub_ps(_mm512_mul_ps(v_C1, v_av3),
                               _mm512_mul_ps(v_C5, v_av1));

        v_av29 = _mm512_add_ps(v_cv9, v_tv2);
        v_av30 = _mm512_add_ps(v_av29, v_av28);
        v_tv9 = _mm512_mul_ps(v_C2, v_av8);
        v_tv11 = _mm512_mul_ps(v_C6, v_av6);
        v_av31 = _mm512_sub_ps(v_tv11, v_tv9);
        v_av32 = _mm512_sub_ps(v_tv5, v_tv7);
        v_av33 = _mm512_add_ps(v_av31, v_av32);
        v_av33 = SWAP_RI_512_S(CONJ_512_S(v_av33));

        // Output point 4 : X[3]
        v_out3 = _mm512_sub_ps(v_av30, v_av33);
        // Output point 14 : X[13]
        v_out13 = _mm512_add_ps(v_av30, v_av33);

        v_av42 = _mm512_sub_ps(v_av29, v_av28);
        v_av43 = _mm512_sub_ps(v_av31, v_av32);
        v_av43 = SWAP_RI_512_S(CONJ_512_S(v_av43));

        // Output point 6 : X[5]
        v_out5 = _mm512_sub_ps(v_av42, v_av43);
        // Output point 12 : X[11]
        v_out11 = _mm512_add_ps(v_av42, v_av43);

        v_av34 = _mm512_add_ps(v_cv1, v_cv5);
        v_av35 = _mm512_add_ps(v_cv3, v_cv7);
        v_av36 = _mm512_sub_ps(v_av34, v_av35);
        v_tv12 = _mm512_mul_ps(v_C7, _mm512_sub_ps(v_av22, v_av23));
        v_tv12 = SWAP_RI_512_S(CONJ_512_S(v_tv12));

        // Output point 5 : X[4]
        v_out4 = _mm512_sub_ps(v_av36, v_tv12);
        // Output point 13 : X[12]
        v_out12 = _mm512_add_ps(v_av36, v_tv12);

        v_av39 = _mm512_add_ps(v_av34, v_av35);
        v_av40 = _mm512_add_ps(v_av17, v_av18);

        // Output point 1 : X[0]
        v_out0 = _mm512_add_ps(v_av39, v_av40);
        // Output point 9 : X[8]
        v_out8 = _mm512_sub_ps(v_av39, v_av40);
        ...
        else
        {
            ...
            SCATTER8_512_S(curr_out, v_out_stride, v_out15, is_contiguous_out);
        }
    ...
    if (remaining_sets >= NUM_SETS_256_S)
    {
        ...
        curr_in = in_r + in_strides[15];
        GATHER4_256_S(curr_in, v_in_stride, v_in15, is_contiguous_in);
        ...
        else
        {
            ...
            curr_out = out_r + out_strides[15];
            SCATTER4_256_S(curr_out, v_out_stride, v_out15, is_contiguous_out);
        }
    ...
    if (remaining_sets >= NUM_SETS_128_S)
    {
        ...
        curr_in = in_r + in_strides[15];
        GATHER2_128_S(curr_in, v_in_stride, v_in15, is_contiguous_in);
        ...
        else
        {
            ...
            curr_out = out_r + out_strides[15];
            SCATTER2_128_S(curr_out, v_out_stride, v_out15, is_contiguous_out);
        }
...
static FFTZ_VOID fft16avx512fp64(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                 FFTZ_INTP n, aoclfftz_strides_t *strides,
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    __m512d v_C1 = _mm512_set1_pd(CRTM_16[0]);
    __m512d v_C2 = _mm512_set1_pd(CRTM_16[1]);
    v_C2 = _mm512_xor_pd(v_C2, _neg_512_d[flag].d);
    __m512d v_C3 = _mm512_set1_pd(CRTM_16[2]);
    __m512d v_C4 = _mm512_set1_pd(CRTM_16[2]);
    v_C4 = _mm512_xor_pd(v_C4, _neg_512_d[flag].d);
    __m512d v_C5 = _mm512_set1_pd(CRTM_16[1]);
    __m512d v_C6 = _mm512_set1_pd(CRTM_16[0]);
    v_C6 = _mm512_xor_pd(v_C6, _neg_512_d[flag].d);
    __m512d v_C7 = _mm512_set1_pd(CRTM_16[3]);
    v_C7 = _mm512_xor_pd(v_C7, _neg_512_d[flag].d);

    for (count = 0; count < N; count++)
    {
        __m512d v_in0, v_in1, v_in2, v_in3, v_in4, v_in5;
        __m512d v_in6, v_in7, v_in8, v_in9, v_in10;
        __m512d v_in11, v_in12, v_in13, v_in14, v_in15;
        __m512d v_tv1, v_tv2, v_tv3, v_tv4, v_tv5, v_tv6;
        __m512d v_tv7, v_tv9, v_tv11, v_tv12;
        __m512d v_av1, v_av2, v_av3, v_av4, v_av5, v_av6;
        __m512d v_av7, v_av8, v_av9, v_av10, v_av12, v_av14;
        __m512d v_av15, v_av16, v_av17, v_av18, v_av19, v_av21;
        __m512d v_av22, v_av23, v_av24, v_av25, v_av20, v_av26;
        __m512d v_av27, v_av28, v_av29, v_av30, v_av31;
        __m512d v_av32, v_av33, v_av34, v_av35, v_av36;
        __m512d v_av39, v_av40, v_av41, v_av42, v_av43;
        __m512d v_cv1, v_cv2, v_cv3, v_cv4, v_cv5, v_cv6, v_cv7;
        __m512d v_cv8, v_cv9, v_cv10, v_cv11, v_cv12, v_cv13;
        __m512d v_cv14, v_cv15, v_cv16;
        __m512d v_out0, v_out1, v_out2, v_out3, v_out4, v_out5, v_out6;
        __m512d v_out7, v_out8, v_out9, v_out10, v_out11, v_out12;
        __m512d v_out13, v_out14, v_out15;
        ...
        curr_in = in_r + in_strides[15];
        GATHER4_512_D(curr_in, v_in_stride, v_in15, is_contiguous_in);

        // common calculations
        v_cv1 = _mm512_add_pd(v_in0, v_in8);
        v_cv2 = _mm512_add_pd(v_in1, v_in15);
        v_cv3 = _mm512_add_pd(v_in2, v_in14);
        v_cv4 = _mm512_add_pd(v_in3, v_in13);
        v_cv5 = _mm512_add_pd(v_in4, v_in12);
        v_cv6 = _mm512_add_pd(v_in5, v_in11);
        v_cv7 = _mm512_add_pd(v_in6, v_in10);
        v_cv8 = _mm512_add_pd(v_in7, v_in9);
        v_cv9 = _mm512_sub_pd(v_in0, v_in8);
        v_cv10 = _mm512_sub_pd(v_in1, v_in15);
        v_cv11 = _mm512_sub_pd(v_in2, v_in14);
        v_cv12 = _mm512_sub_pd(v_in3, v_in13);
        v_cv13 = _mm512_sub_pd(v_in4, v_in12);
        v_cv14 = _mm512_sub_pd(v_in5, v_in11);
        v_cv15 = _mm512_sub_pd(v_in6, v_in10);
        v_cv16 = _mm512_sub_pd(v_in7, v_in9);

        v_av1 = _mm512_sub_pd(v_cv8, v_cv2);
        v_tv1 = _mm512_mul_pd(v_C1, v_av1);
        v_av2 = _mm512_sub_pd(v_cv7, v_cv3);
        v_tv2 = _mm512_mul_pd(v_C3, v_av2);
        v_av3 = _mm512_sub_pd(v_cv6, v_cv4);
        v_tv3 = _mm512_mul_pd(v_C5, v_av3);
        v_av4 = _mm512_sub_pd(v_cv9, v_tv2);
        v_av5 = _mm512_add_pd(v_tv3, v_tv1);
        v_av15 = _mm512_sub_pd(v_av4, v_av5);
        v_av6 = _mm512_add_pd(v_cv16, v_cv10);
        v_tv4 = _mm512_mul_pd(v_C2, v_av6);
        v_av7 = _mm512_add_pd(v_cv11, v_cv15);
        v_tv5 = _mm512_mul_pd(v_C4, v_av7);
        v_av8 = _mm512_add_pd(v_cv12, v_cv14);
        v_tv6 = _mm512_mul_pd(v_C6, v_av8);
        v_tv7 = _mm512_mul_pd(v_C7, v_cv13);
        v_av9 = _mm512_add_pd(v_tv5, v_tv7);
        v_av41 = _mm512_add_pd(v_tv4, v_tv6);
        v_av10 = _mm512_add_pd(v_av41, v_av9);
        v_av10 = SWAP_RI_512_D(CONJ_512_D(v_av10));

        // Output point 2 : X[1]
        v_out1 = _mm512_sub_pd(v_av15, v_av10);
        // Output point 16 : X[15]
        v_out15 = _mm512_add_pd(v_av15, v_av10);
        v_av12 = _mm512_add_pd(v_av4, v_av5);
        v_av14 = _mm512_sub_pd(v_av41, v_av9);
        v_av14 = SWAP_RI_512_D(CONJ_512_D(v_av14));

        // Output point 8 : X[7]
        v_out7 = _mm512_sub_pd(v_av12, v_av14);
        // Output point 10 : X[9]
        v_out9 = _mm512_add_pd(v_av12, v_av14);

        v_av16 = _mm512_sub_pd(v_cv1, v_cv5);
        v_av17 = _mm512_add_pd(v_cv2, v_cv8);
        v_av18 = _mm512_add_pd(v_cv4, v_cv6);
        v_av19 = _mm512_sub_pd(v_av17, v_av18);
        v_av20 = _mm512_mul_pd(v_C3, v_av19);
        v_av21 = _mm512_add_pd(v_av16, v_av20);
        v_av22 = _mm512_sub_pd(v_cv14, v_cv12);
        v_av23 = _mm512_sub_pd(v_cv16, v_cv10);
        v_av24 = _mm512_mul_pd(v_C4, _mm512_add_pd(v_av22, v_av23));
        v_av25 = _mm512_sub_pd(v_cv15, v_cv11);
        v_av26 = _mm512_mul_pd(v_C7, v_av25);
        v_av27 = _mm512_add_pd(v_av24, v_av26);
        v_av27 = SWAP_RI_512_D(CONJ_512_D(v_av27));

        // Output point 3 : X[2]
        v_out2 = _mm512_add_pd(v_av21, v_av27);
        // Output point 15 : X[14]
        v_out14 = _mm512_sub_pd(v_av21, v_av27);

        v_av21 = _mm512_sub_pd(v_av16, v_av20);
        v_av27 = _mm512_sub_pd(v_av24, v_av26);
        v_av27 = SWAP_RI_512_D(CONJ_512_D(v_av27));

        // Output point 7 : X[6]
        v_out6 = _mm512_add_pd(v_av21, v_av27);
        // Output point 11 : X[10]
        v_out10 = _mm512_sub_pd(v_av21, v_av27);

        v_av28 = _mm512_sub_pd(_mm512_mul_pd(v_C1, v_av3),
                               _mm512_mul_pd(v_C5, v_av1));
        v_av29 = _mm512_add_pd(v_cv9, v_tv2);
        v_av30 = _mm512_add_pd(v_av29, v_av28);
        v_tv9 = _mm512_mul_pd(v_C2, v_av8);
        v_tv11 = _mm512_mul_pd(v_C6, v_av6);
        v_av31 = _mm512_sub_pd(v_tv11, v_tv9);
        v_av32 = _mm512_sub_pd(v_tv5, v_tv7);
        v_av33 = _mm512_add_pd(v_av31, v_av32);
        v_av33 = SWAP_RI_512_D(CONJ_512_D(v_av33));

        // Output point 4 : X[3]
        v_out3 = _mm512_sub_pd(v_av30, v_av33);
        // Output point 14 : X[13]
        v_out13 = _mm512_add_pd(v_av30, v_av33);

        v_av42 = _mm512_sub_pd(v_av29, v_av28);
        v_av43 = _mm512_sub_pd(v_av31, v_av32);
        v_av43 = SWAP_RI_512_D(CONJ_512_D(v_av43));

        // Output point 6 : X[5]
        v_out5 = _mm512_sub_pd(v_av42, v_av43);
        // Output point 12 : X[11]
        v_out11 = _mm512_add_pd(v_av42, v_av43);

        v_av34 = _mm512_add_pd(v_cv1, v_cv5);
        v_av35 = _mm512_add_pd(v_cv3, v_cv7);
        v_av36 = _mm512_sub_pd(v_av34, v_av35);
        v_tv12 = _mm512_mul_pd(v_C7, _mm512_sub_pd(v_av22, v_av23));

        v_tv12 = SWAP_RI_512_D(CONJ_512_D(v_tv12));

        // Output point 5 : X[4]
        v_out4 = _mm512_sub_pd(v_av36, v_tv12);
        // Output point 13 : X[12]
        v_out12 = _mm512_add_pd(v_av36, v_tv12);

        v_av39 = _mm512_add_pd(v_av34, v_av35);
        v_av40 = _mm512_add_pd(v_av17, v_av18);

        // Output point 1 : X[0]
        v_out0 = _mm512_add_pd(v_av39, v_av40);
        // Output point 9 : X[8]
        v_out8 = _mm512_sub_pd(v_av39, v_av40);
        ...
        else
        {
            ...
            curr_out = out_r + out_strides[15];
            SCATTER4_512_D(curr_out, v_out_stride, v_out15, is_contiguous_out);
        }
    ...
    if (remaining_sets >= NUM_SETS_256_D)
    {
        ...
        curr_in = in_r + in_strides[15];
        GATHER2_256_D(curr_in, v_in_stride, v_in15, is_contiguous_in);
        ...
        else
        {
            ...
            curr_out = out_r + out_strides[15];
            SCATTER2_256_D(curr_out, v_out_stride, v_out15, is_contiguous_out);
        }
...
kfft_ register_kernel_fft16avx512(FFTZ_UINT8 precision,
                                  FFTZ_UINT8 direction /* unused */)
{
    if (precision == DT_FLOAT)
    {
        return fft16avx512fp32;
    }
    else if (precision == DT_DOUBLE)
    {
        return fft16avx512fp64;
    }
    else
    {
        return NULL;
