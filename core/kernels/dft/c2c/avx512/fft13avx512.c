...
ops_cycles_t get_ops_cnt_fft13avx512(FFTZ_UINT8 precision, FFTZ_UINT8 direction)
{
...
static FFTZ_VOID fft13avx512fp32(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 ...
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    v_C9 = _mm512_xor_ps(v_C9, _neg_512_f[flag].s);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            SCATTER8_512_S_STRIDED(curr_out, v_out_stride, v_out12);
        }
        else
        {
...
static FFTZ_VOID fft13avx512fp64(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                 FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                 FFTZ_INTP n, aoclfftz_strides_t *strides,
                                 FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
    ...
    v_C9 = _mm512_xor_pd(v_C9, _neg_512_d[flag].d);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        if (out_strides[1] == DATA_STRIDE)
        {
            ...
            TRANSPOSE_ST4_512_D(curr_out, v_out_stride, v_out8, v_out9, v_out10,
                                v_out11);
            curr_out = curr_out + NUM_SETS_512_D * DATA_STRIDE;
            SCATTER4_512_D_STRIDED(curr_out, v_out_stride, v_out12);
        }
        else
        {
...
kfft_ register_kernel_fft13avx512(FFTZ_UINT8 precision,
