...
/** @file twid_fwd_fft15c.c
 *
 *  @brief Forward-only twiddle Radix-15 FFT kernel with scalar operations in C
 *
...
static FFTZ_VOID twid_fwd_fft15c_fp64(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
...
static FFTZ_VOID twid_fwd_fft15c_fp32(FFTZ_VOID *in_real, FFTZ_VOID *in_imag,
                                      FFTZ_VOID *out_real, FFTZ_VOID *out_imag,
                                      FFTZ_INTP n, aoclfftz_strides_t *strides,
                                      FFTZ_VOID *twd, FFTZ_UINT8 flag)
{
                                      ...
                                      FFTZ_UINT8 direction /* unused */)
{
    if (precision == DT_FLOAT)
    {
        return twid_fwd_fft15c_fp32;
    }
    else if (precision == DT_DOUBLE)
    {
        return twid_fwd_fft15c_fp64;
    }
    else
    {
        return NULL;
