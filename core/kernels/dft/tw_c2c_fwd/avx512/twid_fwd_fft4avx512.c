...
/** @file twid_fwd_fft4avx512.c
 *
 *  @brief Forward-only twiddle Radix-4 FFT kernel with avx512 operations using
 *  x86 SIMD intrinsics
 *
...
#define TWID_KNAME_FP32 twid_fwd_fft4avx512fp32
#define TWID_KNAME_FP64 twid_fwd_fft4avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_fwd_fft4avx512
#define REGISTER_KERNEL register_kernel_twid_fwd_fft4avx512
