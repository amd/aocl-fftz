...
/** @file twid_fwd_fft16avx512.c
 *
 *  @brief Forward-only twiddle Radix-16 FFT kernel with avx512 operations using
 *  x86 SIMD intrinsics
 *
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {
    {15, 45, 72, 286, 145, 103}, {15, 45, 72, 158, 67, 103}};

#define TWID_KNAME_FP32 twid_fwd_fft16avx512fp32
#define TWID_KNAME_FP64 twid_fwd_fft16avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_fwd_fft16avx512
#define REGISTER_KERNEL register_kernel_twid_fwd_fft16avx512
