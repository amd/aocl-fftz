...
/** @file twid_fwd_fft12avx512.c
 *
 *  @brief Forward-only twiddle Radix-12 FFT kernel with avx512 operations using
 *  x86 SIMD intrinsics
 *
 *  This file contains the DIT twiddle radix-12 FFT implementations using
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{11, 32, 48, 214, 107, 78},
                                                     {11, 32, 48, 118, 49, 78}};

#define TWID_KNAME_FP32 twid_fwd_fft12avx512fp32
#define TWID_KNAME_FP64 twid_fwd_fft12avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_fwd_fft12avx512
#define REGISTER_KERNEL register_kernel_twid_fwd_fft12avx512
...
#include "core/kernels/dft/twid_c2c_common/twid_fft12.h"
