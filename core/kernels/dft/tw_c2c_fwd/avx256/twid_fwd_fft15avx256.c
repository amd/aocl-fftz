...
/** @file twid_fwd_fft15avx256.c
 *
 *  @brief Forward-only twiddle Radix-15 FFT kernel with avx256 operations using
 *  x86 SIMD intrinsics
 *
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 56, 92, 134, 106, 37},
                                                     {0, 56, 92, 74, 63, 37}};

#define TWID_KNAME_FP32 twid_fwd_fft15avx256fp32
#define TWID_KNAME_FP64 twid_fwd_fft15avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_fwd_fft15avx256
#define REGISTER_KERNEL register_kernel_twid_fwd_fft15avx256
...
#include "core/kernels/dft/twid_c2c_common/twid_fft15.h"
