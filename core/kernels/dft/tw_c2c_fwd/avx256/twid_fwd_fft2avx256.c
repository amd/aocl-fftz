...
/** @file twid_fwd_fft2avx256.c
 *
 *  @brief Forward-only twiddle Radix-2 FFT kernel with avx256 operations using
 *  x86 SIMD intrinsics
 *
...
#define TWID_KNAME_FP32 twid_fwd_fft2avx256fp32
#define TWID_KNAME_FP64 twid_fwd_fft2avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_fwd_fft2avx256
#define REGISTER_KERNEL register_kernel_twid_fwd_fft2avx256
