...
/** @file twid_fwd_fft9avx128.c
 *
 *  @brief Forward-only twiddle Radix-9 FFT kernel with avx128 operations using
 *  x86 SIMD intrinsics
 *
...
#define TWID_KNAME_FP32 twid_fwd_fft9avx128fp32
#define TWID_KNAME_FP64 twid_fwd_fft9avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_fwd_fft9avx128
#define REGISTER_KERNEL register_kernel_twid_fwd_fft9avx128
