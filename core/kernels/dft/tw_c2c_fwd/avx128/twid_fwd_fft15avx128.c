...
/** @file twid_fwd_fft15avx128.c
 *
 *  @brief Forward-only twiddle Radix-15 FFT kernel with avx128 operations using
 *  x86 SIMD intrinsics
 *
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 56, 92, 74, 91, 7},
                                                     {0, 56, 92, 58, 35, 7}};

#define TWID_KNAME_FP32 twid_fwd_fft15avx128fp32
#define TWID_KNAME_FP64 twid_fwd_fft15avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_fwd_fft15avx128
#define REGISTER_KERNEL register_kernel_twid_fwd_fft15avx128
