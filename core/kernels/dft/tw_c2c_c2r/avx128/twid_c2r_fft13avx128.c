...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 62, 102, 64, 66, 15},
                                                     {0, 62, 102, 38, 42, 15}};

#define TWID_KNAME_FP32 twid_c2r_fft13avx128fp32
#define TWID_KNAME_FP64 twid_c2r_fft13avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft13avx128
#define REGISTER_KERNEL register_kernel_twid_c2r_fft13avx128
