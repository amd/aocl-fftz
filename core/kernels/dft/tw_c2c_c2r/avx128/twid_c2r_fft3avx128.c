...
#define TWID_KNAME_FP32 twid_c2r_fft3avx128fp32
#define TWID_KNAME_FP64 twid_c2r_fft3avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft3avx128
#define REGISTER_KERNEL register_kernel_twid_c2r_fft3avx128
