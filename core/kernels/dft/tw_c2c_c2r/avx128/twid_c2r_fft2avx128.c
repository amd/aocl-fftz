...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 2, 3, 9, 5, 1},
                                                     {0, 2, 3, 5, 3, 1}};

#define TWID_KNAME_FP32 twid_c2r_fft2avx128fp32
#define TWID_KNAME_FP64 twid_c2r_fft2avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft2avx128
#define REGISTER_KERNEL register_kernel_twid_c2r_fft2avx128
