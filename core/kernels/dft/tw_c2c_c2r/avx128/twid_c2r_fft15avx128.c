...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 56, 92, 74, 77, 14},
                                                     {0, 56, 92, 44, 49, 14}};

#define TWID_KNAME_FP32 twid_c2r_fft15avx128fp32
#define TWID_KNAME_FP64 twid_c2r_fft15avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft15avx128
#define REGISTER_KERNEL register_kernel_twid_c2r_fft15avx128
