...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 14, 23, 29, 27, 5},
                                                     {0, 14, 23, 17, 17, 5}};

#define TWID_KNAME_FP32 twid_c2r_fft6avx128fp32
#define TWID_KNAME_FP64 twid_c2r_fft6avx128fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft6avx128
#define REGISTER_KERNEL register_kernel_twid_c2r_fft6avx128
