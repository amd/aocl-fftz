...
#define TWID_KNAME_FP32 twid_c2r_fft8avx256fp32
#define TWID_KNAME_FP64 twid_c2r_fft8avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft8avx256
#define REGISTER_KERNEL register_kernel_twid_c2r_fft8avx256
