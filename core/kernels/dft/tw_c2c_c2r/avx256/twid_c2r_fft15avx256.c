...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 56, 92, 134, 92, 44},
                                                     {0, 56, 92, 74, 49, 44}};

#define TWID_KNAME_FP32 twid_c2r_fft15avx256fp32
#define TWID_KNAME_FP64 twid_c2r_fft15avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft15avx256
#define REGISTER_KERNEL register_kernel_twid_c2r_fft15avx256
