 ...
 *
 *  This file contains the DIT twiddle radix-2 FFT implementations using AVX-256
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 2, 3, 17, 7, 9},
                                                     {0, 2, 3, 9, 3, 9}};

#define TWID_KNAME_FP32 twid_c2r_fft2avx256fp32
#define TWID_KNAME_FP64 twid_c2r_fft2avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft2avx256
#define REGISTER_KERNEL register_kernel_twid_c2r_fft2avx256
