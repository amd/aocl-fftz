...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 30, 39, 62, 40, 20},
                                                     {0, 30, 39, 34, 21, 20}};

#define TWID_KNAME_FP32 twid_c2r_fft7avx256fp32
#define TWID_KNAME_FP64 twid_c2r_fft7avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft7avx256
#define REGISTER_KERNEL register_kernel_twid_c2r_fft7avx256
