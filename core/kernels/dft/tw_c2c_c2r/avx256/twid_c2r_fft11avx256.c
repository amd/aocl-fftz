...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 70, 80, 98, 66, 32},
                                                     {0, 70, 80, 54, 35, 32}};

#define TWID_KNAME_FP32 twid_c2r_fft11avx256fp32
#define TWID_KNAME_FP64 twid_c2r_fft11avx256fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft11avx256
#define REGISTER_KERNEL register_kernel_twid_c2r_fft11avx256
