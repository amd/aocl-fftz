...
/** @file twid_c2r_fft2avx512.c
 *
 *  @brief C2R fused twiddle (conjugate input + twiddle output) Radix-2 FFT
 *  kernel with avx512 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT twiddle radix-2 FFT implementations using AVX-512
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{1, 2, 2, 34, 11, 13},
                                                     {1, 2, 2, 18, 3, 13}};

#define TWID_KNAME_FP32 twid_c2r_fft2avx512fp32
#define TWID_KNAME_FP64 twid_c2r_fft2avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft2avx512
#define REGISTER_KERNEL register_kernel_twid_c2r_fft2avx512
