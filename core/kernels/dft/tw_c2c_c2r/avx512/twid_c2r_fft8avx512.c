...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{7, 18, 26, 142, 62, 55},
                                                     {7, 18, 26, 78, 24, 55}};

#define TWID_KNAME_FP32 twid_c2r_fft8avx512fp32
#define TWID_KNAME_FP64 twid_c2r_fft8avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft8avx512
#define REGISTER_KERNEL register_kernel_twid_c2r_fft8avx512
