...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{12, 62, 90, 232, 105, 93},
                                                     {12, 62, 90, 128, 42, 93}};

#define TWID_KNAME_FP32 twid_c2r_fft13avx512fp32
#define TWID_KNAME_FP64 twid_c2r_fft13avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft13avx512
#define REGISTER_KERNEL register_kernel_twid_c2r_fft13avx512
...
#include "core/kernels/dft/twid_c2c_common/twid_fft13.h"
