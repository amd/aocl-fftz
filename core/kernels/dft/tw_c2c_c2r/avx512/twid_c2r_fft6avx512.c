...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{5, 14, 18, 106, 45, 41},
                                                     {5, 14, 18, 58, 17, 41}};

#define TWID_KNAME_FP32 twid_c2r_fft6avx512fp32
#define TWID_KNAME_FP64 twid_c2r_fft6avx512fp64
#define GET_OPS_COUNT get_ops_cnt_twid_c2r_fft6avx512
#define REGISTER_KERNEL register_kernel_twid_c2r_fft6avx512
