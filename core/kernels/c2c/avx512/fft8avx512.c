...
/** @file fft8avx512.c
 *
 *  @brief Radix-8 FFT kernel with AVX-512 operations using x86 SIMD intrinsics
 *
 *  This file contains the DIT radix-8 FFT implementations using AVX-512
...
static const ops_cycles_t ops_cnt[NUM_PRECISIONS] = {{0, 4, 26, 128, 27, 51},
                                                     {0, 4, 26,  64,  3, 51}};
...
static VOID fft8avx512fp32(VOID *in_real, VOID *in_imag, VOID *out_real,
                           ...
                           VOID *twd, UINT8 flag)
{
    ...
    __m512 v_C1 = _mm512_set1_ps(CRTM_8[0]);
    v_C1 = _mm512_xor_ps(v_C1, _neg_512_f[flag].s);
    __m512 v_C2 = _mm512_set1_ps(CRTM_8[1]);
    __m512 v_C3 = _mm512_xor_ps(v_C2, _neg_512_f[flag].s);
    ...
    for (count = 0; count < N; count++)
    {
        ...
        __m512 v_av1, v_av2, v_av3, v_av4, v_av5, v_av6, v_av7, v_av8,
               v_tv1, v_tv2, v_tv3;
        __m512 v_cv1, v_cv2, v_cv3, v_cv4;
        ...
        // common operations
        v_av1 = _mm512_add_ps(v_in0, v_in4);
        v_av2 = _mm512_add_ps(v_in2, v_in6);
        v_av3 = _mm512_add_ps(v_in1, v_in5);
        v_av4 = _mm512_add_ps(v_in3, v_in7);

        v_av5 = _mm512_sub_ps(v_in0, v_in4);
        v_av6 = _mm512_sub_ps(v_in2, v_in6);
        v_av7 = _mm512_sub_ps(v_in1, v_in5);
        v_av8 = _mm512_sub_ps(v_in3, v_in7);

        v_cv1 = _mm512_add_ps(v_av1, v_av2);
        v_cv2 = _mm512_add_ps(v_av3, v_av4);

        // Output point 1
        v_out0 = _mm512_add_ps(v_cv1, v_cv2);
        // Output point 5
        v_out4 = _mm512_sub_ps(v_cv1, v_cv2);

        v_cv1 = _mm512_sub_ps(v_av3, v_av4);
        v_cv2 = _mm512_sub_ps(v_av1, v_av2);

        v_tv1 = _mm512_mul_ps(v_C1, v_cv1);
        v_tv1 = CONJ_512_S(v_tv1);
        v_tv1 = SWAP_RI_512_S(v_tv1);

        // Output point 7
        v_out6 = _mm512_add_ps(v_cv2, v_tv1);
        // Output point 3
        v_out2 = _mm512_sub_ps(v_cv2, v_tv1);

        v_cv1 = _mm512_sub_ps(v_av7, v_av8);
        v_tv1 = _mm512_mul_ps(v_C2, v_cv1);

        v_cv1 = _mm512_add_ps(v_av7, v_av8);
        v_tv2 = _mm512_mul_ps(v_C3, v_cv1);
        v_tv3 = _mm512_mul_ps(v_C1, v_av6);

        v_cv1 = _mm512_sub_ps(v_tv3, v_tv2);
        v_cv2 = _mm512_add_ps(v_tv3, v_tv2);

        v_cv1 = CONJ_512_S(v_cv1);
        v_cv1 = SWAP_RI_512_S(v_cv1);
        v_cv2 = CONJ_512_S(v_cv2);
        v_cv2 = SWAP_RI_512_S(v_cv2);

        v_cv3 = _mm512_sub_ps(v_av5, v_tv1);
        v_cv4 = _mm512_add_ps(v_av5, v_tv1);

        // Output point 2
        v_out1 = _mm512_sub_ps(v_cv4, v_cv2);
        // Output point 8
        v_out7 = _mm512_add_ps(v_cv4, v_cv2);

        // Output point 6
        v_out5 = _mm512_sub_ps(v_cv3, v_cv1);
        // Output point 4
        v_out3 = _mm512_add_ps(v_cv3, v_cv1);
    ...
    if (remaining_sets >= NUM_SETS_256_S)
    {
        ...
        v_tv1 = _mm256_mul_ps(v_K1, v_cv1);
        ...
        v_tv1 = _mm256_mul_ps(v_K2, v_cv1);

        v_cv1 = _mm256_add_ps(v_av7, v_av8);
        v_tv2 = _mm256_mul_ps(v_K3, v_cv1);
        v_tv3 = _mm256_mul_ps(v_K1, v_av6);
...
static VOID fft8avx512fp64(VOID *in_real, VOID *in_imag, VOID *out_real,
                           VOID *out_imag, INTP n, aoclfftz_strides_t *strides,
                           VOID *twd, UINT8 flag)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
    ...
    __m512d v_C1 = _mm512_set1_pd(CRTM_8[0]);
    v_C1 = _mm512_xor_pd(v_C1, _neg_512_d[flag].d);
    __m512d v_C2 = _mm512_set1_pd(CRTM_8[1]);
    __m512d v_C3 = _mm512_xor_pd(v_C2, _neg_512_d[flag].d);

    for (count = 0; count < N; count++)
    {
        __m512d v_in0, v_in1, v_in2, v_in3, v_in4, v_in5, v_in6, v_in7;
        __m512d v_out0, v_out1, v_out2, v_out3, v_out4, v_out5, v_out6, v_out7;
        __m512d v_av1, v_av2, v_av3, v_av4, v_av5, v_av6, v_av7, v_av8,
                v_tv1, v_tv2, v_tv3;
        __m512d v_cv1, v_cv2, v_cv3, v_cv4;
        ...
        // common operations
        v_av1 = _mm512_add_pd(v_in0, v_in4);
        v_av2 = _mm512_add_pd(v_in2, v_in6);
        v_av3 = _mm512_add_pd(v_in1, v_in5);
        v_av4 = _mm512_add_pd(v_in3, v_in7);

        v_av5 = _mm512_sub_pd(v_in0, v_in4);
        v_av6 = _mm512_sub_pd(v_in2, v_in6);
        v_av7 = _mm512_sub_pd(v_in1, v_in5);
        v_av8 = _mm512_sub_pd(v_in3, v_in7);

        v_cv1 = _mm512_add_pd(v_av1, v_av2);
        v_cv2 = _mm512_add_pd(v_av3, v_av4);

        // Output point 1
        v_out0 = _mm512_add_pd(v_cv1, v_cv2);
        // Output point 5
        v_out4 = _mm512_sub_pd(v_cv1, v_cv2);

        v_cv1 = _mm512_sub_pd(v_av3, v_av4);
        v_cv2 = _mm512_sub_pd(v_av1, v_av2);

        v_tv1 = _mm512_mul_pd(v_C1, v_cv1);
        v_tv1 = CONJ_512_D(v_tv1);
        v_tv1 = SWAP_RI_512_D(v_tv1);

        // Output point 7
        v_out6 = _mm512_add_pd(v_cv2, v_tv1);
        // Output point 3
        v_out2 = _mm512_sub_pd(v_cv2, v_tv1);

        v_cv1 = _mm512_sub_pd(v_av7, v_av8);
        v_tv1 = _mm512_mul_pd(v_C2, v_cv1);

        v_cv1 = _mm512_add_pd(v_av7, v_av8);
        v_tv2 = _mm512_mul_pd(v_C3, v_cv1);
        v_tv3 = _mm512_mul_pd(v_C1, v_av6);

        v_cv1 = _mm512_sub_pd(v_tv3, v_tv2);
        v_cv2 = _mm512_add_pd(v_tv3, v_tv2);

        v_cv1 = CONJ_512_D(v_cv1);
        v_cv1 = SWAP_RI_512_D(v_cv1);
        v_cv2 = CONJ_512_D(v_cv2);
        v_cv2 = SWAP_RI_512_D(v_cv2);

        v_cv3 = _mm512_sub_pd(v_av5, v_tv1);
        v_cv4 = _mm512_add_pd(v_av5, v_tv1);

        // Output point 2
        v_out1 = _mm512_sub_pd(v_cv4, v_cv2);
        // Output point 8
        v_out7 = _mm512_add_pd(v_cv4, v_cv2);

        // Output point 6
        v_out5 = _mm512_sub_pd(v_cv3, v_cv1);
        // Output point 4
        v_out3 = _mm512_add_pd(v_cv3, v_cv1);
    ...
    if (remaining_sets >= NUM_SETS_256_D)
    {
        ...
        v_tv1 = _mm256_mul_pd(v_K1, v_cv1);
        ...
        v_tv1 = _mm256_mul_pd(v_K2, v_cv1);

        v_cv1 = _mm256_add_pd(v_av7, v_av8);
        v_tv2 = _mm256_mul_pd(v_K3, v_cv1);
        v_tv3 = _mm256_mul_pd(v_K1, v_av6);
...
kfft_ register_kernel_fft8avx512(UINT8 precision, UINT8 direction /* unused */)
{
    if (precision == DT_FLOAT)
    {
        return fft8avx512fp32;
    }
    else if (precision == DT_DOUBLE)
    {
        return fft8avx512fp64;
    }
    else
    {
        return NULL;
