...
static FFTZ_VOID complex_mul_fp32_c_fwd(FFTZ_VOID *out, FFTZ_VOID *a,
...
static FFTZ_VOID complex_mul_fp32_c_bwd(FFTZ_VOID *out, FFTZ_VOID *a,
                                        FFTZ_VOID *b, FFTZ_INTP n)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
    FFTZ_FLOAT *p_out = (FFTZ_FLOAT *)out;
...
static FFTZ_VOID complex_mul_fp64_c_fwd(FFTZ_VOID *out, FFTZ_VOID *a,
                                        FFTZ_VOID *b, FFTZ_INTP n)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
...
static FFTZ_VOID complex_mul_fp64_c_bwd(FFTZ_VOID *out, FFTZ_VOID *a,
                                        FFTZ_VOID *b, FFTZ_INTP n)
{
    AOCLFFTZ_LOG(DEBUG, global_logger_mode, "Enter");
    FFTZ_DOUBLE *p_out = (FFTZ_DOUBLE *)out;
