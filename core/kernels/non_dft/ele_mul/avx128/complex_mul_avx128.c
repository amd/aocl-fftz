                                                 ...
                                                 FFTZ_UINT8 direction)
{
    if (direction == FORWARD_FFT_DIR)
    {
        ...
        {
            return complex_mul_fp32_avx128_fwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return complex_mul_fp64_avx128_fwd;
        }
        else
        {
            return NULL;
    ...
    else
    {
        if (precision == DT_FLOAT)
        {
            return complex_mul_fp32_avx128_bwd;
        }
        else if (precision == DT_DOUBLE)
        {
            return complex_mul_fp64_avx128_bwd;
        }
        else
        {
            return NULL;
