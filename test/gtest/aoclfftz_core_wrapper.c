...
ops_cycles_t get_ops_cnt_r2hc_rfft9c_wrapper(UINT8 precision, UINT8 direction)
{
    return get_ops_cnt_r2hc_rfft9c(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hc_rfft11c_wrapper(UINT8 precision, UINT8 direction)
{
    return get_ops_cnt_r2hc_rfft11c(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hcf_rfft9c_wrapper(UINT8 precision, UINT8 direction)
{
    return get_ops_cnt_r2hcf_rfft9c(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hcf_rfft11c_wrapper(UINT8 precision, UINT8 direction)
{
    return get_ops_cnt_r2hcf_rfft11c(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hc_rfft9avx128_wrapper(UINT8 precision,
                                                  UINT8 direction)
{
    return get_ops_cnt_r2hc_rfft9avx128(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hc_rfft11avx128_wrapper(UINT8 precision,
                                                   UINT8 direction)
{
    return get_ops_cnt_r2hc_rfft11avx128(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hcf_rfft9avx128_wrapper(UINT8 precision,
                                                    UINT8 direction)
{
    return get_ops_cnt_r2hcf_rfft9avx128(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hcf_rfft11avx128_wrapper(UINT8 precision,
                                                    UINT8 direction)
{
    return get_ops_cnt_r2hcf_rfft11avx128(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hc_rfft9avx256_wrapper(UINT8 precision,
                                                  UINT8 direction)
{
    return get_ops_cnt_r2hc_rfft9avx256(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hc_rfft11avx256_wrapper(UINT8 precision,
                                                   UINT8 direction)
{
    return get_ops_cnt_r2hc_rfft11avx256(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hcf_rfft9avx256_wrapper(UINT8 precision,
                                                   UINT8 direction)
{
    return get_ops_cnt_r2hcf_rfft9avx256(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hcf_rfft11avx256_wrapper(UINT8 precision,
                                                    UINT8 direction)
{
    return get_ops_cnt_r2hcf_rfft11avx256(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hc_rfft9avx512_wrapper(UINT8 precision,
                                                  UINT8 direction)
{
    return get_ops_cnt_r2hc_rfft9avx512(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hc_rfft11avx512_wrapper(UINT8 precision,
                                                   UINT8 direction)
{
    return get_ops_cnt_r2hc_rfft11avx512(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hcf_rfft9avx512_wrapper(UINT8 precision,
                                                   UINT8 direction)
{
    return get_ops_cnt_r2hcf_rfft9avx512(precision, direction);
}
...
ops_cycles_t get_ops_cnt_r2hcf_rfft11avx512_wrapper(UINT8 precision,
                                                    UINT8 direction)
{
    return get_ops_cnt_r2hcf_rfft11avx512(precision, direction);
}
...
kfft_ register_kernel_r2hc_rfft9c_wrapper(UINT8 precision, UINT8 direction)
{
    return register_kernel_r2hc_rfft9c(precision, direction);
}
...
kfft_ register_kernel_r2hc_rfft11c_wrapper(UINT8 precision, UINT8 direction)
{
    return register_kernel_r2hc_rfft11c(precision, direction);
}
...
kfft_ register_kernel_r2hcf_rfft9c_wrapper(UINT8 precision, UINT8 direction)
{
    return register_kernel_r2hcf_rfft9c(precision, direction);
}
...
kfft_ register_kernel_r2hcf_rfft11c_wrapper(UINT8 precision, UINT8 direction)
{
    return register_kernel_r2hcf_rfft11c(precision, direction);
}
...
kfft_ register_kernel_r2hc_rfft9avx128_wrapper(UINT8 precision, UINT8 direction)
{
    return register_kernel_r2hc_rfft9avx128(precision, direction);
}
...
kfft_ register_kernel_r2hc_rfft11avx128_wrapper(UINT8 precision,
                                                UINT8 direction)
{
    return register_kernel_r2hc_rfft11avx128(precision, direction);
}
...
kfft_ register_kernel_r2hcf_rfft9avx128_wrapper(UINT8 precision,
                                                UINT8 direction)
{
    return register_kernel_r2hcf_rfft9avx128(precision, direction);
}
...
kfft_ register_kernel_r2hcf_rfft11avx128_wrapper(UINT8 precision,
                                                 UINT8 direction)
{
    return register_kernel_r2hcf_rfft11avx128(precision, direction);
}
...
kfft_ register_kernel_r2hc_rfft9avx256_wrapper(UINT8 precision, UINT8 direction)
{
    return register_kernel_r2hc_rfft9avx256(precision, direction);
}
...
kfft_ register_kernel_r2hc_rfft11avx256_wrapper(UINT8 precision,
                                                UINT8 direction)
{
    return register_kernel_r2hc_rfft11avx256(precision, direction);
}
...
kfft_ register_kernel_r2hcf_rfft9avx256_wrapper(UINT8 precision,
                                                UINT8 direction)
{
    return register_kernel_r2hcf_rfft9avx256(precision, direction);
}
...
kfft_ register_kernel_r2hcf_rfft11avx256_wrapper(UINT8 precision,
                                                 UINT8 direction)
{
    return register_kernel_r2hcf_rfft11avx256(precision, direction);
}
...
kfft_ register_kernel_r2hc_rfft9avx512_wrapper(UINT8 precision, UINT8 direction)
{
    return register_kernel_r2hc_rfft9avx512(precision, direction);
}
...
kfft_ register_kernel_r2hc_rfft11avx512_wrapper(UINT8 precision,
                                                UINT8 direction)
{
    return register_kernel_r2hc_rfft11avx512(precision, direction);
}
...
kfft_ register_kernel_r2hcf_rfft9avx512_wrapper(UINT8 precision,
                                                UINT8 direction)
{
    return register_kernel_r2hcf_rfft9avx512(precision, direction);
}
...
kfft_ register_kernel_r2hcf_rfft11avx512_wrapper(UINT8 precision,
                                                 UINT8 direction)
{
    return register_kernel_r2hcf_rfft11avx512(precision, direction);
}
